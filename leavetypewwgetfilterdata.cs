...
namespace GeneXus.Programs {
   public class leavetypewwgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV31GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV30GridState.gxTpr_Filtervalues.Item(AV46GXV1));
      ...
      protected void S121( )
      {
         ...
         AV48Leavetypewwds_1_filterfulltext = AV39FilterFullText;
         AV49Leavetypewwds_2_tfleavetypename = AV13TFLeaveTypeName;
         AV50Leavetypewwds_3_tfleavetypename_sel = AV14TFLeaveTypeName_Sel;
         AV51Leavetypewwds_4_tfleavetypevacationleave_sels = AV41TFLeaveTypeVacationLeave_Sels;
         AV52Leavetypewwds_5_tfleavetypeloggingworkhours_sels = AV43TFLeaveTypeLoggingWorkHours_Sels;
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              AV51Leavetypewwds_4_tfleavetypevacationleave_sels ,
                                              A145LeaveTypeLoggingWorkHours ,
                                              AV52Leavetypewwds_5_tfleavetypeloggingworkhours_sels ,
                                              AV48Leavetypewwds_1_filterfulltext ,
                                              AV50Leavetypewwds_3_tfleavetypename_sel ,
                                              AV49Leavetypewwds_2_tfleavetypename ,
                                              AV51Leavetypewwds_4_tfleavetypevacationleave_sels.Count ,
                                              AV52Leavetypewwds_5_tfleavetypeloggingworkhours_sels.Count ,
                                              A125LeaveTypeName ,
                                              A100CompanyId ,
                                              AV53Udparg6 } ,
                                              new int[]{
         ...
         lV48Leavetypewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV48Leavetypewwds_1_filterfulltext), "%", "");
         lV48Leavetypewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV48Leavetypewwds_1_filterfulltext), "%", "");
         lV48Leavetypewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV48Leavetypewwds_1_filterfulltext), "%", "");
         lV48Leavetypewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV48Leavetypewwds_1_filterfulltext), "%", "");
         lV48Leavetypewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV48Leavetypewwds_1_filterfulltext), "%", "");
         lV49Leavetypewwds_2_tfleavetypename = StringUtil.PadR( StringUtil.RTrim( AV49Leavetypewwds_2_tfleavetypename), 100, "%");
         /* Using cursor P005C2 */
         pr_default.execute(0, new Object[] {AV53Udparg6, lV48Leavetypewwds_1_filterfulltext, lV48Leavetypewwds_1_filterfulltext, lV48Leavetypewwds_1_filterfulltext, lV48Leavetypewwds_1_filterfulltext, lV48Leavetypewwds_1_filterfulltext, lV49Leavetypewwds_2_tfleavetypename, AV50Leavetypewwds_3_tfleavetypename_sel});
      ...
      public override void initialize( )
      {
         ...
         AV49Leavetypewwds_2_tfleavetypename = "";
         AV50Leavetypewwds_3_tfleavetypename_sel = "";
         AV51Leavetypewwds_4_tfleavetypevacationleave_sels = new GxSimpleCollection<string>();
         AV52Leavetypewwds_5_tfleavetypeloggingworkhours_sels = new GxSimpleCollection<string>();
         scmdbuf = "";
         lV48Leavetypewwds_1_filterfulltext = "";
         lV49Leavetypewwds_2_tfleavetypename = "";
         A144LeaveTypeVacationLeave = "";
         A145LeaveTypeLoggingWorkHours = "";
         A125LeaveTypeName = "";
      ...
      private int AV51Leavetypewwds_4_tfleavetypevacationleave_sels_Count ;
      private int AV52Leavetypewwds_5_tfleavetypeloggingworkhours_sels_Count ;
      ...
      private string AV49Leavetypewwds_2_tfleavetypename ;
      private string AV50Leavetypewwds_3_tfleavetypename_sel ;
      private string scmdbuf ;
      private string lV49Leavetypewwds_2_tfleavetypename ;
      ...
      private string AV48Leavetypewwds_1_filterfulltext ;
      private string lV48Leavetypewwds_1_filterfulltext ;
      ...
      private GxSimpleCollection<string> AV51Leavetypewwds_4_tfleavetypevacationleave_sels ;
      private GxSimpleCollection<string> AV52Leavetypewwds_5_tfleavetypeloggingworkhours_sels ;
   ...
   public class leavetypewwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P005C2( IGxContext context ,
                                             ...
                                             GxSimpleCollection<string> AV51Leavetypewwds_4_tfleavetypevacationleave_sels ,
                                             string A145LeaveTypeLoggingWorkHours ,
                                             GxSimpleCollection<string> AV52Leavetypewwds_5_tfleavetypeloggingworkhours_sels ,
                                             string AV48Leavetypewwds_1_filterfulltext ,
                                             string AV50Leavetypewwds_3_tfleavetypename_sel ,
                                             string AV49Leavetypewwds_2_tfleavetypename ,
                                             int AV51Leavetypewwds_4_tfleavetypevacationleave_sels_Count ,
                                             int AV52Leavetypewwds_5_tfleavetypeloggingworkhours_sels_Count ,
                                             ...
                                             long AV53Udparg6 )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV48Leavetypewwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(LeaveTypeName) like '%' || LOWER(:lV48Leavetypewwds_1_filterfulltext)) or ( 'no' like '%' || LOWER(:lV48Leavetypewwds_1_filterfulltext) and LeaveTypeVacationLeave = ( 'No')) or ( 'yes' like '%' || LOWER(:lV48Leavetypewwds_1_filterfulltext) and LeaveTypeVacationLeave = ( 'Yes')) or ( 'no' like '%' || LOWER(:lV48Leavetypewwds_1_filterfulltext) and LeaveTypeLoggingWorkHours = ( 'No')) or ( 'yes' like '%' || LOWER(:lV48Leavetypewwds_1_filterfulltext) and LeaveTypeLoggingWorkHours = ( 'Yes')))");
         }
         else
         {
            GXv_int1[1] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV50Leavetypewwds_3_tfleavetypename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV49Leavetypewwds_2_tfleavetypename)) ) )
         {
            AddWhere(sWhereString, "(LOWER(LeaveTypeName) like LOWER(:lV49Leavetypewwds_2_tfleavetypename))");
         }
         else
         {
            GXv_int1[6] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV50Leavetypewwds_3_tfleavetypename_sel)) && ! ( StringUtil.StrCmp(AV50Leavetypewwds_3_tfleavetypename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(LeaveTypeName = ( :AV50Leavetypewwds_3_tfleavetypename_sel))");
         }
         else
         {
            GXv_int1[7] = 1;
         }
         if ( StringUtil.StrCmp(AV50Leavetypewwds_3_tfleavetypename_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from LeaveTypeName))=0))");
         }
         if ( AV51Leavetypewwds_4_tfleavetypevacationleave_sels_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV51Leavetypewwds_4_tfleavetypevacationleave_sels, "LeaveTypeVacationLeave IN (", ")")+")");
         }
         if ( AV52Leavetypewwds_5_tfleavetypeloggingworkhours_sels_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV52Leavetypewwds_5_tfleavetypeloggingworkhours_sels, "LeaveTypeLoggingWorkHours IN (", ")")+")");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV48Leavetypewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV48Leavetypewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV48Leavetypewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV48Leavetypewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV48Leavetypewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV49Leavetypewwds_2_tfleavetypename",GXType.Char,100,0) ,
          new ParDef("AV50Leavetypewwds_3_tfleavetypename_sel",GXType.Char,100,0)
          };
          def= new CursorDef[] {
