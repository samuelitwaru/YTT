...
namespace GeneXus.Programs {
   public class sitesettingwwexport : GXProcedure
   {
      ...
      protected void S131( )
      {
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Setting Id") ;
            AV14CellRow = GXt_int2;
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Hour Open") ;
            AV14CellRow = GXt_int2;
      ...
      protected void S161( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A100CompanyId = P00BC2_A100CompanyId[0];
            A160SiteSettingId = P00BC2_A160SiteSettingId[0];
      ...
      protected void S151( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "SiteSettingId",  "",  "Setting Id",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "CompanyId",  "",  "Id",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "IsLogHourOpen",  "",  "Hour Open",  true,  "") ;
         GXt_char1 = AV28UserCustomValue;
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "SiteSettingWWColumnsSelector", out  GXt_char1) ;
      ...
      protected void S201( )
      {
         ...
         {
            AV22GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "SiteSettingWWGridState"), null, "", "");
         }
         else
         {
      ...
      public override void initialize( )
      {
         ...
         P00BC2_A160SiteSettingId = new long[1] ;
         AV28UserCustomValue = "";
         GXt_char1 = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sitesettingwwexport__default(),
            new Object[][] {
                new Object[] {
               P00BC2_A161IsLogHourOpen, P00BC2_A100CompanyId, P00BC2_A160SiteSettingId
               }
            }
         );
         /* GeneXus formulas. */
