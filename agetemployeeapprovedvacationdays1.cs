...
namespace GeneXus.Programs {
   public class agetemployeeapprovedvacationdays1 : GXProcedure
   {
      public static int Main( string[] args )
      {
         try
         {
            ...
            return new agetemployeeapprovedvacationdays1().executeCmdLine(args); ;
         }
         catch ( Exception e )
         {
      ...
      public agetemployeeapprovedvacationdays1( )
      {
      ...
      public agetemployeeapprovedvacationdays1( IGxContext context )
      {
      ...
      public void executeSubmit( long aP0_EmployeeId ,
                                 ...
                                 out decimal aP3_Days )
      {
         agetemployeeapprovedvacationdays1 objagetemployeeapprovedvacationdays1;
         objagetemployeeapprovedvacationdays1 = new agetemployeeapprovedvacationdays1();
         objagetemployeeapprovedvacationdays1.AV11EmployeeId = aP0_EmployeeId;
         objagetemployeeapprovedvacationdays1.AV10DateFrom = aP1_DateFrom;
         objagetemployeeapprovedvacationdays1.AV9DateTo = aP2_DateTo;
         objagetemployeeapprovedvacationdays1.AV17Days = 0 ;
         objagetemployeeapprovedvacationdays1.context.SetSubmitInitialConfig(context);
         objagetemployeeapprovedvacationdays1.initialize();
         Submit( executePrivateCatch,objagetemployeeapprovedvacationdays1);
         aP3_Days=this.AV17Days;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((agetemployeeapprovedvacationdays1)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
            GXUtil.SaveToEventLog( "Design", e);
      ...
      void executePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            if ( ( DateTimeUtil.ResetTime ( A129LeaveRequestStartDate ) < DateTimeUtil.ResetTime ( AV10DateFrom ) ) && ( DateTimeUtil.ResetTime ( A130LeaveRequestEndDate ) <= DateTimeUtil.ResetTime ( AV9DateTo ) ) )
            {
               ...
               AV22ExceptDays = (decimal)(AV22ExceptDays+(GXt_decimal1));
               AV17Days = (decimal)(AV17Days+AV22ExceptDays);
               new logtofile(context ).execute(  "Except Days: "+StringUtil.Str( AV22ExceptDays, 4, 1)) ;
            }
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.agetemployeeapprovedvacationdays1__default(),
            new Object[][] {
                new Object[] {
   ...
   public class agetemployeeapprovedvacationdays1__default : DataStoreHelperBase, IDataStoreHelper
   {
