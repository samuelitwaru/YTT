...
namespace GeneXus.Programs {
   public class leavetypeview : GXDataArea
   {
      ...
      public leavetypeview( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12LeaveTypeId = (long)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12LeaveTypeId", StringUtil.LTrimStr( (decimal)(AV12LeaveTypeId), 10, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vLEAVETYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12LeaveTypeId), "ZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("leavetypeview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12LeaveTypeId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"LeaveTypeId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vLEAVETYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12LeaveTypeId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vLEAVETYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12LeaveTypeId), "ZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("leavetypeview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12LeaveTypeId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"LeaveTypeId","TabCode"})  ;
      }
      ...
      protected void WB2P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Leave Types", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_LeaveTypeView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_LeaveTypeView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLeaverequest_title_Internalname, "Leave Request", "", "", lblLeaverequest_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_LeaveTypeView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Leaverequestwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldLeaverequestwc = cgiGet( "W0033");
                           ...
                           if ( StringUtil.Len( WebComp_Leaverequestwc_Component) != 0 )
                           {
                              WebComp_Leaverequestwc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Leaverequestwc_Component = OldLeaverequestwc;
                        }
                     }
      ...
      protected void STRUP2P0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12LeaveTypeId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vLEAVETYPEID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E112P2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("leavetypeww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H002P2 */
         pr_default.execute(0, new Object[] {AV12LeaveTypeId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A124LeaveTypeId = H002P2_A124LeaveTypeId[0];
            A125LeaveTypeName = H002P2_A125LeaveTypeName[0];
            AV16GXLvl9 = 1;
            Form.Caption = A125LeaveTypeName;
      ...
      protected void S112( )
      {
         ...
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV14SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "LeaveTypeGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "leavetypegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "LeaveTypeGeneral";
               WebComp_Generalwc_Component = "LeaveTypeGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0025",(string)"",(long)AV12LeaveTypeId});
         ...
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "LeaveRequest") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Leaverequestwc_Component), StringUtil.Lower( "LeaveTypeLeaveRequestWC")) != 0 )
            {
               WebComp_Leaverequestwc = getWebComponent(GetType(), "GeneXus.Programs", "leavetypeleaverequestwc", new Object[] {context} );
               WebComp_Leaverequestwc.ComponentInit();
               WebComp_Leaverequestwc.Name = "LeaveTypeLeaveRequestWC";
               WebComp_Leaverequestwc_Component = "LeaveTypeLeaveRequestWC";
            }
            if ( StringUtil.Len( WebComp_Leaverequestwc_Component) != 0 )
            {
               WebComp_Leaverequestwc.setjustcreated();
               WebComp_Leaverequestwc.componentprepare(new Object[] {(string)"W0033",(string)"",(long)AV12LeaveTypeId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12LeaveTypeId = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12LeaveTypeId", StringUtil.LTrimStr( (decimal)(AV12LeaveTypeId), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vLEAVETYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12LeaveTypeId), "ZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512254953", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("leavetypeview.js", "?2024102512254953", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leavetypeview__default(),
            new Object[][] {
                new Object[] {
               H002P2_A124LeaveTypeId, H002P2_A125LeaveTypeName
               }
            }
         );
      ...
      private int idxLst ;
      private long AV12LeaveTypeId ;
      private long wcpOAV12LeaveTypeId ;
   ...
   public class leavetypeview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV12LeaveTypeId",GXType.Int64,10,0)
          };
          def= new CursorDef[] {
              new CursorDef("H002P2", "SELECT LeaveTypeId, LeaveTypeName FROM LeaveType WHERE LeaveTypeId = :AV12LeaveTypeId ORDER BY LeaveTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002P2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
