   ...
   public class login : GXDataArea
   {
      ...
      protected void WB030( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCellLogin CellPaddingLogin", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblForgotpassword_Internalname, "Forgot Password?", "", "", lblForgotpassword_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11031_client"+"'", "", "DataDescriptionLogin", 7, "", lblForgotpassword_Visible, 1, 0, 1, "HLP_Login.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(60), 2, 0)+","+"null"+");", bttBtnenter_Caption, bttBtnenter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_Login.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 hidden-xs hidden-sm hidden-md hidden-lg DataContentCellLogin CellPaddingLogin", "Center", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRegisteruser_Internalname, "Sign Up", lblRegisteruser_Link, "", lblRegisteruser_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "DataDescriptionLogin", 0, "", 1, 1, 0, 0, "HLP_Login.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "GRIDAUTHTYPES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "VIMAGEAUTHTYPE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "VIMAGEAUTHTYPE.CLICK") == 0 ) )
                           {
                              ...
                              AV63ImageAuthType = cgiGet( edtavImageauthtype_Internalname);
                              AssignProp("", false, edtavImageauthtype_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV63ImageAuthType)) ? AV78Imageauthtype_GXI : context.convertURL( context.PathToRelativeUrl( AV63ImageAuthType))), !bGXsfl_60_Refreshing);
                              AssignProp("", false, edtavImageauthtype_Internalname, "SrcSet", context.GetImageSrcSet( AV63ImageAuthType), true);
                              ...
                              AV64TypeAuthType = cgiGet( cmbavTypeauthtype_Internalname);
                              AssignAttri("", false, cmbavTypeauthtype_Internalname, AV64TypeAuthType);
      ...
      protected void E14032( )
      {
         ...
         else
         {
            if ( ! AV18isConnectionOK )
            {
               ...
               {
                  AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnectionbyrepositoryguid(AV28RepositoryGUID, out  AV66Errors);
                  AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
               }
               else
               {
                  ...
                  {
                     AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnection(((GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo)AV9ConnectionInfoCollection.Item(1)).gxTpr_Name, out  AV66Errors);
                     AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
                  }
               }
            }
      ...
      private void E15032( )
      {
         ...
         while ( AV77GXV1 <= AV7AuthenticationTypes.Count )
         {
            ...
            if ( ! AV6AuthenticationType.gxTpr_Needusername )
            {
               ...
               {
                  AV63ImageAuthType = context.GetImagePath( AV6AuthenticationType.gxTpr_Smallimagename, "", context.GetTheme( ));
                  AssignAttri("", false, edtavImageauthtype_Internalname, AV63ImageAuthType);
                  AV78Imageauthtype_GXI = GXDbFile.PathToUrl( AV6AuthenticationType.gxTpr_Smallimagename, context);
               }
               else
               {
                  edtavImageauthtype_gximage = "GAM_GAMButtonGAMRemoteSmall";
                  AV63ImageAuthType = context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( ));
                  AssignAttri("", false, edtavImageauthtype_Internalname, AV63ImageAuthType);
                  AV78Imageauthtype_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( )), context);
               }
               AV64TypeAuthType = AV6AuthenticationType.gxTpr_Type;
               AssignAttri("", false, cmbavTypeauthtype_Internalname, AV64TypeAuthType);
         ...
         cmbavTypeauthtype.CurrentValue = StringUtil.RTrim( AV64TypeAuthType);
      }
      ...
      protected void E12032( )
      {
         ...
         AV24LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV31UserName, AV32UserPassword, AV5AdditionalParameter, out  AV66Errors);
         if ( AV24LoginOK )
         {
         ...
         {
            if ( AV66Errors.Count > 0 )
            {
               if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV66Errors.Item(1)).gxTpr_Code == 24 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV66Errors.Item(1)).gxTpr_Code == 23 ) )
               {
               ...
               else if ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV66Errors.Item(1)).gxTpr_Code == 161 )
               {
               ...
               else if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV66Errors.Item(1)).gxTpr_Code == 400 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV66Errors.Item(1)).gxTpr_Code == 410 ) )
               {
      ...
      protected void E16032( )
      {
         ...
         /* Refresh Routine */
         returnInSub = false;
         AV68isRedirect = false;
         AV67ErrorsLogin = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
         if ( AV67ErrorsLogin.Count > 0 )
         {
            if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV67ErrorsLogin.Item(1)).gxTpr_Code == 1 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV67ErrorsLogin.Item(1)).gxTpr_Code == 104 ) )
            {
            }
            else
            {
         ...
         if ( ! AV68isRedirect )
         {
            AV72SessionValid = new GeneXus.Programs.genexussecurity.SdtGAMSession(context).isvalid(out  AV71Session, out  AV66Errors);
            if ( AV72SessionValid && ! AV71Session.gxTpr_Isanonymous )
            {
               ...
               {
                  AV73GAMApplicationCollection = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getapplications(AV74GAMApplicationFilter, out  AV66Errors);
                  AV79GXV2 = 1;
                  while ( AV79GXV2 <= AV73GAMApplicationCollection.Count )
                  {
                     AV75GAMApplication = ((GeneXus.Programs.genexussecurity.SdtGAMApplication)AV73GAMApplicationCollection.Item(AV79GXV2));
                     if ( StringUtil.StrCmp(AV75GAMApplication.gxTpr_Guid, "8d9934db-05db-4d64-adba-5e0466c3appU") != 0 )
                     {
                        if (true) break;
                     }
                     AV79GXV2 = (int)(AV79GXV2+1);
                  }
                  AV75GAMApplication = AV75GAMApplication.get();
                  if ( StringUtil.StrCmp(AV75GAMApplication.gxTpr_Homeobject, "") != 0 )
                  {
                     new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).applicationgohome(AV75GAMApplication.gxTpr_Guid) ;
                  }
                  else
                  {
                     if ( AV76GAMUser.checkrole("Administrator") )
            ...
            else
            {
               ...
               AV7AuthenticationTypes = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getenabledauthenticationtypes(AV23Language, out  AV66Errors);
               AV80GXV3 = 1;
               while ( AV80GXV3 <= AV7AuthenticationTypes.Count )
               {
                  AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV80GXV3));
                  if ( AV6AuthenticationType.gxTpr_Needusername )
                  {
               ...
               AV20isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getrememberlogin(out  AV25LogOnTo, out  AV8AuxUserName, out  AV33UserRememberMe, out  AV66Errors);
               ...
               AV70Repository = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).get();
               if ( cmbavLogonto.ItemCount > 1 )
               {
                  AV25LogOnTo = AV70Repository.gxTpr_Defaultauthenticationtypename;
                  AssignAttri("", false, "AV25LogOnTo", AV25LogOnTo);
               }
               ...
               if (returnInSub) return;
               AV81GXV4 = 1;
               while ( AV81GXV4 <= AV7AuthenticationTypes.Count )
               {
                  AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV81GXV4));
         ...
         AssignProp("", false, cmbavLogonto_Internalname, "Values", cmbavLogonto.ToJavascriptSource(), true);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV6AuthenticationType", AV6AuthenticationType);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV70Repository", AV70Repository);
      }
      ...
      protected void E13032( )
      {
         ...
         AV19isModeOTP = false;
         AV82GXV5 = 1;
         while ( AV82GXV5 <= AV7AuthenticationTypes.Count )
         {
            AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV82GXV5));
            if ( StringUtil.StrCmp(AV6AuthenticationType.gxTpr_Name, AV25LogOnTo) == 0 )
            {
               /* Execute user subroutine: 'VALIDLOGONTOOTP' */
               S152 ();
      ...
      protected void S112( )
      {
         ...
         {
            AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnectionbyrepositoryid(AV13GAMRepository.gxTpr_Authenticationmasterrepositoryid, out  AV66Errors);
            AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
         }
         if ( ! AV18isConnectionOK )
         {
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV70Repository.gxTpr_Userremembermetype, "Login") == 0 )
         {
            chkavKeepmeloggedin.Visible = 0;
            AssignProp("", false, chkavKeepmeloggedin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavKeepmeloggedin.Visible), 5, 0), true);
            chkavRememberme.Visible = 1;
         ...
         else if ( StringUtil.StrCmp(AV70Repository.gxTpr_Userremembermetype, "Auth") == 0 )
         {
            chkavKeepmeloggedin.Visible = 1;
            AssignProp("", false, chkavKeepmeloggedin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavKeepmeloggedin.Visible), 5, 0), true);
            chkavRememberme.Visible = 0;
         ...
         else if ( StringUtil.StrCmp(AV70Repository.gxTpr_Userremembermetype, "Both") == 0 )
         {
            chkavKeepmeloggedin.Visible = 1;
            AssignProp("", false, chkavKeepmeloggedin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavKeepmeloggedin.Visible), 5, 0), true);
            chkavRememberme.Visible = 1;
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         AV83GXV6 = 1;
         while ( AV83GXV6 <= AV66Errors.Count )
         {
            AV65Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV66Errors.Item(AV83GXV6));
            if ( AV65Error.gxTpr_Code != 13 )
            {
               GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Error!",  AV65Error.gxTpr_Message,  "error",  "#"+edtavUserpassword_Internalname,  "true",  ""));
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255218301259", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("login.js", "?20255218301264", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Mask/jquery.mask.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/BootstrapSelect.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/WorkWithPlusUtilitiesRender.js", "", false, true);
      ...
      protected void sendrow_602( )
      {
         ...
         StyleString = "";
         AV63ImageAuthType_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV63ImageAuthType))&&String.IsNullOrEmpty(StringUtil.RTrim( AV78Imageauthtype_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV63ImageAuthType)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV63ImageAuthType)) ? AV78Imageauthtype_GXI : context.PathToRelativeUrl( AV63ImageAuthType));
         GridauthtypesRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavImageauthtype_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)1,(short)1,(string)"",(string)edtavImageauthtype_Tooltiptext,(short)0,(short)-1,(short)0,(string)"",(short)0,(string)"",(short)0,(short)0,(short)5,(string)edtavImageauthtype_Jsonclick,"'"+""+"'"+",false,"+"'"+"EVIMAGEAUTHTYPE.CLICK."+sGXsfl_60_idx+"'",(string)StyleString,(string)ClassString,(string)"",(string)"",(string)"",(string)"",(string)""+TempTags,(string)"",(string)"",(short)1,(bool)AV63ImageAuthType_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
         GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridauthtypesRow.AddRenderProperties(GridauthtypesColumn);
      ...
      protected void StartGridControl60( )
      {
         ...
         else
         {
            ...
            GridauthtypesContainer.AddColumnProperties(GridauthtypesColumn);
            GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridauthtypesColumn.AddObjectProperty("Value", context.convertURL( AV63ImageAuthType));
            ...
            GridauthtypesContainer.AddColumnProperties(GridauthtypesColumn);
            GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridauthtypesColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV64TypeAuthType)));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDAUTHTYPES.LOAD",""","oparms":[{"av":"AV63ImageAuthType","fld":"vIMAGEAUTHTYPE"},{"av":"cmbavTypeauthtype"},{"av":"AV64TypeAuthType","fld":"vTYPEAUTHTYPE"},{"av":"AV26NameAuthType","fld":"vNAMEAUTHTYPE"},{"av":"edtavImageauthtype_Tooltiptext","ctrl":"vIMAGEAUTHTYPE","prop":"Tooltiptext"},{"av":"divTablebuttons_Visible","ctrl":"TABLEBUTTONS","prop":"Visible"}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV76GAMUser = new GeneXus.Programs.genexussecurity.SdtGAMUser(context);
         AV67ErrorsLogin = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         AV71Session = new GeneXus.Programs.genexussecurity.SdtGAMSession(context);
         AV73GAMApplicationCollection = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication>( context, "GeneXus.Programs.genexussecurity.SdtGAMApplication", "GeneXus.Programs");
         AV74GAMApplicationFilter = new GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter(context);
         AV75GAMApplication = new GeneXus.Programs.genexussecurity.SdtGAMApplication(context);
         AV70Repository = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context);
      ...
      private string AV64TypeAuthType ;
      ...
      private bool AV68isRedirect ;
      private bool AV72SessionValid ;
      private bool AV20isOK ;
      private bool AV19isModeOTP ;
      private bool AV63ImageAuthType_IsBlob ;
      private string AV8AuxUserName ;
      private string AV25LogOnTo ;
      private string AV31UserName ;
      private string AV30URL ;
      private string AV78Imageauthtype_GXI ;
      private string AV63ImageAuthType ;
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMUser AV76GAMUser ;
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV67ErrorsLogin ;
      private GeneXus.Programs.genexussecurity.SdtGAMSession AV71Session ;
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication> AV73GAMApplicationCollection ;
      private GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter AV74GAMApplicationFilter ;
      private GeneXus.Programs.genexussecurity.SdtGAMApplication AV75GAMApplication ;
      private GeneXus.Programs.genexussecurity.SdtGAMRepository AV70Repository ;
