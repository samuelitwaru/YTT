   ...
   public class login : GXDataArea
   {
      ...
      protected void WB030( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-1 hidden-xs col-sm-12 hidden-sm hidden-md hidden-lg DataContentCellLogin CellPaddingLogin", "Center", "top", "", "", "div");
            /* Text block */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "GRIDAUTHTYPES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "VIMAGEAUTHTYPE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "VIMAGEAUTHTYPE.CLICK") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtavImageauthtype_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV17ImageAuthType)) ? AV54Imageauthtype_GXI : context.convertURL( context.PathToRelativeUrl( AV17ImageAuthType))), !bGXsfl_60_Refreshing);
         ...
         while ( AV53GXV1 <= AV7AuthenticationTypes.Count )
         {
            ...
            if ( ! AV6AuthenticationType.gxTpr_Needusername )
            {
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV6AuthenticationType.gxTpr_Smallimagename)) )
               {
                  ...
                  AV54Imageauthtype_GXI = GXDbFile.PathToUrl( AV6AuthenticationType.gxTpr_Smallimagename);
               }
               else
               {
                  ...
                  AssignAttri("", false, edtavImageauthtype_Internalname, AV17ImageAuthType);
                  AV54Imageauthtype_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( )));
               }
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         AV58GXV5 = 1;
         while ( AV58GXV5 <= AV36Errors.Count )
         {
            AV35Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV36Errors.Item(AV58GXV5));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202462821122889", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("login.js", "?202462821122893", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Mask/jquery.mask.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/BootstrapSelect.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/WorkWithPlusUtilitiesRender.js", "", false, true);
      ...
      protected void sendrow_602( )
      {
         ...
         TempTags = " " + ((edtavImageauthtype_Enabled!=0)&&(edtavImageauthtype_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 65,'',false,'',60)\"" : " ");
         ClassString = "AttributeImage30" + " " + ((StringUtil.StrCmp(edtavImageauthtype_gximage, "")==0) ? "" : "GX_Image_"+edtavImageauthtype_gximage+"_Class");
         StyleString = "";
         AV17ImageAuthType_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV17ImageAuthType))&&String.IsNullOrEmpty(StringUtil.RTrim( AV54Imageauthtype_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV17ImageAuthType)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV17ImageAuthType)) ? AV54Imageauthtype_GXI : context.PathToRelativeUrl( AV17ImageAuthType));
         ...
         GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridauthtypesRow.AddRenderProperties(GridauthtypesColumn);
         TempTags = " " + ((cmbavTypeauthtype.Enabled!=0)&&(cmbavTypeauthtype.Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 72,'',false,'"+sGXsfl_60_idx+"',60)\"" : " ");
         ...
         GridauthtypesRow.AddRenderProperties(GridauthtypesColumn);
         /* Single line edit */
         TempTags = " " + ((edtavNameauthtype_Enabled!=0)&&(edtavNameauthtype_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 75,'',false,'"+sGXsfl_60_idx+"',60)\"" : " ");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E12032',iparms:[{av:'AV22KeepMeLoggedIn',fld:'vKEEPMELOGGEDIN',pic:''},{av:'AV27RememberMe',fld:'vREMEMBERME',pic:''},{av:'cmbavLogonto'},{av:'AV25LogOnTo',fld:'vLOGONTO',pic:''},{av:'AV31UserName',fld:'vUSERNAME',pic:''},{av:'AV32UserPassword',fld:'vUSERPASSWORD',pic:''},{av:'AV16IDP_State',fld:'vIDP_STATE',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV16IDP_State',fld:'vIDP_STATE',pic:''},{av:'AV32UserPassword',fld:'vUSERPASSWORD',pic:''}]}");
         setEventMetadata("VIMAGEAUTHTYPE.CLICK","{handler:'E17032',iparms:[{av:'AV26NameAuthType',fld:'vNAMEAUTHTYPE',pic:''},{av:'AV31UserName',fld:'vUSERNAME',pic:''},{av:'AV32UserPassword',fld:'vUSERPASSWORD',pic:''}]");
         setEventMetadata("VIMAGEAUTHTYPE.CLICK",",oparms:[]}");
         setEventMetadata("VLOGONTO.CLICK","{handler:'E13032',iparms:[{av:'AV23Language',fld:'vLANGUAGE',pic:'',hsh:true},{av:'cmbavLogonto'},{av:'AV25LogOnTo',fld:'vLOGONTO',pic:''}]");
         ...
         setEventMetadata("FORGOTPASSWORD.CLICK","{handler:'E11031',iparms:[{av:'AV16IDP_State',fld:'vIDP_STATE',pic:''}]");
         setEventMetadata("FORGOTPASSWORD.CLICK",",oparms:[{av:'AV16IDP_State',fld:'vIDP_STATE',pic:''}]}");
         setEventMetadata("'SELECTAUTHENTICATIONTYPE'","{handler:'E18032',iparms:[{av:'AV26NameAuthType',fld:'vNAMEAUTHTYPE',pic:''},{av:'AV31UserName',fld:'vUSERNAME',pic:''},{av:'AV32UserPassword',fld:'vUSERPASSWORD',pic:''}]");
