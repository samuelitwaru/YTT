...
namespace GeneXus.Programs {
   public class workhourlogdateduration : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         /* Using cursor P008A2 */
         pr_default.execute(0, new Object[] {AV13WorkHourLogDate, AV15Udparg1});
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workhourlogdateduration__default(),
            new Object[][] {
                new Object[] {
               P008A2_A106EmployeeId, P008A2_A119WorkHourLogDate, P008A2_A122WorkHourLogMinute, P008A2_A121WorkHourLogHour, P008A2_A118WorkHourLogId
               }
            }
         );
         /* GeneXus formulas. */
   ...
   public class workhourlogdateduration__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P008A2", "SELECT EmployeeId, WorkHourLogDate, WorkHourLogMinute, WorkHourLogHour, WorkHourLogId FROM WorkHourLog WHERE (WorkHourLogDate = :AV13WorkHourLogDate) AND (EmployeeId = :AV15Udparg1) ORDER BY WorkHourLogDate ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008A2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
