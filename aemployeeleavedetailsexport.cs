...
namespace GeneXus.Programs {
   public class aemployeeleavedetailsexport : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A100CompanyId = P00BX2_A100CompanyId[0];
            A157CompanyLocationId = P00BX2_A157CompanyLocationId[0];
            A101CompanyName = P00BX2_A101CompanyName[0];
      ...
      public override void initialize( )
      {
         ...
         P00BX2_A100CompanyId = new long[1] ;
         P00BX2_A157CompanyLocationId = new long[1] ;
         P00BX2_A101CompanyName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aemployeeleavedetailsexport__default(),
            new Object[][] {
                new Object[] {
               P00BX2_A100CompanyId, P00BX2_A157CompanyLocationId, P00BX2_A101CompanyName, P00BX2_A124LeaveTypeId, P00BX2_A125LeaveTypeName
               }
            }
         );
      ...
      private long[] P00BX2_A100CompanyId ;
      private long[] P00BX2_A157CompanyLocationId ;
      private string[] P00BX2_A101CompanyName ;
   ...
   public class aemployeeleavedetailsexport__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00BX2", "SELECT T1.CompanyId, T2.CompanyLocationId, T2.CompanyName, T1.LeaveTypeId, T1.LeaveTypeName FROM (LeaveType T1 INNER JOIN Company T2 ON T2.CompanyId = T1.CompanyId) WHERE T2.CompanyLocationId = :AV20CompanyLocationId ORDER BY T1.LeaveTypeName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BX2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
