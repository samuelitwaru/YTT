	...
	this.Scripts = [];
		...
		this.Start = function() {
					...
					for (let i = 0; i < this.SDTEmployeeLeaveDetailsCollection.length; i++) {
						...
						console.log(item.EmployeeId +'-'+ item.FirstLeaveTypeId)
