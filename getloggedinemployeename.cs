...
namespace GeneXus.Programs {
   public class getloggedinemployeename : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A106EmployeeId = P00CP2_A106EmployeeId[0];
            A148EmployeeName = P00CP2_A148EmployeeName[0];
      ...
      {
         AV8employeename = "";
         P00CP2_A106EmployeeId = new long[1] ;
         P00CP2_A148EmployeeName = new string[] {""} ;
         A148EmployeeName = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.getloggedinemployeename__default(),
            new Object[][] {
                new Object[] {
               P00CP2_A106EmployeeId, P00CP2_A148EmployeeName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P00CP2_A106EmployeeId ;
      private string[] P00CP2_A148EmployeeName ;
   ...
   public class getloggedinemployeename__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00CP2", "SELECT EmployeeId, EmployeeName FROM Employee WHERE EmployeeId = :AV9Loggedinemployee ORDER BY EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00CP2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
