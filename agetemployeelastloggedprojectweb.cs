...
namespace GeneXus.Programs {
   public class agetemployeelastloggedprojectweb : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A106EmployeeId = P00CE2_A106EmployeeId[0];
            A102ProjectId = P00CE2_A102ProjectId[0];
            A118WorkHourLogId = P00CE2_A118WorkHourLogId[0];
      ...
      {
         P00CE2_A106EmployeeId = new long[1] ;
         P00CE2_A102ProjectId = new long[1] ;
         P00CE2_A118WorkHourLogId = new long[1] ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.agetemployeelastloggedprojectweb__default(),
            new Object[][] {
                new Object[] {
               P00CE2_A106EmployeeId, P00CE2_A102ProjectId, P00CE2_A118WorkHourLogId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P00CE2_A106EmployeeId ;
      private long[] P00CE2_A102ProjectId ;
      private long[] P00CE2_A118WorkHourLogId ;
   ...
   public class agetemployeelastloggedprojectweb__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00CE2", "SELECT EmployeeId, ProjectId, WorkHourLogId FROM WorkHourLog WHERE EmployeeId = :AV9EmployeeId ORDER BY WorkHourLogId DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00CE2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
