   ...
   public class wwp_aigetnlfilterfromai : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV9ErrorMessage)) )
         {
            ...
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV9ErrorMessage)) )
            {
               ...
               {
                  AV16GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV19ListName+"GridState"), null, "", "");
                  ...
                  new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV19ListName+"NLQuery",  AV25UserQuery) ;
               }
            }
         }
         this.cleanup();
      ...
      protected void S111( )
      {
         ...
         while ( AV38GXV2 <= AV12FiltersFixes.Count )
         {
            ...
            {
               AV17GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV16GridState.gxTpr_Filtervalues.Item(AV39GXV3));
         ...
         {
            AV17GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV16GridState.gxTpr_Filtervalues.Item(AV42GXV6));
            if ( StringUtil.StartsWith( AV17GridStateFilterValue.gxTpr_Name, "DYN") )
            {
               AV34DynFilter = new GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_DynamicFilter(context);
      ...
      public override void initialize( )
      {
         ...
         AV15FoundGridStateFilterValue = new GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue(context);
