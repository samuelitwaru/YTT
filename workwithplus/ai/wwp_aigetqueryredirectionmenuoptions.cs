...
namespace GeneXus.Programs.workwithplus.ai {
   public class wwp_aigetqueryredirectionmenuoptions : GXProcedure
   {
      ...
      public void execute( GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item> aP0_MenuOptions ,
      ...
      public string executeUdp( GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item> aP0_MenuOptions ,
                                string aP1_MenuOptionPrefix ,
                                ref GxSimpleCollection<string> aP2_LinkedPages )
      {
      ...
      public void executeSubmit( GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item> aP0_MenuOptions ,
                                 string aP1_MenuOptionPrefix ,
                                 ref GxSimpleCollection<string> aP2_LinkedPages ,
                                 ref string aP3_SystemContent )
      {
      ...
      void executePrivate( )
      {
         ...
         {
            AV8MenuOption = ((GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item)AV11MenuOptions.Item(AV14GXV1));
      ...
      {
         AV8MenuOption = new GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item(context);
