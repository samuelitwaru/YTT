...
namespace GeneXus.Programs.workwithplus.ai {
   public class wwp_aigetqueryredirection : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( AV8DataAdded )
         {
            ...
            else
            {
               if ( ! AV10IsMenuOption )
               {
                  new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV13ListName+"NLQuery",  AV21UserQuery) ;
               }
            }
         }
         else
      ...
      protected void S121( )
      {
         ...
         {
            AV14MenuOption = ((GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item)AV17MenuOptionsToAnalize.Item(1));
            ...
            if ( AV14MenuOption.gxTpr_Subitems.Count > 0 )
            {
               ...
               {
                  AV15MenuOptionAux = ((GeneXus.Programs.wwpbaseobjects.SdtDVelop_Menu_Item)AV14MenuOption.gxTpr_Subitems.Item(AV31GXV4));
