...
namespace GeneXus.Programs.workwithplus.nativemobile {
   public class wwpgetradialgaugedark : GXWebProcedure
   {
      ...
      public void executeSubmit( short aP0_Value ,
                                 ...
                                 out string aP2_HTML )
      {
         wwpgetradialgaugedark objwwpgetradialgaugedark;
         objwwpgetradialgaugedark = new wwpgetradialgaugedark();
         objwwpgetradialgaugedark.AV10Value = aP0_Value;
         objwwpgetradialgaugedark.AV9ProgressColor = aP1_ProgressColor;
         objwwpgetradialgaugedark.AV8HTML = "" ;
         objwwpgetradialgaugedark.context.SetSubmitInitialConfig(context);
         objwwpgetradialgaugedark.initialize();
         Submit( executePrivateCatch,objwwpgetradialgaugedark);
         aP2_HTML=this.AV8HTML;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wwpgetradialgaugedark)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
