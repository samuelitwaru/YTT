...
namespace GeneXus.Programs.workwithplus.nativemobile {
   public class examplegetimagefrombase64 : GXWebProcedure
   {
      ...
      {
         get {
            return "examplegetimagefrombase64_Services_Execute" ;
         }
      ...
      public override void webExecute( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.Method), "get") == 0 )
         {
            if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.QueryString), "wsdl") == 0 )
            {
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.ExampleGetImageFromBase64");
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.ExampleGetImageFromBase64.Execute");
               ...
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("element");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.ExampleGetImageFromBase64.ExecuteResponse");
               GXSoapXMLWriter.WriteStartElement("complexType");
               GXSoapXMLWriter.WriteStartElement("sequence");
               GXSoapXMLWriter.WriteElement("element", "");
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.ExampleGetImageFromBase64.ExecuteSoapIn");
               GXSoapXMLWriter.WriteElement("part", "");
               GXSoapXMLWriter.WriteAttribute("name", "parameters");
               GXSoapXMLWriter.WriteAttribute("element", "tns:WorkWithPlus.NativeMobile.ExampleGetImageFromBase64.Execute");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("message");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.ExampleGetImageFromBase64.ExecuteSoapOut");
               GXSoapXMLWriter.WriteElement("part", "");
               GXSoapXMLWriter.WriteAttribute("name", "parameters");
               GXSoapXMLWriter.WriteAttribute("element", "tns:WorkWithPlus.NativeMobile.ExampleGetImageFromBase64.ExecuteResponse");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("portType");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.ExampleGetImageFromBase64SoapPort");
               GXSoapXMLWriter.WriteStartElement("operation");
               GXSoapXMLWriter.WriteAttribute("name", "Execute");
               GXSoapXMLWriter.WriteElement("input", "");
               GXSoapXMLWriter.WriteAttribute("message", "wsdlns:"+"WorkWithPlus.NativeMobile.ExampleGetImageFromBase64.ExecuteSoapIn");
               GXSoapXMLWriter.WriteElement("output", "");
               GXSoapXMLWriter.WriteAttribute("message", "wsdlns:"+"WorkWithPlus.NativeMobile.ExampleGetImageFromBase64.ExecuteSoapOut");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("binding");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.ExampleGetImageFromBase64SoapBinding");
               GXSoapXMLWriter.WriteAttribute("type", "wsdlns:"+"WorkWithPlus.NativeMobile.ExampleGetImageFromBase64SoapPort");
               ...
               GXSoapXMLWriter.WriteAttribute("soapAction", "YTT_version4action/"+"workwithplus.nativemobile.AEXAMPLEGETIMAGEFROMBASE64.Execute");
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.ExampleGetImageFromBase64SoapPort");
               GXSoapXMLWriter.WriteAttribute("binding", "wsdlns:"+"WorkWithPlus.NativeMobile.ExampleGetImageFromBase64SoapBinding");
               GXSoapXMLWriter.WriteElement("soap:address", "");
               GXSoapXMLWriter.WriteAttribute("location", "http://"+context.GetServerName( )+((context.GetServerPort( )>0)&&(context.GetServerPort( )!=80)&&(context.GetServerPort( )!=443) ? ":"+StringUtil.LTrim( StringUtil.Str( (decimal)(context.GetServerPort( )), 6, 0)) : "")+context.GetScriptPath( )+"workwithplus.nativemobile.examplegetimagefrombase64.aspx");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteEndElement();
                     ...
                     if ( currSoapErr == 0 )
                     {
                        ...
                        if ( GXSoapXMLReader.IsSimple == 0 )
                        {
                           ...
                           while ( ( ( StringUtil.StrCmp(GXSoapXMLReader.Name, sTagName) != 0 ) || ( GXSoapXMLReader.NodeType == 1 ) ) && ( GXSoapError > 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp2( GXSoapXMLReader.LocalName, "Imagebase64") && ( GXSoapXMLReader.NodeType != 2 ) && ( StringUtil.StrCmp(GXSoapXMLReader.NamespaceURI, "YTT_version4") == 0 ) )
                              {
                                 AV10ImageBase64 = GXSoapXMLReader.Value;
                                 readElement = true;
                                 if ( GXSoapError > 0 )
                                 {
                                    readOk = 1;
         ...
         if ( ( StringUtil.StringSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
         {
            ...
            GXSoapXMLWriter.WriteStartElement("WorkWithPlus.NativeMobile.ExampleGetImageFromBase64.ExecuteResponse");
      ...
      public examplegetimagefrombase64( IGxContext context )
      {
         this.context = context;
         IsMain = false;
      }

      public void execute( string aP0_ImageBase64 )
      {
      ...
      void executePrivate( )
      {
         ...
         AV12NewLine = StringUtil.Chr( 10);
         AV11ImageBase64NoLines = StringUtil.StringReplace( AV10ImageBase64, AV12NewLine, "");
         AV8BlobImage=context.FileFromBase64( AV11ImageBase64NoLines) ;
         AV9CaptureImage = AV8BlobImage;
         AV13Captureimage_GXI = GXDbFile.GetUriFromFile( "", "", AV8BlobImage);
      ...
      private string AV13Captureimage_GXI ;
