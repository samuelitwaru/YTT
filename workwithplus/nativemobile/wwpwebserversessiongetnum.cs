...
namespace GeneXus.Programs.workwithplus.nativemobile {
   public class wwpwebserversessiongetnum : GXWebProcedure
   {
      ...
      {
         get {
            return "wwpwebserversessiongetnum_Services_Execute" ;
         }
      ...
      public override void webExecute( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.Method), "get") == 0 )
         {
            if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.QueryString), "wsdl") == 0 )
            {
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPWebServerSessionGetNum");
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPWebServerSessionGetNum.Execute");
               ...
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("element");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPWebServerSessionGetNum.ExecuteResponse");
               GXSoapXMLWriter.WriteStartElement("complexType");
               GXSoapXMLWriter.WriteStartElement("sequence");
               GXSoapXMLWriter.WriteElement("element", "");
               GXSoapXMLWriter.WriteAttribute("minOccurs", "1");
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPWebServerSessionGetNum.ExecuteSoapIn");
               GXSoapXMLWriter.WriteElement("part", "");
               GXSoapXMLWriter.WriteAttribute("name", "parameters");
               GXSoapXMLWriter.WriteAttribute("element", "tns:WorkWithPlus.NativeMobile.WWPWebServerSessionGetNum.Execute");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("message");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPWebServerSessionGetNum.ExecuteSoapOut");
               GXSoapXMLWriter.WriteElement("part", "");
               GXSoapXMLWriter.WriteAttribute("name", "parameters");
               GXSoapXMLWriter.WriteAttribute("element", "tns:WorkWithPlus.NativeMobile.WWPWebServerSessionGetNum.ExecuteResponse");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("portType");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPWebServerSessionGetNumSoapPort");
               GXSoapXMLWriter.WriteStartElement("operation");
               GXSoapXMLWriter.WriteAttribute("name", "Execute");
               GXSoapXMLWriter.WriteElement("input", "");
               GXSoapXMLWriter.WriteAttribute("message", "wsdlns:"+"WorkWithPlus.NativeMobile.WWPWebServerSessionGetNum.ExecuteSoapIn");
               GXSoapXMLWriter.WriteElement("output", "");
               GXSoapXMLWriter.WriteAttribute("message", "wsdlns:"+"WorkWithPlus.NativeMobile.WWPWebServerSessionGetNum.ExecuteSoapOut");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("binding");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPWebServerSessionGetNumSoapBinding");
               GXSoapXMLWriter.WriteAttribute("type", "wsdlns:"+"WorkWithPlus.NativeMobile.WWPWebServerSessionGetNumSoapPort");
               ...
               GXSoapXMLWriter.WriteAttribute("soapAction", "YTT_version4action/"+"workwithplus.nativemobile.AWWPWEBSERVERSESSIONGETNUM.Execute");
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPWebServerSessionGetNumSoapPort");
               GXSoapXMLWriter.WriteAttribute("binding", "wsdlns:"+"WorkWithPlus.NativeMobile.WWPWebServerSessionGetNumSoapBinding");
               GXSoapXMLWriter.WriteElement("soap:address", "");
               GXSoapXMLWriter.WriteAttribute("location", "http://"+context.GetServerName( )+((context.GetServerPort( )>0)&&(context.GetServerPort( )!=80)&&(context.GetServerPort( )!=443) ? ":"+StringUtil.LTrim( StringUtil.Str( (decimal)(context.GetServerPort( )), 6, 0)) : "")+context.GetScriptPath( )+"workwithplus.nativemobile.wwpwebserversessiongetnum.aspx");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteEndElement();
            ...
            else
            {
               ...
               currSoapErrmsg = "No SOAP request found. Call " + "http://" + context.GetServerName( ) + ((context.GetServerPort( )>0)&&(context.GetServerPort( )!=80)&&(context.GetServerPort( )!=443) ? ":"+StringUtil.LTrim( StringUtil.Str( (decimal)(context.GetServerPort( )), 6, 0)) : "") + context.GetScriptPath( ) + "workwithplus.nativemobile.wwpwebserversessiongetnum.aspx" + "?wsdl to get the WSDL.";
            }
         }
         if ( currSoapErr == 0 )
         {
         ...
         if ( ( StringUtil.StringSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
         {
            ...
            GXSoapXMLWriter.WriteStartElement("WorkWithPlus.NativeMobile.WWPWebServerSessionGetNum.ExecuteResponse");
            GXSoapXMLWriter.WriteAttribute("xmlns", "YTT_version4");
            if ( currSoapErr == 0 )
            {
               GXSoapXMLWriter.WriteElement("Parameternumvalue", StringUtil.Trim( StringUtil.Str( AV11ParameterNumValue, 8, 2)));
               GXSoapXMLWriter.WriteAttribute("xmlns", "YTT_version4");
            }
            else
            {
      ...
      public wwpwebserversessiongetnum( IGxContext context )
      {
      ...
      public void execute( string aP0_ParameterKey ,
                           out decimal aP1_ParameterNumValue )
      {
         this.AV8ParameterKey = aP0_ParameterKey;
         this.AV11ParameterNumValue = 0 ;
         initialize();
         executePrivate();
         aP1_ParameterNumValue=this.AV11ParameterNumValue;
      }

      public decimal executeUdp( string aP0_ParameterKey )
      {
         execute(aP0_ParameterKey, out aP1_ParameterNumValue);
      ...
      public void executeSubmit( string aP0_ParameterKey ,
                                 out decimal aP1_ParameterNumValue )
      {
         wwpwebserversessiongetnum objwwpwebserversessiongetnum;
         objwwpwebserversessiongetnum = new wwpwebserversessiongetnum();
         objwwpwebserversessiongetnum.AV8ParameterKey = aP0_ParameterKey;
         objwwpwebserversessiongetnum.AV11ParameterNumValue = 0 ;
         objwwpwebserversessiongetnum.context.SetSubmitInitialConfig(context);
         objwwpwebserversessiongetnum.initialize();
         Submit( executePrivateCatch,objwwpwebserversessiongetnum);
         aP1_ParameterNumValue=this.AV11ParameterNumValue;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wwpwebserversessiongetnum)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV11ParameterNumValue = NumberUtil.Val( StringUtil.Trim( AV9ParameterValue), ".");
      ...
      private decimal AV11ParameterNumValue ;
      ...
      private decimal aP1_ParameterNumValue ;
   }
