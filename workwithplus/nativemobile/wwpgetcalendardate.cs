...
namespace GeneXus.Programs.workwithplus.nativemobile {
   public class wwpgetcalendardate : GXWebProcedure
   {
      ...
      {
         get {
            return "wwpgetcalendardate_Services_Execute" ;
         }
      ...
      public override void webExecute( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.Method), "get") == 0 )
         {
            if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.QueryString), "wsdl") == 0 )
            {
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPGetCalendarDate");
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPGetCalendarDate.Execute");
               ...
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("element");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPGetCalendarDate.ExecuteResponse");
               GXSoapXMLWriter.WriteStartElement("complexType");
               GXSoapXMLWriter.WriteStartElement("sequence");
               GXSoapXMLWriter.WriteElement("element", "");
               GXSoapXMLWriter.WriteAttribute("minOccurs", "1");
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPGetCalendarDate.ExecuteSoapIn");
               GXSoapXMLWriter.WriteElement("part", "");
               GXSoapXMLWriter.WriteAttribute("name", "parameters");
               GXSoapXMLWriter.WriteAttribute("element", "tns:WorkWithPlus.NativeMobile.WWPGetCalendarDate.Execute");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("message");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPGetCalendarDate.ExecuteSoapOut");
               GXSoapXMLWriter.WriteElement("part", "");
               GXSoapXMLWriter.WriteAttribute("name", "parameters");
               GXSoapXMLWriter.WriteAttribute("element", "tns:WorkWithPlus.NativeMobile.WWPGetCalendarDate.ExecuteResponse");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("portType");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPGetCalendarDateSoapPort");
               GXSoapXMLWriter.WriteStartElement("operation");
               GXSoapXMLWriter.WriteAttribute("name", "Execute");
               GXSoapXMLWriter.WriteElement("input", "");
               GXSoapXMLWriter.WriteAttribute("message", "wsdlns:"+"WorkWithPlus.NativeMobile.WWPGetCalendarDate.ExecuteSoapIn");
               GXSoapXMLWriter.WriteElement("output", "");
               GXSoapXMLWriter.WriteAttribute("message", "wsdlns:"+"WorkWithPlus.NativeMobile.WWPGetCalendarDate.ExecuteSoapOut");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteStartElement("binding");
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPGetCalendarDateSoapBinding");
               GXSoapXMLWriter.WriteAttribute("type", "wsdlns:"+"WorkWithPlus.NativeMobile.WWPGetCalendarDateSoapPort");
               ...
               GXSoapXMLWriter.WriteAttribute("soapAction", "YTT_version4action/"+"workwithplus.nativemobile.AWWPGETCALENDARDATE.Execute");
               ...
               GXSoapXMLWriter.WriteAttribute("name", "WorkWithPlus.NativeMobile.WWPGetCalendarDateSoapPort");
               GXSoapXMLWriter.WriteAttribute("binding", "wsdlns:"+"WorkWithPlus.NativeMobile.WWPGetCalendarDateSoapBinding");
               GXSoapXMLWriter.WriteElement("soap:address", "");
               GXSoapXMLWriter.WriteAttribute("location", "http://"+context.GetServerName( )+((context.GetServerPort( )>0)&&(context.GetServerPort( )!=80)&&(context.GetServerPort( )!=443) ? ":"+StringUtil.LTrim( StringUtil.Str( (decimal)(context.GetServerPort( )), 6, 0)) : "")+context.GetScriptPath( )+"workwithplus.nativemobile.wwpgetcalendardate.aspx");
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteEndElement();
               GXSoapXMLWriter.WriteEndElement();
            ...
            else
            {
               ...
               currSoapErrmsg = "No SOAP request found. Call " + "http://" + context.GetServerName( ) + ((context.GetServerPort( )>0)&&(context.GetServerPort( )!=80)&&(context.GetServerPort( )!=443) ? ":"+StringUtil.LTrim( StringUtil.Str( (decimal)(context.GetServerPort( )), 6, 0)) : "") + context.GetScriptPath( ) + "workwithplus.nativemobile.wwpgetcalendardate.aspx" + "?wsdl to get the WSDL.";
            }
         }
         if ( currSoapErr == 0 )
         {
         ...
         if ( ( StringUtil.StringSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
         {
            ...
            GXSoapXMLWriter.WriteStartElement("WorkWithPlus.NativeMobile.WWPGetCalendarDate.ExecuteResponse");
      ...
      public wwpgetcalendardate( IGxContext context )
      {
      ...
      public void execute( [GxJsonFormat("yyyy-MM-dd")] DateTime aP0_Date ,
                           out string aP1_DateJson )
      {
         this.AV9Date = aP0_Date;
         this.AV10DateJson = "" ;
         initialize();
         executePrivate();
         aP1_DateJson=this.AV10DateJson;
      }

      public string executeUdp( DateTime aP0_Date )
      {
         execute(aP0_Date, out aP1_DateJson);
         return AV10DateJson ;
      }
      ...
      public void executeSubmit( DateTime aP0_Date ,
                                 out string aP1_DateJson )
      {
         wwpgetcalendardate objwwpgetcalendardate;
         objwwpgetcalendardate = new wwpgetcalendardate();
         objwwpgetcalendardate.AV9Date = aP0_Date;
         objwwpgetcalendardate.AV10DateJson = "" ;
         objwwpgetcalendardate.context.SetSubmitInitialConfig(context);
         objwwpgetcalendardate.initialize();
         Submit( executePrivateCatch,objwwpgetcalendardate);
         aP1_DateJson=this.AV10DateJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wwpgetcalendardate)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV8CurrentDate.gxTpr_Year = (short)(DateTimeUtil.Year( AV9Date));
         AV8CurrentDate.gxTpr_Month = (short)(DateTimeUtil.Month( AV9Date));
         AV8CurrentDate.gxTpr_Day = (short)(DateTimeUtil.Day( AV9Date));
