...
namespace GeneXus.Programs {
   public class testprojectlogsbyemployeeexport : GXProcedure
   {
      ...
      protected void S131( )
      {
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV38TFWorkHourLogDuration_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV38TFWorkHourLogDuration_Sel)) ? "(Empty)" : AV38TFWorkHourLogDuration_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV37TFWorkHourLogDuration)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV37TFWorkHourLogDuration, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV40TFWorkHourLogDescription_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV40TFWorkHourLogDescription_Sel)) ? "(Empty)" : StringUtil.Substring( AV40TFWorkHourLogDescription_Sel, 1, 1000)), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV39TFWorkHourLogDescription)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  StringUtil.Substring( AV39TFWorkHourLogDescription, 1, 1000), out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV42TFProjectName_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV42TFProjectName_Sel)) ? "(Empty)" : AV42TFProjectName_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV41TFProjectName)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV41TFProjectName, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
      ...
      protected void S161( )
      {
         ...
         {
            A102ProjectId = P00BE2_A102ProjectId[0];
            A103ProjectName = P00BE2_A103ProjectName[0];
            A123WorkHourLogDescription = P00BE2_A123WorkHourLogDescription[0];
            A120WorkHourLogDuration = P00BE2_A120WorkHourLogDuration[0];
            A119WorkHourLogDate = P00BE2_A119WorkHourLogDate[0];
            A118WorkHourLogId = P00BE2_A118WorkHourLogId[0];
            A103ProjectName = P00BE2_A103ProjectName[0];
      ...
      protected void S151( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "TestProjectLogsByEmployeeColumnsSelector", out  GXt_char1) ;
      ...
      protected void S201( )
      {
         ...
         {
            AV22GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "TestProjectLogsByEmployeeGridState"), null, "", "");
         }
         else
         {
      ...
      public override void initialize( )
      {
         ...
         P00BE2_A102ProjectId = new long[1] ;
         P00BE2_A103ProjectName = new string[] {""} ;
         P00BE2_A123WorkHourLogDescription = new string[] {""} ;
         P00BE2_A120WorkHourLogDuration = new string[] {""} ;
         P00BE2_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P00BE2_A118WorkHourLogId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.testprojectlogsbyemployeeexport__default(),
            new Object[][] {
                new Object[] {
               P00BE2_A102ProjectId, P00BE2_A103ProjectName, P00BE2_A123WorkHourLogDescription, P00BE2_A120WorkHourLogDuration, P00BE2_A119WorkHourLogDate, P00BE2_A118WorkHourLogId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00BE2_A123WorkHourLogDescription ;
   ...
   {
      protected Object[] conditional_P00BE2( IGxContext context ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00BE2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (DateTime)dynConstraints[12] , (short)dynConstraints[13] , (bool)dynConstraints[14] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00BE2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BE2,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
