...
namespace GeneXus.Programs {
   public class sitesettingview : GXDataArea
   {
      public sitesettingview( )
      {
      ...
      public sitesettingview( IGxContext context )
      {
      ...
      public void execute( long aP0_SiteSettingId ,
                           string aP1_TabCode )
      {
         this.AV10SiteSettingId = aP0_SiteSettingId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10SiteSettingId = (long)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV10SiteSettingId", StringUtil.LTrimStr( (decimal)(AV10SiteSettingId), 10, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vSITESETTINGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SiteSettingId), "ZZZZZZZZZ9"), context));
      ...
      {
         get {
            return "sitesettingview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("sitesettingview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10SiteSettingId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"SiteSettingId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vSITESETTINGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10SiteSettingId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSITESETTINGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SiteSettingId), "ZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("sitesettingview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10SiteSettingId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"SiteSettingId","TabCode"})  ;
      }
      ...
      protected void WB5O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Site Setting", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_SiteSettingView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_SiteSettingView.htm");
            /* Div Control */
      ...
      protected void START5O2( )
      {
         ...
         Form.Meta.addItem("description", "Site Setting View", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP5O0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10SiteSettingId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vSITESETTINGID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E115O2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("sitesettingww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H005O2 */
         pr_default.execute(0, new Object[] {AV10SiteSettingId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A160SiteSettingId = H005O2_A160SiteSettingId[0];
            A161IsLogHourOpen = H005O2_A161IsLogHourOpen[0];
            AV16GXLvl9 = 1;
            Form.Caption = StringUtil.BoolToStr( A161IsLogHourOpen);
         ...
         AV15AIAppliedFilters = AV14Session.Get("SiteSettingViewQueryAppliedFilters");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( StringUtil.Trim( AV15AIAppliedFilters))) )
         {
            GX_msglist.addItem(AV15AIAppliedFilters);
            AV14Session.Remove("SiteSettingViewQueryAppliedFilters");
         }
      }
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "SiteSettingGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "sitesettinggeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "SiteSettingGeneral";
               WebComp_Generalwc_Component = "SiteSettingGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0025",(string)"",(long)AV10SiteSettingId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10SiteSettingId = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV10SiteSettingId", StringUtil.LTrimStr( (decimal)(AV10SiteSettingId), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vSITESETTINGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10SiteSettingId), "ZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112810473449", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("sitesettingview.js", "?2024112810473449", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Site Setting View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV10SiteSettingId","fld":"vSITESETTINGID","pic":"ZZZZZZZZZ9","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         H005O2_A160SiteSettingId = new long[1] ;
         H005O2_A161IsLogHourOpen = new bool[] {false} ;
         AV15AIAppliedFilters = "";
         AV14Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sitesettingview__default(),
            new Object[][] {
                new Object[] {
               H005O2_A160SiteSettingId, H005O2_A161IsLogHourOpen
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10SiteSettingId ;
      private long wcpOAV10SiteSettingId ;
      ...
      private long[] H005O2_A160SiteSettingId ;
      private bool[] H005O2_A161IsLogHourOpen ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class sitesettingview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10SiteSettingId",GXType.Int64,10,0)
          };
          def= new CursorDef[] {
              new CursorDef("H005O2", "SELECT SiteSettingId, IsLogHourOpen FROM SiteSetting WHERE SiteSettingId = :AV10SiteSettingId ORDER BY SiteSettingId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005O2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
