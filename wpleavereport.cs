...
namespace GeneXus.Programs {
   public class wpleavereport : GXDataArea
   {
      ...
      protected void E202Z2( )
      {
         ...
         AV34AGExportData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         AV35AGExportDataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
      ...
      protected void E212Z2( )
      {
         ...
         edtavSdtleavereport_periodcollection__label_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavSdtleavereport_periodcollection__fromdate_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavSdtleavereport_periodcollection__todate_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavSdtleavereport_periodcollection__formattedtotalwork_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavSdtleavereport_periodcollection__formattedtotalleave_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(5)).gxTpr_Isvisible ? 1 : 0);
      ...
      protected void E192Z2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "WPLeaveReportColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV19ColumnsSelectorXML)) ? "" : AV21ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E112Z2( )
      {
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "WPLeaveReportFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char4) ;
            ...
            else
            {
               ...
               S162 ();
               if (returnInSub) return;
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV72Pgmname+"GridState",  AV25ManageFiltersXml) ;
      ...
      protected void E232Z2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Grid_dwc_Component) != 0 )
         {
            ...
            WebComp_Grid_dwc.componentprepare(new Object[] {(string)"W0092",(string)"",((SdtSDTLeaveReport_PeriodCollectionItem)(AV16SDTLeaveReport.gxTpr_Periodcollection.CurrentItem)).gxTpr_Fromdate,((SdtSDTLeaveReport_PeriodCollectionItem)(AV16SDTLeaveReport.gxTpr_Periodcollection.CurrentItem)).gxTpr_Todate,(long)AV39EmployeeId,(long)AV60CompanyLocationId,((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible,((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(5)).gxTpr_Isvisible});
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "SDTLeaveReport_PeriodCollection__Label",  "",  "Period",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "SDTLeaveReport_PeriodCollection__FromDate",  "",  "DateFrom",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "SDTLeaveReport_PeriodCollection__ToDate",  "",  "Date To",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "SDTLeaveReport_PeriodCollection__FormattedTotalWork",  "",  "Work Hours",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "SDTLeaveReport_PeriodCollection__FormattedTotalLeave",  "",  "Leave Hours",  true,  "") ;
         GXt_char4 = AV20UserCustomValue;
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "WPLeaveReportColumnsSelector", out  GXt_char4) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "WPLeaveReportFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item5) ;
      ...
      protected void S132( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV13GridState,  "EMPLOYEEID",  "Employee",  !(0==AV39EmployeeId),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV39EmployeeId), 10, 0)),  AV47AuxText,  false,  "",  "") ;
         GXt_char4 = AV47AuxText;
         new wpleavereportloaddvcombo(context ).execute(  "ProjectId",  "GET_DSC_TEXT",  AV38ProjectId.ToJSonString(false), out  GXt_char4) ;
         AV47AuxText = GXt_char4;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV13GridState,  "PROJECTID",  "Project",  !(AV38ProjectId.Count==0),  0,  AV38ProjectId.ToJSonString(false),  ((AV38ProjectId.Count==1) ? AV47AuxText : "multiple values"),  false,  "",  "") ;
         GXt_char4 = AV47AuxText;
         ...
         AV47AuxText = GXt_char4;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV13GridState,  "COMPANYLOCATIONID",  "Location",  !(0==AV60CompanyLocationId),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV60CompanyLocationId), 10, 0)),  AV47AuxText,  false,  "",  "") ;
      ...
      protected void S222( )
      {
         ...
         returnInSub = false;
         AV42PeriodicCategory_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112810464957", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpleavereport.js", "?2024112810464961", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV42PeriodicCategory_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV44EmployeeId_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV57ProjectId_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV61CompanyLocationId_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         AV31GridAppliedFilters = "";
         AV34AGExportData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         AV59Date_RangePickerOptions = new GeneXus.Programs.wwpbaseobjects.SdtWWPDateRangePickerOptions(context);
         Combo_periodiccategory_Selectedvalue_set = "";
         Combo_employeeid_Selectedvalue_set = "";
         Combo_employeeid_Selectedtext_set = "";
