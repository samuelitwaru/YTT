...
namespace GeneXus.Programs {
   public class testprojectlogsbyemployee : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV48RedirectToFirstDetail = StringUtil.StrToBool( GetPar( "RedirectToFirstDetail"));
         AV49QueryIntent = GetPar( "QueryIntent");
         AV44GridAppliedFilters = GetPar( "GridAppliedFilters");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV16FilterFullText, AV26ManageFiltersExecutionStep, AV21ColumnsSelector, AV50Pgmname, AV27TFWorkHourLogDate, AV28TFWorkHourLogDate_To, AV32TFWorkHourLogDuration, AV33TFWorkHourLogDuration_Sel, AV34TFWorkHourLogDescription, AV35TFWorkHourLogDescription_Sel, AV36TFProjectName, AV37TFProjectName_Sel, AV48RedirectToFirstDetail, AV49QueryIntent, AV44GridAppliedFilters, AV47IsAuthorized_Insert) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vREDIRECTTOFIRSTDETAIL", AV48RedirectToFirstDetail);
         GxWebStd.gx_hidden_field( context, "gxhash_vREDIRECTTOFIRSTDETAIL", GetSecureSignedToken( "", AV48RedirectToFirstDetail, context));
         GxWebStd.gx_hidden_field( context, "vQUERYINTENT", AV49QueryIntent);
         GxWebStd.gx_hidden_field( context, "gxhash_vQUERYINTENT", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV49QueryIntent, "")), context));
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV48RedirectToFirstDetail ,
                                       string AV49QueryIntent ,
                                       string AV44GridAppliedFilters ,
      ...
      protected void E195P2( )
      {
         ...
         AV49QueryIntent = StringUtil.Trim( AV23Session.Get(AV50Pgmname+"QueryIntent"));
         AssignAttri("", false, "AV49QueryIntent", AV49QueryIntent);
         GxWebStd.gx_hidden_field( context, "gxhash_vQUERYINTENT", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV49QueryIntent, "")), context));
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV49QueryIntent)) )
         {
            AV23Session.Remove(AV50Pgmname+"QueryIntent");
            if ( StringUtil.StrCmp(AV49QueryIntent, "5") == 0 )
            {
               if ( new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context).executeUdp(  "workhourlog_Insert") )
               {
            ...
            {
               AV48RedirectToFirstDetail = true;
               AssignAttri("", false, "AV48RedirectToFirstDetail", AV48RedirectToFirstDetail);
               GxWebStd.gx_hidden_field( context, "gxhash_vREDIRECTTOFIRSTDETAIL", GetSecureSignedToken( "", AV48RedirectToFirstDetail, context));
            }
         }
         AV51Testprojectlogsbyemployeeds_1_filterfulltext = AV16FilterFullText;
      ...
      private void E205P2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         if ( AV48RedirectToFirstDetail )
         {
            if ( StringUtil.StrCmp(AV49QueryIntent, "2") == 0 )
            {
               AV23Session.Set("WorkHourLogViewQueryAppliedFilters", AV44GridAppliedFilters);
            ...
            AV48RedirectToFirstDetail = false;
            AssignAttri("", false, "AV48RedirectToFirstDetail", AV48RedirectToFirstDetail);
            GxWebStd.gx_hidden_field( context, "gxhash_vREDIRECTTOFIRSTDETAIL", GetSecureSignedToken( "", AV48RedirectToFirstDetail, context));
         }
         /* Load Method */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202513120362997", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("testprojectlogsbyemployee.js", "?202513120362999", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E205P2","iparms":[{"av":"AV48RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true},{"av":"AV49QueryIntent","fld":"vQUERYINTENT","hsh":true},{"av":"AV44GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"A118WorkHourLogId","fld":"WORKHOURLOGID","pic":"ZZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV48RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E165P2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV50Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFWorkHourLogDate","fld":"vTFWORKHOURLOGDATE"},{"av":"AV28TFWorkHourLogDate_To","fld":"vTFWORKHOURLOGDATE_TO"},{"av":"AV32TFWorkHourLogDuration","fld":"vTFWORKHOURLOGDURATION"},{"av":"AV33TFWorkHourLogDuration_Sel","fld":"vTFWORKHOURLOGDURATION_SEL"},{"av":"AV34TFWorkHourLogDescription","fld":"vTFWORKHOURLOGDESCRIPTION"},{"av":"AV35TFWorkHourLogDescription_Sel","fld":"vTFWORKHOURLOGDESCRIPTION_SEL"},{"av":"AV36TFProjectName","fld":"vTFPROJECTNAME"},{"av":"AV37TFProjectName_Sel","fld":"vTFPROJECTNAME_SEL"},{"av":"AV48RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true},{"av":"AV49QueryIntent","fld":"vQUERYINTENT","hsh":true},{"av":"AV44GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV47IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"},{"av":"A118WorkHourLogId","fld":"WORKHOURLOGID","pic":"ZZZZZZZZZ9","hsh":true}]""");
      ...
      private bool AV48RedirectToFirstDetail ;
      ...
      private string AV49QueryIntent ;
