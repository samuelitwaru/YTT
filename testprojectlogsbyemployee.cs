...
namespace GeneXus.Programs {
   public class testprojectlogsbyemployee : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV26ManageFiltersExecutionStep, AV21ColumnsSelector, AV48Pgmname, AV27TFWorkHourLogDate, AV28TFWorkHourLogDate_To, AV32TFWorkHourLogDuration, AV33TFWorkHourLogDuration_Sel, AV34TFWorkHourLogDescription, AV35TFWorkHourLogDescription_Sel, AV36TFProjectName, AV37TFProjectName_Sel, AV13OrderedBy, AV14OrderedDsc, AV47IsAuthorized_Insert) ;
      ...
      protected void WB5P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(41), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TestProjectLogsByEmployee.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnagexport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(41), 2, 0)+","+"null"+");", "Export", bttBtnagexport_Jsonclick, 0, "Export", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_TestProjectLogsByEmployee.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(41), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_TestProjectLogsByEmployee.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            wb_table1_23_5P2( true) ;
         }
         else
         {
            wb_table1_23_5P2( false) ;
         }
         return  ;
      }

      protected void wb_table1_23_5P2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 41 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_workhourlogdateauxdatetext_Internalname, AV31DDO_WorkHourLogDateAuxDateText, StringUtil.RTrim( context.localUtil.Format( AV31DDO_WorkHourLogDateAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,63);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_workhourlogdateauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_TestProjectLogsByEmployee.htm");
            /* User Defined Control */
      ...
      {
         /* GeneXus formulas. */
         AV48Pgmname = "TestProjectLogsByEmployee";
      }
      ...
      protected void RF5P2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV49Testprojectlogsbyemployeeds_1_filterfulltext ,
                                                 AV50Testprojectlogsbyemployeeds_2_tfworkhourlogdate ,
                                                 AV51Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to ,
                                                 AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel ,
                                                 AV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration ,
                                                 AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel ,
                                                 AV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription ,
                                                 AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel ,
                                                 AV56Testprojectlogsbyemployeeds_8_tfprojectname ,
            ...
            lV49Testprojectlogsbyemployeeds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV49Testprojectlogsbyemployeeds_1_filterfulltext), "%", "");
            lV49Testprojectlogsbyemployeeds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV49Testprojectlogsbyemployeeds_1_filterfulltext), "%", "");
            lV49Testprojectlogsbyemployeeds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV49Testprojectlogsbyemployeeds_1_filterfulltext), "%", "");
            lV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration = StringUtil.Concat( StringUtil.RTrim( AV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration), "%", "");
            lV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription = StringUtil.Concat( StringUtil.RTrim( AV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription), "%", "");
            lV56Testprojectlogsbyemployeeds_8_tfprojectname = StringUtil.PadR( StringUtil.RTrim( AV56Testprojectlogsbyemployeeds_8_tfprojectname), 100, "%");
            /* Using cursor H005P2 */
            pr_default.execute(0, new Object[] {lV49Testprojectlogsbyemployeeds_1_filterfulltext, lV49Testprojectlogsbyemployeeds_1_filterfulltext, lV49Testprojectlogsbyemployeeds_1_filterfulltext, AV50Testprojectlogsbyemployeeds_2_tfworkhourlogdate, AV51Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to, lV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration, AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel, lV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription, AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel, lV56Testprojectlogsbyemployeeds_8_tfprojectname, AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_41_idx = 1;
            sGXsfl_41_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_41_idx), 4, 0), 4, "0");
            SubsflControlProps_412( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A103ProjectName = H005P2_A103ProjectName[0];
               A102ProjectId = H005P2_A102ProjectId[0];
               A107EmployeeFirstName = H005P2_A107EmployeeFirstName[0];
               A106EmployeeId = H005P2_A106EmployeeId[0];
               A123WorkHourLogDescription = H005P2_A123WorkHourLogDescription[0];
               A122WorkHourLogMinute = H005P2_A122WorkHourLogMinute[0];
               A121WorkHourLogHour = H005P2_A121WorkHourLogHour[0];
               A120WorkHourLogDuration = H005P2_A120WorkHourLogDuration[0];
               A119WorkHourLogDate = H005P2_A119WorkHourLogDate[0];
               A118WorkHourLogId = H005P2_A118WorkHourLogId[0];
               A103ProjectName = H005P2_A103ProjectName[0];
               A107EmployeeFirstName = H005P2_A107EmployeeFirstName[0];
               E205P2 ();
      ...
      protected void send_integrity_lvl_hashes5P2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_INSERT", AV47IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV47IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, "gxhash_WORKHOURLOGID"+"_"+sGXsfl_41_idx, GetSecureSignedToken( sGXsfl_41_idx, context.localUtil.Format( (decimal)(A118WorkHourLogId), "ZZZZZZZZZ9"), context));
      }
      ...
      {
         AV49Testprojectlogsbyemployeeds_1_filterfulltext = AV16FilterFullText;
         AV50Testprojectlogsbyemployeeds_2_tfworkhourlogdate = AV27TFWorkHourLogDate;
         AV51Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to = AV28TFWorkHourLogDate_To;
         AV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration = AV32TFWorkHourLogDuration;
         AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel = AV33TFWorkHourLogDuration_Sel;
         AV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription = AV34TFWorkHourLogDescription;
         AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel = AV35TFWorkHourLogDescription_Sel;
         AV56Testprojectlogsbyemployeeds_8_tfprojectname = AV36TFProjectName;
         AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel = AV37TFProjectName_Sel;
         ...
         lV56Testprojectlogsbyemployeeds_8_tfprojectname = StringUtil.PadR( StringUtil.RTrim( AV56Testprojectlogsbyemployeeds_8_tfprojectname), 100, "%");
         /* Using cursor H005P3 */
         pr_default.execute(1, new Object[] {lV49Testprojectlogsbyemployeeds_1_filterfulltext, lV49Testprojectlogsbyemployeeds_1_filterfulltext, lV49Testprojectlogsbyemployeeds_1_filterfulltext, AV50Testprojectlogsbyemployeeds_2_tfworkhourlogdate, AV51Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to, lV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration, AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel, lV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription, AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel, lV56Testprojectlogsbyemployeeds_8_tfprojectname, AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtWorkHourLogId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtWorkHourLogId_Enabled), 5, 0), !bGXsfl_41_Refreshing);
         edtWorkHourLogDate_Enabled = 0;
         AssignProp("", false, edtWorkHourLogDate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtWorkHourLogDate_Enabled), 5, 0), !bGXsfl_41_Refreshing);
         edtWorkHourLogDuration_Enabled = 0;
         AssignProp("", false, edtWorkHourLogDuration_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtWorkHourLogDuration_Enabled), 5, 0), !bGXsfl_41_Refreshing);
         edtWorkHourLogHour_Enabled = 0;
         AssignProp("", false, edtWorkHourLogHour_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtWorkHourLogHour_Enabled), 5, 0), !bGXsfl_41_Refreshing);
         edtWorkHourLogMinute_Enabled = 0;
         AssignProp("", false, edtWorkHourLogMinute_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtWorkHourLogMinute_Enabled), 5, 0), !bGXsfl_41_Refreshing);
         edtWorkHourLogDescription_Enabled = 0;
         AssignProp("", false, edtWorkHourLogDescription_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtWorkHourLogDescription_Enabled), 5, 0), !bGXsfl_41_Refreshing);
      ...
      protected void E195P2( )
      {
         ...
         edtWorkHourLogDate_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtWorkHourLogDate_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtWorkHourLogDate_Visible), 5, 0), !bGXsfl_41_Refreshing);
         edtWorkHourLogDuration_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtWorkHourLogDuration_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtWorkHourLogDuration_Visible), 5, 0), !bGXsfl_41_Refreshing);
         edtWorkHourLogDescription_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtWorkHourLogDescription_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtWorkHourLogDescription_Visible), 5, 0), !bGXsfl_41_Refreshing);
         edtProjectName_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV21ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible ? 1 : 0);
      ...
      protected void E165P2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "TestProjectLogsByEmployeeColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV19ColumnsSelectorXML)) ? "" : AV21ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E115P2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("TestProjectLogsByEmployeeFilters")),UrlEncode(StringUtil.RTrim(AV48Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV26ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV26ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV26ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "TestProjectLogsByEmployeeFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV48Pgmname+"GridState",  AV25ManageFiltersXml) ;
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "TestProjectLogsByEmployeeColumnsSelector", out  GXt_char2) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "TestProjectLogsByEmployeeFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV23Session.Get(AV48Pgmname+"GridState"), "") == 0 )
         {
            AV11GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV48Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV23Session.Get(AV48Pgmname+"GridState"), null, "", "");
         }
         AV13OrderedBy = AV11GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV13OrderedBy", StringUtil.LTrimStr( (decimal)(AV13OrderedBy), 4, 0));
         AV14OrderedDsc = AV11GridState.gxTpr_Ordereddsc;
      ...
      protected void S192( )
      {
         ...
         GXt_char2 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV33TFWorkHourLogDuration_Sel)),  AV33TFWorkHourLogDuration_Sel, out  GXt_char2) ;
         GXt_char5 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV35TFWorkHourLogDescription_Sel)),  AV35TFWorkHourLogDescription_Sel, out  GXt_char5) ;
         GXt_char6 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV37TFProjectName_Sel)),  AV37TFProjectName_Sel, out  GXt_char6) ;
         Ddo_grid_Selectedvalue_set = "|"+GXt_char2+"|"+GXt_char5+"|"+GXt_char6;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char6 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV32TFWorkHourLogDuration)),  AV32TFWorkHourLogDuration, out  GXt_char6) ;
         GXt_char5 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV34TFWorkHourLogDescription)),  AV34TFWorkHourLogDescription, out  GXt_char5) ;
         GXt_char2 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV36TFProjectName)),  AV36TFProjectName, out  GXt_char2) ;
      ...
      protected void wb_table1_23_5P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_28_5P2( true) ;
         }
         else
         {
            wb_table2_28_5P2( false) ;
         }
         return  ;
      }

      protected void wb_table2_28_5P2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_23_5P2e( true) ;
         }
         else
         {
            wb_table1_23_5P2e( false) ;
         }
      }

      protected void wb_table2_28_5P2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481416571249", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("testprojectlogsbyemployee.js", "?202481416571251", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtWorkHourLogId_Internalname = "WORKHOURLOGID_"+sGXsfl_41_idx;
         edtWorkHourLogDate_Internalname = "WORKHOURLOGDATE_"+sGXsfl_41_idx;
         edtWorkHourLogDuration_Internalname = "WORKHOURLOGDURATION_"+sGXsfl_41_idx;
         edtWorkHourLogHour_Internalname = "WORKHOURLOGHOUR_"+sGXsfl_41_idx;
         edtWorkHourLogMinute_Internalname = "WORKHOURLOGMINUTE_"+sGXsfl_41_idx;
         edtWorkHourLogDescription_Internalname = "WORKHOURLOGDESCRIPTION_"+sGXsfl_41_idx;
      ...
      {
         edtWorkHourLogId_Internalname = "WORKHOURLOGID_"+sGXsfl_41_fel_idx;
         edtWorkHourLogDate_Internalname = "WORKHOURLOGDATE_"+sGXsfl_41_fel_idx;
         edtWorkHourLogDuration_Internalname = "WORKHOURLOGDURATION_"+sGXsfl_41_fel_idx;
         edtWorkHourLogHour_Internalname = "WORKHOURLOGHOUR_"+sGXsfl_41_fel_idx;
         edtWorkHourLogMinute_Internalname = "WORKHOURLOGMINUTE_"+sGXsfl_41_fel_idx;
         edtWorkHourLogDescription_Internalname = "WORKHOURLOGDESCRIPTION_"+sGXsfl_41_fel_idx;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV26ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV21ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFWorkHourLogDate',fld:'vTFWORKHOURLOGDATE',pic:''},{av:'AV28TFWorkHourLogDate_To',fld:'vTFWORKHOURLOGDATE_TO',pic:''},{av:'AV32TFWorkHourLogDuration',fld:'vTFWORKHOURLOGDURATION',pic:''},{av:'AV33TFWorkHourLogDuration_Sel',fld:'vTFWORKHOURLOGDURATION_SEL',pic:''},{av:'AV34TFWorkHourLogDescription',fld:'vTFWORKHOURLOGDESCRIPTION',pic:''},{av:'AV35TFWorkHourLogDescription_Sel',fld:'vTFWORKHOURLOGDESCRIPTION_SEL',pic:''},{av:'AV36TFProjectName',fld:'vTFPROJECTNAME',pic:''},{av:'AV37TFProjectName_Sel',fld:'vTFPROJECTNAME_SEL',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV47IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV26ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV21ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtWorkHourLogDate_Visible',ctrl:'WORKHOURLOGDATE',prop:'Visible'},{av:'edtWorkHourLogDuration_Visible',ctrl:'WORKHOURLOGDURATION',prop:'Visible'},{av:'edtWorkHourLogDescription_Visible',ctrl:'WORKHOURLOGDESCRIPTION',prop:'Visible'},{av:'edtProjectName_Visible',ctrl:'PROJECTNAME',prop:'Visible'},{av:'AV42GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV43GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV44GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV47IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV24ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E125P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV26ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV21ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFWorkHourLogDate',fld:'vTFWORKHOURLOGDATE',pic:''},{av:'AV28TFWorkHourLogDate_To',fld:'vTFWORKHOURLOGDATE_TO',pic:''},{av:'AV32TFWorkHourLogDuration',fld:'vTFWORKHOURLOGDURATION',pic:''},{av:'AV33TFWorkHourLogDuration_Sel',fld:'vTFWORKHOURLOGDURATION_SEL',pic:''},{av:'AV34TFWorkHourLogDescription',fld:'vTFWORKHOURLOGDESCRIPTION',pic:''},{av:'AV35TFWorkHourLogDescription_Sel',fld:'vTFWORKHOURLOGDESCRIPTION_SEL',pic:''},{av:'AV36TFProjectName',fld:'vTFPROJECTNAME',pic:''},{av:'AV37TFProjectName_Sel',fld:'vTFPROJECTNAME_SEL',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV47IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         ...
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E155P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV26ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV21ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFWorkHourLogDate',fld:'vTFWORKHOURLOGDATE',pic:''},{av:'AV28TFWorkHourLogDate_To',fld:'vTFWORKHOURLOGDATE_TO',pic:''},{av:'AV32TFWorkHourLogDuration',fld:'vTFWORKHOURLOGDURATION',pic:''},{av:'AV33TFWorkHourLogDuration_Sel',fld:'vTFWORKHOURLOGDURATION_SEL',pic:''},{av:'AV34TFWorkHourLogDescription',fld:'vTFWORKHOURLOGDESCRIPTION',pic:''},{av:'AV35TFWorkHourLogDescription_Sel',fld:'vTFWORKHOURLOGDESCRIPTION_SEL',pic:''},{av:'AV36TFProjectName',fld:'vTFPROJECTNAME',pic:''},{av:'AV37TFProjectName_Sel',fld:'vTFPROJECTNAME_SEL',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV47IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'Ddo_grid_Selectedcolumn',ctrl:'DDO_GRID',prop:'SelectedColumn'},{av:'Ddo_grid_Filteredtext_get',ctrl:'DDO_GRID',prop:'FilteredText_get'},{av:'Ddo_grid_Filteredtextto_get',ctrl:'DDO_GRID',prop:'FilteredTextTo_get'}]");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",",oparms:[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27TFWorkHourLogDate',fld:'vTFWORKHOURLOGDATE',pic:''},{av:'AV28TFWorkHourLogDate_To',fld:'vTFWORKHOURLOGDATE_TO',pic:''},{av:'AV32TFWorkHourLogDuration',fld:'vTFWORKHOURLOGDURATION',pic:''},{av:'AV33TFWorkHourLogDuration_Sel',fld:'vTFWORKHOURLOGDURATION_SEL',pic:''},{av:'AV34TFWorkHourLogDescription',fld:'vTFWORKHOURLOGDESCRIPTION',pic:''},{av:'AV35TFWorkHourLogDescription_Sel',fld:'vTFWORKHOURLOGDESCRIPTION_SEL',pic:''},{av:'AV36TFProjectName',fld:'vTFPROJECTNAME',pic:''},{av:'AV37TFProjectName_Sel',fld:'vTFPROJECTNAME_SEL',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E205P2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","{handler:'E165P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV26ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV21ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFWorkHourLogDate',fld:'vTFWORKHOURLOGDATE',pic:''},{av:'AV28TFWorkHourLogDate_To',fld:'vTFWORKHOURLOGDATE_TO',pic:''},{av:'AV32TFWorkHourLogDuration',fld:'vTFWORKHOURLOGDURATION',pic:''},{av:'AV33TFWorkHourLogDuration_Sel',fld:'vTFWORKHOURLOGDURATION_SEL',pic:''},{av:'AV34TFWorkHourLogDescription',fld:'vTFWORKHOURLOGDESCRIPTION',pic:''},{av:'AV35TFWorkHourLogDescription_Sel',fld:'vTFWORKHOURLOGDESCRIPTION_SEL',pic:''},{av:'AV36TFProjectName',fld:'vTFPROJECTNAME',pic:''},{av:'AV37TFProjectName_Sel',fld:'vTFPROJECTNAME_SEL',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV47IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_gridcolumnsselector_Columnsselectorvalues',ctrl:'DDO_GRIDCOLUMNSSELECTOR',prop:'ColumnsSelectorValues'}]");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",",oparms:[{av:'AV21ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV26ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'edtWorkHourLogDate_Visible',ctrl:'WORKHOURLOGDATE',prop:'Visible'},{av:'edtWorkHourLogDuration_Visible',ctrl:'WORKHOURLOGDURATION',prop:'Visible'},{av:'edtWorkHourLogDescription_Visible',ctrl:'WORKHOURLOGDESCRIPTION',prop:'Visible'},{av:'edtProjectName_Visible',ctrl:'PROJECTNAME',prop:'Visible'},{av:'AV42GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV43GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV44GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV47IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV24ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV26ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV27TFWorkHourLogDate',fld:'vTFWORKHOURLOGDATE',pic:''},{av:'AV28TFWorkHourLogDate_To',fld:'vTFWORKHOURLOGDATE_TO',pic:''},{av:'AV32TFWorkHourLogDuration',fld:'vTFWORKHOURLOGDURATION',pic:''},{av:'AV33TFWorkHourLogDuration_Sel',fld:'vTFWORKHOURLOGDURATION_SEL',pic:''},{av:'AV34TFWorkHourLogDescription',fld:'vTFWORKHOURLOGDESCRIPTION',pic:''},{av:'AV35TFWorkHourLogDescription_Sel',fld:'vTFWORKHOURLOGDESCRIPTION_SEL',pic:''},{av:'AV36TFProjectName',fld:'vTFPROJECTNAME',pic:''},{av:'AV37TFProjectName_Sel',fld:'vTFPROJECTNAME_SEL',pic:''},{av:'Ddo_grid_Selectedvalue_set',ctrl:'DDO_GRID',prop:'SelectedValue_set'},{av:'Ddo_grid_Filteredtext_set',ctrl:'DDO_GRID',prop:'FilteredText_set'},{av:'Ddo_grid_Filteredtextto_set',ctrl:'DDO_GRID',prop:'FilteredTextTo_set'},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'},{av:'AV21ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtWorkHourLogDate_Visible',ctrl:'WORKHOURLOGDATE',prop:'Visible'},{av:'edtWorkHourLogDuration_Visible',ctrl:'WORKHOURLOGDURATION',prop:'Visible'},{av:'edtWorkHourLogDescription_Visible',ctrl:'WORKHOURLOGDESCRIPTION',prop:'Visible'},{av:'edtProjectName_Visible',ctrl:'PROJECTNAME',prop:'Visible'},{av:'AV42GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV43GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV44GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV47IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV24ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
         setEventMetadata("'DOINSERT'","{handler:'E175P2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV26ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV21ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFWorkHourLogDate',fld:'vTFWORKHOURLOGDATE',pic:''},{av:'AV28TFWorkHourLogDate_To',fld:'vTFWORKHOURLOGDATE_TO',pic:''},{av:'AV32TFWorkHourLogDuration',fld:'vTFWORKHOURLOGDURATION',pic:''},{av:'AV33TFWorkHourLogDuration_Sel',fld:'vTFWORKHOURLOGDURATION_SEL',pic:''},{av:'AV34TFWorkHourLogDescription',fld:'vTFWORKHOURLOGDESCRIPTION',pic:''},{av:'AV35TFWorkHourLogDescription_Sel',fld:'vTFWORKHOURLOGDESCRIPTION_SEL',pic:''},{av:'AV36TFProjectName',fld:'vTFPROJECTNAME',pic:''},{av:'AV37TFProjectName_Sel',fld:'vTFPROJECTNAME_SEL',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV47IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A118WorkHourLogId',fld:'WORKHOURLOGID',pic:'ZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV26ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV21ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtWorkHourLogDate_Visible',ctrl:'WORKHOURLOGDATE',prop:'Visible'},{av:'edtWorkHourLogDuration_Visible',ctrl:'WORKHOURLOGDURATION',prop:'Visible'},{av:'edtWorkHourLogDescription_Visible',ctrl:'WORKHOURLOGDESCRIPTION',prop:'Visible'},{av:'edtProjectName_Visible',ctrl:'PROJECTNAME',prop:'Visible'},{av:'AV42GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV43GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV44GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV47IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV24ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'E145P2',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV33TFWorkHourLogDuration_Sel',fld:'vTFWORKHOURLOGDURATION_SEL',pic:''},{av:'AV35TFWorkHourLogDescription_Sel',fld:'vTFWORKHOURLOGDESCRIPTION_SEL',pic:''},{av:'AV37TFProjectName_Sel',fld:'vTFPROJECTNAME_SEL',pic:''},{av:'AV27TFWorkHourLogDate',fld:'vTFWORKHOURLOGDATE',pic:''},{av:'AV32TFWorkHourLogDuration',fld:'vTFWORKHOURLOGDURATION',pic:''},{av:'AV34TFWorkHourLogDescription',fld:'vTFWORKHOURLOGDESCRIPTION',pic:''},{av:'AV36TFProjectName',fld:'vTFPROJECTNAME',pic:''},{av:'AV28TFWorkHourLogDate_To',fld:'vTFWORKHOURLOGDATE_TO',pic:''}]");
         setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",",oparms:[{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV26ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV21ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFWorkHourLogDate',fld:'vTFWORKHOURLOGDATE',pic:''},{av:'AV28TFWorkHourLogDate_To',fld:'vTFWORKHOURLOGDATE_TO',pic:''},{av:'AV32TFWorkHourLogDuration',fld:'vTFWORKHOURLOGDURATION',pic:''},{av:'AV33TFWorkHourLogDuration_Sel',fld:'vTFWORKHOURLOGDURATION_SEL',pic:''},{av:'AV34TFWorkHourLogDescription',fld:'vTFWORKHOURLOGDESCRIPTION',pic:''},{av:'AV35TFWorkHourLogDescription_Sel',fld:'vTFWORKHOURLOGDESCRIPTION_SEL',pic:''},{av:'AV36TFProjectName',fld:'vTFPROJECTNAME',pic:''},{av:'AV37TFProjectName_Sel',fld:'vTFPROJECTNAME_SEL',pic:''},{av:'AV47IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'},{av:'Ddo_grid_Selectedvalue_set',ctrl:'DDO_GRID',prop:'SelectedValue_set'},{av:'Ddo_grid_Filteredtext_set',ctrl:'DDO_GRID',prop:'FilteredText_set'},{av:'Ddo_grid_Filteredtextto_set',ctrl:'DDO_GRID',prop:'FilteredTextTo_set'}]}");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV49Testprojectlogsbyemployeeds_1_filterfulltext = "";
         lV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration = "";
         lV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription = "";
         lV56Testprojectlogsbyemployeeds_8_tfprojectname = "";
         AV49Testprojectlogsbyemployeeds_1_filterfulltext = "";
         AV50Testprojectlogsbyemployeeds_2_tfworkhourlogdate = DateTime.MinValue;
         AV51Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to = DateTime.MinValue;
         AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel = "";
         AV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration = "";
         AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel = "";
         AV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription = "";
         AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel = "";
         AV56Testprojectlogsbyemployeeds_8_tfprojectname = "";
         H005P2_A103ProjectName = new string[] {""} ;
         H005P2_A102ProjectId = new long[1] ;
         H005P2_A107EmployeeFirstName = new string[] {""} ;
         H005P2_A106EmployeeId = new long[1] ;
         H005P2_A123WorkHourLogDescription = new string[] {""} ;
         H005P2_A122WorkHourLogMinute = new short[1] ;
         H005P2_A121WorkHourLogHour = new short[1] ;
         H005P2_A120WorkHourLogDuration = new string[] {""} ;
         H005P2_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         H005P2_A118WorkHourLogId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.testprojectlogsbyemployee__default(),
            new Object[][] {
                new Object[] {
               H005P2_A103ProjectName, H005P2_A102ProjectId, H005P2_A107EmployeeFirstName, H005P2_A106EmployeeId, H005P2_A123WorkHourLogDescription, H005P2_A122WorkHourLogMinute, H005P2_A121WorkHourLogHour, H005P2_A120WorkHourLogDuration, H005P2_A119WorkHourLogDate, H005P2_A118WorkHourLogId
               }
               , new Object[] {
      ...
      private string lV56Testprojectlogsbyemployeeds_8_tfprojectname ;
      private string AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel ;
      private string AV56Testprojectlogsbyemployeeds_8_tfprojectname ;
      ...
      private DateTime AV50Testprojectlogsbyemployeeds_2_tfworkhourlogdate ;
      private DateTime AV51Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to ;
      ...
      private string lV49Testprojectlogsbyemployeeds_1_filterfulltext ;
      private string lV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration ;
      private string lV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription ;
      private string AV49Testprojectlogsbyemployeeds_1_filterfulltext ;
      private string AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel ;
      private string AV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration ;
      private string AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel ;
      private string AV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription ;
      ...
      private string[] H005P2_A103ProjectName ;
      private long[] H005P2_A102ProjectId ;
      private string[] H005P2_A107EmployeeFirstName ;
      private long[] H005P2_A106EmployeeId ;
      private string[] H005P2_A123WorkHourLogDescription ;
      private short[] H005P2_A122WorkHourLogMinute ;
      private short[] H005P2_A121WorkHourLogHour ;
      private string[] H005P2_A120WorkHourLogDuration ;
      private DateTime[] H005P2_A119WorkHourLogDate ;
      private long[] H005P2_A118WorkHourLogId ;
   ...
   public class testprojectlogsbyemployee__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H005P2( IGxContext context ,
                                             string AV49Testprojectlogsbyemployeeds_1_filterfulltext ,
                                             DateTime AV50Testprojectlogsbyemployeeds_2_tfworkhourlogdate ,
                                             DateTime AV51Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to ,
                                             string AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel ,
                                             string AV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration ,
                                             string AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel ,
                                             string AV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription ,
                                             string AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel ,
                                             string AV56Testprojectlogsbyemployeeds_8_tfprojectname ,
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV49Testprojectlogsbyemployeeds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T1.WorkHourLogDuration) like '%' || LOWER(:lV49Testprojectlogsbyemployeeds_1_filterfulltext)) or ( LOWER(T1.WorkHourLogDescription) like '%' || LOWER(:lV49Testprojectlogsbyemployeeds_1_filterfulltext)) or ( LOWER(T2.ProjectName) like '%' || LOWER(:lV49Testprojectlogsbyemployeeds_1_filterfulltext)))");
         }
         else
         {
            GXv_int7[0] = 1;
         ...
         if ( ! (DateTime.MinValue==AV50Testprojectlogsbyemployeeds_2_tfworkhourlogdate) )
         {
            AddWhere(sWhereString, "(T1.WorkHourLogDate >= :AV50Testprojectlogsbyemployeeds_2_tfworkhourlogdate)");
         }
         else
         {
            GXv_int7[3] = 1;
         }
         if ( ! (DateTime.MinValue==AV51Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to) )
         {
            AddWhere(sWhereString, "(T1.WorkHourLogDate <= :AV51Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to)");
         }
         else
         {
            GXv_int7[4] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration)) ) )
         {
            AddWhere(sWhereString, "(LOWER(T1.WorkHourLogDuration) like LOWER(:lV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration))");
         }
         else
         {
            GXv_int7[5] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel)) && ! ( StringUtil.StrCmp(AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.WorkHourLogDuration = ( :AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel))");
         }
         else
         {
            GXv_int7[6] = 1;
         }
         if ( StringUtil.StrCmp(AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.WorkHourLogDuration))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription)) ) )
         {
            AddWhere(sWhereString, "(LOWER(T1.WorkHourLogDescription) like LOWER(:lV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription))");
         }
         else
         {
            GXv_int7[7] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel)) && ! ( StringUtil.StrCmp(AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.WorkHourLogDescription = ( :AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel))");
         }
         else
         {
            GXv_int7[8] = 1;
         }
         if ( StringUtil.StrCmp(AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.WorkHourLogDescription))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Testprojectlogsbyemployeeds_8_tfprojectname)) ) )
         {
            AddWhere(sWhereString, "(LOWER(T2.ProjectName) like LOWER(:lV56Testprojectlogsbyemployeeds_8_tfprojectname))");
         }
         else
         {
            GXv_int7[9] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel)) && ! ( StringUtil.StrCmp(AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.ProjectName = ( :AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel))");
         }
         else
         {
            GXv_int7[10] = 1;
         }
         if ( StringUtil.StrCmp(AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel, "<#Empty#>") == 0 )
         {
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV49Testprojectlogsbyemployeeds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T1.WorkHourLogDuration) like '%' || LOWER(:lV49Testprojectlogsbyemployeeds_1_filterfulltext)) or ( LOWER(T1.WorkHourLogDescription) like '%' || LOWER(:lV49Testprojectlogsbyemployeeds_1_filterfulltext)) or ( LOWER(T3.ProjectName) like '%' || LOWER(:lV49Testprojectlogsbyemployeeds_1_filterfulltext)))");
         }
         else
         {
            GXv_int9[0] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Testprojectlogsbyemployeeds_8_tfprojectname)) ) )
         {
            AddWhere(sWhereString, "(LOWER(T3.ProjectName) like LOWER(:lV56Testprojectlogsbyemployeeds_8_tfprojectname))");
         }
         else
         {
            GXv_int9[9] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel)) && ! ( StringUtil.StrCmp(AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T3.ProjectName = ( :AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel))");
         }
         else
         {
            GXv_int9[10] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005P2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (DateTime)dynConstraints[12] , (short)dynConstraints[13] , (bool)dynConstraints[14] );
               case 1 :
                     return conditional_H005P3(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (DateTime)dynConstraints[12] , (short)dynConstraints[13] , (bool)dynConstraints[14] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV49Testprojectlogsbyemployeeds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV49Testprojectlogsbyemployeeds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV49Testprojectlogsbyemployeeds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("AV50Testprojectlogsbyemployeeds_2_tfworkhourlogdate",GXType.Date,8,0) ,
          new ParDef("AV51Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to",GXType.Date,8,0) ,
          new ParDef("lV52Testprojectlogsbyemployeeds_4_tfworkhourlogduration",GXType.VarChar,40,3) ,
          new ParDef("AV53Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel",GXType.VarChar,40,3) ,
          new ParDef("lV54Testprojectlogsbyemployeeds_6_tfworkhourlogdescription",GXType.VarChar,200,0) ,
          new ParDef("AV55Testprojectlogsbyemployeeds_7_tfworkhourlogdescription_sel",GXType.VarChar,200,0) ,
          new ParDef("lV56Testprojectlogsbyemployeeds_8_tfprojectname",GXType.Char,100,0) ,
          new ParDef("AV57Testprojectlogsbyemployeeds_9_tfprojectname_sel",GXType.Char,100,0) ,
