...
namespace GeneXus.Programs {
   public class dpleaveevent : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A112EmployeeIsActive = P001S2_A112EmployeeIsActive[0];
      ...
      public override void initialize( )
      {
         ...
         P001S2_A112EmployeeIsActive = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.dpleaveevent__default(),
            new Object[][] {
                new Object[] {
               P001S2_A124LeaveTypeId, P001S2_A100CompanyId, P001S2_A112EmployeeIsActive, P001S2_A106EmployeeId, P001S2_A157CompanyLocationId, P001S2_A132LeaveRequestStatus, P001S2_A127LeaveRequestId, P001S2_A129LeaveRequestStartDate, P001S2_A130LeaveRequestEndDate, P001S2_A175LeaveTypeColorApproved,
      ...
      private bool[] P001S2_A112EmployeeIsActive ;
   ...
   public class dpleaveevent__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P001S2(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (int)dynConstraints[2] , (string)dynConstraints[3] , (long)dynConstraints[4] , (long)dynConstraints[5] , (bool)dynConstraints[6] );
         }
