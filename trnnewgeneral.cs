   ...
   public class trnnewgeneral : GXWebComponent
   {
      ...
      protected void WB5V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e115v1_client"+"'", TempTags, "", 2, "HLP_TrnNewGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e125v1_client"+"'", TempTags, "", 2, "HLP_TrnNewGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF5V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40000TrnNewImage_GXI = H005V2_A40000TrnNewImage_GXI[0];
      ...
      protected void E145V2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trnnew_Update", out  GXt_boolean1) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trnnew_Delete", out  GXt_boolean1) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512202194", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trnnewgeneral.js", "?2024102512202194", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","""{"handler":"E115V1","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A180TrnNewId","fld":"TRNNEWID","pic":"ZZZZZZZZZ9"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E125V1","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A180TrnNewId","fld":"TRNNEWID","pic":"ZZZZZZZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H005V2_A180TrnNewId = new long[1] ;
         H005V2_A40000TrnNewImage_GXI = new string[] {""} ;
         H005V2_A182TrnNewDate = new DateTime[] {DateTime.MinValue} ;
         H005V2_A181TrnNewName = new string[] {""} ;
         H005V2_A183TrnNewImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trnnewgeneral__default(),
            new Object[][] {
                new Object[] {
               H005V2_A180TrnNewId, H005V2_A40000TrnNewImage_GXI, H005V2_A182TrnNewDate, H005V2_A181TrnNewName, H005V2_A183TrnNewImage
               }
            }
         );
         AV14Pgmname = "TrnNewGeneral";
      ...
      private long[] H005V2_A180TrnNewId ;
      private string[] H005V2_A40000TrnNewImage_GXI ;
      private DateTime[] H005V2_A182TrnNewDate ;
      private string[] H005V2_A181TrnNewName ;
      private string[] H005V2_A183TrnNewImage ;
   ...
   public class trnnewgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005V2", "SELECT TrnNewId, TrnNewImage_GXI, TrnNewDate, TrnNewName, TrnNewImage FROM TrnNew WHERE TrnNewId = :TrnNewId ORDER BY TrnNewId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005V2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
