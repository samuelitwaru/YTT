...
namespace GeneXus.Programs {
   public class reportdetails2 : GXWebComponent
   {
      ...
      protected void RF4W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A119WorkHourLogDate = H004W2_A119WorkHourLogDate[0];
               A102ProjectId = H004W2_A102ProjectId[0];
               A157CompanyLocationId = H004W2_A157CompanyLocationId[0];
               A148EmployeeName = H004W2_A148EmployeeName[0];
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtEmployeeId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmployeeId_Enabled), 5, 0), !bGXsfl_6_Refreshing);
         edtEmployeeName_Enabled = 0;
         AssignProp(sPrefix, false, edtEmployeeName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmployeeName_Enabled), 5, 0), !bGXsfl_6_Refreshing);
         edtCompanyLocationId_Enabled = 0;
         AssignProp(sPrefix, false, edtCompanyLocationId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCompanyLocationId_Enabled), 5, 0), !bGXsfl_6_Refreshing);
         edtProjectId_Enabled = 0;
         AssignProp(sPrefix, false, edtProjectId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtProjectId_Enabled), 5, 0), !bGXsfl_6_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202452012155359", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("reportdetails2.js", "?202452012155359", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID1.LOAD","{handler:'E124W2',iparms:[]");
         ...
         setEventMetadata("GLOBALEVENTS.REPORTSFILTERCHANAGED","{handler:'E114W2',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'sPrefix'},{av:'AV9ToDate',fld:'vTODATE',pic:''},{av:'AV8FromDate',fld:'vFROMDATE',pic:''},{av:'AV7ProjectId',fld:'vPROJECTID',pic:''},{av:'AV5EmployeeId',fld:'vEMPLOYEEID',pic:''},{av:'AV6CompanyLocationId',fld:'vCOMPANYLOCATIONID',pic:''}]");
         setEventMetadata("GLOBALEVENTS.REPORTSFILTERCHANAGED",",oparms:[{av:'AV6CompanyLocationId',fld:'vCOMPANYLOCATIONID',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         H004W2_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         H004W2_A102ProjectId = new long[1] ;
         H004W2_A157CompanyLocationId = new long[1] ;
         H004W2_A148EmployeeName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportdetails2__default(),
            new Object[][] {
                new Object[] {
               H004W2_A100CompanyId, H004W2_A119WorkHourLogDate, H004W2_A102ProjectId, H004W2_A157CompanyLocationId, H004W2_A148EmployeeName, H004W2_A106EmployeeId
               }
            }
         );
      ...
      private DateTime[] H004W2_A119WorkHourLogDate ;
      private long[] H004W2_A102ProjectId ;
      private long[] H004W2_A157CompanyLocationId ;
      private string[] H004W2_A148EmployeeName ;
   ...
   public class reportdetails2__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004W2(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (long)dynConstraints[2] , (GxSimpleCollection<long>)dynConstraints[3] , (long)dynConstraints[4] , (GxSimpleCollection<long>)dynConstraints[5] , (int)dynConstraints[6] , (int)dynConstraints[7] , (DateTime)dynConstraints[8] , (DateTime)dynConstraints[9] , (DateTime)dynConstraints[10] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004W2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004W2,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
