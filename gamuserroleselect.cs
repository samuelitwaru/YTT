   ...
   public class gamuserroleselect : GXDataArea
   {
      ...
      protected void WB1O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_1O2( true) ;
         }
         else
         {
            wb_table1_14_1O2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_1O2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void wb_table1_14_1O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_19_1O2( true) ;
         }
         else
         {
            wb_table2_19_1O2( false) ;
         }
         return  ;
      }

      protected void wb_table2_19_1O2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_14_1O2e( true) ;
         }
         else
         {
            wb_table1_14_1O2e( false) ;
         }
      }

      protected void wb_table2_19_1O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_19_1O2e( true) ;
         }
         else
         {
            wb_table2_19_1O2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202443019171134", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamuserroleselect.js", "?202443019171140", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E171O2',iparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV22UserId',fld:'vUSERID',pic:'',hsh:true},{av:'AV12FilName',fld:'vFILNAME',pic:''},{av:'AV11FilExternalId',fld:'vFILEXTERNALID',pic:'',hsh:true}]");
         ...
         setEventMetadata("'DOADDSELECTED'","{handler:'E141O2',iparms:[{av:'AV22UserId',fld:'vUSERID',pic:'',hsh:true},{av:'AV21Select',fld:'vSELECT',grid:38,pic:''},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_38',ctrl:'GRID',grid:38,prop:'GridRC',grid:38},{av:'AV16Id',fld:'vID',grid:38,pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV17isOK',fld:'vISOK',pic:''}]");
