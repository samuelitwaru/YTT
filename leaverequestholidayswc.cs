...
namespace GeneXus.Programs {
   public class leaverequestholidayswc : GXWebComponent
   {
      public leaverequestholidayswc( )
      {
      ...
      public leaverequestholidayswc( IGxContext context )
      {
      ...
      {
         chkIsApplicable = new GXCheckbox();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8LeaveRequestId = (long)(Math.Round(NumberUtil.Val( GetPar( "LeaveRequestId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8LeaveRequestId", StringUtil.LTrimStr( (decimal)(AV8LeaveRequestId), 10, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV8LeaveRequestId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV8LeaveRequestId, AV23Pgmname, AV14OrderedBy, AV15OrderedDsc, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV23Pgmname = "LeaveRequestHolidaysWC";
               WS5F2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Leave Request Holidays WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("leaverequestholidayswc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8LeaveRequestId,10,0))}, new string[] {"LeaveRequestId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8LeaveRequestId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8LeaveRequestId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV23Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV23Pgmname, "")), context));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vLEAVEREQUESTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8LeaveRequestId), 10, 0, ".", "")));
      ...
      {
         return "LeaveRequestHolidaysWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Leave Request Holidays WC" ;
      }
      ...
      protected void WB5F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "leaverequestholidayswc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void START5F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Leave Request Holidays WC", 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A179IsApplicable = StringUtil.StrToBool( cgiGet( chkIsApplicable_Internalname));
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      protected void RF5F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H005F2 */
            pr_default.execute(0, new Object[] {AV8LeaveRequestId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_15_idx = 1;
            sGXsfl_15_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_15_idx), 4, 0), 4, "0");
            SubsflControlProps_152( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A179IsApplicable = H005F2_A179IsApplicable[0];
               A115HolidayStartDate = H005F2_A115HolidayStartDate[0];
               A114HolidayName = H005F2_A114HolidayName[0];
               A113HolidayId = H005F2_A113HolidayId[0];
               A115HolidayStartDate = H005F2_A115HolidayStartDate[0];
               A114HolidayName = H005F2_A114HolidayName[0];
               E165F2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H005F3 */
         pr_default.execute(1, new Object[] {AV8LeaveRequestId});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtHolidayId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtHolidayId_Enabled), 5, 0), !bGXsfl_15_Refreshing);
         edtHolidayName_Enabled = 0;
         AssignProp(sPrefix, false, edtHolidayName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtHolidayName_Enabled), 5, 0), !bGXsfl_15_Refreshing);
         edtHolidayStartDate_Enabled = 0;
         AssignProp(sPrefix, false, edtHolidayStartDate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtHolidayStartDate_Enabled), 5, 0), !bGXsfl_15_Refreshing);
         chkIsApplicable.Enabled = 0;
         AssignProp(sPrefix, false, chkIsApplicable_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(chkIsApplicable.Enabled), 5, 0), !bGXsfl_15_Refreshing);
      ...
      protected void STRUP5F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8LeaveRequestId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8LeaveRequestId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "LeaveRequestId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8LeaveRequestId), 10, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8LeaveRequestId = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8LeaveRequestId", StringUtil.LTrimStr( (decimal)(AV8LeaveRequestId), 10, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8LeaveRequestId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "leaverequestholidayswc", GetJustCreated( ));
         ...
         {
            AV8LeaveRequestId = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8LeaveRequestId", StringUtil.LTrimStr( (decimal)(AV8LeaveRequestId), 10, 0));
         }
         wcpOAV8LeaveRequestId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8LeaveRequestId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8LeaveRequestId != wcpOAV8LeaveRequestId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8LeaveRequestId = AV8LeaveRequestId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8LeaveRequestId = cgiGet( sPrefix+"AV8LeaveRequestId_CTRL");
         if ( StringUtil.Len( sCtrlAV8LeaveRequestId) > 0 )
         {
            AV8LeaveRequestId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8LeaveRequestId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8LeaveRequestId", StringUtil.LTrimStr( (decimal)(AV8LeaveRequestId), 10, 0));
         }
         else
         {
            AV8LeaveRequestId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8LeaveRequestId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8LeaveRequestId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8LeaveRequestId), 10, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8LeaveRequestId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8LeaveRequestId_CTRL", StringUtil.RTrim( sCtrlAV8LeaveRequestId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202471612482199", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("leaverequestholidayswc.js", "?202471612482199", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtHolidayId_Internalname = sPrefix+"HOLIDAYID_"+sGXsfl_15_idx;
         edtHolidayName_Internalname = sPrefix+"HOLIDAYNAME_"+sGXsfl_15_idx;
         edtHolidayStartDate_Internalname = sPrefix+"HOLIDAYSTARTDATE_"+sGXsfl_15_idx;
         chkIsApplicable_Internalname = sPrefix+"ISAPPLICABLE_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtHolidayId_Internalname = sPrefix+"HOLIDAYID_"+sGXsfl_15_fel_idx;
         edtHolidayName_Internalname = sPrefix+"HOLIDAYNAME_"+sGXsfl_15_fel_idx;
         edtHolidayStartDate_Internalname = sPrefix+"HOLIDAYSTARTDATE_"+sGXsfl_15_fel_idx;
         chkIsApplicable_Internalname = sPrefix+"ISAPPLICABLE_"+sGXsfl_15_fel_idx;
      }
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            GXCCtl = "ISAPPLICABLE_" + sGXsfl_15_idx;
            chkIsApplicable.Name = GXCCtl;
            chkIsApplicable.WebTags = "";
            chkIsApplicable.Caption = "";
            AssignProp(sPrefix, false, chkIsApplicable_Internalname, "TitleCaption", chkIsApplicable.Caption, !bGXsfl_15_Refreshing);
            chkIsApplicable.CheckedValue = "false";
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkIsApplicable_Internalname,StringUtil.BoolToStr( A179IsApplicable),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn",(string)"",(string)""});
      ...
      protected void StartGridControl15( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.BoolToStr( A179IsApplicable)));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void init_default_properties( )
      {
         ...
         chkIsApplicable_Internalname = sPrefix+"ISAPPLICABLE";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:HolidayId|1:HolidayName|2:HolidayStartDate|3:IsApplicable";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8LeaveRequestId',fld:'vLEAVEREQUESTID',pic:'ZZZZZZZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E115F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8LeaveRequestId',fld:'vLEAVEREQUESTID',pic:'ZZZZZZZZZ9'},{av:'AV23Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E165F2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("VALID_HOLIDAYID","{handler:'Valid_Holidayid',iparms:[]");
         setEventMetadata("VALID_HOLIDAYID",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Isapplicable',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         H005F2_A179IsApplicable = new bool[] {false} ;
         H005F2_A115HolidayStartDate = new DateTime[] {DateTime.MinValue} ;
         H005F2_A114HolidayName = new string[] {""} ;
         H005F2_A113HolidayId = new long[1] ;
         ...
         sCtrlAV8LeaveRequestId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GXCCtl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestholidayswc__default(),
            new Object[][] {
                new Object[] {
               H005F2_A127LeaveRequestId, H005F2_A179IsApplicable, H005F2_A115HolidayStartDate, H005F2_A114HolidayName, H005F2_A113HolidayId
               }
               , new Object[] {
      ...
      private long wcpOAV8LeaveRequestId ;
      ...
      private string chkIsApplicable_Internalname ;
      private string scmdbuf ;
      private string GXt_char2 ;
      private string sCtrlAV8LeaveRequestId ;
      ...
      private GXCheckbox chkIsApplicable ;
      private IDataStoreProvider pr_default ;
      private long[] H005F2_A127LeaveRequestId ;
      private bool[] H005F2_A179IsApplicable ;
      private DateTime[] H005F2_A115HolidayStartDate ;
      private string[] H005F2_A114HolidayName ;
      private long[] H005F2_A113HolidayId ;
   ...
   public class leaverequestholidayswc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long A127LeaveRequestId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.LeaveRequestId, T1.IsApplicable, T2.HolidayStartDate, T2.HolidayName, T1.HolidayId";
         sFromString = " FROM (LeaveRequestHolidays T1 INNER JOIN Holiday T2 ON T2.HolidayId = T1.HolidayId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.LeaveRequestId = :AV8LeaveRequestId)");
         if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.LeaveRequestId, T1.HolidayId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.LeaveRequestId DESC, T1.HolidayId DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.LeaveRequestId, T2.HolidayName, T1.HolidayId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.LeaveRequestId DESC, T2.HolidayName DESC, T1.HolidayId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.LeaveRequestId, T2.HolidayStartDate, T1.HolidayId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.LeaveRequestId DESC, T2.HolidayStartDate DESC, T1.HolidayId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.LeaveRequestId, T1.IsApplicable, T1.HolidayId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.LeaveRequestId DESC, T1.IsApplicable DESC, T1.HolidayId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.LeaveRequestId, T1.HolidayId";
                                             ...
                                             long A127LeaveRequestId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (LeaveRequestHolidays T1 INNER JOIN Holiday T2 ON T2.HolidayId = T1.HolidayId)";
         AddWhere(sWhereString, "(T1.LeaveRequestId = :AV8LeaveRequestId)");
