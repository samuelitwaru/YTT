...
namespace GeneXus.Programs {
   public class sdisgamuserblocked : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A109EmployeeEmail = P00AD2_A109EmployeeEmail[0];
            A112EmployeeIsActive = P00AD2_A112EmployeeIsActive[0];
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sdisgamuserblocked__default(),
            new Object[][] {
                new Object[] {
               P00AD2_A109EmployeeEmail, P00AD2_A112EmployeeIsActive, P00AD2_A106EmployeeId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00AD2_A109EmployeeEmail ;
      private bool[] P00AD2_A112EmployeeIsActive ;
   ...
   public class sdisgamuserblocked__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00AD2", "SELECT EmployeeEmail, EmployeeIsActive, EmployeeId FROM Employee WHERE EmployeeEmail = ( :AV10UserEmail) ORDER BY EmployeeEmail ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AD2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
