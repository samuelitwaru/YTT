...
namespace GeneXus.Programs {
   public class switchtimetracker : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( AV9GXLvl1 == 0 )
         {
            ...
            */
            ...
            A160SiteSettingId = P00934_A160SiteSettingId[0];
            pr_default.close(2);
            pr_default.SmartCacheProvider.SetUpdated("SiteSetting");
      ...
      private long[] P00934_A160SiteSettingId ;
   }
   ...
   public class switchtimetracker__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00932", "UPDATE SiteSetting SET IsLogHourOpen=:IsLogHourOpen  WHERE CompanyId = :AV10Udparg1", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK,prmP00932)
             ,new CursorDef("P00933", "SAVEPOINT gxupdate;INSERT INTO SiteSetting(CompanyId, IsLogHourOpen) VALUES(:CompanyId, :IsLogHourOpen);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_MASKLOOPLOCK,prmP00933)
             ,new CursorDef("P00934", "SELECT currval('SiteSettingId') ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00934,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
