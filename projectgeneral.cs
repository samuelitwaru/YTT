...
namespace GeneXus.Programs {
   public class projectgeneral : GXWebComponent
   {
      ...
      public projectgeneral( IGxContext context )
      {
      ...
      {
         this.A102ProjectId = aP0_ProjectId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)A102ProjectId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Project General") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("projectgeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A102ProjectId,10,0))}, new string[] {"ProjectId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA102ProjectId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA102ProjectId), 10, 0, ".", "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      protected void WB5B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "projectgeneral.aspx");
            }
            ...
            GxWebStd.gx_single_line_edit( context, edtProjectName_Internalname, StringUtil.RTrim( A103ProjectName), StringUtil.RTrim( context.localUtil.Format( A103ProjectName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProjectName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProjectName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_ProjectGeneral.htm");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtProjectDescription_Internalname, A104ProjectDescription, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,18);\"", 0, 1, edtProjectDescription_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "GeneXusUnanimo\\Description", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_ProjectGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbProjectStatus, cmbProjectStatus_Internalname, StringUtil.RTrim( A105ProjectStatus), 1, cmbProjectStatus_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbProjectStatus.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,23);\"", "", true, 0, "HLP_ProjectGeneral.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e115b1_client"+"'", TempTags, "", 2, "HLP_ProjectGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e125b1_client"+"'", TempTags, "", 2, "HLP_ProjectGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START5B2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Project General", 0) ;
            context.wjLoc = "";
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "LSCR") == 0 )
                           {
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    GX_FocusControl = edtavProjectmanagerid_description_Internalname;
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            cmbProjectStatus.CurrentValue = StringUtil.RTrim( A105ProjectStatus);
            AssignProp(sPrefix, false, cmbProjectStatus_Internalname, "Values", cmbProjectStatus.ToJavascriptSource(), true);
         }
      }
      ...
      protected void RF5B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A105ProjectStatus = H005B2_A105ProjectStatus[0];
               AssignAttri(sPrefix, false, "A105ProjectStatus", A105ProjectStatus);
               A104ProjectDescription = H005B2_A104ProjectDescription[0];
               AssignAttri(sPrefix, false, "A104ProjectDescription", A104ProjectDescription);
               A103ProjectName = H005B2_A103ProjectName[0];
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, cmbProjectStatus_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbProjectStatus.Enabled), 5, 0), true);
      ...
      protected void STRUP5B0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA102ProjectId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA102ProjectId"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            AssignAttri(sPrefix, false, "A105ProjectStatus", A105ProjectStatus);
            AV14ProjectManagerId_Description = cgiGet( edtavProjectmanagerid_description_Internalname);
            AssignAttri(sPrefix, false, "AV14ProjectManagerId_Description", AV14ProjectManagerId_Description);
      ...
      protected void E135B2( )
      {
         ...
         new projectloaddvcombo(context ).execute(  "ProjectManagerId",  "GET_DSC",  A102ProjectId, out  AV17ComboSelectedValue, out  AV14ProjectManagerId_Description, out  GXt_objcol_SdtDVB_SDTComboData_Item1) ;
         AssignAttri(sPrefix, false, "AV14ProjectManagerId_Description", AV14ProjectManagerId_Description);
      ...
      protected void E145B2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "project_Update", out  GXt_boolean2) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "project_Delete", out  GXt_boolean2) ;
      ...
      protected void S112( )
      {
         ...
         AV8TrnContext.gxTpr_Transactionname = "Project";
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A102ProjectId = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "A102ProjectId", StringUtil.LTrimStr( (decimal)(A102ProjectId), 10, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA102ProjectId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "projectgeneral", GetJustCreated( ));
         ...
         {
            A102ProjectId = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "A102ProjectId", StringUtil.LTrimStr( (decimal)(A102ProjectId), 10, 0));
         }
         wcpOA102ProjectId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA102ProjectId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A102ProjectId != wcpOA102ProjectId ) ) )
         {
            setjustcreated();
         }
         wcpOA102ProjectId = A102ProjectId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA102ProjectId = cgiGet( sPrefix+"A102ProjectId_CTRL");
         if ( StringUtil.Len( sCtrlA102ProjectId) > 0 )
         {
            A102ProjectId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA102ProjectId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A102ProjectId", StringUtil.LTrimStr( (decimal)(A102ProjectId), 10, 0));
         }
         else
         {
            A102ProjectId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A102ProjectId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A102ProjectId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A102ProjectId), 10, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA102ProjectId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A102ProjectId_CTRL", StringUtil.RTrim( sCtrlA102ProjectId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512185693", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("projectgeneral.js", "?2024102512185694", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         edtavProjectmanagerid_description_Jsonclick = "";
         edtavProjectmanagerid_description_Enabled = 1;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A102ProjectId","fld":"PROJECTID","pic":"ZZZZZZZZZ9"},{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E115B1","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A102ProjectId","fld":"PROJECTID","pic":"ZZZZZZZZZ9"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E125B1","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A102ProjectId","fld":"PROJECTID","pic":"ZZZZZZZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         A105ProjectStatus = "";
         AV14ProjectManagerId_Description = "";
         ...
         EvtRowId = "";
         sEvtType = "";
         H005B2_A102ProjectId = new long[1] ;
         H005B2_A105ProjectStatus = new string[] {""} ;
         H005B2_A104ProjectDescription = new string[] {""} ;
         H005B2_A103ProjectName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.projectgeneral__default(),
            new Object[][] {
                new Object[] {
               H005B2_A102ProjectId, H005B2_A105ProjectStatus, H005B2_A104ProjectDescription, H005B2_A103ProjectName
               }
            }
         );
         AV18Pgmname = "ProjectGeneral";
      ...
      private long wcpOA102ProjectId ;
      ...
      private string edtavProjectmanagerid_description_Internalname ;
      ...
      private string edtavProjectmanagerid_description_Jsonclick ;
      ...
      private string sCtrlA102ProjectId ;
      ...
      private string AV14ProjectManagerId_Description ;
      ...
      private long[] H005B2_A102ProjectId ;
      private string[] H005B2_A105ProjectStatus ;
      private string[] H005B2_A104ProjectDescription ;
      private string[] H005B2_A103ProjectName ;
   ...
   public class projectgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005B2", "SELECT ProjectId, ProjectStatus, ProjectDescription, ProjectName FROM Project WHERE ProjectId = :ProjectId ORDER BY ProjectId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005B2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
