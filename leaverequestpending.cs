...
namespace GeneXus.Programs {
   public class leaverequestpending : GXWebComponent
   {
      ...
      protected void S192( )
      {
         ...
         Ddo_grid_Filteredtext_set = GXt_char5+"|"+((DateTime.MinValue==AV38TFLeaveRequestStartDate) ? "" : context.localUtil.DToC( AV38TFLeaveRequestStartDate, 1, "/"))+"|"+((DateTime.MinValue==AV43TFLeaveRequestEndDate) ? "" : context.localUtil.DToC( AV43TFLeaveRequestEndDate, 1, "/"))+"|"+((0==AV48TFLeaveRequestDuration) ? "" : StringUtil.Str( (decimal)(AV48TFLeaveRequestDuration), 4, 0))+"|"+GXt_char4+"|"+GXt_char2;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "FilteredText_set", Ddo_grid_Filteredtext_set);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202451922525354", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("leaverequestpending.js", "?202451922525355", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H00392_A131LeaveRequestDuration = new short[1] ;
      ...
      private short AV91Leaverequestpendingds_10_tfleaverequestduration ;
      private short AV92Leaverequestpendingds_11_tfleaverequestduration_to ;
      ...
      private short[] H00392_A131LeaveRequestDuration ;
 ...
 public class leaverequestpending__default : DataStoreHelperBase, IDataStoreHelper
 {
    protected Object[] conditional_H00392( IGxContext context ,
                                           ...
                                           short AV91Leaverequestpendingds_10_tfleaverequestduration ,
                                           short AV92Leaverequestpendingds_11_tfleaverequestduration_to ,
                                           ...
                                           long AV82Udparg2 )
    {
       ...
       if ( ! (0==AV91Leaverequestpendingds_10_tfleaverequestduration) )
       {
       ...
       if ( ! (0==AV92Leaverequestpendingds_11_tfleaverequestduration_to) )
       {
                                           ...
                                           long AV82Udparg2 )
    {
       ...
       if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV84Leaverequestpendingds_3_filterfulltext)) )
       {
          AddWhere(sWhereString, "(( LOWER(T2.LeaveTypeName) like '%' || LOWER(:lV84Leaverequestpendingds_3_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'9999'), 2) like '%' || :lV84Leaverequestpendingds_3_filterfulltext) or ( LOWER(T1.LeaveRequestDescription) like '%' || LOWER(:lV84Leaverequestpendingds_3_filterfulltext)) or ( LOWER(T3.EmployeeName) like '%' || LOWER(:lV84Leaverequestpendingds_3_filterfulltext)))");
       }
       else
       {
          GXv_int9[2] = 1;
                                                   ...
                                                   Object [] dynConstraints )
    {
       ...
       {
             case 0 :
                   return conditional_H00392(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (DateTime)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (short)dynConstraints[16] , (string)dynConstraints[17] , (string)dynConstraints[18] , (DateTime)dynConstraints[19] , (DateTime)dynConstraints[20] , (short)dynConstraints[21] , (bool)dynConstraints[22] , (string)dynConstraints[23] , (bool)dynConstraints[24] , (long)dynConstraints[25] , (long)dynConstraints[26] );
             case 1 :
                   return conditional_H00393(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (DateTime)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (short)dynConstraints[16] , (string)dynConstraints[17] , (string)dynConstraints[18] , (DateTime)dynConstraints[19] , (DateTime)dynConstraints[20] , (short)dynConstraints[21] , (bool)dynConstraints[22] , (string)dynConstraints[23] , (bool)dynConstraints[24] , (long)dynConstraints[25] , (long)dynConstraints[26] );
       }
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        new ParDef("AV91Leaverequestpendingds_10_tfleaverequestduration",GXType.Int16,4,0) ,
        new ParDef("AV92Leaverequestpendingds_11_tfleaverequestduration_to",GXType.Int16,4,0) ,
