...
namespace GeneXus.Programs {
   public class leaverequestpending : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV99Udparg16 = (long)(Math.Round(NumberUtil.Val( GetPar( "Udparg16"), "."), 18, MidpointRounding.ToEven));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV18FilterFullText, AV28ManageFiltersExecutionStep, AV23ColumnsSelector, AV83Pgmname, AV31TFLeaveTypeName, AV32TFLeaveTypeName_Sel, AV38TFLeaveRequestStartDate, AV39TFLeaveRequestStartDate_To, AV43TFLeaveRequestEndDate, AV44TFLeaveRequestEndDate_To, AV48TFLeaveRequestDuration, AV49TFLeaveRequestDuration_To, AV50TFLeaveRequestDescription, AV51TFLeaveRequestDescription_Sel, AV29TFEmployeeName, AV30TFEmployeeName_Sel, A166ProjectManagerId, AV99Udparg16, A102ProjectId, AV78ProjectIds, AV15OrderedBy, AV16OrderedDsc, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV83Pgmname = "LeaveRequestPending";
               edtavApprove_Enabled = 0;
               AssignProp(sPrefix, false, edtavApprove_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavApprove_Enabled), 5, 0), !bGXsfl_39_Refreshing);
               edtavReject_Enabled = 0;
               AssignProp(sPrefix, false, edtavReject_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavReject_Enabled), 5, 0), !bGXsfl_39_Refreshing);
               WS392( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vUDPARG16", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV99Udparg16), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vUDPARG16", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV99Udparg16), "9999999999"), context));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Title", StringUtil.RTrim( Dvelop_confirmpanel_approve_Title));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Confirmationtext", StringUtil.RTrim( Dvelop_confirmpanel_approve_Confirmationtext));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Yesbuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_approve_Yesbuttoncaption));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Nobuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_approve_Nobuttoncaption));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Cancelbuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_approve_Cancelbuttoncaption));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Yesbuttonposition", StringUtil.RTrim( Dvelop_confirmpanel_approve_Yesbuttonposition));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Confirmtype", StringUtil.RTrim( Dvelop_confirmpanel_approve_Confirmtype));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Title", StringUtil.RTrim( Dvelop_confirmpanel_reject_Title));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Confirmationtext", StringUtil.RTrim( Dvelop_confirmpanel_reject_Confirmationtext));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Yesbuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_reject_Yesbuttoncaption));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Nobuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_reject_Nobuttoncaption));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Cancelbuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_reject_Cancelbuttoncaption));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Yesbuttonposition", StringUtil.RTrim( Dvelop_confirmpanel_reject_Yesbuttonposition));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Confirmtype", StringUtil.RTrim( Dvelop_confirmpanel_reject_Confirmtype));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Comment", StringUtil.RTrim( Dvelop_confirmpanel_reject_Comment));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Bodycontentinternalname", StringUtil.RTrim( Dvelop_confirmpanel_reject_Bodycontentinternalname));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Result", StringUtil.RTrim( Dvelop_confirmpanel_approve_Result));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Result", StringUtil.RTrim( Dvelop_confirmpanel_reject_Result));
      ...
      protected void WB390( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnagexport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Export", bttBtnagexport_Jsonclick, 0, "Export", "", StyleString, ClassString, 1, 0, "standard", "'"+sPrefix+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_LeaveRequestPending.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+sPrefix+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_LeaveRequestPending.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            wb_table1_21_392( true) ;
         }
         else
         {
            wb_table1_21_392( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_392e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 39 )
         {
            ...
            wb_table2_63_392( true) ;
         }
         else
         {
            wb_table2_63_392( false) ;
         }
         return  ;
      }

      protected void wb_table2_63_392e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_68_392( true) ;
         }
         else
         {
            wb_table3_68_392( false) ;
         }
         return  ;
      }

      protected void wb_table3_68_392e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
            GxWebStd.gx_div_start( context, divDiv_dvelop_confirmpanel_reject_body_Internalname, 1, 0, "px", 0, "px", "Invisible", "start", "top", "", "", "div");
            /* Multiple line edit */
            ...
            ClassString = "ConfirmComment";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDvelop_confirmpanel_reject_comment_Internalname, AV66DVelop_ConfirmPanel_reject_Comment, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,74);\"", 0, 1, 1, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "Type reason for rejection", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_LeaveRequestPending.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* User Defined Control */
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 77,'" + sPrefix + "',false,'" + sGXsfl_39_idx + "',0)\"";
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "DVELOP_CONFIRMPANEL_APPROVE.CLOSE") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP390( ) ;
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "DVELOP_CONFIRMPANEL_REJECT.CLOSE") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP390( ) ;
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "LSCR") == 0 )
                           {
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    GX_FocusControl = edtavApprove_Internalname;
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV68approve = cgiGet( edtavApprove_Internalname);
                              AssignAttri(sPrefix, false, edtavApprove_Internalname, AV68approve);
                              AV69reject = cgiGet( edtavReject_Internalname);
                              AssignAttri(sPrefix, false, edtavReject_Internalname, AV69reject);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      protected void RF392( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 A106EmployeeId ,
                                                 AV79EmployeeIds ,
                                                 AV84Leaverequestpendingds_3_filterfulltext ,
                                                 AV86Leaverequestpendingds_5_tfleavetypename_sel ,
                                                 AV85Leaverequestpendingds_4_tfleavetypename ,
                                                 AV87Leaverequestpendingds_6_tfleaverequeststartdate ,
                                                 AV88Leaverequestpendingds_7_tfleaverequeststartdate_to ,
                                                 AV89Leaverequestpendingds_8_tfleaverequestenddate ,
                                                 AV90Leaverequestpendingds_9_tfleaverequestenddate_to ,
                                                 AV91Leaverequestpendingds_10_tfleaverequestduration ,
                                                 AV92Leaverequestpendingds_11_tfleaverequestduration_to ,
                                                 AV94Leaverequestpendingds_13_tfleaverequestdescription_sel ,
                                                 AV93Leaverequestpendingds_12_tfleaverequestdescription ,
                                                 AV96Leaverequestpendingds_15_tfemployeename_sel ,
                                                 AV95Leaverequestpendingds_14_tfemployeename ,
                                                 A125LeaveTypeName ,
            ...
            lV84Leaverequestpendingds_3_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV84Leaverequestpendingds_3_filterfulltext), "%", "");
            lV84Leaverequestpendingds_3_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV84Leaverequestpendingds_3_filterfulltext), "%", "");
            lV84Leaverequestpendingds_3_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV84Leaverequestpendingds_3_filterfulltext), "%", "");
            lV84Leaverequestpendingds_3_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV84Leaverequestpendingds_3_filterfulltext), "%", "");
            lV85Leaverequestpendingds_4_tfleavetypename = StringUtil.PadR( StringUtil.RTrim( AV85Leaverequestpendingds_4_tfleavetypename), 100, "%");
            lV93Leaverequestpendingds_12_tfleaverequestdescription = StringUtil.Concat( StringUtil.RTrim( AV93Leaverequestpendingds_12_tfleaverequestdescription), "%", "");
            lV95Leaverequestpendingds_14_tfemployeename = StringUtil.PadR( StringUtil.RTrim( AV95Leaverequestpendingds_14_tfemployeename), 128, "%");
            /* Using cursor H00392 */
            pr_default.execute(0, new Object[] {AV81Udparg1, AV82Udparg2, lV84Leaverequestpendingds_3_filterfulltext, lV84Leaverequestpendingds_3_filterfulltext, lV84Leaverequestpendingds_3_filterfulltext, lV84Leaverequestpendingds_3_filterfulltext, lV85Leaverequestpendingds_4_tfleavetypename, AV86Leaverequestpendingds_5_tfleavetypename_sel, AV87Leaverequestpendingds_6_tfleaverequeststartdate, AV88Leaverequestpendingds_7_tfleaverequeststartdate_to, AV89Leaverequestpendingds_8_tfleaverequestenddate, AV90Leaverequestpendingds_9_tfleaverequestenddate_to, AV91Leaverequestpendingds_10_tfleaverequestduration, AV92Leaverequestpendingds_11_tfleaverequestduration_to, lV93Leaverequestpendingds_12_tfleaverequestdescription, AV94Leaverequestpendingds_13_tfleaverequestdescription_sel, lV95Leaverequestpendingds_14_tfemployeename, AV96Leaverequestpendingds_15_tfemployeename_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
      ...
      protected void send_integrity_lvl_hashes392( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPROJECTIDS", GetSecureSignedToken( sPrefix, AV78ProjectIds, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_LEAVEREQUESTID"+"_"+sGXsfl_39_idx, GetSecureSignedToken( sPrefix+sGXsfl_39_idx, context.localUtil.Format( (decimal)(A127LeaveRequestId), "ZZZZZZZZZ9"), context));
      }
      ...
      {
         AV84Leaverequestpendingds_3_filterfulltext = AV18FilterFullText;
         AV85Leaverequestpendingds_4_tfleavetypename = AV31TFLeaveTypeName;
         AV86Leaverequestpendingds_5_tfleavetypename_sel = AV32TFLeaveTypeName_Sel;
         AV87Leaverequestpendingds_6_tfleaverequeststartdate = AV38TFLeaveRequestStartDate;
         AV88Leaverequestpendingds_7_tfleaverequeststartdate_to = AV39TFLeaveRequestStartDate_To;
         AV89Leaverequestpendingds_8_tfleaverequestenddate = AV43TFLeaveRequestEndDate;
         AV90Leaverequestpendingds_9_tfleaverequestenddate_to = AV44TFLeaveRequestEndDate_To;
         AV91Leaverequestpendingds_10_tfleaverequestduration = AV48TFLeaveRequestDuration;
         AV92Leaverequestpendingds_11_tfleaverequestduration_to = AV49TFLeaveRequestDuration_To;
         AV93Leaverequestpendingds_12_tfleaverequestdescription = AV50TFLeaveRequestDescription;
         AV94Leaverequestpendingds_13_tfleaverequestdescription_sel = AV51TFLeaveRequestDescription_Sel;
         AV95Leaverequestpendingds_14_tfemployeename = AV29TFEmployeeName;
         AV96Leaverequestpendingds_15_tfemployeename_sel = AV30TFEmployeeName_Sel;
         AV81Udparg1 = new userhasrole(context).executeUdp(  "Manager");
         AV82Udparg2 = new getloggedinusercompanyid(context).executeUdp( );
         AV99Udparg16 = new getloggedinemployeeid(context).executeUdp( );
         ...
         lV95Leaverequestpendingds_14_tfemployeename = StringUtil.PadR( StringUtil.RTrim( AV95Leaverequestpendingds_14_tfemployeename), 128, "%");
         /* Using cursor H00393 */
         pr_default.execute(1, new Object[] {AV81Udparg1, AV82Udparg2, lV84Leaverequestpendingds_3_filterfulltext, lV84Leaverequestpendingds_3_filterfulltext, lV84Leaverequestpendingds_3_filterfulltext, lV84Leaverequestpendingds_3_filterfulltext, lV85Leaverequestpendingds_4_tfleavetypename, AV86Leaverequestpendingds_5_tfleavetypename_sel, AV87Leaverequestpendingds_6_tfleaverequeststartdate, AV88Leaverequestpendingds_7_tfleaverequeststartdate_to, AV89Leaverequestpendingds_8_tfleaverequestenddate, AV90Leaverequestpendingds_9_tfleaverequestenddate_to, AV91Leaverequestpendingds_10_tfleaverequestduration, AV92Leaverequestpendingds_11_tfleaverequestduration_to, lV93Leaverequestpendingds_12_tfleaverequestdescription, AV94Leaverequestpendingds_13_tfleaverequestdescription_sel, lV95Leaverequestpendingds_14_tfemployeename, AV96Leaverequestpendingds_15_tfemployeename_sel});
      ...
      protected void STRUP390( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            Dvelop_confirmpanel_approve_Title = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Title");
            Dvelop_confirmpanel_approve_Confirmationtext = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Confirmationtext");
            Dvelop_confirmpanel_approve_Yesbuttoncaption = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Yesbuttoncaption");
            Dvelop_confirmpanel_approve_Nobuttoncaption = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Nobuttoncaption");
            Dvelop_confirmpanel_approve_Cancelbuttoncaption = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Cancelbuttoncaption");
            Dvelop_confirmpanel_approve_Yesbuttonposition = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Yesbuttonposition");
            Dvelop_confirmpanel_approve_Confirmtype = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Confirmtype");
            Dvelop_confirmpanel_reject_Title = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Title");
            Dvelop_confirmpanel_reject_Confirmationtext = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Confirmationtext");
            Dvelop_confirmpanel_reject_Yesbuttoncaption = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Yesbuttoncaption");
            Dvelop_confirmpanel_reject_Nobuttoncaption = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Nobuttoncaption");
            Dvelop_confirmpanel_reject_Cancelbuttoncaption = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Cancelbuttoncaption");
            Dvelop_confirmpanel_reject_Yesbuttonposition = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Yesbuttonposition");
            Dvelop_confirmpanel_reject_Confirmtype = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Confirmtype");
            Dvelop_confirmpanel_reject_Comment = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Comment");
            Dvelop_confirmpanel_reject_Bodycontentinternalname = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Bodycontentinternalname");
            ...
            subGrid_Rows = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"GRID_Rows"), ".", ","), 18, MidpointRounding.ToEven));
            GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            Dvelop_confirmpanel_approve_Result = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_APPROVE_Result");
            Dvelop_confirmpanel_reject_Result = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_REJECT_Result");
            ...
            AV66DVelop_ConfirmPanel_reject_Comment = cgiGet( edtavDvelop_confirmpanel_reject_comment_Internalname);
            AssignAttri(sPrefix, false, "AV66DVelop_ConfirmPanel_reject_Comment", AV66DVelop_ConfirmPanel_reject_Comment);
      ...
      protected void E19392( )
      {
         ...
         Dvelop_confirmpanel_reject_Bodycontentinternalname = edtavDvelop_confirmpanel_reject_comment_Internalname;
         ucDvelop_confirmpanel_reject.SendProperty(context, sPrefix, false, Dvelop_confirmpanel_reject_Internalname, "BodyContentInternalName", Dvelop_confirmpanel_reject_Bodycontentinternalname);
      ...
      protected void E20392( )
      {
         ...
         edtEmployeeName_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV23ColumnsSelector.gxTpr_Columns.Item(6)).gxTpr_Isvisible ? 1 : 0);
      ...
      protected void E16392( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "LeaveRequestPendingColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV21ColumnsSelectorXML)) ? "" : AV23ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E11392( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("LeaveRequestPendingFilters")),UrlEncode(StringUtil.RTrim(AV83Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV28ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV28ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV28ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         ...
         else
         {
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV83Pgmname+"GridState",  AV27ManageFiltersXml) ;
      ...
      {
         /* Dvelop_confirmpanel_approve_Close Routine */
         returnInSub = false;
         if ( StringUtil.StrCmp(Dvelop_confirmpanel_approve_Result, "Yes") == 0 )
         {
            /* Execute user subroutine: 'DO APPROVE' */
            S202 ();
            if ( returnInSub )
            {
               returnInSub = true;
      ...
      {
         /* Dvelop_confirmpanel_reject_Close Routine */
         returnInSub = false;
         if ( ( StringUtil.StrCmp(Dvelop_confirmpanel_reject_Result, "Yes") == 0 ) && ! String.IsNullOrEmpty(StringUtil.RTrim( AV66DVelop_ConfirmPanel_reject_Comment)) )
         {
            /* Execute user subroutine: 'DO REJECT' */
            S212 ();
            if ( returnInSub )
            {
               returnInSub = true;
      ...
      protected void S122( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "LeaveRequestPendingFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void S202( )
      {
         ...
         if ( AV65LeaveRequest.Update() )
         {
            ...
            if ( AV75Employee.Update() )
            {
               ...
               new sdsendpushnotifications(context ).execute(  "Leave Request Approved",  "Your leave request made on "+context.localUtil.DToC( AV65LeaveRequest.gxTpr_Leaverequestdate, 1, "/")+" has been approved",  AV65LeaveRequest.gxTpr_Employeeid) ;
            }
            else
            {
         ...
         {
            context.RollbackDataStores("leaverequestpending",pr_default);
            GX_msglist.addItem(AV65LeaveRequest.GetMessages().ToJSonString(false));
         }
      }
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV25Session.Get(AV83Pgmname+"GridState"), "") == 0 )
         {
            AV13GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV83Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV13GridState.FromXml(AV25Session.Get(AV83Pgmname+"GridState"), null, "", "");
         }
         AV15OrderedBy = AV13GridState.gxTpr_Orderedby;
         AssignAttri(sPrefix, false, "AV15OrderedBy", StringUtil.LTrimStr( (decimal)(AV15OrderedBy), 4, 0));
         AV16OrderedDsc = AV13GridState.gxTpr_Ordereddsc;
      ...
      protected void S192( )
      {
         ...
         returnInSub = false;
         AV97GXV1 = 1;
         while ( AV97GXV1 <= AV13GridState.gxTpr_Filtervalues.Count )
         {
            AV14GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV13GridState.gxTpr_Filtervalues.Item(AV97GXV1));
         ...
         GXt_char4 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV32TFLeaveTypeName_Sel)),  AV32TFLeaveTypeName_Sel, out  GXt_char4) ;
         GXt_char2 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV51TFLeaveRequestDescription_Sel)),  AV51TFLeaveRequestDescription_Sel, out  GXt_char2) ;
         GXt_char5 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV30TFEmployeeName_Sel)),  AV30TFEmployeeName_Sel, out  GXt_char5) ;
         Ddo_grid_Selectedvalue_set = GXt_char4+"||||"+GXt_char2+"|"+GXt_char5;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char5 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV31TFLeaveTypeName)),  AV31TFLeaveTypeName, out  GXt_char5) ;
         GXt_char4 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV50TFLeaveRequestDescription)),  AV50TFLeaveRequestDescription, out  GXt_char4) ;
         GXt_char2 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV29TFEmployeeName)),  AV29TFEmployeeName, out  GXt_char2) ;
         Ddo_grid_Filteredtext_set = GXt_char5+"|"+((DateTime.MinValue==AV38TFLeaveRequestStartDate) ? "" : context.localUtil.DToC( AV38TFLeaveRequestStartDate, 1, "/"))+"|"+((DateTime.MinValue==AV43TFLeaveRequestEndDate) ? "" : context.localUtil.DToC( AV43TFLeaveRequestEndDate, 1, "/"))+"|"+((Convert.ToDecimal(0)==AV48TFLeaveRequestDuration) ? "" : StringUtil.Str( AV48TFLeaveRequestDuration, 4, 1))+"|"+GXt_char4+"|"+GXt_char2;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "FilteredText_set", Ddo_grid_Filteredtext_set);
      ...
      protected void S162( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV83Pgmname+"GridState",  AV13GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S132( )
      {
         ...
         AV11TrnContext.gxTpr_Callerobject = AV83Pgmname;
      ...
      protected void S112( )
      {
         ...
         AV99Udparg16 = new getloggedinemployeeid(context).executeUdp( );
         /* Using cursor H00394 */
         pr_default.execute(2, new Object[] {AV99Udparg16});
         while ( (pr_default.getStatus(2) != 101) )
         {
            A166ProjectManagerId = H00394_A166ProjectManagerId[0];
            n166ProjectManagerId = H00394_n166ProjectManagerId[0];
      ...
      protected void wb_table3_68_392( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTabledvelop_confirmpanel_reject_Internalname, tblTabledvelop_confirmpanel_reject_Internalname, "", "Table", 0, "", "", 1, 2, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tbody>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td data-align=\"center\"  style=\""+CSSHelper.Prettify( "text-align:-khtml-center;text-align:-moz-center;text-align:-webkit-center")+"\">") ;
            /* User Defined Control */
            ucDvelop_confirmpanel_reject.SetProperty("Title", Dvelop_confirmpanel_reject_Title);
            ucDvelop_confirmpanel_reject.SetProperty("ConfirmationText", Dvelop_confirmpanel_reject_Confirmationtext);
            ucDvelop_confirmpanel_reject.SetProperty("YesButtonCaption", Dvelop_confirmpanel_reject_Yesbuttoncaption);
            ucDvelop_confirmpanel_reject.SetProperty("NoButtonCaption", Dvelop_confirmpanel_reject_Nobuttoncaption);
            ucDvelop_confirmpanel_reject.SetProperty("CancelButtonCaption", Dvelop_confirmpanel_reject_Cancelbuttoncaption);
            ucDvelop_confirmpanel_reject.SetProperty("YesButtonPosition", Dvelop_confirmpanel_reject_Yesbuttonposition);
            ucDvelop_confirmpanel_reject.SetProperty("ConfirmType", Dvelop_confirmpanel_reject_Confirmtype);
            ucDvelop_confirmpanel_reject.SetProperty("Comment", Dvelop_confirmpanel_reject_Comment);
            ucDvelop_confirmpanel_reject.Render(context, "dvelop.gxbootstrap.confirmpanel", Dvelop_confirmpanel_reject_Internalname, sPrefix+"DVELOP_CONFIRMPANEL_REJECTContainer");
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+sPrefix+"DVELOP_CONFIRMPANEL_REJECTContainer"+"Body"+"\" style=\"display:none;\">") ;
            context.WriteHtmlText( "</div>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_68_392e( true) ;
         }
         else
         {
            wb_table3_68_392e( false) ;
         }
      }

      protected void wb_table2_63_392( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTabledvelop_confirmpanel_approve_Internalname, tblTabledvelop_confirmpanel_approve_Internalname, "", "Table", 0, "", "", 1, 2, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tbody>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td data-align=\"center\"  style=\""+CSSHelper.Prettify( "text-align:-khtml-center;text-align:-moz-center;text-align:-webkit-center")+"\">") ;
            /* User Defined Control */
            ucDvelop_confirmpanel_approve.SetProperty("Title", Dvelop_confirmpanel_approve_Title);
            ucDvelop_confirmpanel_approve.SetProperty("ConfirmationText", Dvelop_confirmpanel_approve_Confirmationtext);
            ucDvelop_confirmpanel_approve.SetProperty("YesButtonCaption", Dvelop_confirmpanel_approve_Yesbuttoncaption);
            ucDvelop_confirmpanel_approve.SetProperty("NoButtonCaption", Dvelop_confirmpanel_approve_Nobuttoncaption);
            ucDvelop_confirmpanel_approve.SetProperty("CancelButtonCaption", Dvelop_confirmpanel_approve_Cancelbuttoncaption);
            ucDvelop_confirmpanel_approve.SetProperty("YesButtonPosition", Dvelop_confirmpanel_approve_Yesbuttonposition);
            ucDvelop_confirmpanel_approve.SetProperty("ConfirmType", Dvelop_confirmpanel_approve_Confirmtype);
            ucDvelop_confirmpanel_approve.Render(context, "dvelop.gxbootstrap.confirmpanel", Dvelop_confirmpanel_approve_Internalname, sPrefix+"DVELOP_CONFIRMPANEL_APPROVEContainer");
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+sPrefix+"DVELOP_CONFIRMPANEL_APPROVEContainer"+"Body"+"\" style=\"display:none;\">") ;
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_63_392e( true) ;
         }
         else
         {
            wb_table2_63_392e( false) ;
         }
      }

      protected void wb_table1_21_392( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table4_26_392( true) ;
         }
         else
         {
            wb_table4_26_392( false) ;
         }
         return  ;
      }

      protected void wb_table4_26_392e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_21_392e( true) ;
         }
         else
         {
            wb_table1_21_392e( false) ;
         }
      }

      protected void wb_table4_26_392( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202461311235811", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("leaverequestpending.js", "?202461311235812", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_392( )
      {
         ...
         edtavApprove_Internalname = sPrefix+"vAPPROVE_"+sGXsfl_39_idx;
         edtavReject_Internalname = sPrefix+"vREJECT_"+sGXsfl_39_idx;
      }
      ...
      protected void SubsflControlProps_fel_392( )
      {
         ...
         edtavApprove_Internalname = sPrefix+"vAPPROVE_"+sGXsfl_39_fel_idx;
         edtavReject_Internalname = sPrefix+"vREJECT_"+sGXsfl_39_fel_idx;
      }
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavApprove_Enabled!=0)&&(edtavApprove_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 52,'"+sPrefix+"',false,'"+sGXsfl_39_idx+"',39)\"" : " ");
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavApprove_Internalname,StringUtil.RTrim( AV68approve),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavApprove_Enabled!=0)&&(edtavApprove_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,52);\"" : " "),(string)"'"+sPrefix+"'"+",false,"+"'"+"e22392_client"+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavApprove_Jsonclick,(short)7,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWActionColumn",(string)"",(short)-1,(int)edtavApprove_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            TempTags = " " + ((edtavReject_Enabled!=0)&&(edtavReject_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 53,'"+sPrefix+"',false,'"+sGXsfl_39_idx+"',39)\"" : " ");
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavReject_Internalname,StringUtil.RTrim( AV69reject),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavReject_Enabled!=0)&&(edtavReject_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,53);\"" : " "),(string)"'"+sPrefix+"'"+",false,"+"'"+"e23392_client"+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavReject_Jsonclick,(short)7,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWActionColumn",(string)"",(short)-1,(int)edtavReject_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
      ...
      protected void StartGridControl39( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV68approve)));
            GridColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavApprove_Enabled), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV69reject)));
            GridColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavReject_Enabled), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void init_default_properties( )
      {
         ...
         edtavApprove_Internalname = sPrefix+"vAPPROVE";
         edtavReject_Internalname = sPrefix+"vREJECT";
         ...
         Dvelop_confirmpanel_approve_Internalname = sPrefix+"DVELOP_CONFIRMPANEL_APPROVE";
         tblTabledvelop_confirmpanel_approve_Internalname = sPrefix+"TABLEDVELOP_CONFIRMPANEL_APPROVE";
         Dvelop_confirmpanel_reject_Internalname = sPrefix+"DVELOP_CONFIRMPANEL_REJECT";
         tblTabledvelop_confirmpanel_reject_Internalname = sPrefix+"TABLEDVELOP_CONFIRMPANEL_REJECT";
         edtavDvelop_confirmpanel_reject_comment_Internalname = sPrefix+"vDVELOP_CONFIRMPANEL_REJECT_COMMENT";
         divDiv_dvelop_confirmpanel_reject_body_Internalname = sPrefix+"DIV_DVELOP_CONFIRMPANEL_REJECT_BODY";
      ...
      public override void initialize_properties( )
      {
         ...
         subGrid_Header = "";
         edtavReject_Jsonclick = "";
         edtavReject_Visible = -1;
         edtavReject_Enabled = 1;
         edtavApprove_Jsonclick = "";
         edtavApprove_Visible = -1;
         edtavApprove_Enabled = 1;
         ...
         Dvelop_confirmpanel_reject_Comment = "Required";
         Dvelop_confirmpanel_reject_Confirmtype = "1";
         Dvelop_confirmpanel_reject_Yesbuttonposition = "left";
         Dvelop_confirmpanel_reject_Cancelbuttoncaption = "WWP_ConfirmTextCancel";
         Dvelop_confirmpanel_reject_Nobuttoncaption = "WWP_ConfirmTextNo";
         Dvelop_confirmpanel_reject_Yesbuttoncaption = "WWP_ConfirmTextYes";
         Dvelop_confirmpanel_reject_Confirmationtext = "Are you sure you want to reject leave";
         Dvelop_confirmpanel_reject_Title = "Reject Leave";
         Dvelop_confirmpanel_approve_Confirmtype = "1";
         Dvelop_confirmpanel_approve_Yesbuttonposition = "left";
         Dvelop_confirmpanel_approve_Cancelbuttoncaption = "WWP_ConfirmTextCancel";
         Dvelop_confirmpanel_approve_Nobuttoncaption = "WWP_ConfirmTextNo";
         Dvelop_confirmpanel_approve_Yesbuttoncaption = "WWP_ConfirmTextYes";
         Dvelop_confirmpanel_approve_Confirmationtext = "Are you sure you want to approve this leave";
         Dvelop_confirmpanel_approve_Title = "Approve Leave";
         ...
         Ddo_grid_Filtertype = "Character|Date|Date|Numeric|Character|Character";
         Ddo_grid_Includefilter = "T";
         Ddo_grid_Fixable = "T";
         Ddo_grid_Includesortasc = "T";
         Ddo_grid_Columnssortvalues = "2|3|4|5|6|7";
         Ddo_grid_Columnids = "2:LeaveTypeName|4:LeaveRequestStartDate|5:LeaveRequestEndDate|6:LeaveRequestDuration|8:LeaveRequestDescription|11:EmployeeName";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'sPrefix'},{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'A166ProjectManagerId',fld:'PROJECTMANAGERID',pic:'ZZZZZZZZZ9'},{av:'AV99Udparg16',fld:'vUDPARG16',pic:'9999999999',hsh:true},{av:'A102ProjectId',fld:'PROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtLeaveTypeName_Visible',ctrl:'LEAVETYPENAME',prop:'Visible'},{av:'edtLeaveRequestStartDate_Visible',ctrl:'LEAVEREQUESTSTARTDATE',prop:'Visible'},{av:'edtLeaveRequestEndDate_Visible',ctrl:'LEAVEREQUESTENDDATE',prop:'Visible'},{av:'edtLeaveRequestDuration_Visible',ctrl:'LEAVEREQUESTDURATION',prop:'Visible'},{av:'edtLeaveRequestDescription_Visible',ctrl:'LEAVEREQUESTDESCRIPTION',prop:'Visible'},{av:'edtEmployeeName_Visible',ctrl:'EMPLOYEENAME',prop:'Visible'},{av:'AV54GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV55GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV56GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV26ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV13GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E12392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'A166ProjectManagerId',fld:'PROJECTMANAGERID',pic:'ZZZZZZZZZ9'},{av:'AV99Udparg16',fld:'vUDPARG16',pic:'9999999999',hsh:true},{av:'A102ProjectId',fld:'PROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E13392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'A166ProjectManagerId',fld:'PROJECTMANAGERID',pic:'ZZZZZZZZZ9'},{av:'AV99Udparg16',fld:'vUDPARG16',pic:'9999999999',hsh:true},{av:'A102ProjectId',fld:'PROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E15392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'A166ProjectManagerId',fld:'PROJECTMANAGERID',pic:'ZZZZZZZZZ9'},{av:'AV99Udparg16',fld:'vUDPARG16',pic:'9999999999',hsh:true},{av:'A102ProjectId',fld:'PROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'},{av:'Ddo_grid_Filteredtextto_get',ctrl:'DDO_GRID',prop:'FilteredTextTo_get'},{av:'Ddo_grid_Filteredtext_get',ctrl:'DDO_GRID',prop:'FilteredText_get'},{av:'Ddo_grid_Selectedcolumn',ctrl:'DDO_GRID',prop:'SelectedColumn'}]");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",",oparms:[{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E21392',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV68approve',fld:'vAPPROVE',pic:''},{av:'AV69reject',fld:'vREJECT',pic:''}]}");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","{handler:'E16392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'A166ProjectManagerId',fld:'PROJECTMANAGERID',pic:'ZZZZZZZZZ9'},{av:'AV99Udparg16',fld:'vUDPARG16',pic:'9999999999',hsh:true},{av:'A102ProjectId',fld:'PROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Ddo_gridcolumnsselector_Columnsselectorvalues',ctrl:'DDO_GRIDCOLUMNSSELECTOR',prop:'ColumnsSelectorValues'}]");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E11392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'A166ProjectManagerId',fld:'PROJECTMANAGERID',pic:'ZZZZZZZZZ9'},{av:'AV99Udparg16',fld:'vUDPARG16',pic:'9999999999',hsh:true},{av:'A102ProjectId',fld:'PROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV13GridState',fld:'vGRIDSTATE',pic:''}]");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV13GridState',fld:'vGRIDSTATE',pic:''},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV18FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'Ddo_grid_Selectedvalue_set',ctrl:'DDO_GRID',prop:'SelectedValue_set'},{av:'Ddo_grid_Filteredtext_set',ctrl:'DDO_GRID',prop:'FilteredText_set'},{av:'Ddo_grid_Filteredtextto_set',ctrl:'DDO_GRID',prop:'FilteredTextTo_set'},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtLeaveTypeName_Visible',ctrl:'LEAVETYPENAME',prop:'Visible'},{av:'edtLeaveRequestStartDate_Visible',ctrl:'LEAVEREQUESTSTARTDATE',prop:'Visible'},{av:'edtLeaveRequestEndDate_Visible',ctrl:'LEAVEREQUESTENDDATE',prop:'Visible'},{av:'edtLeaveRequestDuration_Visible',ctrl:'LEAVEREQUESTDURATION',prop:'Visible'},{av:'edtLeaveRequestDescription_Visible',ctrl:'LEAVEREQUESTDESCRIPTION',prop:'Visible'},{av:'edtEmployeeName_Visible',ctrl:'EMPLOYEENAME',prop:'Visible'},{av:'AV54GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV55GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV56GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV26ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
         setEventMetadata("VAPPROVE.CLICK","{handler:'E22392',iparms:[{av:'A127LeaveRequestId',fld:'LEAVEREQUESTID',pic:'ZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("VAPPROVE.CLICK",",oparms:[]}");
         setEventMetadata("DVELOP_CONFIRMPANEL_APPROVE.CLOSE","{handler:'E17392',iparms:[{av:'Dvelop_confirmpanel_approve_Result',ctrl:'DVELOP_CONFIRMPANEL_APPROVE',prop:'Result'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'A166ProjectManagerId',fld:'PROJECTMANAGERID',pic:'ZZZZZZZZZ9'},{av:'AV99Udparg16',fld:'vUDPARG16',pic:'9999999999',hsh:true},{av:'A102ProjectId',fld:'PROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'A127LeaveRequestId',fld:'LEAVEREQUESTID',pic:'ZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("DVELOP_CONFIRMPANEL_APPROVE.CLOSE",",oparms:[{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtLeaveTypeName_Visible',ctrl:'LEAVETYPENAME',prop:'Visible'},{av:'edtLeaveRequestStartDate_Visible',ctrl:'LEAVEREQUESTSTARTDATE',prop:'Visible'},{av:'edtLeaveRequestEndDate_Visible',ctrl:'LEAVEREQUESTENDDATE',prop:'Visible'},{av:'edtLeaveRequestDuration_Visible',ctrl:'LEAVEREQUESTDURATION',prop:'Visible'},{av:'edtLeaveRequestDescription_Visible',ctrl:'LEAVEREQUESTDESCRIPTION',prop:'Visible'},{av:'edtEmployeeName_Visible',ctrl:'EMPLOYEENAME',prop:'Visible'},{av:'AV54GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV55GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV56GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV26ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV13GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("VREJECT.CLICK","{handler:'E23392',iparms:[{av:'A127LeaveRequestId',fld:'LEAVEREQUESTID',pic:'ZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("VREJECT.CLICK",",oparms:[{av:'AV66DVelop_ConfirmPanel_reject_Comment',fld:'vDVELOP_CONFIRMPANEL_REJECT_COMMENT',pic:''}]}");
         setEventMetadata("DVELOP_CONFIRMPANEL_REJECT.CLOSE","{handler:'E18392',iparms:[{av:'Dvelop_confirmpanel_reject_Result',ctrl:'DVELOP_CONFIRMPANEL_REJECT',prop:'Result'},{av:'AV66DVelop_ConfirmPanel_reject_Comment',fld:'vDVELOP_CONFIRMPANEL_REJECT_COMMENT',pic:''},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'A166ProjectManagerId',fld:'PROJECTMANAGERID',pic:'ZZZZZZZZZ9'},{av:'AV99Udparg16',fld:'vUDPARG16',pic:'9999999999',hsh:true},{av:'A102ProjectId',fld:'PROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'sPrefix'},{av:'A127LeaveRequestId',fld:'LEAVEREQUESTID',pic:'ZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("DVELOP_CONFIRMPANEL_REJECT.CLOSE",",oparms:[{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtLeaveTypeName_Visible',ctrl:'LEAVETYPENAME',prop:'Visible'},{av:'edtLeaveRequestStartDate_Visible',ctrl:'LEAVEREQUESTSTARTDATE',prop:'Visible'},{av:'edtLeaveRequestEndDate_Visible',ctrl:'LEAVEREQUESTENDDATE',prop:'Visible'},{av:'edtLeaveRequestDuration_Visible',ctrl:'LEAVEREQUESTDURATION',prop:'Visible'},{av:'edtLeaveRequestDescription_Visible',ctrl:'LEAVEREQUESTDESCRIPTION',prop:'Visible'},{av:'edtEmployeeName_Visible',ctrl:'EMPLOYEENAME',prop:'Visible'},{av:'AV54GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV55GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV56GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'AV26ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV13GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","{handler:'E14392',iparms:[{av:'Ddo_agexport_Activeeventkey',ctrl:'DDO_AGEXPORT',prop:'ActiveEventKey'},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV13GridState',fld:'vGRIDSTATE',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'}]");
         setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",",oparms:[{av:'AV13GridState',fld:'vGRIDSTATE',pic:''},{av:'AV15OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV16OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV18FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV23ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV31TFLeaveTypeName',fld:'vTFLEAVETYPENAME',pic:''},{av:'AV32TFLeaveTypeName_Sel',fld:'vTFLEAVETYPENAME_SEL',pic:''},{av:'AV38TFLeaveRequestStartDate',fld:'vTFLEAVEREQUESTSTARTDATE',pic:''},{av:'AV39TFLeaveRequestStartDate_To',fld:'vTFLEAVEREQUESTSTARTDATE_TO',pic:''},{av:'AV43TFLeaveRequestEndDate',fld:'vTFLEAVEREQUESTENDDATE',pic:''},{av:'AV44TFLeaveRequestEndDate_To',fld:'vTFLEAVEREQUESTENDDATE_TO',pic:''},{av:'AV48TFLeaveRequestDuration',fld:'vTFLEAVEREQUESTDURATION',pic:'Z9.9'},{av:'AV49TFLeaveRequestDuration_To',fld:'vTFLEAVEREQUESTDURATION_TO',pic:'Z9.9'},{av:'AV50TFLeaveRequestDescription',fld:'vTFLEAVEREQUESTDESCRIPTION',pic:''},{av:'AV51TFLeaveRequestDescription_Sel',fld:'vTFLEAVEREQUESTDESCRIPTION_SEL',pic:''},{av:'AV29TFEmployeeName',fld:'vTFEMPLOYEENAME',pic:''},{av:'AV30TFEmployeeName_Sel',fld:'vTFEMPLOYEENAME_SEL',pic:''},{av:'A166ProjectManagerId',fld:'PROJECTMANAGERID',pic:'ZZZZZZZZZ9'},{av:'AV99Udparg16',fld:'vUDPARG16',pic:'9999999999',hsh:true},{av:'A102ProjectId',fld:'PROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV78ProjectIds',fld:'vPROJECTIDS',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'},{av:'Ddo_grid_Selectedvalue_set',ctrl:'DDO_GRID',prop:'SelectedValue_set'},{av:'Ddo_grid_Filteredtext_set',ctrl:'DDO_GRID',prop:'FilteredText_set'},{av:'Ddo_grid_Filteredtextto_set',ctrl:'DDO_GRID',prop:'FilteredTextTo_set'}]}");
         ...
         setEventMetadata("NULL","{handler:'Validv_Reject',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         Dvelop_confirmpanel_approve_Result = "";
         Dvelop_confirmpanel_reject_Result = "";
         ...
         Dvelop_confirmpanel_reject_Bodycontentinternalname = "";
         ...
         AV66DVelop_ConfirmPanel_reject_Comment = "";
         ...
         AV69reject = "";
         scmdbuf = "";
         lV84Leaverequestpendingds_3_filterfulltext = "";
         lV85Leaverequestpendingds_4_tfleavetypename = "";
         lV93Leaverequestpendingds_12_tfleaverequestdescription = "";
         lV95Leaverequestpendingds_14_tfemployeename = "";
         AV79EmployeeIds = new GxSimpleCollection<long>();
         AV84Leaverequestpendingds_3_filterfulltext = "";
         AV86Leaverequestpendingds_5_tfleavetypename_sel = "";
         AV85Leaverequestpendingds_4_tfleavetypename = "";
         AV87Leaverequestpendingds_6_tfleaverequeststartdate = DateTime.MinValue;
         AV88Leaverequestpendingds_7_tfleaverequeststartdate_to = DateTime.MinValue;
         AV89Leaverequestpendingds_8_tfleaverequestenddate = DateTime.MinValue;
         AV90Leaverequestpendingds_9_tfleaverequestenddate_to = DateTime.MinValue;
         AV94Leaverequestpendingds_13_tfleaverequestdescription_sel = "";
         AV93Leaverequestpendingds_12_tfleaverequestdescription = "";
         AV96Leaverequestpendingds_15_tfemployeename_sel = "";
         AV95Leaverequestpendingds_14_tfemployeename = "";
         ...
         ucDvelop_confirmpanel_reject = new GXUserControl();
         AV63AGExportDataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item(context);
         ...
         AV19ExcelFilename = "";
         AV20ErrorMessage = "";
         H00394_A166ProjectManagerId = new long[1] ;
         H00394_n166ProjectManagerId = new bool[] {false} ;
         H00394_A102ProjectId = new long[1] ;
         GXt_objcol_int6 = new GxSimpleCollection<long>();
         ucDvelop_confirmpanel_approve = new GXUserControl();
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestpending__default(),
            new Object[][] {
                new Object[] {
               H00392_A100CompanyId, H00392_A148EmployeeName, H00392_A106EmployeeId, H00392_A134LeaveRequestRejectionReason, H00392_A133LeaveRequestDescription, H00392_A132LeaveRequestStatus, H00392_A131LeaveRequestDuration, H00392_A130LeaveRequestEndDate, H00392_A129LeaveRequestStartDate, H00392_A128LeaveRequestDate,
               H00392_A125LeaveTypeName, H00392_A124LeaveTypeId, H00392_A127LeaveRequestId
               }
               , new Object[] {
               H00393_AGRID_nRecordCount
               }
               , new Object[] {
               H00394_A166ProjectManagerId, H00394_n166ProjectManagerId, H00394_A102ProjectId
               }
            }
         );
         AV83Pgmname = "LeaveRequestPending";
      ...
      private int edtavApprove_Enabled ;
      private int edtavReject_Enabled ;
      ...
      private int edtavApprove_Visible ;
      private int edtavReject_Visible ;
      ...
      private decimal AV91Leaverequestpendingds_10_tfleaverequestduration ;
      private decimal AV92Leaverequestpendingds_11_tfleaverequestduration_to ;
      ...
      private string Dvelop_confirmpanel_approve_Result ;
      private string Dvelop_confirmpanel_reject_Result ;
      ...
      private string edtavApprove_Internalname ;
      private string edtavReject_Internalname ;
      ...
      private string Dvelop_confirmpanel_approve_Title ;
      private string Dvelop_confirmpanel_approve_Confirmationtext ;
      private string Dvelop_confirmpanel_approve_Yesbuttoncaption ;
      private string Dvelop_confirmpanel_approve_Nobuttoncaption ;
      private string Dvelop_confirmpanel_approve_Cancelbuttoncaption ;
      private string Dvelop_confirmpanel_approve_Yesbuttonposition ;
      private string Dvelop_confirmpanel_approve_Confirmtype ;
      private string Dvelop_confirmpanel_reject_Title ;
      private string Dvelop_confirmpanel_reject_Confirmationtext ;
      private string Dvelop_confirmpanel_reject_Yesbuttoncaption ;
      private string Dvelop_confirmpanel_reject_Nobuttoncaption ;
      private string Dvelop_confirmpanel_reject_Cancelbuttoncaption ;
      private string Dvelop_confirmpanel_reject_Yesbuttonposition ;
      private string Dvelop_confirmpanel_reject_Confirmtype ;
      private string Dvelop_confirmpanel_reject_Comment ;
      private string Dvelop_confirmpanel_reject_Bodycontentinternalname ;
      ...
      private string divDiv_dvelop_confirmpanel_reject_body_Internalname ;
      private string edtavDvelop_confirmpanel_reject_comment_Internalname ;
      ...
      private string AV68approve ;
      private string AV69reject ;
      private string edtavFilterfulltext_Internalname ;
      private string scmdbuf ;
      private string lV85Leaverequestpendingds_4_tfleavetypename ;
      private string lV95Leaverequestpendingds_14_tfemployeename ;
      private string AV86Leaverequestpendingds_5_tfleavetypename_sel ;
      private string AV85Leaverequestpendingds_4_tfleavetypename ;
      private string AV96Leaverequestpendingds_15_tfemployeename_sel ;
      private string AV95Leaverequestpendingds_14_tfemployeename ;
      private string Dvelop_confirmpanel_reject_Internalname ;
      private string GXt_char5 ;
      private string GXt_char4 ;
      private string GXt_char2 ;
      private string tblTabledvelop_confirmpanel_reject_Internalname ;
      private string tblTabledvelop_confirmpanel_approve_Internalname ;
      private string Dvelop_confirmpanel_approve_Internalname ;
      ...
      private string edtavApprove_Jsonclick ;
      private string edtavReject_Jsonclick ;
      ...
      private DateTime AV87Leaverequestpendingds_6_tfleaverequeststartdate ;
      private DateTime AV88Leaverequestpendingds_7_tfleaverequeststartdate_to ;
      private DateTime AV89Leaverequestpendingds_8_tfleaverequestenddate ;
      private DateTime AV90Leaverequestpendingds_9_tfleaverequestenddate_to ;
      ...
      private string AV66DVelop_ConfirmPanel_reject_Comment ;
      ...
      private string lV84Leaverequestpendingds_3_filterfulltext ;
      private string lV93Leaverequestpendingds_12_tfleaverequestdescription ;
      private string AV84Leaverequestpendingds_3_filterfulltext ;
      private string AV94Leaverequestpendingds_13_tfleaverequestdescription_sel ;
      private string AV93Leaverequestpendingds_12_tfleaverequestdescription ;
      ...
      private GXUserControl ucDvelop_confirmpanel_reject ;
      private GXUserControl ucDvelop_confirmpanel_approve ;
      ...
      private long[] H00394_A166ProjectManagerId ;
      private bool[] H00394_n166ProjectManagerId ;
 ...
 public class leaverequestpending__default : DataStoreHelperBase, IDataStoreHelper
 {
    protected Object[] conditional_H00392( IGxContext context ,
                                           ...
                                           string AV84Leaverequestpendingds_3_filterfulltext ,
                                           string AV86Leaverequestpendingds_5_tfleavetypename_sel ,
                                           string AV85Leaverequestpendingds_4_tfleavetypename ,
                                           DateTime AV87Leaverequestpendingds_6_tfleaverequeststartdate ,
                                           DateTime AV88Leaverequestpendingds_7_tfleaverequeststartdate_to ,
                                           DateTime AV89Leaverequestpendingds_8_tfleaverequestenddate ,
                                           DateTime AV90Leaverequestpendingds_9_tfleaverequestenddate_to ,
                                           decimal AV91Leaverequestpendingds_10_tfleaverequestduration ,
                                           decimal AV92Leaverequestpendingds_11_tfleaverequestduration_to ,
                                           string AV94Leaverequestpendingds_13_tfleaverequestdescription_sel ,
                                           string AV93Leaverequestpendingds_12_tfleaverequestdescription ,
                                           string AV96Leaverequestpendingds_15_tfemployeename_sel ,
                                           string AV95Leaverequestpendingds_14_tfemployeename ,
                                           ...
                                           long AV82Udparg2 )
    {
       ...
       AddWhere(sWhereString, "(Not ( :AV81Udparg1) or ( T3.CompanyId = :AV82Udparg2))");
       if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV84Leaverequestpendingds_3_filterfulltext)) )
       {
          AddWhere(sWhereString, "(( LOWER(T3.LeaveTypeName) like '%' || LOWER(:lV84Leaverequestpendingds_3_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'90.9'), 2) like '%' || :lV84Leaverequestpendingds_3_filterfulltext) or ( LOWER(T1.LeaveRequestDescription) like '%' || LOWER(:lV84Leaverequestpendingds_3_filterfulltext)) or ( LOWER(T2.EmployeeName) like '%' || LOWER(:lV84Leaverequestpendingds_3_filterfulltext)))");
       }
       else
       {
          GXv_int7[2] = 1;
       ...
       if ( String.IsNullOrEmpty(StringUtil.RTrim( AV86Leaverequestpendingds_5_tfleavetypename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV85Leaverequestpendingds_4_tfleavetypename)) ) )
       {
          AddWhere(sWhereString, "(LOWER(T3.LeaveTypeName) like LOWER(:lV85Leaverequestpendingds_4_tfleavetypename))");
       }
       else
       {
          GXv_int7[6] = 1;
       }
       if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV86Leaverequestpendingds_5_tfleavetypename_sel)) && ! ( StringUtil.StrCmp(AV86Leaverequestpendingds_5_tfleavetypename_sel, "<#Empty#>") == 0 ) )
       {
          AddWhere(sWhereString, "(T3.LeaveTypeName = ( :AV86Leaverequestpendingds_5_tfleavetypename_sel))");
       }
       else
       {
          GXv_int7[7] = 1;
       }
       if ( StringUtil.StrCmp(AV86Leaverequestpendingds_5_tfleavetypename_sel, "<#Empty#>") == 0 )
       {
          AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T3.LeaveTypeName))=0))");
       }
       if ( ! (DateTime.MinValue==AV87Leaverequestpendingds_6_tfleaverequeststartdate) )
       {
          AddWhere(sWhereString, "(T1.LeaveRequestStartDate >= :AV87Leaverequestpendingds_6_tfleaverequeststartdate)");
       }
       else
       {
          GXv_int7[8] = 1;
       }
       if ( ! (DateTime.MinValue==AV88Leaverequestpendingds_7_tfleaverequeststartdate_to) )
       {
          AddWhere(sWhereString, "(T1.LeaveRequestStartDate <= :AV88Leaverequestpendingds_7_tfleaverequeststartdate_to)");
       }
       else
       {
          GXv_int7[9] = 1;
       }
       if ( ! (DateTime.MinValue==AV89Leaverequestpendingds_8_tfleaverequestenddate) )
       {
          AddWhere(sWhereString, "(T1.LeaveRequestEndDate >= :AV89Leaverequestpendingds_8_tfleaverequestenddate)");
       }
       else
       {
          GXv_int7[10] = 1;
       }
       if ( ! (DateTime.MinValue==AV90Leaverequestpendingds_9_tfleaverequestenddate_to) )
       {
          AddWhere(sWhereString, "(T1.LeaveRequestEndDate <= :AV90Leaverequestpendingds_9_tfleaverequestenddate_to)");
       }
       else
       {
          GXv_int7[11] = 1;
       }
       if ( ! (Convert.ToDecimal(0)==AV91Leaverequestpendingds_10_tfleaverequestduration) )
       {
          AddWhere(sWhereString, "(T1.LeaveRequestDuration >= :AV91Leaverequestpendingds_10_tfleaverequestduration)");
       }
       else
       {
          GXv_int7[12] = 1;
       }
       if ( ! (Convert.ToDecimal(0)==AV92Leaverequestpendingds_11_tfleaverequestduration_to) )
       {
          AddWhere(sWhereString, "(T1.LeaveRequestDuration <= :AV92Leaverequestpendingds_11_tfleaverequestduration_to)");
       }
       else
       {
          GXv_int7[13] = 1;
       }
       if ( String.IsNullOrEmpty(StringUtil.RTrim( AV94Leaverequestpendingds_13_tfleaverequestdescription_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV93Leaverequestpendingds_12_tfleaverequestdescription)) ) )
       {
          AddWhere(sWhereString, "(LOWER(T1.LeaveRequestDescription) like LOWER(:lV93Leaverequestpendingds_12_tfleaverequestdescription))");
       }
       else
       {
          GXv_int7[14] = 1;
       }
       if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV94Leaverequestpendingds_13_tfleaverequestdescription_sel)) && ! ( StringUtil.StrCmp(AV94Leaverequestpendingds_13_tfleaverequestdescription_sel, "<#Empty#>") == 0 ) )
       {
          AddWhere(sWhereString, "(T1.LeaveRequestDescription = ( :AV94Leaverequestpendingds_13_tfleaverequestdescription_sel))");
       }
       else
       {
          GXv_int7[15] = 1;
       }
       if ( StringUtil.StrCmp(AV94Leaverequestpendingds_13_tfleaverequestdescription_sel, "<#Empty#>") == 0 )
       {
          AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.LeaveRequestDescription))=0))");
       }
       if ( String.IsNullOrEmpty(StringUtil.RTrim( AV96Leaverequestpendingds_15_tfemployeename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV95Leaverequestpendingds_14_tfemployeename)) ) )
       {
          AddWhere(sWhereString, "(LOWER(T2.EmployeeName) like LOWER(:lV95Leaverequestpendingds_14_tfemployeename))");
       }
       else
       {
          GXv_int7[16] = 1;
       }
       if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV96Leaverequestpendingds_15_tfemployeename_sel)) && ! ( StringUtil.StrCmp(AV96Leaverequestpendingds_15_tfemployeename_sel, "<#Empty#>") == 0 ) )
       {
          AddWhere(sWhereString, "(T2.EmployeeName = ( :AV96Leaverequestpendingds_15_tfemployeename_sel))");
       }
       else
       {
          GXv_int7[17] = 1;
       }
       if ( StringUtil.StrCmp(AV96Leaverequestpendingds_15_tfemployeename_sel, "<#Empty#>") == 0 )
       {
                                           ...
                                           long AV82Udparg2 )
    {
       ...
       AddWhere(sWhereString, "(T1.LeaveRequestStatus = ( 'Pending'))");
       AddWhere(sWhereString, "(Not ( :AV81Udparg1) or ( T2.CompanyId = :AV82Udparg2))");
       if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV84Leaverequestpendingds_3_filterfulltext)) )
       {
          AddWhere(sWhereString, "(( LOWER(T2.LeaveTypeName) like '%' || LOWER(:lV84Leaverequestpendingds_3_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'90.9'), 2) like '%' || :lV84Leaverequestpendingds_3_filterfulltext) or ( LOWER(T1.LeaveRequestDescription) like '%' || LOWER(:lV84Leaverequestpendingds_3_filterfulltext)) or ( LOWER(T3.EmployeeName) like '%' || LOWER(:lV84Leaverequestpendingds_3_filterfulltext)))");
       }
       else
       {
          GXv_int9[2] = 1;
       ...
       if ( String.IsNullOrEmpty(StringUtil.RTrim( AV86Leaverequestpendingds_5_tfleavetypename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV85Leaverequestpendingds_4_tfleavetypename)) ) )
       {
          AddWhere(sWhereString, "(LOWER(T2.LeaveTypeName) like LOWER(:lV85Leaverequestpendingds_4_tfleavetypename))");
       }
       else
       {
          GXv_int9[6] = 1;
       ...
       if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV86Leaverequestpendingds_5_tfleavetypename_sel)) && ! ( StringUtil.StrCmp(AV86Leaverequestpendingds_5_tfleavetypename_sel, "<#Empty#>") == 0 ) )
       {
          AddWhere(sWhereString, "(T2.LeaveTypeName = ( :AV86Leaverequestpendingds_5_tfleavetypename_sel))");
       }
       else
       {
          GXv_int9[7] = 1;
       ...
       if ( String.IsNullOrEmpty(StringUtil.RTrim( AV96Leaverequestpendingds_15_tfemployeename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV95Leaverequestpendingds_14_tfemployeename)) ) )
       {
          AddWhere(sWhereString, "(LOWER(T3.EmployeeName) like LOWER(:lV95Leaverequestpendingds_14_tfemployeename))");
       }
       else
       {
          GXv_int9[16] = 1;
       ...
       if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV96Leaverequestpendingds_15_tfemployeename_sel)) && ! ( StringUtil.StrCmp(AV96Leaverequestpendingds_15_tfemployeename_sel, "<#Empty#>") == 0 ) )
       {
          AddWhere(sWhereString, "(T3.EmployeeName = ( :AV96Leaverequestpendingds_15_tfemployeename_sel))");
       }
       else
       {
          GXv_int9[17] = 1;
                                                   ...
                                                   Object [] dynConstraints )
    {
       ...
       {
             case 0 :
                   return conditional_H00392(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (DateTime)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (decimal)dynConstraints[9] , (decimal)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (decimal)dynConstraints[16] , (string)dynConstraints[17] , (string)dynConstraints[18] , (DateTime)dynConstraints[19] , (DateTime)dynConstraints[20] , (short)dynConstraints[21] , (bool)dynConstraints[22] , (string)dynConstraints[23] , (bool)dynConstraints[24] , (long)dynConstraints[25] , (long)dynConstraints[26] );
             case 1 :
                   return conditional_H00393(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (DateTime)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (decimal)dynConstraints[9] , (decimal)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (decimal)dynConstraints[16] , (string)dynConstraints[17] , (string)dynConstraints[18] , (DateTime)dynConstraints[19] , (DateTime)dynConstraints[20] , (short)dynConstraints[21] , (bool)dynConstraints[22] , (string)dynConstraints[23] , (bool)dynConstraints[24] , (long)dynConstraints[25] , (long)dynConstraints[26] );
       }
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        new ParDef("AV99Udparg16",GXType.Int64,10,0)
        };
        Object[] prmH00392;
        prmH00392 = new Object[] {
        new ParDef("AV81Udparg1",GXType.Boolean,4,0) ,
        new ParDef("AV82Udparg2",GXType.Int64,10,0) ,
        new ParDef("lV84Leaverequestpendingds_3_filterfulltext",GXType.VarChar,100,0) ,
        new ParDef("lV84Leaverequestpendingds_3_filterfulltext",GXType.VarChar,100,0) ,
        new ParDef("lV84Leaverequestpendingds_3_filterfulltext",GXType.VarChar,100,0) ,
        new ParDef("lV84Leaverequestpendingds_3_filterfulltext",GXType.VarChar,100,0) ,
        new ParDef("lV85Leaverequestpendingds_4_tfleavetypename",GXType.Char,100,0) ,
        new ParDef("AV86Leaverequestpendingds_5_tfleavetypename_sel",GXType.Char,100,0) ,
        new ParDef("AV87Leaverequestpendingds_6_tfleaverequeststartdate",GXType.Date,8,0) ,
        new ParDef("AV88Leaverequestpendingds_7_tfleaverequeststartdate_to",GXType.Date,8,0) ,
        new ParDef("AV89Leaverequestpendingds_8_tfleaverequestenddate",GXType.Date,8,0) ,
        new ParDef("AV90Leaverequestpendingds_9_tfleaverequestenddate_to",GXType.Date,8,0) ,
        new ParDef("AV91Leaverequestpendingds_10_tfleaverequestduration",GXType.Number,4,1) ,
        new ParDef("AV92Leaverequestpendingds_11_tfleaverequestduration_to",GXType.Number,4,1) ,
        new ParDef("lV93Leaverequestpendingds_12_tfleaverequestdescription",GXType.VarChar,200,0) ,
        new ParDef("AV94Leaverequestpendingds_13_tfleaverequestdescription_sel",GXType.VarChar,200,0) ,
        new ParDef("lV95Leaverequestpendingds_14_tfemployeename",GXType.Char,128,0) ,
        new ParDef("AV96Leaverequestpendingds_15_tfemployeename_sel",GXType.Char,128,0) ,
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("H00394", "SELECT ProjectManagerId, ProjectId FROM Project WHERE ProjectManagerId = :AV99Udparg16 ORDER BY ProjectManagerId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00394,100, GxCacheFrequency.OFF ,false,false )
        };
     }
  }
