...
namespace GeneXus.Programs {
   public class companylocationview : GXDataArea
   {
      public companylocationview( )
      {
      ...
      public companylocationview( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10CompanyLocationId = (long)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV10CompanyLocationId", StringUtil.LTrimStr( (decimal)(AV10CompanyLocationId), 10, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vCOMPANYLOCATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompanyLocationId), "ZZZZZZZZZ9"), context));
      ...
      {
         get {
            return "companylocationview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("companylocationview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10CompanyLocationId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"CompanyLocationId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vCOMPANYLOCATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CompanyLocationId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOMPANYLOCATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompanyLocationId), "ZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Companywc == null ) )
         {
            WebComp_Companywc.componentjscripts();
         }
      }
      ...
      {
         return formatLink("companylocationview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10CompanyLocationId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"CompanyLocationId","TabCode"})  ;
      }
      ...
      protected void WB4G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Company Location", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_CompanyLocationView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_CompanyLocationView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCompany_title_Internalname, "Location", "", "", lblCompany_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_CompanyLocationView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Company") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablecompany_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Companywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0033"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Companywc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldCompanywc), StringUtil.Lower( WebComp_Companywc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
                  }
                  WebComp_Companywc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldCompanywc), StringUtil.Lower( WebComp_Companywc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldCompanywc = cgiGet( "W0033");
                           if ( ( StringUtil.Len( OldCompanywc) == 0 ) || ( StringUtil.StrCmp(OldCompanywc, WebComp_Companywc_Component) != 0 ) )
                           {
                              WebComp_Companywc = getWebComponent(GetType(), "GeneXus.Programs", OldCompanywc, new Object[] {context} );
                              WebComp_Companywc.ComponentInit();
                              WebComp_Companywc.Name = "OldCompanywc";
                              WebComp_Companywc_Component = OldCompanywc;
                           }
                           if ( StringUtil.Len( WebComp_Companywc_Component) != 0 )
                           {
                              WebComp_Companywc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Companywc_Component = OldCompanywc;
                        }
                     }
      ...
      protected void RF4G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Companywc_Component) != 0 )
               {
                  WebComp_Companywc.componentstart();
               }
            }
         }
      ...
      protected void STRUP4G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10CompanyLocationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vCOMPANYLOCATIONID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "CompanyLocationGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "companylocationgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "CompanyLocationGeneral";
               WebComp_Generalwc_Component = "CompanyLocationGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0025",(string)"",(long)AV10CompanyLocationId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "Company") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Companywc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Companywc_Component), StringUtil.Lower( "CompanyLocationCompanyWC")) != 0 )
            {
               WebComp_Companywc = getWebComponent(GetType(), "GeneXus.Programs", "companylocationcompanywc", new Object[] {context} );
               WebComp_Companywc.ComponentInit();
               WebComp_Companywc.Name = "CompanyLocationCompanyWC";
               WebComp_Companywc_Component = "CompanyLocationCompanyWC";
            }
            if ( StringUtil.Len( WebComp_Companywc_Component) != 0 )
            {
               WebComp_Companywc.setjustcreated();
               WebComp_Companywc.componentprepare(new Object[] {(string)"W0033",(string)"",(long)AV10CompanyLocationId});
               WebComp_Companywc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Companywc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
               WebComp_Companywc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10CompanyLocationId = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV10CompanyLocationId", StringUtil.LTrimStr( (decimal)(AV10CompanyLocationId), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOMPANYLOCATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CompanyLocationId), "ZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Companywc == null ) )
         {
            if ( StringUtil.Len( WebComp_Companywc_Component) != 0 )
            {
               WebComp_Companywc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112810465097", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("companylocationview.js", "?2024112810465097", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblCompany_title_Internalname = "COMPANY_TITLE";
         divUnnamedtablecompany_Internalname = "UNNAMEDTABLECOMPANY";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Company Location View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void initialize( )
      {
         ...
         OldGeneralwc = "";
         lblCompany_title_Jsonclick = "";
         WebComp_Companywc_Component = "";
         OldCompanywc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.companylocationview__default(),
            new Object[][] {
                new Object[] {
               H004G2_A157CompanyLocationId, H004G2_A158CompanyLocationName
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Companywc = new GeneXus.Http.GXNullWebComponent();
         /* GeneXus formulas. */
      }
      ...
      private long wcpOAV10CompanyLocationId ;
      ...
      private string lblCompany_title_Internalname ;
      private string lblCompany_title_Jsonclick ;
      private string divUnnamedtablecompany_Internalname ;
      private string WebComp_Companywc_Component ;
      private string OldCompanywc ;
      private string sEvt ;
   ...
   public class companylocationview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004G2", "SELECT CompanyLocationId, CompanyLocationName FROM CompanyLocation WHERE CompanyLocationId = :AV10CompanyLocationId ORDER BY CompanyLocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004G2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
