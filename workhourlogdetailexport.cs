...
namespace GeneXus.Programs {
   public class workhourlogdetailexport : GXProcedure
   {
      ...
      public void executeSubmit( GXBaseCollection<SdtSDTWorkHourLog_SDTWorkHourLogItem> aP0_SDTWorkHourLog ,
                                 ...
                                 out string aP2_ErrorMessage )
      {
         workhourlogdetailexport objworkhourlogdetailexport;
         objworkhourlogdetailexport = new workhourlogdetailexport();
         objworkhourlogdetailexport.AV23SDTWorkHourLog = aP0_SDTWorkHourLog;
         objworkhourlogdetailexport.AV12Filename = "" ;
         objworkhourlogdetailexport.AV13ErrorMessage = "" ;
         objworkhourlogdetailexport.context.SetSubmitInitialConfig(context);
         objworkhourlogdetailexport.initialize();
         Submit( executePrivateCatch,objworkhourlogdetailexport);
         aP1_Filename=this.AV12Filename;
         aP2_ErrorMessage=this.AV13ErrorMessage;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((workhourlogdetailexport)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
         ...
         while ( AV37GXV2 <= AV23SDTWorkHourLog.Count )
         {
            ...
            while ( AV38GXV3 <= AV24ColumnsSelector.gxTpr_Columns.Count )
            {
               ...
               if ( AV26ColumnsSelector_Column.gxTpr_Isvisible )
               {
                  ...
                  {
                     GXt_char1 = "";
                     new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV17SDTWorkHourLogItem.gxTpr_Employeename, out  GXt_char1) ;
                  ...
                  {
                     GXt_char1 = "";
                     new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV17SDTWorkHourLogItem.gxTpr_Projectname, out  GXt_char1) ;
                     AV11ExcelDocument.get_Cells(AV14CellRow, (int)(AV15FirstColumn+AV32VisibleColumnCount), 1, 1).Text = GXt_char1;
                  }
                  ...
                  {
                     GXt_char1 = "";
                     new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV17SDTWorkHourLogItem.gxTpr_Workhourlogduration, out  GXt_char1) ;
                     AV11ExcelDocument.get_Cells(AV14CellRow, (int)(AV15FirstColumn+AV32VisibleColumnCount), 1, 1).Text = GXt_char1;
                  }
                  else if ( StringUtil.StrCmp(AV26ColumnsSelector_Column.gxTpr_Columnname, "SDTWorkHourLog__WorkHourLogDescription") == 0 )
                  {
                     GXt_char1 = "";
                     new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  StringUtil.Substring( AV17SDTWorkHourLogItem.gxTpr_Workhourlogdescription, 1, 1000), out  GXt_char1) ;
                     AV11ExcelDocument.get_Cells(AV14CellRow, (int)(AV15FirstColumn+AV32VisibleColumnCount), 1, 1).Text = GXt_char1;
                  }
                  AV32VisibleColumnCount = (long)(AV32VisibleColumnCount+1);
               }
      ...
      protected void S151( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "SDTWorkHourLog__EmployeeName",  "",  "Employee First Name",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "SDTWorkHourLog__ProjectName",  "",  "Project Name",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "SDTWorkHourLog__WorkHourLogDate",  "",  "Log Date",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "SDTWorkHourLog__WorkHourLogDuration",  "",  "Duration",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "SDTWorkHourLog__WorkHourLogDescription",  "",  "Work Hour Log Description",  true,  "") ;
         GXt_char1 = AV28UserCustomValue;
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "WorkHourLogDetailColumnsSelector", out  GXt_char1) ;
      ...
      protected void S201( )
      {
         ...
         {
            AV21GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "WorkHourLogDetailGridState"), null, "", "");
         }
         else
         {
