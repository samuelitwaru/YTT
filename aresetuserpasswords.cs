...
namespace GeneXus.Programs {
   public class aresetuserpasswords : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A109EmployeeEmail = P00BZ2_A109EmployeeEmail[0];
            A111GAMUserGUID = P00BZ2_A111GAMUserGUID[0];
      ...
      {
         P00BZ2_A109EmployeeEmail = new string[] {""} ;
         P00BZ2_A111GAMUserGUID = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aresetuserpasswords__default(),
            new Object[][] {
                new Object[] {
               P00BZ2_A109EmployeeEmail, P00BZ2_A111GAMUserGUID, P00BZ2_A106EmployeeId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00BZ2_A109EmployeeEmail ;
      private string[] P00BZ2_A111GAMUserGUID ;
   ...
   public class aresetuserpasswords__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00BZ2", "SELECT EmployeeEmail, GAMUserGUID, EmployeeId FROM Employee ORDER BY EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BZ2,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
