...
namespace GeneXus.Programs {
   public class leaverequestlist : GXDataArea
   {
      ...
      protected void RF5X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A144LeaveTypeVacationLeave = H005X2_A144LeaveTypeVacationLeave[0];
               A147EmployeeBalance = H005X2_A147EmployeeBalance[0];
               A106EmployeeId = H005X2_A106EmployeeId[0];
               A134LeaveRequestRejectionReason = H005X2_A134LeaveRequestRejectionReason[0];
               A133LeaveRequestDescription = H005X2_A133LeaveRequestDescription[0];
               A132LeaveRequestStatus = H005X2_A132LeaveRequestStatus[0];
               A131LeaveRequestDuration = H005X2_A131LeaveRequestDuration[0];
               A173LeaveRequestHalfDay = H005X2_A173LeaveRequestHalfDay[0];
               n173LeaveRequestHalfDay = H005X2_n173LeaveRequestHalfDay[0];
               A130LeaveRequestEndDate = H005X2_A130LeaveRequestEndDate[0];
               A129LeaveRequestStartDate = H005X2_A129LeaveRequestStartDate[0];
               A148EmployeeName = H005X2_A148EmployeeName[0];
               A128LeaveRequestDate = H005X2_A128LeaveRequestDate[0];
               A125LeaveTypeName = H005X2_A125LeaveTypeName[0];
               A124LeaveTypeId = H005X2_A124LeaveTypeId[0];
               A127LeaveRequestId = H005X2_A127LeaveRequestId[0];
               A147EmployeeBalance = H005X2_A147EmployeeBalance[0];
               A148EmployeeName = H005X2_A148EmployeeName[0];
               A144LeaveTypeVacationLeave = H005X2_A144LeaveTypeVacationLeave[0];
               A125LeaveTypeName = H005X2_A125LeaveTypeName[0];
      ...
      protected void E115X2( )
      {
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "LeaveRequestListFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV69Pgmname+"GridState",  AV28ManageFiltersXml) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "LeaveRequestListFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item3) ;
      ...
      protected void S132( )
      {
         ...
         {
            AV14GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV69Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S172( )
      {
         ...
         {
            AV15GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV14GridState.gxTpr_Filtervalues.Item(AV85GXV1));
         ...
         GXt_char2 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV31TFLeaveTypeName_Sel)),  AV31TFLeaveTypeName_Sel, out  GXt_char2) ;
         GXt_char4 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV33TFEmployeeName_Sel)),  AV33TFEmployeeName_Sel, out  GXt_char4) ;
         GXt_char5 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV45TFLeaveRequestHalfDay_Sel)),  AV45TFLeaveRequestHalfDay_Sel, out  GXt_char5) ;
         GXt_char6 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV51TFLeaveRequestDescription_Sel)),  AV51TFLeaveRequestDescription_Sel, out  GXt_char6) ;
         Ddo_grid_Selectedvalue_set = GXt_char2+"|"+GXt_char4+"|||"+GXt_char5+"||"+GXt_char6;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char6 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV30TFLeaveTypeName)),  AV30TFLeaveTypeName, out  GXt_char6) ;
         GXt_char5 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV32TFEmployeeName)),  AV32TFEmployeeName, out  GXt_char5) ;
         GXt_char4 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV44TFLeaveRequestHalfDay)),  AV44TFLeaveRequestHalfDay, out  GXt_char4) ;
         GXt_char2 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV50TFLeaveRequestDescription)),  AV50TFLeaveRequestDescription, out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV69Pgmname+"GridState",  AV14GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512281063", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("leaverequestlist.js", "?2024102512281065", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E185X2","iparms":[]}""");
         ...
         setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","""{"handler":"E145X2","iparms":[{"av":"Ddo_agexport_Activeeventkey","ctrl":"DDO_AGEXPORT","prop":"ActiveEventKey"}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV84Leaverequestlistds_15_tfleaverequestdescription_sel = "";
         AV83Leaverequestlistds_14_tfleaverequestdescription = "";
         H005X2_A144LeaveTypeVacationLeave = new string[] {""} ;
         H005X2_A147EmployeeBalance = new decimal[1] ;
         H005X2_A106EmployeeId = new long[1] ;
         H005X2_A134LeaveRequestRejectionReason = new string[] {""} ;
         H005X2_A133LeaveRequestDescription = new string[] {""} ;
         H005X2_A132LeaveRequestStatus = new string[] {""} ;
         H005X2_A131LeaveRequestDuration = new decimal[1] ;
         H005X2_A173LeaveRequestHalfDay = new string[] {""} ;
         H005X2_n173LeaveRequestHalfDay = new bool[] {false} ;
         H005X2_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         H005X2_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         H005X2_A148EmployeeName = new string[] {""} ;
         H005X2_A128LeaveRequestDate = new DateTime[] {DateTime.MinValue} ;
         H005X2_A125LeaveTypeName = new string[] {""} ;
         H005X2_A124LeaveTypeId = new long[1] ;
         H005X2_A127LeaveRequestId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestlist__default(),
            new Object[][] {
                new Object[] {
               H005X2_A144LeaveTypeVacationLeave, H005X2_A147EmployeeBalance, H005X2_A106EmployeeId, H005X2_A134LeaveRequestRejectionReason, H005X2_A133LeaveRequestDescription, H005X2_A132LeaveRequestStatus, H005X2_A131LeaveRequestDuration, H005X2_A173LeaveRequestHalfDay, H005X2_n173LeaveRequestHalfDay, H005X2_A130LeaveRequestEndDate,
               H005X2_A129LeaveRequestStartDate, H005X2_A148EmployeeName, H005X2_A128LeaveRequestDate, H005X2_A125LeaveTypeName, H005X2_A124LeaveTypeId, H005X2_A127LeaveRequestId
               }
               , new Object[] {
      ...
      private string[] H005X2_A144LeaveTypeVacationLeave ;
      private decimal[] H005X2_A147EmployeeBalance ;
      private long[] H005X2_A106EmployeeId ;
      private string[] H005X2_A134LeaveRequestRejectionReason ;
      private string[] H005X2_A133LeaveRequestDescription ;
      private string[] H005X2_A132LeaveRequestStatus ;
      private decimal[] H005X2_A131LeaveRequestDuration ;
      private string[] H005X2_A173LeaveRequestHalfDay ;
      private bool[] H005X2_n173LeaveRequestHalfDay ;
      private DateTime[] H005X2_A130LeaveRequestEndDate ;
      private DateTime[] H005X2_A129LeaveRequestStartDate ;
      private string[] H005X2_A148EmployeeName ;
      private DateTime[] H005X2_A128LeaveRequestDate ;
      private string[] H005X2_A125LeaveTypeName ;
      private long[] H005X2_A124LeaveTypeId ;
      private long[] H005X2_A127LeaveRequestId ;
   ...
   public class leaverequestlist__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             DateTime AV66FromDate )
      {
         ...
         {
            AddWhere(sWhereString, "(( LOWER(T3.LeaveTypeName) like '%' || LOWER(:lV70Leaverequestlistds_1_filterfulltext)) or ( LOWER(T2.EmployeeName) like '%' || LOWER(:lV70Leaverequestlistds_1_filterfulltext)) or ( LOWER(T1.LeaveRequestHalfDay) like '%' || LOWER(:lV70Leaverequestlistds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'90.9'), 2) like '%' || :lV70Leaverequestlistds_1_filterfulltext) or ( LOWER(T1.LeaveRequestDescription) like '%' || LOWER(:lV70Leaverequestlistds_1_filterfulltext)))");
         }
         else
         {
            GXv_int7[2] = 1;
                                             ...
                                             DateTime AV66FromDate )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV70Leaverequestlistds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T2.LeaveTypeName) like '%' || LOWER(:lV70Leaverequestlistds_1_filterfulltext)) or ( LOWER(T3.EmployeeName) like '%' || LOWER(:lV70Leaverequestlistds_1_filterfulltext)) or ( LOWER(T1.LeaveRequestHalfDay) like '%' || LOWER(:lV70Leaverequestlistds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'90.9'), 2) like '%' || :lV70Leaverequestlistds_1_filterfulltext) or ( LOWER(T1.LeaveRequestDescription) like '%' || LOWER(:lV70Leaverequestlistds_1_filterfulltext)))");
         }
         else
         {
            GXv_int9[2] = 1;
