...
namespace GeneXus.Programs.genexusreporting
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.Format.ConditionalStyle" , Namespace="GeneXus.Reporting" )]
	[Serializable]
	public class SdtQueryViewerElements_Element_Format_ConditionalStyle : GxUserType
	{
		...
		protected short gxTv_SdtQueryViewerElements_Element_Format_ConditionalStyle_Operator;
