...
namespace GeneXus.Programs.genexusreporting
{
	...
	[XmlType(TypeName="QueryViewerElements.Element.Grouping" , Namespace="GeneXus.Reporting" )]
	[Serializable]
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"QueryViewerElements.Element.Grouping", Namespace="GeneXus.Reporting")]
