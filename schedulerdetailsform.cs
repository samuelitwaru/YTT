   ...
   public class schedulerdetailsform : GXHttpHandler
   {
      ...
      protected void WB3J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            context.WriteHtmlText( "</p>") ;
            wb_table1_5_3J2( true) ;
         }
         else
         {
            wb_table1_5_3J2( false) ;
         }
         return  ;
      }

      protected void wb_table1_5_3J2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table1_5_3J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_5_3J2e( true) ;
         }
         else
         {
            wb_table1_5_3J2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512262096", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("schedulerdetailsform.js", "?2024102512262096", false, true);
         }
