...
namespace GeneXus.Programs {
   public class aweeklyremindertomanagerug : GXWebProcedure
   {
      ...
      public aweeklyremindertomanagerug( )
      {
      ...
      public aweeklyremindertomanagerug( IGxContext context )
      {
      ...
      void executePrivate( )
      {
         ...
         {
            A157CompanyLocationId = P00AM3_A157CompanyLocationId[0];
            A100CompanyId = P00AM3_A100CompanyId[0];
            A159CompanyLocationCode = P00AM3_A159CompanyLocationCode[0];
            A40000GXC1 = P00AM3_A40000GXC1[0];
            n40000GXC1 = P00AM3_n40000GXC1[0];
            A159CompanyLocationCode = P00AM3_A159CompanyLocationCode[0];
            A40000GXC1 = P00AM3_A40000GXC1[0];
            n40000GXC1 = P00AM3_n40000GXC1[0];
            AV19TotalHour = 0;
            ...
            {
               A106EmployeeId = P00AM4_A106EmployeeId[0];
               A112EmployeeIsActive = P00AM4_A112EmployeeIsActive[0];
               A110EmployeeIsManager = P00AM4_A110EmployeeIsManager[0];
               A107EmployeeFirstName = P00AM4_A107EmployeeFirstName[0];
               A109EmployeeEmail = P00AM4_A109EmployeeEmail[0];
               AV19TotalHour = 0;
               AV20TotalMinute = 0;
               /* Optimized group. */
               /* Using cursor P00AM5 */
               pr_default.execute(2, new Object[] {A106EmployeeId, Gx_date});
               c121WorkHourLogHour = P00AM5_A121WorkHourLogHour[0];
               c122WorkHourLogMinute = P00AM5_A122WorkHourLogMinute[0];
               pr_default.close(2);
      ...
      public override void initialize( )
      {
         ...
         P00AM3_A40000GXC1 = new int[1] ;
         P00AM3_n40000GXC1 = new bool[] {false} ;
         A159CompanyLocationCode = "";
         P00AM4_A100CompanyId = new long[1] ;
         P00AM4_A106EmployeeId = new long[1] ;
         P00AM4_A112EmployeeIsActive = new bool[] {false} ;
         P00AM4_A110EmployeeIsManager = new bool[] {false} ;
         P00AM4_A107EmployeeFirstName = new string[] {""} ;
         P00AM4_A109EmployeeEmail = new string[] {""} ;
         A107EmployeeFirstName = "";
         A109EmployeeEmail = "";
         Gx_date = DateTime.MinValue;
         P00AM5_A121WorkHourLogHour = new short[1] ;
         P00AM5_A122WorkHourLogMinute = new short[1] ;
         AV14name = "";
         AV10email = "";
         AV17Subject = "";
         AV8Body = "";
         AV22HttpRequest = new GxHttpRequest( context);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aweeklyremindertomanagerug__default(),
            new Object[][] {
                new Object[] {
               P00AM3_A157CompanyLocationId, P00AM3_A100CompanyId, P00AM3_A159CompanyLocationCode, P00AM3_A40000GXC1, P00AM3_n40000GXC1
               }
               , new Object[] {
               P00AM4_A100CompanyId, P00AM4_A106EmployeeId, P00AM4_A112EmployeeIsActive, P00AM4_A110EmployeeIsManager, P00AM4_A107EmployeeFirstName, P00AM4_A109EmployeeEmail
               }
               , new Object[] {
               P00AM5_A121WorkHourLogHour, P00AM5_A122WorkHourLogMinute
               }
            }
         );
      ...
      private long[] P00AM3_A157CompanyLocationId ;
      private long[] P00AM3_A100CompanyId ;
      private string[] P00AM3_A159CompanyLocationCode ;
      private int[] P00AM3_A40000GXC1 ;
      private bool[] P00AM3_n40000GXC1 ;
      private long[] P00AM4_A100CompanyId ;
      private long[] P00AM4_A106EmployeeId ;
      private bool[] P00AM4_A112EmployeeIsActive ;
      private bool[] P00AM4_A110EmployeeIsManager ;
      private string[] P00AM4_A107EmployeeFirstName ;
   ...
   public class aweeklyremindertomanagerug__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00AM3", "SELECT T1.CompanyLocationId, T1.CompanyId, T2.CompanyLocationCode, COALESCE( T3.GXC1, 0) AS GXC1 FROM ((Company T1 INNER JOIN CompanyLocation T2 ON T2.CompanyLocationId = T1.CompanyLocationId) LEFT JOIN LATERAL (SELECT COUNT(*) AS GXC1, CompanyId FROM Employee WHERE T1.CompanyId = CompanyId GROUP BY CompanyId ) T3 ON T3.CompanyId = T1.CompanyId) WHERE T2.CompanyLocationCode = ( 'ug') ORDER BY T1.CompanyId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AM3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00AM4", "SELECT CompanyId, EmployeeId, EmployeeIsActive, EmployeeIsManager, EmployeeFirstName, EmployeeEmail FROM Employee WHERE (CompanyId = :CompanyId) AND (EmployeeIsActive = TRUE) ORDER BY CompanyId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AM4,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00AM5", "SELECT SUM(WorkHourLogHour), SUM(WorkHourLogMinute) FROM WorkHourLog WHERE (EmployeeId = :EmployeeId) AND (WorkHourLogDate <= :Gx_date and WorkHourLogDate >= (CAST(:Gx_date AS date) + CAST (( -4) || ' DAY' AS INTERVAL))) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AM5,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
