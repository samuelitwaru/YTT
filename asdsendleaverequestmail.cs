...
namespace GeneXus.Programs {
   public class asdsendleaverequestmail : GXProcedure
   {
      public static int Main( string[] args )
      {
         try
         {
            ...
            return new asdsendleaverequestmail().executeCmdLine(args); ;
         }
         catch ( Exception e )
         {
      ...
      {
         DateTime aP0_LeaveRequestStartDate = new DateTime()  ;
         DateTime aP1_LeaveRequestEndDate = new DateTime()  ;
         string aP2_LeaveRequestDescription = new string(' ',0)  ;
         string aP3_LeaveTypeName = new string(' ',0)  ;
         string aP4_EmployeeName = new string(' ',0)  ;
          long aP5_EmployeeId ;
         if ( 0 < args.Length )
         {
            aP0_LeaveRequestStartDate=((DateTime)(context.localUtil.CToD( (string)(args[0]), 1)));
         }
         else
         {
            aP0_LeaveRequestStartDate=DateTime.MinValue;
         }
         if ( 1 < args.Length )
         {
            aP1_LeaveRequestEndDate=((DateTime)(context.localUtil.CToD( (string)(args[1]), 1)));
         }
         else
         {
            aP1_LeaveRequestEndDate=DateTime.MinValue;
         }
         if ( 2 < args.Length )
         {
            aP2_LeaveRequestDescription=((string)(args[2]));
         }
         else
         {
            aP2_LeaveRequestDescription="";
         }
         if ( 3 < args.Length )
         {
            aP3_LeaveTypeName=((string)(args[3]));
         }
         else
         {
            aP3_LeaveTypeName="";
         ...
         if ( 4 < args.Length )
         {
            aP4_EmployeeName=((string)(args[4]));
         }
         else
         {
            aP4_EmployeeName="";
         ...
         if ( 5 < args.Length )
         {
            aP5_EmployeeId=((long)(NumberUtil.Val( (string)(args[5]), ".")));
         }
         else
         {
            aP5_EmployeeId=0;
         }
         execute(aP0_LeaveRequestStartDate, aP1_LeaveRequestEndDate, aP2_LeaveRequestDescription, aP3_LeaveTypeName, aP4_EmployeeName, aP5_EmployeeId);
      ...
      public asdsendleaverequestmail( )
      {
      ...
      public asdsendleaverequestmail( IGxContext context )
      {
      ...
      public void executeSubmit( DateTime aP0_LeaveRequestStartDate ,
                                 ...
                                 long aP5_EmployeeId )
      {
         asdsendleaverequestmail objasdsendleaverequestmail;
         objasdsendleaverequestmail = new asdsendleaverequestmail();
         objasdsendleaverequestmail.AV16LeaveRequestStartDate = aP0_LeaveRequestStartDate;
         objasdsendleaverequestmail.AV17LeaveRequestEndDate = aP1_LeaveRequestEndDate;
         objasdsendleaverequestmail.AV18LeaveRequestDescription = aP2_LeaveRequestDescription;
         objasdsendleaverequestmail.AV19LeaveTypeName = aP3_LeaveTypeName;
         objasdsendleaverequestmail.AV20EmployeeName = aP4_EmployeeName;
         objasdsendleaverequestmail.AV22EmployeeId = aP5_EmployeeId;
         objasdsendleaverequestmail.context.SetSubmitInitialConfig(context);
         objasdsendleaverequestmail.initialize();
         Submit( executePrivateCatch,objasdsendleaverequestmail);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((asdsendleaverequestmail)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
            GXUtil.SaveToEventLog( "Design", e);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.asdsendleaverequestmail__default(),
            new Object[][] {
                new Object[] {
   ...
   public class asdsendleaverequestmail__default : DataStoreHelperBase, IDataStoreHelper
   {
