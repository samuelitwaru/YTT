   ...
   public class gamroleselect : GXDataArea
   {
      ...
      protected void WB1I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_1I2( true) ;
         }
         else
         {
            wb_table1_14_1I2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_1I2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void wb_table1_14_1I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_19_1I2( true) ;
         }
         else
         {
            wb_table2_19_1I2( false) ;
         }
         return  ;
      }

      protected void wb_table2_19_1I2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_14_1I2e( true) ;
         }
         else
         {
            wb_table1_14_1I2e( false) ;
         }
      }

      protected void wb_table2_19_1I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_19_1I2e( true) ;
         }
         else
         {
            wb_table2_19_1I2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202443019141785", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamroleselect.js", "?202443019141787", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E171I2',iparms:[{av:'AV21RoleIdAux',fld:'vROLEIDAUX',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'AV10FilExternalId',fld:'vFILEXTERNALID',pic:''}]");
         ...
         setEventMetadata("'DOADD'","{handler:'E141I2',iparms:[{av:'AV21RoleIdAux',fld:'vROLEIDAUX',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV22Select',fld:'vSELECT',grid:38,pic:''},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_38',ctrl:'GRID',grid:38,prop:'GridRC',grid:38},{av:'AV15Id',fld:'vID',grid:38,pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV16isOK',fld:'vISOK',pic:''}]");
