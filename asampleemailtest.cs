...
namespace GeneXus.Programs {
   public class asampleemailtest : GXWebProcedure
   {
      ...
      public asampleemailtest( IGxContext context )
      {
      ...
      {
         asampleemailtest objasampleemailtest;
         objasampleemailtest = new asampleemailtest();
         objasampleemailtest.context.SetSubmitInitialConfig(context);
         objasampleemailtest.initialize();
         Submit( executePrivateCatch,objasampleemailtest);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((asampleemailtest)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            AV10MailRecipient.Address = "samuel.itwaru@yukon.ug";
            AV10MailRecipient.Name = "Samuel";
            AV9MailMessage.Subject = "Test email";
            AV9MailMessage.HTMLText = "Testing email from genexus";
            AV9MailMessage.To.Add(AV10MailRecipient);
            AV8SMTPSession.Login();
            if ( AV8SMTPSession.ErrCode == 0 )
            {
               AV8SMTPSession.Send(AV9MailMessage);
               HAG0( false, 100) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText("Text", 317, Gx_line+33, 428, Gx_line+66, 0, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
      ...
      protected void HAG0( bool bFoot ,
                           int Inc )
      {
