...
namespace GeneXus.Programs {
   public class getemployeetologhoursprojects : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( ( AV11FormWorkHourLogEmployeeId == AV8EmployeeId ) || ( AV9IsManager ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A103ProjectName = P00C92_A103ProjectName[0];
               A104ProjectDescription = P00C92_A104ProjectDescription[0];
               A105ProjectStatus = P00C92_A105ProjectStatus[0];
               A103ProjectName = P00C92_A103ProjectName[0];
               A104ProjectDescription = P00C92_A104ProjectDescription[0];
            ...
            while ( AV19GXV1 <= AV16Employees.Count )
            {
               ...
               if ( AV17Employee == AV8EmployeeId )
               {
                  ...
                  while ( (pr_default.getStatus(1) != 101) )
                  {
                     ...
                     A103ProjectName = P00C93_A103ProjectName[0];
                     A104ProjectDescription = P00C93_A104ProjectDescription[0];
                     A105ProjectStatus = P00C93_A105ProjectStatus[0];
                     A103ProjectName = P00C93_A103ProjectName[0];
                     A104ProjectDescription = P00C93_A104ProjectDescription[0];
                     AV12SDTEmployeeProjectItem = new SdtSDTEmployeeProject_SDTEmployeeProjectItem(context);
      ...
      public override void initialize( )
      {
         ...
         P00C92_A103ProjectName = new string[] {""} ;
         P00C92_A104ProjectDescription = new string[] {""} ;
         A105ProjectStatus = "";
         A103ProjectName = "";
         ...
         P00C93_A103ProjectName = new string[] {""} ;
         P00C93_A104ProjectDescription = new string[] {""} ;
      ...
      private string[] P00C92_A103ProjectName ;
      private string[] P00C92_A104ProjectDescription ;
      ...
      private string[] P00C93_A103ProjectName ;
      private string[] P00C93_A104ProjectDescription ;
   ...
   {
      protected Object[] conditional_P00C93( IGxContext context ,
                                             long A102ProjectId ,
