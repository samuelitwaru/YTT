...
namespace GeneXus.Programs {
   public class gamauthenticationtypeentry : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202462821123840", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamauthenticationtypeentry.js", "?202462821123840", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VTYPEID.CLICK","{handler:'E11171',iparms:[{av:'cmbavTypeid'},{av:'AV6TypeId',fld:'vTYPEID',pic:''},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV5Name',fld:'vNAME',pic:'',hsh:true}]");
