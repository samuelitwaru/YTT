...
namespace GeneXus.Programs {
   public class employeeww : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512263796", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("employeeww.js", "?2024102512263799", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public class employeeww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long AV87Udparg3 )
      {
         ...
         {
            AddWhere(sWhereString, "(( LOWER(T1.EmployeeName) like '%' || LOWER(:lV89Employeewwds_4_filterfulltext)) or ( LOWER(T1.EmployeeEmail) like '%' || LOWER(:lV89Employeewwds_4_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.EmployeeVactionDays,'90.9'), 2) like '%' || :lV89Employeewwds_4_filterfulltext) or ( SUBSTR(TO_CHAR(T1.EmployeeBalance,'90.9'), 2) like '%' || :lV89Employeewwds_4_filterfulltext))");
         }
         else
         {
            GXv_int9[3] = 1;
