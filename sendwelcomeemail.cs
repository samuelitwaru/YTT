   ...
   public class sendwelcomeemail : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(AV18Repository.gxTpr_Useractivationmethod, "U") == 0 )
         {
            ...
            AV13SMTPSession.Host = "smtp.gmail.com";
            AV13SMTPSession.Port = 587;
            AV13SMTPSession.Authentication = 1;
            AV13SMTPSession.AuthenticationMethod = "STARTTLS";
            AV13SMTPSession.UserName = "markbrightbaraka22@gmail.com";
            AV13SMTPSession.Password = "fpmizvkxpbhaclfl";
            AV13SMTPSession.Secure = 1;
            AV13SMTPSession.Sender.Address = "markbrightbaraka@gmail.com";
