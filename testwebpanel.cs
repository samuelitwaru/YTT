...
namespace GeneXus.Programs {
   public class testwebpanel : GXWebComponent
   {
      ...
      {
         this.AV5WorkHourLog = aP0_WorkHourLog;
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  ajax_req_read_hidden_sdt(GetNextPar( ), AV5WorkHourLog);
                  AV36EmployeeName = GetPar( "EmployeeName");
                  AssignAttri(sPrefix, false, "AV36EmployeeName", AV36EmployeeName);
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(GXBaseCollection<SdtSDTEmployeeWorkHourLogs_WorkHourLogItem>)AV5WorkHourLog,(string)AV36EmployeeName});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Test Web Panel") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vWORKHOURLOG", AV5WorkHourLog);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vWORKHOURLOG", AV5WorkHourLog);
         }
      ...
      protected void START4S2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Test Web Panel", 0) ;
            context.wjLoc = "";
      ...
      protected void E134S2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV16SDTEmployeeWorkHourLogs.gxTpr_Workhourlog = AV5WorkHourLog;
      ...
      protected void E144S2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV42Pgmname, out  GXt_char1) ;
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV5WorkHourLog = (GXBaseCollection<SdtSDTEmployeeWorkHourLogs_WorkHourLogItem>)getParm(obj,0);
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV5WorkHourLog = (string)((string)getParm(obj,0));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            AV5WorkHourLog = (GXBaseCollection<SdtSDTEmployeeWorkHourLogs_WorkHourLogItem>)getParm(obj,2);
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV5WorkHourLog = cgiGet( sPrefix+"AV5WorkHourLog_CTRL");
         if ( StringUtil.Len( sCtrlAV5WorkHourLog) > 0 )
         {
            AV5WorkHourLog = new GXBaseCollection<SdtSDTEmployeeWorkHourLogs_WorkHourLogItem>();
         }
         else
         {
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"AV5WorkHourLog_PARM"), AV5WorkHourLog);
         }
      ...
      protected void WCParametersSet( )
      {
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"AV5WorkHourLog_PARM", AV5WorkHourLog);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"AV5WorkHourLog_PARM", AV5WorkHourLog);
         }
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV5WorkHourLog)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV5WorkHourLog_CTRL", StringUtil.RTrim( sCtrlAV5WorkHourLog));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202471517102915", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("testwebpanel.js", "?202471517102915", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV16SDTEmployeeWorkHourLogs',fld:'vSDTEMPLOYEEWORKHOURLOGS',pic:''},{av:'nRC_GXsfl_18',ctrl:'GRID',prop:'GridRC',grid:18},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV29GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV30GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV31GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E114S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV16SDTEmployeeWorkHourLogs',fld:'vSDTEMPLOYEEWORKHOURLOGS',pic:''},{av:'nRC_GXsfl_18',ctrl:'GRID',prop:'GridRC',grid:18},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E124S2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV16SDTEmployeeWorkHourLogs',fld:'vSDTEMPLOYEEWORKHOURLOGS',pic:''},{av:'nRC_GXsfl_18',ctrl:'GRID',prop:'GridRC',grid:18},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E154S2',iparms:[]");
      ...
      {
         AV5WorkHourLog = new GXBaseCollection<SdtSDTEmployeeWorkHourLogs_WorkHourLogItem>( context, "SDTEmployeeWorkHourLogs.WorkHourLogItem", "YTT_version4");
      ...
      private string sCtrlAV5WorkHourLog ;
      ...
      private GXBaseCollection<SdtSDTEmployeeWorkHourLogs_WorkHourLogItem> AV5WorkHourLog ;
