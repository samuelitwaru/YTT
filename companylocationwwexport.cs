...
namespace GeneXus.Programs {
   public class companylocationwwexport : GXProcedure
   {
      ...
      public void executeSubmit( out string aP0_Filename ,
                                 out string aP1_ErrorMessage )
      {
         companylocationwwexport objcompanylocationwwexport;
         objcompanylocationwwexport = new companylocationwwexport();
         objcompanylocationwwexport.AV12Filename = "" ;
         objcompanylocationwwexport.AV13ErrorMessage = "" ;
         objcompanylocationwwexport.context.SetSubmitInitialConfig(context);
         objcompanylocationwwexport.initialize();
         Submit( executePrivateCatch,objcompanylocationwwexport);
         aP0_Filename=this.AV12Filename;
         aP1_ErrorMessage=this.AV13ErrorMessage;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((companylocationwwexport)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S131( )
      {
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Country") ;
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV38TFCompanyLocationName_Sel)) ? "(Empty)" : AV38TFCompanyLocationName_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV37TFCompanyLocationName)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV37TFCompanyLocationName, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Country Code") ;
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV40TFCompanyLocationCode_Sel)) ? "(Empty)" : AV40TFCompanyLocationCode_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV39TFCompanyLocationCode)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV39TFCompanyLocationCode, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
      ...
      protected void S161( )
      {
         ...
         AV49Udparg6 = new getloggedinusercompanyid(context).executeUdp( );
         AV49Udparg6 = new getloggedinusercompanyid(context).executeUdp( );
         AV49Udparg6 = new getloggedinusercompanyid(context).executeUdp( );
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              AV49Udparg6 } ,
                                              new int[]{
                                              TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.LONG
                                              }
         });
         ...
         {
            A159CompanyLocationCode = P00922_A159CompanyLocationCode[0];
            A158CompanyLocationName = P00922_A158CompanyLocationName[0];
            A157CompanyLocationId = P00922_A157CompanyLocationId[0];
            ...
            while ( AV50GXV2 <= AV24ColumnsSelector.gxTpr_Columns.Count )
            {
               ...
               if ( AV26ColumnsSelector_Column.gxTpr_Isvisible )
               {
                  ...
                  {
                     GXt_char1 = "";
                     new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  A158CompanyLocationName, out  GXt_char1) ;
                  ...
                  {
                     GXt_char1 = "";
                     new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  A159CompanyLocationCode, out  GXt_char1) ;
                     AV11ExcelDocument.get_Cells(AV14CellRow, (int)(AV15FirstColumn+AV32VisibleColumnCount), 1, 1).Text = GXt_char1;
                  }
                  AV32VisibleColumnCount = (long)(AV32VisibleColumnCount+1);
               }
      ...
      protected void S151( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "CompanyLocationName",  "",  "Country",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "CompanyLocationCode",  "",  "Country Code",  true,  "") ;
         GXt_char1 = AV28UserCustomValue;
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "CompanyLocationWWColumnsSelector", out  GXt_char1) ;
      ...
      protected void S201( )
      {
         ...
         {
            AV22GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "CompanyLocationWWGridState"), null, "", "");
         }
         else
         {
      ...
      public override void initialize( )
      {
         ...
         A158CompanyLocationName = "";
         A159CompanyLocationCode = "";
         P00922_A159CompanyLocationCode = new string[] {""} ;
         P00922_A158CompanyLocationName = new string[] {""} ;
         P00922_A157CompanyLocationId = new long[1] ;
         AV28UserCustomValue = "";
         GXt_char1 = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.companylocationwwexport__default(),
            new Object[][] {
                new Object[] {
               P00922_A159CompanyLocationCode, P00922_A158CompanyLocationName, P00922_A157CompanyLocationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00922_A159CompanyLocationCode ;
      private string[] P00922_A158CompanyLocationName ;
      private long[] P00922_A157CompanyLocationId ;
   ...
   public class companylocationwwexport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long AV49Udparg6 )
      {
         ...
         {
            AddWhere(sWhereString, "(LOWER(CompanyLocationName) like LOWER(:lV45Companylocationwwds_2_tfcompanylocationname))");
         }
         else
         {
            GXv_int3[2] = 1;
         ...
         {
            AddWhere(sWhereString, "(LOWER(CompanyLocationCode) like LOWER(:lV47Companylocationwwds_4_tfcompanylocationcode))");
         }
         else
         {
            GXv_int3[4] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00922(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (bool)dynConstraints[8] , (long)dynConstraints[10] );
         }
