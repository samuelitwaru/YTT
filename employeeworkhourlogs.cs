...
namespace GeneXus.Programs {
   public class employeeworkhourlogs : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         {
            BRK1A2 = false;
            A100CompanyId = P001A2_A100CompanyId[0];
            A148EmployeeName = P001A2_A148EmployeeName[0];
            A118WorkHourLogId = P001A2_A118WorkHourLogId[0];
            A119WorkHourLogDate = P001A2_A119WorkHourLogDate[0];
            A120WorkHourLogDuration = P001A2_A120WorkHourLogDuration[0];
            A121WorkHourLogHour = P001A2_A121WorkHourLogHour[0];
            A122WorkHourLogMinute = P001A2_A122WorkHourLogMinute[0];
            A123WorkHourLogDescription = P001A2_A123WorkHourLogDescription[0];
            A106EmployeeId = P001A2_A106EmployeeId[0];
            A107EmployeeFirstName = P001A2_A107EmployeeFirstName[0];
            A102ProjectId = P001A2_A102ProjectId[0];
            A103ProjectName = P001A2_A103ProjectName[0];
            A157CompanyLocationId = P001A2_A157CompanyLocationId[0];
            A100CompanyId = P001A2_A100CompanyId[0];
            A148EmployeeName = P001A2_A148EmployeeName[0];
            A107EmployeeFirstName = P001A2_A107EmployeeFirstName[0];
            A157CompanyLocationId = P001A2_A157CompanyLocationId[0];
            ...
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P001A2_A148EmployeeName[0], A148EmployeeName) == 0 ) )
            {
               BRK1A2 = false;
               A118WorkHourLogId = P001A2_A118WorkHourLogId[0];
               A119WorkHourLogDate = P001A2_A119WorkHourLogDate[0];
      ...
      public override void initialize( )
      {
         ...
         P001A2_A118WorkHourLogId = new long[1] ;
         P001A2_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P001A2_A120WorkHourLogDuration = new string[] {""} ;
         P001A2_A121WorkHourLogHour = new short[1] ;
         P001A2_A122WorkHourLogMinute = new short[1] ;
         P001A2_A123WorkHourLogDescription = new string[] {""} ;
         P001A2_A106EmployeeId = new long[1] ;
         P001A2_A107EmployeeFirstName = new string[] {""} ;
         P001A2_A102ProjectId = new long[1] ;
         P001A2_A103ProjectName = new string[] {""} ;
         P001A2_A157CompanyLocationId = new long[1] ;
         A148EmployeeName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.employeeworkhourlogs__default(),
            new Object[][] {
                new Object[] {
               P001A2_A100CompanyId, P001A2_A148EmployeeName, P001A2_A118WorkHourLogId, P001A2_A119WorkHourLogDate, P001A2_A120WorkHourLogDuration, P001A2_A121WorkHourLogHour, P001A2_A122WorkHourLogMinute, P001A2_A123WorkHourLogDescription, P001A2_A106EmployeeId, P001A2_A107EmployeeFirstName,
               P001A2_A102ProjectId, P001A2_A103ProjectName, P001A2_A157CompanyLocationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P001A2_A118WorkHourLogId ;
      private DateTime[] P001A2_A119WorkHourLogDate ;
      private string[] P001A2_A120WorkHourLogDuration ;
      private short[] P001A2_A121WorkHourLogHour ;
      private short[] P001A2_A122WorkHourLogMinute ;
      private string[] P001A2_A123WorkHourLogDescription ;
      private long[] P001A2_A106EmployeeId ;
      private string[] P001A2_A107EmployeeFirstName ;
   ...
   {
      protected Object[] conditional_P001A2( IGxContext context ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P001A2(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (long)dynConstraints[2] , (GxSimpleCollection<long>)dynConstraints[3] , (long)dynConstraints[4] , (GxSimpleCollection<long>)dynConstraints[5] , (int)dynConstraints[6] , (int)dynConstraints[7] , (int)dynConstraints[8] , (DateTime)dynConstraints[9] , (DateTime)dynConstraints[10] , (DateTime)dynConstraints[11] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P001A2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP001A2,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
