...
namespace GeneXus.Programs {
   public class leavetypeleaverequestwc : GXWebComponent
   {
      public leavetypeleaverequestwc( )
      {
      ...
      public leavetypeleaverequestwc( IGxContext context )
      {
      ...
      {
         this.AV8LeaveTypeId = aP0_LeaveTypeId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "AV8LeaveTypeId", StringUtil.LTrimStr( (decimal)(AV8LeaveTypeId), 10, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV8LeaveTypeId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV8LeaveTypeId, AV20ManageFiltersExecutionStep, AV32Pgmname, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV32Pgmname = "LeaveTypeLeaveRequestWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Leave Type Leave Request WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("leavetypeleaverequestwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8LeaveTypeId,10,0))}, new string[] {"LeaveTypeId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8LeaveTypeId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8LeaveTypeId), 10, 0, ".", "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vLEAVETYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8LeaveTypeId), 10, 0, ".", "")));
      ...
      {
         return "LeaveTypeLeaveRequestWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Leave Type Leave Request WC" ;
      }
      ...
      protected void WB2R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "leavetypeleaverequestwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(35), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_LeaveTypeLeaveRequestWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START2R2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Leave Type Leave Request WC", 0) ;
            context.wjLoc = "";
      ...
      protected void RF2R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8LeaveTypeId } ,
                                                 new int[]{
                                                 TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.DECIMAL, TypeConstants.LONG, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.LONG
                                                 }
            });
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H002R2 */
            pr_default.execute(0, new Object[] {AV8LeaveTypeId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A124LeaveTypeId = H002R2_A124LeaveTypeId[0];
               AssignAttri(sPrefix, false, "A124LeaveTypeId", StringUtil.LTrimStr( (decimal)(A124LeaveTypeId), 10, 0));
               A106EmployeeId = H002R2_A106EmployeeId[0];
               A134LeaveRequestRejectionReason = H002R2_A134LeaveRequestRejectionReason[0];
               A133LeaveRequestDescription = H002R2_A133LeaveRequestDescription[0];
               A132LeaveRequestStatus = H002R2_A132LeaveRequestStatus[0];
               A131LeaveRequestDuration = H002R2_A131LeaveRequestDuration[0];
               A173LeaveRequestHalfDay = H002R2_A173LeaveRequestHalfDay[0];
               n173LeaveRequestHalfDay = H002R2_n173LeaveRequestHalfDay[0];
               A130LeaveRequestEndDate = H002R2_A130LeaveRequestEndDate[0];
               A129LeaveRequestStartDate = H002R2_A129LeaveRequestStartDate[0];
               A128LeaveRequestDate = H002R2_A128LeaveRequestDate[0];
               A127LeaveRequestId = H002R2_A127LeaveRequestId[0];
               /* Execute user event: Grid.Load */
               E182R2 ();
      ...
      protected void send_integrity_lvl_hashes2R2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_LEAVEREQUESTID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, context.localUtil.Format( (decimal)(A127LeaveRequestId), "ZZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H002R3 */
         pr_default.execute(1, new Object[] {AV8LeaveTypeId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void STRUP2R0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8LeaveTypeId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8LeaveTypeId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E112R2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("LeaveTypeLeaveRequestWCFilters")),UrlEncode(StringUtil.RTrim(AV32Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("LeaveTypeLeaveRequestWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "LeaveTypeLeaveRequestWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "LeaveTypeLeaveRequestWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "LeaveRequest";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "LeaveTypeId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8LeaveTypeId), 10, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8LeaveTypeId = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8LeaveTypeId", StringUtil.LTrimStr( (decimal)(AV8LeaveTypeId), 10, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8LeaveTypeId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "leavetypeleaverequestwc", GetJustCreated( ));
         ...
         {
            AV8LeaveTypeId = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8LeaveTypeId", StringUtil.LTrimStr( (decimal)(AV8LeaveTypeId), 10, 0));
         }
         wcpOAV8LeaveTypeId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8LeaveTypeId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8LeaveTypeId != wcpOAV8LeaveTypeId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8LeaveTypeId = AV8LeaveTypeId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8LeaveTypeId = cgiGet( sPrefix+"AV8LeaveTypeId_CTRL");
         if ( StringUtil.Len( sCtrlAV8LeaveTypeId) > 0 )
         {
            AV8LeaveTypeId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8LeaveTypeId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8LeaveTypeId", StringUtil.LTrimStr( (decimal)(AV8LeaveTypeId), 10, 0));
         }
         else
         {
            AV8LeaveTypeId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8LeaveTypeId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8LeaveTypeId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8LeaveTypeId), 10, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8LeaveTypeId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8LeaveTypeId_CTRL", StringUtil.RTrim( sCtrlAV8LeaveTypeId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512194672", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("leavetypeleaverequestwc.js", "?2024102512194672", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtLeaveRequestId_Internalname = sPrefix+"LEAVEREQUESTID_"+sGXsfl_35_idx;
         edtLeaveRequestDate_Internalname = sPrefix+"LEAVEREQUESTDATE_"+sGXsfl_35_idx;
         edtLeaveRequestStartDate_Internalname = sPrefix+"LEAVEREQUESTSTARTDATE_"+sGXsfl_35_idx;
         edtLeaveRequestEndDate_Internalname = sPrefix+"LEAVEREQUESTENDDATE_"+sGXsfl_35_idx;
         edtLeaveRequestHalfDay_Internalname = sPrefix+"LEAVEREQUESTHALFDAY_"+sGXsfl_35_idx;
         edtLeaveRequestDuration_Internalname = sPrefix+"LEAVEREQUESTDURATION_"+sGXsfl_35_idx;
         cmbLeaveRequestStatus_Internalname = sPrefix+"LEAVEREQUESTSTATUS_"+sGXsfl_35_idx;
         edtLeaveRequestDescription_Internalname = sPrefix+"LEAVEREQUESTDESCRIPTION_"+sGXsfl_35_idx;
         edtLeaveRequestRejectionReason_Internalname = sPrefix+"LEAVEREQUESTREJECTIONREASON_"+sGXsfl_35_idx;
         edtEmployeeId_Internalname = sPrefix+"EMPLOYEEID_"+sGXsfl_35_idx;
      }
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtLeaveRequestId_Internalname = sPrefix+"LEAVEREQUESTID_"+sGXsfl_35_fel_idx;
         edtLeaveRequestDate_Internalname = sPrefix+"LEAVEREQUESTDATE_"+sGXsfl_35_fel_idx;
         edtLeaveRequestStartDate_Internalname = sPrefix+"LEAVEREQUESTSTARTDATE_"+sGXsfl_35_fel_idx;
         edtLeaveRequestEndDate_Internalname = sPrefix+"LEAVEREQUESTENDDATE_"+sGXsfl_35_fel_idx;
         edtLeaveRequestHalfDay_Internalname = sPrefix+"LEAVEREQUESTHALFDAY_"+sGXsfl_35_fel_idx;
         edtLeaveRequestDuration_Internalname = sPrefix+"LEAVEREQUESTDURATION_"+sGXsfl_35_fel_idx;
         cmbLeaveRequestStatus_Internalname = sPrefix+"LEAVEREQUESTSTATUS_"+sGXsfl_35_fel_idx;
         edtLeaveRequestDescription_Internalname = sPrefix+"LEAVEREQUESTDESCRIPTION_"+sGXsfl_35_fel_idx;
         edtLeaveRequestRejectionReason_Internalname = sPrefix+"LEAVEREQUESTREJECTIONREASON_"+sGXsfl_35_fel_idx;
         edtEmployeeId_Internalname = sPrefix+"EMPLOYEEID_"+sGXsfl_35_fel_idx;
      }
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            AssignProp(sPrefix, false, cmbLeaveRequestStatus_Internalname, "Values", (string)(cmbLeaveRequestStatus.ToJavascriptSource()), !bGXsfl_35_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:LeaveRequestId|3:LeaveRequestDate|4:LeaveRequestStartDate|5:LeaveRequestEndDate|6:LeaveRequestHalfDay|7:LeaveRequestDuration|8:LeaveRequestStatus|9:LeaveRequestDescription|10:LeaveRequestRejectionReason|11:EmployeeId";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV8LeaveTypeId","fld":"vLEAVETYPEID","pic":"ZZZZZZZZZ9"},{"av":"sPrefix"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV32Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV30IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E122R2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8LeaveTypeId","fld":"vLEAVETYPEID","pic":"ZZZZZZZZZ9"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV32Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV30IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E132R2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8LeaveTypeId","fld":"vLEAVETYPEID","pic":"ZZZZZZZZZ9"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV32Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV30IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E142R2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8LeaveTypeId","fld":"vLEAVETYPEID","pic":"ZZZZZZZZZ9"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV32Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV30IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E182R2","iparms":[{"av":"AV28IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A127LeaveRequestId","fld":"LEAVEREQUESTID","pic":"ZZZZZZZZZ9","hsh":true},{"av":"AV30IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E112R2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8LeaveTypeId","fld":"vLEAVETYPEID","pic":"ZZZZZZZZZ9"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV32Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV30IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E152R2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8LeaveTypeId","fld":"vLEAVETYPEID","pic":"ZZZZZZZZZ9"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV32Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV30IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A127LeaveRequestId","fld":"LEAVEREQUESTID","pic":"ZZZZZZZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         A134LeaveRequestRejectionReason = "";
         lV16FilterFullText = "";
         H002R2_A124LeaveTypeId = new long[1] ;
         H002R2_A106EmployeeId = new long[1] ;
         H002R2_A134LeaveRequestRejectionReason = new string[] {""} ;
         H002R2_A133LeaveRequestDescription = new string[] {""} ;
         H002R2_A132LeaveRequestStatus = new string[] {""} ;
         H002R2_A131LeaveRequestDuration = new decimal[1] ;
         H002R2_A173LeaveRequestHalfDay = new string[] {""} ;
         H002R2_n173LeaveRequestHalfDay = new bool[] {false} ;
         H002R2_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         H002R2_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         H002R2_A128LeaveRequestDate = new DateTime[] {DateTime.MinValue} ;
         H002R2_A127LeaveRequestId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leavetypeleaverequestwc__default(),
            new Object[][] {
                new Object[] {
               H002R2_A124LeaveTypeId, H002R2_A106EmployeeId, H002R2_A134LeaveRequestRejectionReason, H002R2_A133LeaveRequestDescription, H002R2_A132LeaveRequestStatus, H002R2_A131LeaveRequestDuration, H002R2_A173LeaveRequestHalfDay, H002R2_n173LeaveRequestHalfDay, H002R2_A130LeaveRequestEndDate, H002R2_A129LeaveRequestStartDate,
               H002R2_A128LeaveRequestDate, H002R2_A127LeaveRequestId
               }
               , new Object[] {
      ...
      private long wcpOAV8LeaveTypeId ;
      ...
      private string sCtrlAV8LeaveTypeId ;
      ...
      private long[] H002R2_A124LeaveTypeId ;
      private long[] H002R2_A106EmployeeId ;
      private string[] H002R2_A134LeaveRequestRejectionReason ;
      private string[] H002R2_A133LeaveRequestDescription ;
      private string[] H002R2_A132LeaveRequestStatus ;
      private decimal[] H002R2_A131LeaveRequestDuration ;
      private string[] H002R2_A173LeaveRequestHalfDay ;
      private bool[] H002R2_n173LeaveRequestHalfDay ;
      private DateTime[] H002R2_A130LeaveRequestEndDate ;
      private DateTime[] H002R2_A129LeaveRequestStartDate ;
      private DateTime[] H002R2_A128LeaveRequestDate ;
      private long[] H002R2_A127LeaveRequestId ;
   ...
   public class leavetypeleaverequestwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long AV8LeaveTypeId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " LeaveTypeId, EmployeeId, LeaveRequestRejectionReason, LeaveRequestDescription, LeaveRequestStatus, LeaveRequestDuration, LeaveRequestHalfDay, LeaveRequestEndDate, LeaveRequestStartDate, LeaveRequestDate, LeaveRequestId";
         sFromString = " FROM LeaveRequest";
         sOrderString = "";
         AddWhere(sWhereString, "(LeaveTypeId = :AV8LeaveTypeId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(LeaveRequestId,'9999999999'), 2) like '%' || :lV16FilterFullText) or ( LOWER(LeaveRequestHalfDay) like '%' || LOWER(:lV16FilterFullText)) or ( SUBSTR(TO_CHAR(LeaveRequestDuration,'90.9'), 2) like '%' || :lV16FilterFullText) or ( 'pending' like '%' || LOWER(:lV16FilterFullText) and LeaveRequestStatus = ( 'Pending')) or ( 'approved' like '%' || LOWER(:lV16FilterFullText) and LeaveRequestStatus = ( 'Approved')) or ( 'rejected' like '%' || LOWER(:lV16FilterFullText) and LeaveRequestStatus = ( 'Rejected')) or ( LOWER(LeaveRequestDescription) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(LeaveRequestRejectionReason) like '%' || LOWER(:lV16FilterFullText)) or ( SUBSTR(TO_CHAR(EmployeeId,'9999999999'), 2) like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY LeaveTypeId, LeaveRequestDate, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY LeaveTypeId DESC, LeaveRequestDate DESC, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY LeaveTypeId, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY LeaveTypeId DESC, LeaveRequestId DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY LeaveTypeId, LeaveRequestStartDate, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY LeaveTypeId DESC, LeaveRequestStartDate DESC, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY LeaveTypeId, LeaveRequestEndDate, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY LeaveTypeId DESC, LeaveRequestEndDate DESC, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY LeaveTypeId, LeaveRequestHalfDay, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY LeaveTypeId DESC, LeaveRequestHalfDay DESC, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY LeaveTypeId, LeaveRequestDuration, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY LeaveTypeId DESC, LeaveRequestDuration DESC, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY LeaveTypeId, LeaveRequestStatus, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY LeaveTypeId DESC, LeaveRequestStatus DESC, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY LeaveTypeId, LeaveRequestDescription, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY LeaveTypeId DESC, LeaveRequestDescription DESC, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY LeaveTypeId, LeaveRequestRejectionReason, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY LeaveTypeId DESC, LeaveRequestRejectionReason DESC, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY LeaveTypeId, EmployeeId, LeaveRequestId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY LeaveTypeId DESC, EmployeeId DESC, LeaveRequestId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY LeaveRequestId";
         }
                                             ...
                                             long AV8LeaveTypeId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM LeaveRequest";
         AddWhere(sWhereString, "(LeaveTypeId = :AV8LeaveTypeId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(LeaveRequestId,'9999999999'), 2) like '%' || :lV16FilterFullText) or ( LOWER(LeaveRequestHalfDay) like '%' || LOWER(:lV16FilterFullText)) or ( SUBSTR(TO_CHAR(LeaveRequestDuration,'90.9'), 2) like '%' || :lV16FilterFullText) or ( 'pending' like '%' || LOWER(:lV16FilterFullText) and LeaveRequestStatus = ( 'Pending')) or ( 'approved' like '%' || LOWER(:lV16FilterFullText) and LeaveRequestStatus = ( 'Approved')) or ( 'rejected' like '%' || LOWER(:lV16FilterFullText) and LeaveRequestStatus = ( 'Rejected')) or ( LOWER(LeaveRequestDescription) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(LeaveRequestRejectionReason) like '%' || LOWER(:lV16FilterFullText)) or ( SUBSTR(TO_CHAR(EmployeeId,'9999999999'), 2) like '%' || :lV16FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002R2(context, (string)dynConstraints[0] , (long)dynConstraints[1] , (string)dynConstraints[2] , (decimal)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (long)dynConstraints[7] , (short)dynConstraints[8] , (bool)dynConstraints[9] , (long)dynConstraints[10] , (long)dynConstraints[11] );
               case 1 :
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8LeaveTypeId",GXType.Int64,10,0) ,
