...
namespace GeneXus.Programs {
   public class sendleaveupdatetmail : GXProcedure
   {
      ...
      {
         sendleaveupdatetmail objsendleaveupdatetmail;
         objsendleaveupdatetmail = new sendleaveupdatetmail();
         objsendleaveupdatetmail.AV12LeaveRequestId = aP0_LeaveRequestId;
         objsendleaveupdatetmail.context.SetSubmitInitialConfig(context);
         objsendleaveupdatetmail.initialize();
         Submit( executePrivateCatch,objsendleaveupdatetmail);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((sendleaveupdatetmail)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         {
            A112EmployeeIsActive = P008Y2_A112EmployeeIsActive[0];
            A110EmployeeIsManager = P008Y2_A110EmployeeIsManager[0];
            A100CompanyId = P008Y2_A100CompanyId[0];
            A109EmployeeEmail = P008Y2_A109EmployeeEmail[0];
            A106EmployeeId = P008Y2_A106EmployeeId[0];
            AV13ManagerEmail = A109EmployeeEmail;
            pr_default.readNext(0);
         }
         pr_default.close(0);
         AV15Subject = StringUtil.Upper( AV10LeaveRequest.gxTpr_Leavetypename) + " REQUEST UPDATE";
         AV11Body = "<p>Dear Manager, </p>" + "<p>This is to inform you that <b>" + AV8Employee.gxTpr_Employeename + "</b> has updated a leave request as below: </p>" + "<p>Start Date: <b>" + context.localUtil.DToC( AV10LeaveRequest.gxTpr_Leaverequeststartdate, 1, "/") + "</b></p>" + "<p>End Date: <b>" + context.localUtil.DToC( AV10LeaveRequest.gxTpr_Leaverequestenddate, 1, "/") + "</b></p>" + "<p>Reason for Leave Request: <b>" + AV10LeaveRequest.gxTpr_Leaverequestdescription + "</b></p>";
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         P008Y2_A112EmployeeIsActive = new bool[] {false} ;
         P008Y2_A110EmployeeIsManager = new bool[] {false} ;
         P008Y2_A100CompanyId = new long[1] ;
         P008Y2_A109EmployeeEmail = new string[] {""} ;
         P008Y2_A106EmployeeId = new long[1] ;
         A109EmployeeEmail = "";
         AV13ManagerEmail = "";
         AV15Subject = "";
         AV11Body = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sendleaveupdatetmail__default(),
            new Object[][] {
                new Object[] {
               P008Y2_A112EmployeeIsActive, P008Y2_A110EmployeeIsManager, P008Y2_A100CompanyId, P008Y2_A109EmployeeEmail, P008Y2_A106EmployeeId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] P008Y2_A112EmployeeIsActive ;
      private bool[] P008Y2_A110EmployeeIsManager ;
      private long[] P008Y2_A100CompanyId ;
      private string[] P008Y2_A109EmployeeEmail ;
      private long[] P008Y2_A106EmployeeId ;
   ...
   public class sendleaveupdatetmail__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P008Y2", "SELECT EmployeeIsActive, EmployeeIsManager, CompanyId, EmployeeEmail, EmployeeId FROM Employee WHERE (CompanyId = :AV8Employee__Companyid) AND (EmployeeIsManager = TRUE) AND (EmployeeIsActive = TRUE) ORDER BY CompanyId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008Y2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
