...
namespace GeneXus.Programs {
   public class leavecalendarview : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202452012215654", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("leavecalendarview.js", "?202452012215654", false, true);
         context.AddJavascriptSource("GXScheduler/dhtmlxscheduler.js", "", false, true);
         context.AddJavascriptSource("GXScheduler/GXSchedulerRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GXSCHEDULER1.EVENTSELECTED","{handler:'E11402',iparms:[{av:'AV5currentEvent',fld:'vCURRENTEVENT',pic:''}]");
