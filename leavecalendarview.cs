...
namespace GeneXus.Programs {
   public class leavecalendarview : GXDataArea
   {
      ...
      public leavecalendarview( IGxContext context )
      {
      ...
      {
         get {
            return "leavecalendarview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("leavecalendarview.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vCURRENTEVENT", AV5currentEvent);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vCURRENTEVENT", AV5currentEvent);
         }
         GxWebStd.gx_hidden_field( context, "vINITIALDATE", context.localUtil.DToC( AV6initialDate, 0, "/"));
         GxWebStd.gx_hidden_field( context, "GXSCHEDULER1_Loadeventsobject", StringUtil.RTrim( Gxscheduler1_Loadeventsobject));
         GxWebStd.gx_hidden_field( context, "GXSCHEDULER1_Loadeventsobjectname", StringUtil.RTrim( Gxscheduler1_Loadeventsobjectname));
         GxWebStd.gx_hidden_field( context, "GXSCHEDULER1_View", StringUtil.RTrim( Gxscheduler1_View));
         GxWebStd.gx_hidden_field( context, "GXSCHEDULER1_Displayweektab", StringUtil.RTrim( Gxscheduler1_Displayweektab));
         GxWebStd.gx_hidden_field( context, "GXSCHEDULER1_Displaydaytab", StringUtil.RTrim( Gxscheduler1_Displaydaytab));
         GxWebStd.gx_hidden_field( context, "GXSCHEDULER1_Montheventsview", StringUtil.RTrim( Gxscheduler1_Montheventsview));
      }
      ...
      {
         return formatLink("leavecalendarview.aspx")  ;
      }
      ...
      protected void WB400( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ucGxscheduler1.SetProperty("MonthEventsView", Gxscheduler1_Montheventsview);
      ...
      protected void START402( )
      {
         ...
         Form.Meta.addItem("description", "Leave Calendar View", 0) ;
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "GXSCHEDULER1.EVENTSELECTED") == 0 )
                           {
                              context.wbHandled = 1;
                              dynload_actions( ) ;
                              /* Execute user event: Gxscheduler1.Eventselected */
                              E11402 ();
                           }
      ...
      protected void STRUP400( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vCURRENTEVENT"), AV5currentEvent);
            /* Read saved values. */
            AV6initialDate = context.localUtil.CToD( cgiGet( "vINITIALDATE"), 0);
            Gxscheduler1_Loadeventsobject = cgiGet( "GXSCHEDULER1_Loadeventsobject");
      ...
      protected void E11402( )
      {
         ...
         returnInSub = false;
         AV7websession.Set("currentevent", AV5currentEvent.ToXml(false, true, "", ""));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512265149", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("leavecalendarview.js", "?2024102512265150", false, true);
         context.AddJavascriptSource("GXScheduler/dhtmlxscheduler.js", "", false, true);
         context.AddJavascriptSource("GXScheduler/GXSchedulerRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Gxscheduler1_Montheventsview = "singleline";
         Gxscheduler1_Displaydaytab = "false";
         Gxscheduler1_Displayweektab = "false";
         Gxscheduler1_View = "month";
         Gxscheduler1_Loadeventsobjectname = "GetLeaveEvents";
         Gxscheduler1_Loadeventsobject = "getleaveevents";
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
         Form.Backcolor = (int)(0xFFFFFF);
         Form.Caption = "Leave Calendar View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GXSCHEDULER1.EVENTSELECTED","""{"handler":"E11402","iparms":[{"av":"AV5currentEvent","fld":"vCURRENTEVENT"}]}""");
         return  ;
      }
