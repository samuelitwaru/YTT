...
namespace GeneXus.Programs {
   public class getlastworkhourlogdate : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         {
            A106EmployeeId = P00BG2_A106EmployeeId[0];
            A119WorkHourLogDate = P00BG2_A119WorkHourLogDate[0];
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.getlastworkhourlogdate__default(),
            new Object[][] {
                new Object[] {
               P00BG2_A106EmployeeId, P00BG2_A119WorkHourLogDate, P00BG2_A118WorkHourLogId
               }
            }
         );
      ...
      private long[] P00BG2_A106EmployeeId ;
      private DateTime[] P00BG2_A119WorkHourLogDate ;
      private long[] P00BG2_A118WorkHourLogId ;
   ...
   public class getlastworkhourlogdate__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00BG2", "SELECT EmployeeId, WorkHourLogDate, WorkHourLogId FROM WorkHourLog WHERE EmployeeId = :AV9EmployeeId ORDER BY WorkHourLogDate DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BG2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
