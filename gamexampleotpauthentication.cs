...
namespace GeneXus.Programs {
   public class gamexampleotpauthentication : GXHttpHandler
   {
      ...
      protected void E11082( )
      {
         /* Start Routine */
         returnInSub = false;
         AV13User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getusertootpauthentication(out  AV7AuthenticationTypeName, out  AV16UseTwoFactorAuthentication, out  AV25GAMErrorCollection);
         ...
         {
            AV26GAMAuthenticationTypeSimple = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getenabledauthenticationtypebyname(AV7AuthenticationTypeName, AV27Language, out  AV25GAMErrorCollection);
            if ( ! AV26GAMAuthenticationTypeSimple.gxTpr_Istotp && ! AV26GAMAuthenticationTypeSimple.gxTpr_Twofactorauthentication_istotp )
            {
      ...
      protected void E12082( )
      {
         ...
         if ( AV25GAMErrorCollection.Count == 0 )
         {
            ...
            AV11LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV14UserName, AV15UserPassword, AV6AdditionalParameter, out  AV25GAMErrorCollection);
            if ( AV11LoginOK )
            {
            ...
            else
            {
               if ( AV25GAMErrorCollection.Count > 0 )
               {
                  if ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV25GAMErrorCollection.Item(1)).gxTpr_Code == 161 )
                  {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491115551277", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleotpauthentication.js", "?202491115551281", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'LOGIN'","""{"handler":"E13082","iparms":[{"av":"AV10IDP_State","fld":"vIDP_STATE"}]""");
      ...
      public override void initialize( )
      {
         ...
         AV26GAMAuthenticationTypeSimple = new GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple(context);
         AV27Language = "";
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple AV26GAMAuthenticationTypeSimple ;
