...
namespace GeneXus.Programs {
   public class workhourlogwwexport : GXProcedure
   {
      ...
      public void executeSubmit( out string aP0_Filename ,
                                 out string aP1_ErrorMessage )
      {
         workhourlogwwexport objworkhourlogwwexport;
         objworkhourlogwwexport = new workhourlogwwexport();
         objworkhourlogwwexport.AV12Filename = "" ;
         objworkhourlogwwexport.AV13ErrorMessage = "" ;
         objworkhourlogwwexport.context.SetSubmitInitialConfig(context);
         objworkhourlogwwexport.initialize();
         Submit( executePrivateCatch,objworkhourlogwwexport);
         aP0_Filename=this.AV12Filename;
         aP1_ErrorMessage=this.AV13ErrorMessage;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((workhourlogwwexport)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S131( )
      {
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV40TFWorkHourLogDuration_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV40TFWorkHourLogDuration_Sel)) ? "(Empty)" : AV40TFWorkHourLogDuration_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV39TFWorkHourLogDuration)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV39TFWorkHourLogDuration, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Log Hour") ;
            AV14CellRow = GXt_int2;
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Log Minute") ;
            AV14CellRow = GXt_int2;
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV46TFWorkHourLogDescription_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV46TFWorkHourLogDescription_Sel)) ? "(Empty)" : StringUtil.Substring( AV46TFWorkHourLogDescription_Sel, 1, 1000)), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV45TFWorkHourLogDescription)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  StringUtil.Substring( AV45TFWorkHourLogDescription, 1, 1000), out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV55TFEmployeeFirstName_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV55TFEmployeeFirstName_Sel)) ? "(Empty)" : AV55TFEmployeeFirstName_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV54TFEmployeeFirstName)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV54TFEmployeeFirstName, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV52TFProjectName_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV52TFProjectName_Sel)) ? "(Empty)" : AV52TFProjectName_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV51TFProjectName)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV51TFProjectName, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
      ...
      protected void S141( )
      {
         ...
         {
            AV26ColumnsSelector_Column = ((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV24ColumnsSelector.gxTpr_Columns.Item(AV75GXV1));
      ...
      protected void S161( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            {
               AV26ColumnsSelector_Column = ((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV24ColumnsSelector.gxTpr_Columns.Item(AV94GXV2));
               if ( AV26ColumnsSelector_Column.gxTpr_Isvisible )
               {
      ...
      protected void S151( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "WorkHourLogHour",  "",  "Log Hour",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "WorkHourLogMinute",  "",  "Log Minute",  true,  "") ;
         ...
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "WorkHourLogWWColumnsSelector", out  GXt_char1) ;
      ...
      protected void S201( )
      {
         ...
         {
            AV22GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "WorkHourLogWWGridState"), null, "", "");
         }
         else
         {
         ...
         {
            AV23GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV22GridState.gxTpr_Filtervalues.Item(AV95GXV3));
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workhourlogwwexport__default(),
            new Object[][] {
                new Object[] {
               P006O2_A106EmployeeId, P006O2_A102ProjectId, P006O2_A103ProjectName, P006O2_A107EmployeeFirstName, P006O2_A123WorkHourLogDescription, P006O2_A122WorkHourLogMinute, P006O2_A121WorkHourLogHour, P006O2_A120WorkHourLogDuration, P006O2_A119WorkHourLogDate, P006O2_A118WorkHourLogId
               }
            }
         );
         /* GeneXus formulas. */
   ...
   public class workhourlogwwexport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV18OrderedDsc )
      {
         ...
         scmdbuf = "SELECT T1.EmployeeId, T1.ProjectId, T3.ProjectName, T2.EmployeeFirstName, T1.WorkHourLogDescription, T1.WorkHourLogMinute, T1.WorkHourLogHour, T1.WorkHourLogDuration, T1.WorkHourLogDate, T1.WorkHourLogId FROM ((WorkHourLog T1 INNER JOIN Employee T2 ON T2.EmployeeId = T1.EmployeeId) INNER JOIN Project T3 ON T3.ProjectId = T1.ProjectId)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV77Workhourlogwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T1.WorkHourLogDuration) like '%' || LOWER(:lV77Workhourlogwwds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.WorkHourLogHour,'9999'), 2) like '%' || :lV77Workhourlogwwds_1_filterfulltext) or ( SUBSTR(TO_CHAR(T1.WorkHourLogMinute,'9999'), 2) like '%' || :lV77Workhourlogwwds_1_filterfulltext) or ( LOWER(T1.WorkHourLogDescription) like '%' || LOWER(:lV77Workhourlogwwds_1_filterfulltext)) or ( LOWER(T2.EmployeeFirstName) like '%' || LOWER(:lV77Workhourlogwwds_1_filterfulltext)) or ( LOWER(T3.ProjectName) like '%' || LOWER(:lV77Workhourlogwwds_1_filterfulltext)))");
         }
         else
         {
            GXv_int4[0] = 1;
         ...
         {
            AddWhere(sWhereString, "(LOWER(T1.WorkHourLogDuration) like LOWER(:lV82Workhourlogwwds_6_tfworkhourlogduration))");
         }
         else
         {
            GXv_int4[13] = 1;
         ...
         {
            AddWhere(sWhereString, "(LOWER(T1.WorkHourLogDescription) like LOWER(:lV88Workhourlogwwds_12_tfworkhourlogdescription))");
         }
         else
         {
            GXv_int4[19] = 1;
         ...
         {
            AddWhere(sWhereString, "(LOWER(T2.EmployeeFirstName) like LOWER(:lV90Workhourlogwwds_14_tfemployeefirstname))");
         }
         else
         {
            GXv_int4[21] = 1;
         ...
         {
            AddWhere(sWhereString, "(LOWER(T3.ProjectName) like LOWER(:lV92Workhourlogwwds_16_tfprojectname))");
         }
         else
         {
            GXv_int4[23] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV82Workhourlogwwds_6_tfworkhourlogduration",GXType.VarChar,200,0) ,
          new ParDef("AV83Workhourlogwwds_7_tfworkhourlogduration_sel",GXType.VarChar,200,0) ,
