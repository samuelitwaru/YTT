...
namespace GeneXus.Programs {
   public class leavetype : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_label_element( context, edtLeaveTypeName_Internalname, "Type Name", " AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 22,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtLeaveTypeName_Internalname, StringUtil.RTrim( A125LeaveTypeName), StringUtil.RTrim( context.localUtil.Format( A125LeaveTypeName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,22);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLeaveTypeName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtLeaveTypeName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_LeaveType.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, "", "Log Work Hours", " AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Radio button */
         ClassString = "Attribute";
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 DataContentCell DscTop", "start", "top", "", "", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+edtLeaveTypeColorPending_Internalname+"\"", "", "div");
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtLeaveTypeColorPending_Internalname, "Color Pending", " AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 39,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtLeaveTypeColorPending_Internalname, StringUtil.RTrim( A174LeaveTypeColorPending), StringUtil.RTrim( context.localUtil.Format( A174LeaveTypeColorPending, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLeaveTypeColorPending_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtLeaveTypeColorPending_Enabled, 0, "color", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "Color", "start", true, "", "HLP_LeaveType.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtLeaveTypeColorApproved_Internalname, "Color Approved", " AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 43,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtLeaveTypeColorApproved_Internalname, StringUtil.RTrim( A175LeaveTypeColorApproved), StringUtil.RTrim( context.localUtil.Format( A175LeaveTypeColorApproved, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,43);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLeaveTypeColorApproved_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtLeaveTypeColorApproved_Enabled, 0, "color", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "Color", "start", true, "", "HLP_LeaveType.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtLeaveTypeId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A124LeaveTypeId), 10, 0, ".", "")), StringUtil.LTrim( ((edtLeaveTypeId_Enabled!=0) ? context.localUtil.Format( (decimal)(A124LeaveTypeId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A124LeaveTypeId), "ZZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLeaveTypeId_Jsonclick, 0, "Attribute", "", "", "", "", edtLeaveTypeId_Visible, edtLeaveTypeId_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_LeaveType.htm");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 57,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtCompanyId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A100CompanyId), 10, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A100CompanyId), "ZZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,57);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCompanyId_Jsonclick, 0, "Attribute", "", "", "", "", edtCompanyId_Visible, edtCompanyId_Enabled, 1, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_LeaveType.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z174LeaveTypeColorPending = cgiGet( "Z174LeaveTypeColorPending");
               n174LeaveTypeColorPending = (String.IsNullOrEmpty(StringUtil.RTrim( A174LeaveTypeColorPending)) ? true : false);
               Z175LeaveTypeColorApproved = cgiGet( "Z175LeaveTypeColorApproved");
      ...
      protected void E110I2( )
      {
         ...
         if ( ( StringUtil.StrCmp(AV10TrnContext.gxTpr_Transactionname, AV24Pgmname) == 0 ) && ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) )
         {
            ...
            {
               AV13TrnContextAtt = ((GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute)AV10TrnContext.gxTpr_Attributes.Item(AV25GXV1));
      ...
      protected void ZM0I20( short GX_JID )
      {
         if ( ( GX_JID == 16 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z174LeaveTypeColorPending = T000I3_A174LeaveTypeColorPending[0];
               Z175LeaveTypeColorApproved = T000I3_A175LeaveTypeColorApproved[0];
            ...
            else
            {
               ...
               Z174LeaveTypeColorPending = A174LeaveTypeColorPending;
               Z175LeaveTypeColorApproved = A175LeaveTypeColorApproved;
      ...
      protected void Load0I20( )
      {
         ...
         if ( (pr_default.getStatus(3) != 101) )
         {
            ...
            AssignAttri("", false, "A145LeaveTypeLoggingWorkHours", A145LeaveTypeLoggingWorkHours);
            A174LeaveTypeColorPending = T000I5_A174LeaveTypeColorPending[0];
            n174LeaveTypeColorPending = T000I5_n174LeaveTypeColorPending[0];
            AssignAttri("", false, "A174LeaveTypeColorPending", A174LeaveTypeColorPending);
            A175LeaveTypeColorApproved = T000I5_A175LeaveTypeColorApproved[0];
            n175LeaveTypeColorApproved = T000I5_n175LeaveTypeColorApproved[0];
            AssignAttri("", false, "A175LeaveTypeColorApproved", A175LeaveTypeColorApproved);
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A145LeaveTypeLoggingWorkHours", A145LeaveTypeLoggingWorkHours);
            A174LeaveTypeColorPending = T000I3_A174LeaveTypeColorPending[0];
            n174LeaveTypeColorPending = T000I3_n174LeaveTypeColorPending[0];
            AssignAttri("", false, "A174LeaveTypeColorPending", A174LeaveTypeColorPending);
            A175LeaveTypeColorApproved = T000I3_A175LeaveTypeColorApproved[0];
            n175LeaveTypeColorApproved = T000I3_n175LeaveTypeColorApproved[0];
            AssignAttri("", false, "A175LeaveTypeColorApproved", A175LeaveTypeColorApproved);
      ...
      protected void CheckOptimisticConcurrency0I20( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z125LeaveTypeName, T000I2_A125LeaveTypeName[0]) != 0 ) || ( StringUtil.StrCmp(Z144LeaveTypeVacationLeave, T000I2_A144LeaveTypeVacationLeave[0]) != 0 ) || ( StringUtil.StrCmp(Z145LeaveTypeLoggingWorkHours, T000I2_A145LeaveTypeLoggingWorkHours[0]) != 0 ) || ( StringUtil.StrCmp(Z174LeaveTypeColorPending, T000I2_A174LeaveTypeColorPending[0]) != 0 ) || ( StringUtil.StrCmp(Z175LeaveTypeColorApproved, T000I2_A175LeaveTypeColorApproved[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( Z100CompanyId != T000I2_A100CompanyId[0] ) )
            {
               ...
               if ( StringUtil.StrCmp(Z174LeaveTypeColorPending, T000I2_A174LeaveTypeColorPending[0]) != 0 )
               {
                  GXUtil.WriteLog("leavetype:[seudo value changed for attri]"+"LeaveTypeColorPending");
                  GXUtil.WriteLogRaw("Old: ",Z174LeaveTypeColorPending);
                  GXUtil.WriteLogRaw("Current: ",T000I2_A174LeaveTypeColorPending[0]);
               }
               if ( StringUtil.StrCmp(Z175LeaveTypeColorApproved, T000I2_A175LeaveTypeColorApproved[0]) != 0 )
               {
                  GXUtil.WriteLog("leavetype:[seudo value changed for attri]"+"LeaveTypeColorApproved");
                  GXUtil.WriteLogRaw("Old: ",Z175LeaveTypeColorApproved);
                  GXUtil.WriteLogRaw("Current: ",T000I2_A175LeaveTypeColorApproved[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A125LeaveTypeName, A144LeaveTypeVacationLeave, A145LeaveTypeLoggingWorkHours, n174LeaveTypeColorPending, A174LeaveTypeColorPending, n175LeaveTypeColorApproved, A175LeaveTypeColorApproved, A100CompanyId});
                     pr_default.close(8);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(10, new Object[] {A125LeaveTypeName, A144LeaveTypeVacationLeave, A145LeaveTypeLoggingWorkHours, n174LeaveTypeColorPending, A174LeaveTypeColorPending, n175LeaveTypeColorApproved, A175LeaveTypeColorApproved, A100CompanyId, A124LeaveTypeId});
                     pr_default.close(10);
                     pr_default.SmartCacheProvider.SetUpdated("LeaveType");
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z174LeaveTypeColorPending", StringUtil.RTrim( Z174LeaveTypeColorPending));
         GxWebStd.gx_hidden_field( context, "Z175LeaveTypeColorApproved", StringUtil.RTrim( Z175LeaveTypeColorApproved));
      ...
      protected void InitializeNonKey0I20( )
      {
         ...
         Z174LeaveTypeColorPending = "";
         Z175LeaveTypeColorApproved = "";
         Z100CompanyId = 0;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024619714373", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("leavetype.js", "?2024619714375", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      {
         setEventMetadata("ENTER","{handler:'UserMainFullajax',iparms:[{postForm:true},{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV14LeaveTypeId',fld:'vLEAVETYPEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]}");
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV10TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV14LeaveTypeId',fld:'vLEAVETYPEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A124LeaveTypeId',fld:'LEAVETYPEID',pic:'ZZZZZZZZZ9'},{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]}");
         setEventMetadata("AFTER TRN","{handler:'E120I2',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV10TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]");
         setEventMetadata("AFTER TRN",",oparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]}");
         setEventMetadata("VALID_LEAVETYPENAME","{handler:'Valid_Leavetypename',iparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]");
         setEventMetadata("VALID_LEAVETYPENAME",",oparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]}");
         setEventMetadata("VALID_LEAVETYPEVACATIONLEAVE","{handler:'Valid_Leavetypevacationleave',iparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]");
         setEventMetadata("VALID_LEAVETYPEVACATIONLEAVE",",oparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]}");
         setEventMetadata("VALID_LEAVETYPELOGGINGWORKHOURS","{handler:'Valid_Leavetypeloggingworkhours',iparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]");
         setEventMetadata("VALID_LEAVETYPELOGGINGWORKHOURS",",oparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]}");
         setEventMetadata("VALID_LEAVETYPEID","{handler:'Valid_Leavetypeid',iparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]");
         setEventMetadata("VALID_LEAVETYPEID",",oparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]}");
         setEventMetadata("VALID_COMPANYID","{handler:'Valid_Companyid',iparms:[{av:'A100CompanyId',fld:'COMPANYID',pic:'ZZZZZZZZZ9'},{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]");
         setEventMetadata("VALID_COMPANYID",",oparms:[{av:'radLeaveTypeVacationLeave'},{av:'A144LeaveTypeVacationLeave',fld:'LEAVETYPEVACATIONLEAVE',pic:''},{av:'radLeaveTypeLoggingWorkHours'},{av:'A145LeaveTypeLoggingWorkHours',fld:'LEAVETYPELOGGINGWORKHOURS',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         T000I5_A174LeaveTypeColorPending = new string[] {""} ;
         T000I5_n174LeaveTypeColorPending = new bool[] {false} ;
         T000I5_A175LeaveTypeColorApproved = new string[] {""} ;
         T000I5_n175LeaveTypeColorApproved = new bool[] {false} ;
         ...
         T000I3_A174LeaveTypeColorPending = new string[] {""} ;
         T000I3_n174LeaveTypeColorPending = new bool[] {false} ;
         T000I3_A175LeaveTypeColorApproved = new string[] {""} ;
         T000I3_n175LeaveTypeColorApproved = new bool[] {false} ;
         ...
         T000I2_A174LeaveTypeColorPending = new string[] {""} ;
         T000I2_n174LeaveTypeColorPending = new bool[] {false} ;
         T000I2_A175LeaveTypeColorApproved = new string[] {""} ;
         T000I2_n175LeaveTypeColorApproved = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leavetype__default(),
            new Object[][] {
                new Object[] {
               T000I2_A124LeaveTypeId, T000I2_A125LeaveTypeName, T000I2_A144LeaveTypeVacationLeave, T000I2_A145LeaveTypeLoggingWorkHours, T000I2_A174LeaveTypeColorPending, T000I2_n174LeaveTypeColorPending, T000I2_A175LeaveTypeColorApproved, T000I2_n175LeaveTypeColorApproved, T000I2_A100CompanyId
               }
               , new Object[] {
               T000I3_A124LeaveTypeId, T000I3_A125LeaveTypeName, T000I3_A144LeaveTypeVacationLeave, T000I3_A145LeaveTypeLoggingWorkHours, T000I3_A174LeaveTypeColorPending, T000I3_n174LeaveTypeColorPending, T000I3_A175LeaveTypeColorApproved, T000I3_n175LeaveTypeColorApproved, T000I3_A100CompanyId
               }
               , new Object[] {
               T000I4_A100CompanyId
               }
               , new Object[] {
               T000I5_A124LeaveTypeId, T000I5_A125LeaveTypeName, T000I5_A144LeaveTypeVacationLeave, T000I5_A145LeaveTypeLoggingWorkHours, T000I5_A174LeaveTypeColorPending, T000I5_n174LeaveTypeColorPending, T000I5_A175LeaveTypeColorApproved, T000I5_n175LeaveTypeColorApproved, T000I5_A100CompanyId
               }
               , new Object[] {
      ...
      private string Z174LeaveTypeColorPending ;
      private string Z175LeaveTypeColorApproved ;
      ...
      private string[] T000I5_A174LeaveTypeColorPending ;
      private bool[] T000I5_n174LeaveTypeColorPending ;
      private string[] T000I5_A175LeaveTypeColorApproved ;
      private bool[] T000I5_n175LeaveTypeColorApproved ;
      ...
      private string[] T000I3_A174LeaveTypeColorPending ;
      private bool[] T000I3_n174LeaveTypeColorPending ;
      private string[] T000I3_A175LeaveTypeColorApproved ;
      private bool[] T000I3_n175LeaveTypeColorApproved ;
      ...
      private string[] T000I2_A174LeaveTypeColorPending ;
      private bool[] T000I2_n174LeaveTypeColorPending ;
      private string[] T000I2_A175LeaveTypeColorApproved ;
      private bool[] T000I2_n175LeaveTypeColorApproved ;
