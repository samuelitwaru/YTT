...
namespace GeneXus.Programs {
   public class home : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPARAMETERS", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV19Parameters), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vITEMCLICKDATA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20ItemClickData), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vITEMDOUBLECLICKDATA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV21ItemDoubleClickData), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vDRAGANDDROPDATA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV22DragAndDropData), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vFILTERCHANGEDDATA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV23FilterChangedData), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vITEMEXPANDDATA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV24ItemExpandData), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vITEMCOLLAPSEDATA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV25ItemCollapseData), 4, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vSDTNOTIFICATIONSDATA", AV7SDTNotificationsData);
         }
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCard1_value_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8Card1_Value), 10, 0, ".", "")), StringUtil.LTrim( ((edtavCard1_value_Enabled!=0) ? context.localUtil.Format( (decimal)(AV8Card1_Value), "ZZ,ZZZ,ZZ9") : context.localUtil.Format( (decimal)(AV8Card1_Value), "ZZ,ZZZ,ZZ9"))), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,20);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCard1_value_Jsonclick, 0, "DashboardNumberCard", "", "", "", "", 1, edtavCard1_value_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "KPINumericValue", "end", false, "", "HLP_Home.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCard2_value_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9Card2_Value), 10, 0, ".", "")), StringUtil.LTrim( ((edtavCard2_value_Enabled!=0) ? context.localUtil.Format( (decimal)(AV9Card2_Value), "ZZ,ZZZ,ZZ9") : context.localUtil.Format( (decimal)(AV9Card2_Value), "ZZ,ZZZ,ZZ9"))), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCard2_value_Jsonclick, 0, "DashboardNumberCard", "", "", "", "", 1, edtavCard2_value_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "KPINumericValue", "end", false, "", "HLP_Home.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavCard3_value_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10Card3_Value), 10, 0, ".", "")), StringUtil.LTrim( ((edtavCard3_value_Enabled!=0) ? context.localUtil.Format( (decimal)(AV10Card3_Value), "ZZ,ZZZ,ZZ9") : context.localUtil.Format( (decimal)(AV10Card3_Value), "ZZ,ZZZ,ZZ9"))), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,50);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCard3_value_Jsonclick, 0, "DashboardNumberCard", "", "", "", "", 1, edtavCard3_value_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "KPINumericValue", "end", false, "", "HLP_Home.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavCard4_value_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11Card4_Value), 10, 0, ".", "")), StringUtil.LTrim( ((edtavCard4_value_Enabled!=0) ? context.localUtil.Format( (decimal)(AV11Card4_Value), "ZZ,ZZZ,ZZ9") : context.localUtil.Format( (decimal)(AV11Card4_Value), "ZZ,ZZZ,ZZ9"))), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,65);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCard4_value_Jsonclick, 0, "DashboardNumberCard", "", "", "", "", 1, edtavCard4_value_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "KPINumericValue", "end", false, "", "HLP_Home.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV30GXV1 = (int)(nGXsfl_103_idx+GRID_nFirstRecordOnPage);
                              if ( ( AV7SDTNotificationsData.Count >= AV30GXV1 ) && ( AV30GXV1 > 0 ) )
                              {
                                 AV7SDTNotificationsData.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem)AV7SDTNotificationsData.Item(AV30GXV1));
      ...
      protected void initialize_formulas( )
      {
         ...
         AssignProp("", false, edtavNotificationicon_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavNotificationicon_Enabled), 5, 0), !bGXsfl_103_Refreshing);
         edtavSdtnotificationsdata__notificationiconclass_Enabled = 0;
         AssignProp("", false, edtavSdtnotificationsdata__notificationiconclass_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdtnotificationsdata__notificationiconclass_Enabled), 5, 0), !bGXsfl_103_Refreshing);
         edtavSdtnotificationsdata__notificationtitle_Enabled = 0;
         AssignProp("", false, edtavSdtnotificationsdata__notificationtitle_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdtnotificationsdata__notificationtitle_Enabled), 5, 0), !bGXsfl_103_Refreshing);
         edtavSdtnotificationsdata__notificationdatetime_Enabled = 0;
         AssignProp("", false, edtavSdtnotificationsdata__notificationdatetime_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSdtnotificationsdata__notificationdatetime_Enabled), 5, 0), !bGXsfl_103_Refreshing);
      }
      ...
      protected void STRUP0H0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV19Parameters = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vPARAMETERS"), ".", ","), 18, MidpointRounding.ToEven));
            AV20ItemClickData = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vITEMCLICKDATA"), ".", ","), 18, MidpointRounding.ToEven));
            AV21ItemDoubleClickData = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vITEMDOUBLECLICKDATA"), ".", ","), 18, MidpointRounding.ToEven));
            AV22DragAndDropData = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vDRAGANDDROPDATA"), ".", ","), 18, MidpointRounding.ToEven));
            AV23FilterChangedData = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vFILTERCHANGEDDATA"), ".", ","), 18, MidpointRounding.ToEven));
            AV24ItemExpandData = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vITEMEXPANDDATA"), ".", ","), 18, MidpointRounding.ToEven));
            AV25ItemCollapseData = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vITEMCOLLAPSEDATA"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            while ( nGXsfl_103_fel_idx < nRC_GXsfl_103 )
            {
               ...
               AV30GXV1 = (int)(nGXsfl_103_fel_idx+GRID_nFirstRecordOnPage);
               if ( ( AV7SDTNotificationsData.Count >= AV30GXV1 ) && ( AV30GXV1 > 0 ) )
               {
                  AV7SDTNotificationsData.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem)AV7SDTNotificationsData.Item(AV30GXV1));
                  AV6NotificationIcon = cgiGet( edtavNotificationicon_Internalname);
            ...
            {
               AV8Card1_Value = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtavCard1_value_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV8Card1_Value", StringUtil.LTrimStr( (decimal)(AV8Card1_Value), 8, 0));
            }
            ...
            {
               AV9Card2_Value = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtavCard2_value_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV9Card2_Value", StringUtil.LTrimStr( (decimal)(AV9Card2_Value), 8, 0));
            }
            ...
            {
               AV10Card3_Value = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtavCard3_value_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV10Card3_Value", StringUtil.LTrimStr( (decimal)(AV10Card3_Value), 8, 0));
            }
            ...
            {
               AV11Card4_Value = (int)(Math.Round(context.localUtil.CToN( cgiGet( edtavCard4_value_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV11Card4_Value", StringUtil.LTrimStr( (decimal)(AV11Card4_Value), 8, 0));
            }
      ...
      private void E120H2( )
      {
         ...
         returnInSub = false;
         AV30GXV1 = 1;
         while ( AV30GXV1 <= AV7SDTNotificationsData.Count )
         {
            AV7SDTNotificationsData.CurrentItem = ((GeneXus.Programs.wwpbaseobjects.SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem)AV7SDTNotificationsData.Item(AV30GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202452012172571", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("home.js", "?202452012172572", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV7SDTNotificationsData',fld:'vSDTNOTIFICATIONSDATA',grid:103,pic:'',hsh:true},{av:'nGXsfl_103_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:103},{av:'nRC_GXsfl_103',ctrl:'GRID',prop:'GridRC',grid:103}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E120H2',iparms:[{av:'AV7SDTNotificationsData',fld:'vSDTNOTIFICATIONSDATA',grid:103,pic:'',hsh:true},{av:'nGXsfl_103_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:103},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_103',ctrl:'GRID',prop:'GridRC',grid:103}]");
         ...
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV7SDTNotificationsData',fld:'vSDTNOTIFICATIONSDATA',grid:103,pic:'',hsh:true},{av:'nGXsfl_103_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:103},{av:'nRC_GXsfl_103',ctrl:'GRID',prop:'GridRC',grid:103}]");
      ...
      public override void initialize( )
      {
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         AV7SDTNotificationsData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem>( context, "WWP_SDTNotificationsDataSampleItem", "YTT_version4");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
         ...
         sEvtType = "";
         AV6NotificationIcon = "";
         AV5HomeSampleData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "YTT_version4");
         GXt_objcol_SdtHomeSampleData_HomeSampleDataItem1 = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "YTT_version4");
         AV13Axis = new GeneXus.Programs.genexusreporting.SdtQueryViewerElements_Element(context);
         ...
         GXt_objcol_SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem2 = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWP_SDTNotificationsDataSample_WWP_SDTNotificationsDataSampleItem>( context, "WWP_SDTNotificationsDataSampleItem", "YTT_version4");
      ...
      private short AV19Parameters ;
      private short AV20ItemClickData ;
      private short AV21ItemDoubleClickData ;
      private short AV22DragAndDropData ;
      private short AV23FilterChangedData ;
      private short AV24ItemExpandData ;
      private short AV25ItemCollapseData ;
      private short wbEnd ;
