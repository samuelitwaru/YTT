...
namespace GeneXus.Programs {
   public class reportsdetail : GXWebComponent
   {
      ...
      public reportsdetail( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         ajax_req_read_hidden_sdt(GetNextPar( ), AV18CompanyLocationId);
         ...
         gxgrGrid_refresh( subGrid_Rows, AV18CompanyLocationId, AV23Pgmname, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("reportsdetail.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDCURRENTPAGE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15GridCurrentPage), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16GridPageCount), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDAPPLIEDFILTERS", AV17GridAppliedFilters);
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV23Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV23Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTODATE", context.localUtil.DToC( AV22ToDate, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vFROMDATE", context.localUtil.DToC( AV21FromDate, 0, "/"));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vPROJECTID", AV20ProjectId);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vPROJECTID", AV20ProjectId);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vEMPLOYEEID", AV19EmployeeId);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vEMPLOYEEID", AV19EmployeeId);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vCOMPANYLOCATIONID", AV18CompanyLocationId);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vCOMPANYLOCATIONID", AV18CompanyLocationId);
         }
      ...
      protected void WB4T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "reportsdetail.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
            }
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 SectionGrid NestedGridCell CellMarginTop GridNoBorderCell", "start", "top", "", "", "div");
            /* Div Control */
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       GxSimpleCollection<long> AV18CompanyLocationId ,
                                       string AV23Pgmname ,
                                       string sPrefix )
      {
         initialize_formulas( ) ;
      ...
      protected void RF4T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV18CompanyLocationId ,
                                                 AV18CompanyLocationId.Count } ,
                                                 new int[]{
            ...
            {
               A100CompanyId = H004T2_A100CompanyId[0];
               A157CompanyLocationId = H004T2_A157CompanyLocationId[0];
               A106EmployeeId = H004T2_A106EmployeeId[0];
               A148EmployeeName = H004T2_A148EmployeeName[0];
               A157CompanyLocationId = H004T2_A157CompanyLocationId[0];
               E154T2 ();
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtEmployeeName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmployeeName_Enabled), 5, 0), !bGXsfl_12_Refreshing);
         edtEmployeeId_Enabled = 0;
         AssignProp(sPrefix, false, edtEmployeeId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmployeeId_Enabled), 5, 0), !bGXsfl_12_Refreshing);
         edtCompanyLocationId_Enabled = 0;
         AssignProp(sPrefix, false, edtCompanyLocationId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCompanyLocationId_Enabled), 5, 0), !bGXsfl_12_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP4T0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV15GridCurrentPage = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDCURRENTPAGE"), ".", ","), 18, MidpointRounding.ToEven));
            AV16GridPageCount = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGECOUNT"), ".", ","), 18, MidpointRounding.ToEven));
            AV17GridAppliedFilters = cgiGet( sPrefix+"vGRIDAPPLIEDFILTERS");
      ...
      protected void E144T2( )
      {
         ...
         AssignAttri(sPrefix, false, "AV15GridCurrentPage", StringUtil.LTrimStr( (decimal)(AV15GridCurrentPage), 10, 0));
         AV16GridPageCount = subGrid_fnc_Pagecount( );
         AssignAttri(sPrefix, false, "AV16GridPageCount", StringUtil.LTrimStr( (decimal)(AV16GridPageCount), 10, 0));
         GXt_char1 = AV17GridAppliedFilters;
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV23Pgmname, out  GXt_char1) ;
         AV17GridAppliedFilters = GXt_char1;
         AssignAttri(sPrefix, false, "AV17GridAppliedFilters", AV17GridAppliedFilters);
      ...
      private void E154T2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wcreportsworkhourlogdetails_Component) != 0 )
         {
            ...
            WebComp_Wcreportsworkhourlogdetails.componentprepare(new Object[] {(string)sPrefix+"W0020",(string)sGXsfl_12_idx,(long)A106EmployeeId});
            WebComp_Wcreportsworkhourlogdetails.componentbind(new Object[] {(string)""});
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV13Session.Get(AV23Pgmname+"GridState"), "") == 0 )
         {
            AV11GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV23Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV13Session.Get(AV23Pgmname+"GridState"), null, "", "");
         }
      ...
      protected void S132( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV23Pgmname+"GridState",  AV11GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void E124T2( )
      {
         ...
         returnInSub = false;
         GX_msglist.addItem(AV18CompanyLocationId.ToJSonString(false));
         context.DoAjaxRefreshCmp(sPrefix);
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV18CompanyLocationId", AV18CompanyLocationId);
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "reportsdetail", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245247551217", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("reportsdetail.js", "?20245247551217", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Table start */
            GridRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {(string)tblGridlayouttable_Internalname+"_"+sGXsfl_12_idx,(short)1,(string)"Table",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(short)2,(string)"",(string)"",(string)"",(string)"px",(string)"px",(string)""});
            ...
            GridRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeName_Internalname,(string)"Employee Name",(string)"gx-form-item AttributeLabel",(short)0,(bool)true,(string)"width: 25%;"});
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeName_Internalname,StringUtil.RTrim( A148EmployeeName),(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEmployeeName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)1,(short)0,(short)0,(string)"text",(string)"",(short)80,(string)"chr",(short)1,(string)"row",(short)128,(short)0,(short)0,(short)12,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            ...
            GridRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
            /* WebComponent */
            GxWebStd.gx_hidden_field( context, sPrefix+"W0020"+sGXsfl_12_idx, StringUtil.RTrim( WebComp_Wcreportsworkhourlogdetails_Component));
            context.WriteHtmlText( "<div") ;
            GxWebStd.ClassAttribute( context, "gxwebcomponent"+" gxwebcomponent-loading");
            context.WriteHtmlText( " id=\""+sPrefix+"gxHTMLWrpW0020"+sGXsfl_12_idx+"\""+"") ;
            context.WriteHtmlText( ">") ;
            if ( bGXsfl_12_Refreshing )
            {
               if ( StringUtil.Len( WebComp_Wcreportsworkhourlogdetails_Component) != 0 )
               {
                  if ( ! context.isAjaxRequest( ) || ( StringUtil.StringSearch( sPrefix+"W0020"+sGXsfl_12_idx, cgiGet( "_EventName"), 1) != 0 ) )
                  {
                     if ( 1 != 0 )
                     {
                        if ( StringUtil.Len( WebComp_Wcreportsworkhourlogdetails_Component) != 0 )
                  ...
                  {
                     context.httpAjaxContext.ajax_rspStartCmp(sPrefix+"gxHTMLWrpW0020"+sGXsfl_12_idx);
                  }
            ...
            WebComp_Wcreportsworkhourlogdetails.componentjscripts();
            GridRow.AddColumnProperties("webcomp", -1, isAjaxCallMode( ), new Object[] {(string)"Wcreportsworkhourlogdetails"});
            if ( GridContainer.GetWrapped() == 1 )
            {
               GridContainer.CloseTag("cell");
            }
            ...
            GridRow.AddColumnProperties("row", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
            GridRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)"Invisible"});
            /* Table start */
            ...
            GridRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)" gx-attribute",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
            /* Attribute/Variable Label */
            GridRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeId_Internalname,(string)"Employee Id",(string)"gx-form-item AttributeLabel",(short)0,(bool)true,(string)"width: 25%;"});
            /* Single line edit */
            ROClassString = "Attribute";
            ...
            GridRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(string)"",(short)1,(short)0,(string)"px",(short)0,(string)"px",(string)" gx-attribute",(string)"start",(string)"top",(string)"",(string)"",(string)"div"});
            /* Attribute/Variable Label */
            GridRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(string)edtCompanyLocationId_Internalname,(string)"Company Location Id",(string)"gx-form-item AttributeLabel",(short)0,(bool)true,(string)"width: 25%;"});
            /* Single line edit */
            ROClassString = "Attribute";
      ...
      protected void StartGridControl12( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtCompanyLocationId_Visible), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void init_default_properties( )
      {
         ...
         tblGridlayouttable_Internalname = sPrefix+"GRIDLAYOUTTABLE";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV18CompanyLocationId',fld:'vCOMPANYLOCATIONID',pic:''},{av:'edtEmployeeId_Visible',ctrl:'EMPLOYEEID',prop:'Visible'},{av:'edtCompanyLocationId_Visible',ctrl:'COMPANYLOCATIONID',prop:'Visible'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV23Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E114T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18CompanyLocationId',fld:'vCOMPANYLOCATIONID',pic:''},{av:'AV23Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'edtEmployeeId_Visible',ctrl:'EMPLOYEEID',prop:'Visible'},{av:'edtCompanyLocationId_Visible',ctrl:'COMPANYLOCATIONID',prop:'Visible'},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E154T2',iparms:[{av:'A106EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{ctrl:'WCREPORTSWORKHOURLOGDETAILS'}]}");
         setEventMetadata("GLOBALEVENTS.REPORTSFILTERCHANAGED","{handler:'E124T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV18CompanyLocationId',fld:'vCOMPANYLOCATIONID',pic:''},{av:'AV23Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'edtEmployeeId_Visible',ctrl:'EMPLOYEEID',prop:'Visible'},{av:'edtCompanyLocationId_Visible',ctrl:'COMPANYLOCATIONID',prop:'Visible'},{av:'sPrefix'},{av:'AV22ToDate',fld:'vTODATE',pic:''},{av:'AV21FromDate',fld:'vFROMDATE',pic:''},{av:'AV20ProjectId',fld:'vPROJECTID',pic:''},{av:'AV19EmployeeId',fld:'vEMPLOYEEID',pic:''}]");
         setEventMetadata("GLOBALEVENTS.REPORTSFILTERCHANAGED",",oparms:[{av:'AV18CompanyLocationId',fld:'vCOMPANYLOCATIONID',pic:''},{av:'AV15GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV16GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV17GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV18CompanyLocationId = new GxSimpleCollection<long>();
         AV23Pgmname = "";
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ...
         AV22ToDate = DateTime.MinValue;
         AV21FromDate = DateTime.MinValue;
         AV20ProjectId = new GxSimpleCollection<long>();
         AV19EmployeeId = new GxSimpleCollection<long>();
         GX_FocusControl = "";
         GridContainer = new GXWebGrid( context);
         sStyleString = "";
         ...
         WebComp_Wcreportsworkhourlogdetails_Component = "";
         scmdbuf = "";
         H004T2_A100CompanyId = new long[1] ;
         H004T2_A157CompanyLocationId = new long[1] ;
         H004T2_A106EmployeeId = new long[1] ;
         H004T2_A148EmployeeName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportsdetail__default(),
            new Object[][] {
                new Object[] {
               H004T2_A100CompanyId, H004T2_A157CompanyLocationId, H004T2_A106EmployeeId, H004T2_A148EmployeeName
               }
               , new Object[] {
      ...
      private int AV18CompanyLocationId_Count ;
      ...
      private string tblGridlayouttable_Internalname ;
      ...
      private GxSimpleCollection<long> AV18CompanyLocationId ;
      private GxSimpleCollection<long> AV20ProjectId ;
      private GxSimpleCollection<long> AV19EmployeeId ;
      ...
      private long[] H004T2_A100CompanyId ;
      private long[] H004T2_A157CompanyLocationId ;
      private long[] H004T2_A106EmployeeId ;
      private string[] H004T2_A148EmployeeName ;
   ...
   public class reportsdetail__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H004T2( IGxContext context ,
                                             long A157CompanyLocationId ,
                                             GxSimpleCollection<long> AV18CompanyLocationId ,
                                             int AV18CompanyLocationId_Count )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.CompanyId, T2.CompanyLocationId, T1.EmployeeId, T1.EmployeeName";
         sFromString = " FROM (Employee T1 INNER JOIN Company T2 ON T2.CompanyId = T1.CompanyId)";
         sOrderString = "";
         if ( AV18CompanyLocationId_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV18CompanyLocationId, "T2.CompanyLocationId IN (", ")")+")");
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004T2(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (int)dynConstraints[2] );
               case 1 :
                     return conditional_H004T3(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (int)dynConstraints[2] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004T2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004T2,100, GxCacheFrequency.OFF ,true,false )
