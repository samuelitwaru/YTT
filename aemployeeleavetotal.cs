   ...
   public class aemployeeleavetotal : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(2) != 101) )
         {
            ...
            pr_default.close(3);
            AV14Duration = (decimal)(AV14Duration+cV14Duration*1);
            /* End optimized group. */
         ...
         if ( AV26GXLvl33 == 0 )
         {
            ...
            AV14Duration = (decimal)(AV14Duration+AV15HolidayCount);
         }
      ...
      public override void initialize( )
      {
         ...
         P00AU5_AV14Duration = new decimal[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aemployeeleavetotal__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00AU4_A124LeaveTypeId, P00AU4_A100CompanyId, P00AU4_A145LeaveTypeLoggingWorkHours, P00AU4_A130LeaveRequestEndDate, P00AU4_A129LeaveRequestStartDate, P00AU4_A106EmployeeId, P00AU4_A173LeaveRequestHalfDay, P00AU4_n173LeaveRequestHalfDay, P00AU4_A127LeaveRequestId
               }
               , new Object[] {
               P00AU5_AV14Duration
               }
      ...
      private decimal[] P00AU5_AV14Duration ;
