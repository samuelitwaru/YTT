   ...
   public class aemployeeleavetotal : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A157CompanyLocationId = P00AU2_A157CompanyLocationId[0];
            AV22EmployeeName = A148EmployeeName;
         ...
         while ( (pr_default.getStatus(2) != 101) )
         {
            ...
            while ( DateTimeUtil.ResetTime ( AV23CurrentDate ) <= DateTimeUtil.ResetTime ( AV13LeaveEndDate ) )
            {
               ...
               else if ( DateTimeUtil.Dow( AV23CurrentDate) == 2 )
               {
                  ...
                  else
                  {
                     ...
                     new logtofile(context ).execute(  "here: "+StringUtil.Str( (decimal)(AV14Duration), 4, 0)) ;
                     if (true) break;
                  }
               }
               else
               {
                  ...
                  new logtofile(context ).execute(  "any other day: "+StringUtil.Str( (decimal)(AV14Duration), 4, 0)) ;
               }
            }
            /* Using cursor P00AU5 */
            ...
            {
               A157CompanyLocationId = P00AU5_A157CompanyLocationId[0];
               A115HolidayStartDate = P00AU5_A115HolidayStartDate[0];
               A113HolidayId = P00AU5_A113HolidayId[0];
               A157CompanyLocationId = P00AU5_A157CompanyLocationId[0];
               AV14Duration = (short)(AV14Duration+1);
               new logtofile(context ).execute(  "Holiday: "+StringUtil.Str( (decimal)(AV14Duration), 4, 0)) ;
         ...
         if ( AV26GXLvl27 == 0 )
         {
            ...
            new logtofile(context ).execute(  "When none: "+StringUtil.Str( (decimal)(AV14Duration), 4, 0)) ;
         }
         new logtofile(context ).execute(  StringUtil.Str( (decimal)(AV14Duration), 4, 0)) ;
      ...
      public override void initialize( )
      {
         ...
         P00AU5_A100CompanyId = new long[1] ;
         P00AU5_A157CompanyLocationId = new long[1] ;
         P00AU5_A115HolidayStartDate = new DateTime[] {DateTime.MinValue} ;
         P00AU5_A113HolidayId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aemployeeleavetotal__default(),
            new Object[][] {
               ...
               , new Object[] {
               P00AU4_A124LeaveTypeId, P00AU4_A100CompanyId, P00AU4_A130LeaveRequestEndDate, P00AU4_A129LeaveRequestStartDate, P00AU4_A106EmployeeId, P00AU4_A127LeaveRequestId
               }
               , new Object[] {
               P00AU5_A100CompanyId, P00AU5_A157CompanyLocationId, P00AU5_A115HolidayStartDate, P00AU5_A113HolidayId
               }
               , new Object[] {
      ...
      private long[] P00AU5_A100CompanyId ;
      private long[] P00AU5_A157CompanyLocationId ;
      private DateTime[] P00AU5_A115HolidayStartDate ;
      private long[] P00AU5_A113HolidayId ;
