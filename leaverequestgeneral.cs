   ...
   public class leaverequestgeneral : GXWebComponent
   {
      ...
      protected void WB4E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavEmployeebalance_Internalname, StringUtil.LTrim( StringUtil.NToC( AV18EmployeeBalance, 4, 1, ".", "")), StringUtil.LTrim( ((edtavEmployeebalance_Enabled!=0) ? context.localUtil.Format( AV18EmployeeBalance, "Z9.9") : context.localUtil.Format( AV18EmployeeBalance, "Z9.9"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','1');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','1');"+";gx.evt.onblur(this,27);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEmployeebalance_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavEmployeebalance_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_LeaveRequestGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20252419215956", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("leaverequestgeneral.js", "?20252419215956", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A127LeaveRequestId","fld":"LEAVEREQUESTID","pic":"ZZZZZZZZZ9"},{"av":"radLeaveRequestHalfDay"},{"av":"A173LeaveRequestHalfDay","fld":"LEAVEREQUESTHALFDAY"},{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E114E1","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A127LeaveRequestId","fld":"LEAVEREQUESTID","pic":"ZZZZZZZZZ9"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E124E1","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A127LeaveRequestId","fld":"LEAVEREQUESTID","pic":"ZZZZZZZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H004E2_A127LeaveRequestId = new long[1] ;
         H004E2_A134LeaveRequestRejectionReason = new string[] {""} ;
         H004E2_A132LeaveRequestStatus = new string[] {""} ;
         H004E2_A131LeaveRequestDuration = new decimal[1] ;
         H004E2_A128LeaveRequestDate = new DateTime[] {DateTime.MinValue} ;
         H004E2_A124LeaveTypeId = new long[1] ;
         H004E2_A106EmployeeId = new long[1] ;
         H004E2_A133LeaveRequestDescription = new string[] {""} ;
         H004E2_A173LeaveRequestHalfDay = new string[] {""} ;
         H004E2_n173LeaveRequestHalfDay = new bool[] {false} ;
         H004E2_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         H004E2_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestgeneral__default(),
            new Object[][] {
                new Object[] {
               H004E2_A127LeaveRequestId, H004E2_A134LeaveRequestRejectionReason, H004E2_A132LeaveRequestStatus, H004E2_A131LeaveRequestDuration, H004E2_A128LeaveRequestDate, H004E2_A124LeaveTypeId, H004E2_A106EmployeeId, H004E2_A133LeaveRequestDescription, H004E2_A173LeaveRequestHalfDay, H004E2_n173LeaveRequestHalfDay,
               H004E2_A130LeaveRequestEndDate, H004E2_A129LeaveRequestStartDate
               }
            }
         );
         AV19Pgmname = "LeaveRequestGeneral";
      ...
      private long[] H004E2_A127LeaveRequestId ;
      private string[] H004E2_A134LeaveRequestRejectionReason ;
      private string[] H004E2_A132LeaveRequestStatus ;
      private decimal[] H004E2_A131LeaveRequestDuration ;
      private DateTime[] H004E2_A128LeaveRequestDate ;
      private long[] H004E2_A124LeaveTypeId ;
      private long[] H004E2_A106EmployeeId ;
      private string[] H004E2_A133LeaveRequestDescription ;
      private string[] H004E2_A173LeaveRequestHalfDay ;
      private bool[] H004E2_n173LeaveRequestHalfDay ;
      private DateTime[] H004E2_A130LeaveRequestEndDate ;
      private DateTime[] H004E2_A129LeaveRequestStartDate ;
