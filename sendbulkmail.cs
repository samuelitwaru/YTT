   ...
   public class sendbulkmail : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         if ( StringUtil.Contains( AV12Subject, "approved") || StringUtil.Contains( AV12Subject, "rejected") )
         {
            ...
            {
               A109EmployeeEmail = P00AW2_A109EmployeeEmail[0];
               A100CompanyId = P00AW2_A100CompanyId[0];
               A106EmployeeId = P00AW2_A106EmployeeId[0];
            ...
            {
               A112EmployeeIsActive = P00AW3_A112EmployeeIsActive[0];
               A110EmployeeIsManager = P00AW3_A110EmployeeIsManager[0];
               A100CompanyId = P00AW3_A100CompanyId[0];
               A109EmployeeEmail = P00AW3_A109EmployeeEmail[0];
               A148EmployeeName = P00AW3_A148EmployeeName[0];
               A106EmployeeId = P00AW3_A106EmployeeId[0];
      ...
      public override void initialize( )
      {
         ...
         A109EmployeeEmail = "";
         P00AW3_A112EmployeeIsActive = new bool[] {false} ;
         P00AW3_A110EmployeeIsManager = new bool[] {false} ;
         P00AW3_A100CompanyId = new long[1] ;
         P00AW3_A109EmployeeEmail = new string[] {""} ;
         P00AW3_A148EmployeeName = new string[] {""} ;
         P00AW3_A106EmployeeId = new long[1] ;
         A148EmployeeName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sendbulkmail__default(),
            new Object[][] {
                new Object[] {
               P00AW2_A109EmployeeEmail, P00AW2_A100CompanyId, P00AW2_A106EmployeeId
               }
               , new Object[] {
               P00AW3_A112EmployeeIsActive, P00AW3_A110EmployeeIsManager, P00AW3_A100CompanyId, P00AW3_A109EmployeeEmail, P00AW3_A148EmployeeName, P00AW3_A106EmployeeId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00AW2_A109EmployeeEmail ;
      private long[] P00AW2_A100CompanyId ;
      private long[] P00AW2_A106EmployeeId ;
      private bool[] P00AW3_A112EmployeeIsActive ;
      private bool[] P00AW3_A110EmployeeIsManager ;
      private long[] P00AW3_A100CompanyId ;
   ...
   public class sendbulkmail__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00AW2", "SELECT EmployeeEmail, CompanyId, EmployeeId FROM Employee WHERE EmployeeEmail = ( :AV13email) ORDER BY EmployeeEmail ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AW2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00AW3", "SELECT EmployeeIsActive, EmployeeIsManager, CompanyId, EmployeeEmail, EmployeeName, EmployeeId FROM Employee WHERE (CompanyId = :AV16EmployeeCompanyId) AND (EmployeeIsManager = TRUE) AND (EmployeeIsActive = TRUE) ORDER BY CompanyId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AW3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
