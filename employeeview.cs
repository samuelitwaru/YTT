...
namespace GeneXus.Programs {
   public class employeeview : GXDataArea
   {
      public employeeview( )
      {
      ...
      public employeeview( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12EmployeeId = (long)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12EmployeeId", StringUtil.LTrimStr( (decimal)(AV12EmployeeId), 10, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmployeeId), "ZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("employeeview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EmployeeId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"EmployeeId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vEMPLOYEEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12EmployeeId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmployeeId), "ZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Leaverequestwc == null ) )
         {
            WebComp_Leaverequestwc.componentjscripts();
         }
      }
      ...
      {
         return formatLink("employeeview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12EmployeeId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"EmployeeId","TabCode"})  ;
      }
      ...
      protected void WB2U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Employees", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_EmployeeView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_EmployeeView.htm");
            /* Div Control */
      ...
      protected void START2U2( )
      {
         ...
         Form.Meta.addItem("description", "Employee View", 0) ;
         context.wjLoc = "";
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 33 )
                        {
                           ...
                           if ( ( StringUtil.Len( OldProjectwc) == 0 ) || ( StringUtil.StrCmp(OldProjectwc, WebComp_Projectwc_Component) != 0 ) )
                           {
                              ...
                              WebComp_Projectwc.ComponentInit();
                              WebComp_Projectwc.Name = "OldProjectwc";
                        ...
                        else if ( nCmpId == 41 )
                        {
                           ...
                           if ( ( StringUtil.Len( OldLeaverequestwc) == 0 ) || ( StringUtil.StrCmp(OldLeaverequestwc, WebComp_Leaverequestwc_Component) != 0 ) )
                           {
                              ...
                              WebComp_Leaverequestwc.ComponentInit();
                              WebComp_Leaverequestwc.Name = "OldLeaverequestwc";
      ...
      protected void RF2U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Projectwc_Component) != 0 )
               {
                  WebComp_Projectwc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Leaverequestwc_Component) != 0 )
               {
                  WebComp_Leaverequestwc.componentstart();
               }
            }
         }
      ...
      protected void STRUP2U0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12EmployeeId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vEMPLOYEEID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E112U2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("employeeww.aspx") ;
         ...
         {
            A106EmployeeId = H002U2_A106EmployeeId[0];
            A107EmployeeFirstName = H002U2_A107EmployeeFirstName[0];
            AV17GXLvl9 = 1;
            Form.Caption = A107EmployeeFirstName;
      ...
      protected void S112( )
      {
         ...
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV14SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0025",(string)"",(long)AV12EmployeeId});
         ...
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "Project") == 0 ) )
         {
            ...
            if ( true )
            {
               bDynCreated_Projectwc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Projectwc_Component), StringUtil.Lower( "EmployeeProjectWC")) != 0 )
            {
               WebComp_Projectwc = getWebComponent(GetType(), "GeneXus.Programs", "employeeprojectwc", new Object[] {context} );
               WebComp_Projectwc.ComponentInit();
               WebComp_Projectwc.Name = "EmployeeProjectWC";
               WebComp_Projectwc_Component = "EmployeeProjectWC";
            }
            if ( StringUtil.Len( WebComp_Projectwc_Component) != 0 )
            {
         ...
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "LeaveRequest") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Leaverequestwc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Leaverequestwc_Component), StringUtil.Lower( "EmployeeLeaveRequestWC")) != 0 )
            {
               WebComp_Leaverequestwc = getWebComponent(GetType(), "GeneXus.Programs", "employeeleaverequestwc", new Object[] {context} );
               WebComp_Leaverequestwc.ComponentInit();
               WebComp_Leaverequestwc.Name = "EmployeeLeaveRequestWC";
               WebComp_Leaverequestwc_Component = "EmployeeLeaveRequestWC";
            }
            if ( StringUtil.Len( WebComp_Leaverequestwc_Component) != 0 )
            {
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12EmployeeId = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12EmployeeId", StringUtil.LTrimStr( (decimal)(AV12EmployeeId), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmployeeId), "ZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Projectwc == null ) )
         {
            if ( StringUtil.Len( WebComp_Projectwc_Component) != 0 )
            {
               WebComp_Projectwc.componentthemes();
            }
         }
         if ( ! ( WebComp_Leaverequestwc == null ) )
         {
            if ( StringUtil.Len( WebComp_Leaverequestwc_Component) != 0 )
            {
               WebComp_Leaverequestwc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202472223255528", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("employeeview.js", "?202472223255528", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divUnnamedtableleaverequest_Internalname = "UNNAMEDTABLELEAVEREQUEST";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12EmployeeId',fld:'vEMPLOYEEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         OldProjectwc = "";
         lblLeaverequest_title_Jsonclick = "";
         WebComp_Leaverequestwc_Component = "";
         OldLeaverequestwc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.employeeview__default(),
            new Object[][] {
                new Object[] {
               H002U2_A106EmployeeId, H002U2_A107EmployeeFirstName
               }
            }
         );
      ...
      private long wcpOAV12EmployeeId ;
      ...
      private string WebComp_Projectwc_Component ;
      private string OldProjectwc ;
      private string lblLeaverequest_title_Internalname ;
      private string lblLeaverequest_title_Jsonclick ;
      private string divUnnamedtableleaverequest_Internalname ;
      private string WebComp_Leaverequestwc_Component ;
      private string OldLeaverequestwc ;
      private string sEvt ;
      ...
      private long[] H002U2_A106EmployeeId ;
      private string[] H002U2_A107EmployeeFirstName ;
   ...
   public class employeeview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002U2", "SELECT EmployeeId, EmployeeFirstName FROM Employee WHERE EmployeeId = :AV12EmployeeId ORDER BY EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002U2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
