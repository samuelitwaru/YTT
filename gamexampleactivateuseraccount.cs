...
namespace GeneXus.Programs {
   public class gamexampleactivateuseraccount : GXHttpHandler
   {
      ...
      protected void E110E2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV8isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).activateuser(AV5ActivationKey, true, out  AV26GAMErrorCollection);
         if ( AV8isOK )
         {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV29GXV1 = 1;
         while ( AV29GXV1 <= AV26GAMErrorCollection.Count )
         {
            AV25GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV26GAMErrorCollection.Item(AV29GXV1));
            GX_msglist.addItem(AV25GAMError.gxTpr_Message);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249167333165", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleactivateuseraccount.js", "?20249167333169", false, true);
