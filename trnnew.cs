   ...
   public class trnnew : GXDataArea
   {
      ...
      protected void CONFIRM_0Q0( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( IsDlt( ) )
            {
               OnDeleteControls0Q31( ) ;
            }
            else
            {
               CheckExtendedTable0Q31( ) ;
               CloseExtendedTableCursors0Q31( ) ;
            }
         }
         if ( AnyError == 0 )
         {
      ...
      protected void ZM0Q31( short GX_JID )
      {
         if ( ( GX_JID == 3 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z181TrnNewName = T000Q3_A181TrnNewName[0];
               Z182TrnNewDate = T000Q3_A182TrnNewDate[0];
            }
            else
            {
      ...
      protected void Load0Q31( )
      {
         ...
         {
            RcdFound31 = 1;
            A181TrnNewName = T000Q4_A181TrnNewName[0];
            AssignAttri("", false, "A181TrnNewName", A181TrnNewName);
            A182TrnNewDate = T000Q4_A182TrnNewDate[0];
            AssignAttri("", false, "A182TrnNewDate", context.localUtil.Format(A182TrnNewDate, "99/99/99"));
            A40000TrnNewImage_GXI = T000Q4_A40000TrnNewImage_GXI[0];
            ...
            A183TrnNewImage = T000Q4_A183TrnNewImage[0];
            AssignAttri("", false, "A183TrnNewImage", A183TrnNewImage);
            AssignProp("", false, imgTrnNewImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A183TrnNewImage)) ? A40000TrnNewImage_GXI : context.convertURL( context.PathToRelativeUrl( A183TrnNewImage))), true);
            AssignProp("", false, imgTrnNewImage_Internalname, "SrcSet", context.GetImageSrcSet( A183TrnNewImage), true);
            ZM0Q31( -3) ;
      ...
      protected void OnLoadActions0Q31( )
      {
      }

      protected void CheckExtendedTable0Q31( )
      {
         Gx_BScreen = 1;
         standaloneModal( ) ;
      }

      protected void CloseExtendedTableCursors0Q31( )
      {
      }
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM0Q31( 3) ;
            RcdFound31 = 1;
            A180TrnNewId = T000Q3_A180TrnNewId[0];
            AssignAttri("", false, "A180TrnNewId", StringUtil.LTrimStr( (decimal)(A180TrnNewId), 10, 0));
            A181TrnNewName = T000Q3_A181TrnNewName[0];
            AssignAttri("", false, "A181TrnNewName", A181TrnNewName);
            A182TrnNewDate = T000Q3_A182TrnNewDate[0];
            AssignAttri("", false, "A182TrnNewDate", context.localUtil.Format(A182TrnNewDate, "99/99/99"));
            A40000TrnNewImage_GXI = T000Q3_A40000TrnNewImage_GXI[0];
            AssignProp("", false, imgTrnNewImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A183TrnNewImage)) ? A40000TrnNewImage_GXI : context.convertURL( context.PathToRelativeUrl( A183TrnNewImage))), true);
            AssignProp("", false, imgTrnNewImage_Internalname, "SrcSet", context.GetImageSrcSet( A183TrnNewImage), true);
            A183TrnNewImage = T000Q3_A183TrnNewImage[0];
            AssignAttri("", false, "A183TrnNewImage", A183TrnNewImage);
            AssignProp("", false, imgTrnNewImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A183TrnNewImage)) ? A40000TrnNewImage_GXI : context.convertURL( context.PathToRelativeUrl( A183TrnNewImage))), true);
            AssignProp("", false, imgTrnNewImage_Internalname, "SrcSet", context.GetImageSrcSet( A183TrnNewImage), true);
            Z180TrnNewId = A180TrnNewId;
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(4) != 101) && ( ( T000Q6_A180TrnNewId[0] < A180TrnNewId ) ) )
            {
               pr_default.readNext(4);
            }
            if ( (pr_default.getStatus(4) != 101) && ( ( T000Q6_A180TrnNewId[0] > A180TrnNewId ) ) )
            {
               A180TrnNewId = T000Q6_A180TrnNewId[0];
               AssignAttri("", false, "A180TrnNewId", StringUtil.LTrimStr( (decimal)(A180TrnNewId), 10, 0));
               RcdFound31 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(5) != 101) && ( ( T000Q7_A180TrnNewId[0] > A180TrnNewId ) ) )
            {
               pr_default.readNext(5);
            }
            if ( (pr_default.getStatus(5) != 101) && ( ( T000Q7_A180TrnNewId[0] < A180TrnNewId ) ) )
            {
               A180TrnNewId = T000Q7_A180TrnNewId[0];
               AssignAttri("", false, "A180TrnNewId", StringUtil.LTrimStr( (decimal)(A180TrnNewId), 10, 0));
               RcdFound31 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency0Q31( )
      {
         if ( ! IsIns( ) )
         {
            /* Using cursor T000Q2 */
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z181TrnNewName, T000Q2_A181TrnNewName[0]) != 0 ) || ( DateTimeUtil.ResetTime ( Z182TrnNewDate ) != DateTimeUtil.ResetTime ( T000Q2_A182TrnNewDate[0] ) ) )
            {
               if ( StringUtil.StrCmp(Z181TrnNewName, T000Q2_A181TrnNewName[0]) != 0 )
               {
                  GXUtil.WriteLog("trnnew:[seudo value changed for attri]"+"TrnNewName");
                  GXUtil.WriteLogRaw("Old: ",Z181TrnNewName);
                  GXUtil.WriteLogRaw("Current: ",T000Q2_A181TrnNewName[0]);
               }
               if ( DateTimeUtil.ResetTime ( Z182TrnNewDate ) != DateTimeUtil.ResetTime ( T000Q2_A182TrnNewDate[0] ) )
               {
                  GXUtil.WriteLog("trnnew:[seudo value changed for attri]"+"TrnNewDate");
                  GXUtil.WriteLogRaw("Old: ",Z182TrnNewDate);
                  GXUtil.WriteLogRaw("Current: ",T000Q2_A182TrnNewDate[0]);
               }
      ...
      protected void Insert0Q31( )
      {
         ...
         {
            ZM0Q31( 0) ;
            CheckOptimisticConcurrency0Q31( ) ;
            if ( AnyError == 0 )
            {
               AfterConfirm0Q31( ) ;
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     A180TrnNewId = T000Q9_A180TrnNewId[0];
                     AssignAttri("", false, "A180TrnNewId", StringUtil.LTrimStr( (decimal)(A180TrnNewId), 10, 0));
                     pr_default.close(7);
      ...
      protected void DeferredUpdate0Q31( )
      {
         if ( AnyError == 0 )
         {
      ...
      protected void OnDeleteControls0Q31( )
      {
         standaloneModal( ) ;
         /* No delete mode formulas found. */
      }

      protected void EndLevel0Q31( )
      {
         if ( ! IsIns( ) )
         {
            pr_default.close(0);
      ...
      public void ScanStart0Q31( )
      {
         ...
         {
            RcdFound31 = 1;
            A180TrnNewId = T000Q13_A180TrnNewId[0];
            AssignAttri("", false, "A180TrnNewId", StringUtil.LTrimStr( (decimal)(A180TrnNewId), 10, 0));
         }
         /* Load Subordinate Levels */
      }

      protected void ScanNext0Q31( )
      {
         /* Scan next routine */
      ...
      protected void ScanEnd0Q31( )
      {
         pr_default.close(11);
      }

      protected void AfterConfirm0Q31( )
      {
         /* After Confirm Rules */
      }

      protected void BeforeInsert0Q31( )
      {
         /* Before Insert Rules */
      }

      protected void BeforeUpdate0Q31( )
      {
         /* Before Update Rules */
      }

      protected void BeforeDelete0Q31( )
      {
         /* Before Delete Rules */
      }

      protected void BeforeComplete0Q31( )
      {
         /* Before Complete Rules */
      }

      protected void BeforeValidate0Q31( )
      {
         /* Before Validate Rules */
      }

      protected void DisableAttributes0Q31( )
      {
         edtTrnNewId_Enabled = 0;
         AssignProp("", false, edtTrnNewId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtTrnNewId_Enabled), 5, 0), true);
      ...
      protected void send_integrity_lvl_hashes0Q31( )
      {
      }
      ...
      protected void InitializeNonKey0Q31( )
      {
         A181TrnNewName = "";
         AssignAttri("", false, "A181TrnNewName", A181TrnNewName);
         A182TrnNewDate = DateTime.MinValue;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512202232", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trnnew.js", "?2024102512202232", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("AFTER TRN","""{"handler":"E120Q2","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV11TrnContext","fld":"vTRNCONTEXT","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         T000Q4_A180TrnNewId = new long[1] ;
         T000Q4_A181TrnNewName = new string[] {""} ;
         T000Q4_A182TrnNewDate = new DateTime[] {DateTime.MinValue} ;
         T000Q4_A40000TrnNewImage_GXI = new string[] {""} ;
         T000Q4_A183TrnNewImage = new string[] {""} ;
         T000Q5_A180TrnNewId = new long[1] ;
         T000Q3_A180TrnNewId = new long[1] ;
         T000Q3_A181TrnNewName = new string[] {""} ;
         T000Q3_A182TrnNewDate = new DateTime[] {DateTime.MinValue} ;
         T000Q3_A40000TrnNewImage_GXI = new string[] {""} ;
         T000Q3_A183TrnNewImage = new string[] {""} ;
         T000Q6_A180TrnNewId = new long[1] ;
         T000Q7_A180TrnNewId = new long[1] ;
         T000Q2_A180TrnNewId = new long[1] ;
         T000Q2_A181TrnNewName = new string[] {""} ;
         T000Q2_A182TrnNewDate = new DateTime[] {DateTime.MinValue} ;
         T000Q2_A40000TrnNewImage_GXI = new string[] {""} ;
         T000Q2_A183TrnNewImage = new string[] {""} ;
         T000Q9_A180TrnNewId = new long[1] ;
         T000Q13_A180TrnNewId = new long[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXCCtlgxBlob = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trnnew__default(),
            new Object[][] {
                new Object[] {
               T000Q2_A180TrnNewId, T000Q2_A181TrnNewName, T000Q2_A182TrnNewDate, T000Q2_A40000TrnNewImage_GXI, T000Q2_A183TrnNewImage
               }
               , new Object[] {
               T000Q3_A180TrnNewId, T000Q3_A181TrnNewName, T000Q3_A182TrnNewDate, T000Q3_A40000TrnNewImage_GXI, T000Q3_A183TrnNewImage
               }
               , new Object[] {
               T000Q4_A180TrnNewId, T000Q4_A181TrnNewName, T000Q4_A182TrnNewDate, T000Q4_A40000TrnNewImage_GXI, T000Q4_A183TrnNewImage
               }
               , new Object[] {
               T000Q5_A180TrnNewId
               }
      ...
      private long[] T000Q4_A180TrnNewId ;
      private string[] T000Q4_A181TrnNewName ;
      private DateTime[] T000Q4_A182TrnNewDate ;
      private string[] T000Q4_A40000TrnNewImage_GXI ;
      private string[] T000Q4_A183TrnNewImage ;
      private long[] T000Q5_A180TrnNewId ;
      private long[] T000Q3_A180TrnNewId ;
      private string[] T000Q3_A181TrnNewName ;
      private DateTime[] T000Q3_A182TrnNewDate ;
      private string[] T000Q3_A40000TrnNewImage_GXI ;
      private string[] T000Q3_A183TrnNewImage ;
      private long[] T000Q6_A180TrnNewId ;
      private long[] T000Q7_A180TrnNewId ;
      private long[] T000Q2_A180TrnNewId ;
      private string[] T000Q2_A181TrnNewName ;
      private DateTime[] T000Q2_A182TrnNewDate ;
      private string[] T000Q2_A40000TrnNewImage_GXI ;
      private string[] T000Q2_A183TrnNewImage ;
      private long[] T000Q9_A180TrnNewId ;
      private long[] T000Q13_A180TrnNewId ;
 ...
 public class trnnew__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
            new CursorDef("T000Q2", "SELECT TrnNewId, TrnNewName, TrnNewDate, TrnNewImage_GXI, TrnNewImage FROM TrnNew WHERE TrnNewId = :TrnNewId  FOR UPDATE OF TrnNew NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT000Q2,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000Q3", "SELECT TrnNewId, TrnNewName, TrnNewDate, TrnNewImage_GXI, TrnNewImage FROM TrnNew WHERE TrnNewId = :TrnNewId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000Q3,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000Q4", "SELECT TM1.TrnNewId, TM1.TrnNewName, TM1.TrnNewDate, TM1.TrnNewImage_GXI, TM1.TrnNewImage FROM TrnNew TM1 WHERE TM1.TrnNewId = :TrnNewId ORDER BY TM1.TrnNewId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000Q4,100, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000Q5", "SELECT TrnNewId FROM TrnNew WHERE TrnNewId = :TrnNewId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000Q5,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000Q6", "SELECT TrnNewId FROM TrnNew WHERE ( TrnNewId > :TrnNewId) ORDER BY TrnNewId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000Q6,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T000Q7", "SELECT TrnNewId FROM TrnNew WHERE ( TrnNewId < :TrnNewId) ORDER BY TrnNewId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT000Q7,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T000Q8", "SAVEPOINT gxupdate;INSERT INTO TrnNew(TrnNewName, TrnNewDate, TrnNewImage, TrnNewImage_GXI) VALUES(:TrnNewName, :TrnNewDate, :TrnNewImage, :TrnNewImage_GXI);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmT000Q8)
           ,new CursorDef("T000Q9", "SELECT currval('TrnNewId') ",true, GxErrorMask.GX_NOMASK, false, this,prmT000Q9,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000Q10", "SAVEPOINT gxupdate;UPDATE TrnNew SET TrnNewName=:TrnNewName, TrnNewDate=:TrnNewDate  WHERE TrnNewId = :TrnNewId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000Q10)
           ,new CursorDef("T000Q11", "SAVEPOINT gxupdate;UPDATE TrnNew SET TrnNewImage=:TrnNewImage, TrnNewImage_GXI=:TrnNewImage_GXI  WHERE TrnNewId = :TrnNewId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000Q11)
           ,new CursorDef("T000Q12", "SAVEPOINT gxupdate;DELETE FROM TrnNew  WHERE TrnNewId = :TrnNewId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000Q12)
           ,new CursorDef("T000Q13", "SELECT TrnNewId FROM TrnNew ORDER BY TrnNewId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000Q13,100, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
