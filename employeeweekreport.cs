...
namespace GeneXus.Programs {
   public class employeeweekreport : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         ajax_req_read_hidden_sdt(GetNextPar( ), AV61ProjectId);
         ...
         gxgrGrid_refresh( subGrid_Rows, AV97Pgmname, AV50DateRange, AV52DateRange_To, AV45CompanyLocationId, AV60EmployeeIds, AV61ProjectId, AV15SDTEmployeeWeekReports) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vPROJECTID", AV61ProjectId);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vPROJECTID", AV61ProjectId);
         }
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void WB580( )
      {
         ...
         if ( wbEnd == 40 )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
            ucUc_setweektableheaders1.Render(context, "uc_setweektableheaders", Uc_setweektableheaders1_Internalname, "UC_SETWEEKTABLEHEADERS1Container");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       GxSimpleCollection<long> AV61ProjectId ,
      ...
      protected void E17582( )
      {
         ...
         this.executeUsercontrolMethod("", false, "UC_SETWEEKTABLEHEADERS1Container", "Refresh", "", new Object[] {(DateTime)AV50DateRange,(DateTime)AV52DateRange_To});
      ...
      private void E18582( )
      {
         ...
         while ( AV71GXV1 <= AV15SDTEmployeeWeekReports.Count )
         {
            ...
            else if ( ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Mon > ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Dailyexpected )
            {
            ...
            else if ( ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Tue > ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Dailyexpected )
            {
            ...
            else if ( ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Wed > ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Dailyexpected )
            {
            ...
            else if ( ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Thu > ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Dailyexpected )
            {
            ...
            else if ( ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Fri > ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Dailyexpected )
            {
            ...
            if ( (Convert.ToDecimal( ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Total ) > ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Expected ) )
            {
            ...
            else if ( (Convert.ToDecimal( ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Total ) < ((SdtSDTEmployeeWeekReport)(AV15SDTEmployeeWeekReports.CurrentItem)).gxTpr_Expected ) )
            {
      ...
      protected void S122( )
      {
         ...
         new prc_employeeweekreport(context ).execute(  AV50DateRange,  AV52DateRange_To,  AV45CompanyLocationId,  AV60EmployeeIds,  AV61ProjectId, out  GXt_objcol_SdtSDTEmployeeWeekReport7) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20255211112892", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("employeeweekreport.js", "?20255211112892", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_402( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_40_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavSdtemployeeweekreports__expected_Internalname,StringUtil.LTrim( StringUtil.NToC( ((SdtSDTEmployeeWeekReport)AV15SDTEmployeeWeekReports.Item(AV71GXV1)).gxTpr_Expected, 10, 2, ".", "")),StringUtil.LTrim( ((edtavSdtemployeeweekreports__expected_Enabled!=0) ? context.localUtil.Format( ((SdtSDTEmployeeWeekReport)AV15SDTEmployeeWeekReports.Item(AV71GXV1)).gxTpr_Expected, "ZZZZZZ9.99") : context.localUtil.Format( ((SdtSDTEmployeeWeekReport)AV15SDTEmployeeWeekReports.Item(AV71GXV1)).gxTpr_Expected, "ZZZZZZ9.99"))),""+" onchange=\""+"gx.num.valid_decimal( this, ',','.','2');"+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavSdtemployeeweekreports__expected_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavSdtemployeeweekreports__expected_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)10,(short)0,(short)0,(short)40,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+"display:none;"+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         Uc_setweektableheaders1_Internalname = "UC_SETWEEKTABLEHEADERS1";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV15SDTEmployeeWeekReports","fld":"vSDTEMPLOYEEWEEKREPORTS","grid":40},{"av":"nGXsfl_40_idx","ctrl":"GRID","prop":"GridCurrRow","grid":40},{"av":"nRC_GXsfl_40","ctrl":"GRID","prop":"GridRC","grid":40},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV97Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV50DateRange","fld":"vDATERANGE"},{"av":"AV52DateRange_To","fld":"vDATERANGE_TO"},{"av":"AV45CompanyLocationId","fld":"vCOMPANYLOCATIONID"},{"av":"AV60EmployeeIds","fld":"vEMPLOYEEIDS"},{"av":"AV61ProjectId","fld":"vPROJECTID"}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E13582","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV97Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV50DateRange","fld":"vDATERANGE"},{"av":"AV52DateRange_To","fld":"vDATERANGE_TO"},{"av":"AV45CompanyLocationId","fld":"vCOMPANYLOCATIONID"},{"av":"AV60EmployeeIds","fld":"vEMPLOYEEIDS"},{"av":"AV61ProjectId","fld":"vPROJECTID"},{"av":"AV15SDTEmployeeWeekReports","fld":"vSDTEMPLOYEEWEEKREPORTS","grid":40},{"av":"nGXsfl_40_idx","ctrl":"GRID","prop":"GridCurrRow","grid":40},{"av":"nRC_GXsfl_40","ctrl":"GRID","prop":"GridRC","grid":40},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
      ...
      public override void initialize( )
      {
         ...
         ucUc_setweektableheaders1 = new GXUserControl();
      ...
      private string Uc_setweektableheaders1_Internalname ;
      ...
      private GXUserControl ucUc_setweektableheaders1 ;
