...
namespace GeneXus.Programs {
   public class leaverequestview : GXDataArea
   {
      ...
      public leaverequestview( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10LeaveRequestId = (long)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV10LeaveRequestId", StringUtil.LTrimStr( (decimal)(AV10LeaveRequestId), 10, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vLEAVEREQUESTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10LeaveRequestId), "ZZZZZZZZZ9"), context));
      ...
      {
         get {
            return "leaverequestview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("leaverequestview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10LeaveRequestId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"LeaveRequestId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vLEAVEREQUESTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10LeaveRequestId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vLEAVEREQUESTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10LeaveRequestId), "ZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("leaverequestview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10LeaveRequestId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"LeaveRequestId","TabCode"})  ;
      }
      ...
      protected void WB4B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Leave Request", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_LeaveRequestView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_LeaveRequestView.htm");
            /* Div Control */
      ...
      protected void STRUP4B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10LeaveRequestId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vLEAVEREQUESTID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "LeaveRequestGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "leaverequestgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "LeaveRequestGeneral";
               WebComp_Generalwc_Component = "LeaveRequestGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0025",(string)"",(long)AV10LeaveRequestId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10LeaveRequestId = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV10LeaveRequestId", StringUtil.LTrimStr( (decimal)(AV10LeaveRequestId), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vLEAVEREQUESTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10LeaveRequestId), "ZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512265967", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("leaverequestview.js", "?2024102512265967", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Leave Request View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestview__default(),
            new Object[][] {
                new Object[] {
               H004B2_A127LeaveRequestId, H004B2_A128LeaveRequestDate
               }
            }
         );
   ...
   public class leaverequestview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004B2", "SELECT LeaveRequestId, LeaveRequestDate FROM LeaveRequest WHERE LeaveRequestId = :AV10LeaveRequestId ORDER BY LeaveRequestId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004B2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
