...
namespace GeneXus.Programs {
   public class testprojectlogsbyemployeegetfilterdata : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         testprojectlogsbyemployeegetfilterdata objtestprojectlogsbyemployeegetfilterdata;
         objtestprojectlogsbyemployeegetfilterdata = new testprojectlogsbyemployeegetfilterdata();
         objtestprojectlogsbyemployeegetfilterdata.AV35DDOName = aP0_DDOName;
         objtestprojectlogsbyemployeegetfilterdata.AV36SearchTxtParms = aP1_SearchTxtParms;
         objtestprojectlogsbyemployeegetfilterdata.AV37SearchTxtTo = aP2_SearchTxtTo;
         objtestprojectlogsbyemployeegetfilterdata.AV38OptionsJson = "" ;
         objtestprojectlogsbyemployeegetfilterdata.AV39OptionsDescJson = "" ;
         objtestprojectlogsbyemployeegetfilterdata.AV40OptionIndexesJson = "" ;
         objtestprojectlogsbyemployeegetfilterdata.context.SetSubmitInitialConfig(context);
         objtestprojectlogsbyemployeegetfilterdata.initialize();
         Submit( executePrivateCatch,objtestprojectlogsbyemployeegetfilterdata);
         aP3_OptionsJson=this.AV38OptionsJson;
         aP4_OptionsDescJson=this.AV39OptionsDescJson;
         aP5_OptionIndexesJson=this.AV40OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((testprojectlogsbyemployeegetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S111( )
      {
         ...
         {
            AV32GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "TestProjectLogsByEmployeeGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         {
            BRKBF2 = false;
            A102ProjectId = P00BF2_A102ProjectId[0];
            A120WorkHourLogDuration = P00BF2_A120WorkHourLogDuration[0];
            A103ProjectName = P00BF2_A103ProjectName[0];
            A123WorkHourLogDescription = P00BF2_A123WorkHourLogDescription[0];
            A119WorkHourLogDate = P00BF2_A119WorkHourLogDate[0];
            A118WorkHourLogId = P00BF2_A118WorkHourLogId[0];
            A103ProjectName = P00BF2_A103ProjectName[0];
            AV29count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00BF2_A120WorkHourLogDuration[0], A120WorkHourLogDuration) == 0 ) )
            {
               BRKBF2 = false;
               A118WorkHourLogId = P00BF2_A118WorkHourLogId[0];
      ...
      protected void S131( )
      {
         ...
         {
            BRKBF4 = false;
            A102ProjectId = P00BF3_A102ProjectId[0];
            A123WorkHourLogDescription = P00BF3_A123WorkHourLogDescription[0];
            A103ProjectName = P00BF3_A103ProjectName[0];
            A120WorkHourLogDuration = P00BF3_A120WorkHourLogDuration[0];
            A119WorkHourLogDate = P00BF3_A119WorkHourLogDate[0];
            A118WorkHourLogId = P00BF3_A118WorkHourLogId[0];
            A103ProjectName = P00BF3_A103ProjectName[0];
            AV29count = 0;
            while ( (pr_default.getStatus(1) != 101) && ( StringUtil.StrCmp(P00BF3_A123WorkHourLogDescription[0], A123WorkHourLogDescription) == 0 ) )
            {
               BRKBF4 = false;
               A118WorkHourLogId = P00BF3_A118WorkHourLogId[0];
               AV29count = (long)(AV29count+1);
      ...
      protected void S141( )
      {
         ...
         {
            BRKBF6 = false;
            A102ProjectId = P00BF4_A102ProjectId[0];
            A103ProjectName = P00BF4_A103ProjectName[0];
            A123WorkHourLogDescription = P00BF4_A123WorkHourLogDescription[0];
            A120WorkHourLogDuration = P00BF4_A120WorkHourLogDuration[0];
            A119WorkHourLogDate = P00BF4_A119WorkHourLogDate[0];
            A118WorkHourLogId = P00BF4_A118WorkHourLogId[0];
            A103ProjectName = P00BF4_A103ProjectName[0];
            AV29count = 0;
            while ( (pr_default.getStatus(2) != 101) && ( StringUtil.StrCmp(P00BF4_A103ProjectName[0], A103ProjectName) == 0 ) )
            {
               BRKBF6 = false;
               A102ProjectId = P00BF4_A102ProjectId[0];
               A118WorkHourLogId = P00BF4_A118WorkHourLogId[0];
      ...
      public override void initialize( )
      {
         ...
         P00BF2_A102ProjectId = new long[1] ;
         P00BF2_A120WorkHourLogDuration = new string[] {""} ;
         P00BF2_A103ProjectName = new string[] {""} ;
         P00BF2_A123WorkHourLogDescription = new string[] {""} ;
         P00BF2_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P00BF2_A118WorkHourLogId = new long[1] ;
         AV24Option = "";
         P00BF3_A102ProjectId = new long[1] ;
         P00BF3_A123WorkHourLogDescription = new string[] {""} ;
         P00BF3_A103ProjectName = new string[] {""} ;
         P00BF3_A120WorkHourLogDuration = new string[] {""} ;
         P00BF3_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P00BF3_A118WorkHourLogId = new long[1] ;
         P00BF4_A102ProjectId = new long[1] ;
         P00BF4_A103ProjectName = new string[] {""} ;
         P00BF4_A123WorkHourLogDescription = new string[] {""} ;
         P00BF4_A120WorkHourLogDuration = new string[] {""} ;
         P00BF4_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P00BF4_A118WorkHourLogId = new long[1] ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.testprojectlogsbyemployeegetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00BF2_A102ProjectId, P00BF2_A120WorkHourLogDuration, P00BF2_A103ProjectName, P00BF2_A123WorkHourLogDescription, P00BF2_A119WorkHourLogDate, P00BF2_A118WorkHourLogId
               }
               , new Object[] {
               P00BF3_A102ProjectId, P00BF3_A123WorkHourLogDescription, P00BF3_A103ProjectName, P00BF3_A120WorkHourLogDuration, P00BF3_A119WorkHourLogDate, P00BF3_A118WorkHourLogId
               }
               , new Object[] {
               P00BF4_A102ProjectId, P00BF4_A103ProjectName, P00BF4_A123WorkHourLogDescription, P00BF4_A120WorkHourLogDuration, P00BF4_A119WorkHourLogDate, P00BF4_A118WorkHourLogId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P00BF2_A102ProjectId ;
      private string[] P00BF2_A120WorkHourLogDuration ;
      private string[] P00BF2_A103ProjectName ;
      private string[] P00BF2_A123WorkHourLogDescription ;
      private DateTime[] P00BF2_A119WorkHourLogDate ;
      private long[] P00BF2_A118WorkHourLogId ;
      private long[] P00BF3_A102ProjectId ;
      private string[] P00BF3_A123WorkHourLogDescription ;
      private string[] P00BF3_A103ProjectName ;
      private string[] P00BF3_A120WorkHourLogDuration ;
      private DateTime[] P00BF3_A119WorkHourLogDate ;
      private long[] P00BF3_A118WorkHourLogId ;
      private long[] P00BF4_A102ProjectId ;
      private string[] P00BF4_A103ProjectName ;
      private string[] P00BF4_A123WorkHourLogDescription ;
      private string[] P00BF4_A120WorkHourLogDuration ;
      private DateTime[] P00BF4_A119WorkHourLogDate ;
      private long[] P00BF4_A118WorkHourLogId ;
   ...
   public class testprojectlogsbyemployeegetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             DateTime A119WorkHourLogDate )
      {
         ...
         {
            AddWhere(sWhereString, "(LOWER(T1.WorkHourLogDuration) like LOWER(:lV47Testprojectlogsbyemployeeds_4_tfworkhourlogduration))");
         }
         else
         {
            GXv_int1[5] = 1;
         ...
         {
            AddWhere(sWhereString, "(LOWER(T1.WorkHourLogDescription) like LOWER(:lV49Testprojectlogsbyemployeeds_6_tfworkhourlogdescription))");
         }
         else
         {
            GXv_int1[7] = 1;
         ...
         {
            AddWhere(sWhereString, "(LOWER(T2.ProjectName) like LOWER(:lV51Testprojectlogsbyemployeeds_8_tfprojectname))");
         }
         else
         {
            GXv_int1[9] = 1;
      ...
      protected Object[] conditional_P00BF3( IGxContext context ,
                                             string AV44Testprojectlogsbyemployeeds_1_filterfulltext ,
                                             DateTime AV45Testprojectlogsbyemployeeds_2_tfworkhourlogdate ,
                                             DateTime AV46Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to ,
                                             string AV48Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel ,
      ...
      protected Object[] conditional_P00BF4( IGxContext context ,
                                             string AV44Testprojectlogsbyemployeeds_1_filterfulltext ,
                                             DateTime AV45Testprojectlogsbyemployeeds_2_tfworkhourlogdate ,
                                             DateTime AV46Testprojectlogsbyemployeeds_3_tfworkhourlogdate_to ,
                                             string AV48Testprojectlogsbyemployeeds_5_tfworkhourlogduration_sel ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00BF2(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (DateTime)dynConstraints[12] );
               case 1 :
                     return conditional_P00BF3(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (DateTime)dynConstraints[12] );
               case 2 :
                     return conditional_P00BF4(context, (string)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (DateTime)dynConstraints[12] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00BF3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BF3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00BF4", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BF4,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
