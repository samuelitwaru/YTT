...
namespace GeneXus.Programs {
   public class holidayview : GXDataArea
   {
      public holidayview( )
      {
      ...
      public holidayview( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12HolidayId = (long)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12HolidayId", StringUtil.LTrimStr( (decimal)(AV12HolidayId), 10, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vHOLIDAYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12HolidayId), "ZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("holidayview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12HolidayId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"HolidayId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vHOLIDAYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12HolidayId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vHOLIDAYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12HolidayId), "ZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("holidayview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12HolidayId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"HolidayId","TabCode"})  ;
      }
      ...
      protected void WB2K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to National Holidays", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_HolidayView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_HolidayView.htm");
            /* Div Control */
      ...
      protected void STRUP2K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12HolidayId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vHOLIDAYID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E112K2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("holidayww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H002K2 */
         pr_default.execute(0, new Object[] {AV12HolidayId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A113HolidayId = H002K2_A113HolidayId[0];
            A114HolidayName = H002K2_A114HolidayName[0];
            AV16GXLvl9 = 1;
            Form.Caption = A114HolidayName;
      ...
      protected void S112( )
      {
         ...
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV14SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "HolidayGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "holidaygeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "HolidayGeneral";
               WebComp_Generalwc_Component = "HolidayGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0025",(string)"",(long)AV12HolidayId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12HolidayId = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12HolidayId", StringUtil.LTrimStr( (decimal)(AV12HolidayId), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vHOLIDAYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12HolidayId), "ZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512253886", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("holidayview.js", "?2024102512253887", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.holidayview__default(),
            new Object[][] {
                new Object[] {
               H002K2_A113HolidayId, H002K2_A114HolidayName
               }
            }
         );
      ...
      private int idxLst ;
      private long AV12HolidayId ;
      private long wcpOAV12HolidayId ;
   ...
   public class holidayview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV12HolidayId",GXType.Int64,10,0)
          };
          def= new CursorDef[] {
              new CursorDef("H002K2", "SELECT HolidayId, HolidayName FROM Holiday WHERE HolidayId = :AV12HolidayId ORDER BY HolidayId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
