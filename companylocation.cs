   ...
   public class companylocation : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
         {
            ...
            {
               AV13CompanyLocationId = (long)(Math.Round(NumberUtil.Val( GetPar( "CompanyLocationId"), "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV13CompanyLocationId", StringUtil.LTrimStr( (decimal)(AV13CompanyLocationId), 10, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vCOMPANYLOCATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13CompanyLocationId), "ZZZZZZZZZ9"), context));
            }
         }
         if ( toggleJsOutput )
         {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtCompanyLocationName_Internalname, StringUtil.RTrim( A158CompanyLocationName), StringUtil.RTrim( context.localUtil.Format( A158CompanyLocationName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,20);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCompanyLocationName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCompanyLocationName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_CompanyLocation.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         GxWebStd.gx_single_line_edit( context, edtCompanyLocationCode_Internalname, StringUtil.RTrim( A159CompanyLocationCode), StringUtil.RTrim( context.localUtil.Format( A159CompanyLocationCode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,24);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCompanyLocationCode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCompanyLocationCode_Enabled, 1, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_CompanyLocation.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Gx_mode = cgiGet( "Mode");
               AV13CompanyLocationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vCOMPANYLOCATIONID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void standaloneNotModal( )
      {
         ...
         if ( ! (0==AV13CompanyLocationId) )
         {
            A157CompanyLocationId = AV13CompanyLocationId;
            AssignAttri("", false, "A157CompanyLocationId", StringUtil.LTrimStr( (decimal)(A157CompanyLocationId), 10, 0));
         }
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCOMPANYLOCATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13CompanyLocationId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOMPANYLOCATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13CompanyLocationId), "ZZZZZZZZZ9"), context));
      }
      ...
      {
         return formatLink("companylocation.aspx", new object[] {UrlEncode(StringUtil.RTrim(Gx_mode)),UrlEncode(StringUtil.LTrimStr(AV13CompanyLocationId,10,0))}, new string[] {"Gx_mode","CompanyLocationId"})  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202462110184670", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("companylocation.js", "?202462110184670", false, true);
      ...
      private int idxLst ;
      private long wcpOAV13CompanyLocationId ;
      private long Z157CompanyLocationId ;
      private long AV13CompanyLocationId ;
