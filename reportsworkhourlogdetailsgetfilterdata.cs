...
namespace GeneXus.Programs {
   public class reportsworkhourlogdetailsgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV30GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "ReportsWorkHourLogDetailsGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A102ProjectId = P009U2_A102ProjectId[0];
            A103ProjectName = P009U2_A103ProjectName[0];
            A123WorkHourLogDescription = P009U2_A123WorkHourLogDescription[0];
            A120WorkHourLogDuration = P009U2_A120WorkHourLogDuration[0];
            A119WorkHourLogDate = P009U2_A119WorkHourLogDate[0];
            A118WorkHourLogId = P009U2_A118WorkHourLogId[0];
            A103ProjectName = P009U2_A103ProjectName[0];
            AV27count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P009U2_A103ProjectName[0], A103ProjectName) == 0 ) )
            {
               BRK9U2 = false;
               A102ProjectId = P009U2_A102ProjectId[0];
               A118WorkHourLogId = P009U2_A118WorkHourLogId[0];
      ...
      protected void S131( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A102ProjectId = P009U3_A102ProjectId[0];
            A120WorkHourLogDuration = P009U3_A120WorkHourLogDuration[0];
            A123WorkHourLogDescription = P009U3_A123WorkHourLogDescription[0];
            A103ProjectName = P009U3_A103ProjectName[0];
            A119WorkHourLogDate = P009U3_A119WorkHourLogDate[0];
            A118WorkHourLogId = P009U3_A118WorkHourLogId[0];
            A103ProjectName = P009U3_A103ProjectName[0];
            AV27count = 0;
            while ( (pr_default.getStatus(1) != 101) && ( StringUtil.StrCmp(P009U3_A120WorkHourLogDuration[0], A120WorkHourLogDuration) == 0 ) )
            {
               BRK9U4 = false;
               A118WorkHourLogId = P009U3_A118WorkHourLogId[0];
               AV27count = (long)(AV27count+1);
      ...
      protected void S141( )
      {
         ...
         {
            BRK9U6 = false;
            A106EmployeeId = P009U4_A106EmployeeId[0];
            A102ProjectId = P009U4_A102ProjectId[0];
            A123WorkHourLogDescription = P009U4_A123WorkHourLogDescription[0];
            A120WorkHourLogDuration = P009U4_A120WorkHourLogDuration[0];
            A103ProjectName = P009U4_A103ProjectName[0];
            A119WorkHourLogDate = P009U4_A119WorkHourLogDate[0];
            A118WorkHourLogId = P009U4_A118WorkHourLogId[0];
            A103ProjectName = P009U4_A103ProjectName[0];
            AV27count = 0;
            while ( (pr_default.getStatus(2) != 101) && ( StringUtil.StrCmp(P009U4_A123WorkHourLogDescription[0], A123WorkHourLogDescription) == 0 ) )
            {
               BRK9U6 = false;
               A118WorkHourLogId = P009U4_A118WorkHourLogId[0];
               AV27count = (long)(AV27count+1);
      ...
      public override void initialize( )
      {
         ...
         P009U2_A102ProjectId = new long[1] ;
         P009U2_A103ProjectName = new string[] {""} ;
         P009U2_A123WorkHourLogDescription = new string[] {""} ;
         P009U2_A120WorkHourLogDuration = new string[] {""} ;
         P009U2_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P009U2_A118WorkHourLogId = new long[1] ;
         AV22Option = "";
         P009U3_A106EmployeeId = new long[1] ;
         P009U3_A102ProjectId = new long[1] ;
         P009U3_A120WorkHourLogDuration = new string[] {""} ;
         P009U3_A123WorkHourLogDescription = new string[] {""} ;
         P009U3_A103ProjectName = new string[] {""} ;
         P009U3_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P009U3_A118WorkHourLogId = new long[1] ;
         P009U4_A106EmployeeId = new long[1] ;
         P009U4_A102ProjectId = new long[1] ;
         P009U4_A123WorkHourLogDescription = new string[] {""} ;
         P009U4_A120WorkHourLogDuration = new string[] {""} ;
         P009U4_A103ProjectName = new string[] {""} ;
         P009U4_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P009U4_A118WorkHourLogId = new long[1] ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportsworkhourlogdetailsgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P009U2_A106EmployeeId, P009U2_A102ProjectId, P009U2_A103ProjectName, P009U2_A123WorkHourLogDescription, P009U2_A120WorkHourLogDuration, P009U2_A119WorkHourLogDate, P009U2_A118WorkHourLogId
               }
               , new Object[] {
               P009U3_A106EmployeeId, P009U3_A102ProjectId, P009U3_A120WorkHourLogDuration, P009U3_A123WorkHourLogDescription, P009U3_A103ProjectName, P009U3_A119WorkHourLogDate, P009U3_A118WorkHourLogId
               }
               , new Object[] {
               P009U4_A106EmployeeId, P009U4_A102ProjectId, P009U4_A123WorkHourLogDescription, P009U4_A120WorkHourLogDuration, P009U4_A103ProjectName, P009U4_A119WorkHourLogDate, P009U4_A118WorkHourLogId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P009U2_A103ProjectName ;
      private string[] P009U2_A123WorkHourLogDescription ;
      private string[] P009U2_A120WorkHourLogDuration ;
      private DateTime[] P009U2_A119WorkHourLogDate ;
      private long[] P009U2_A118WorkHourLogId ;
      private long[] P009U3_A106EmployeeId ;
      private long[] P009U3_A102ProjectId ;
      private string[] P009U3_A120WorkHourLogDuration ;
      private string[] P009U3_A123WorkHourLogDescription ;
      private string[] P009U3_A103ProjectName ;
      private DateTime[] P009U3_A119WorkHourLogDate ;
      private long[] P009U3_A118WorkHourLogId ;
      private long[] P009U4_A106EmployeeId ;
      private long[] P009U4_A102ProjectId ;
      private string[] P009U4_A123WorkHourLogDescription ;
      private string[] P009U4_A120WorkHourLogDuration ;
      private string[] P009U4_A103ProjectName ;
      private DateTime[] P009U4_A119WorkHourLogDate ;
      private long[] P009U4_A118WorkHourLogId ;
   ...
   public class reportsworkhourlogdetailsgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
      ...
      protected Object[] conditional_P009U4( IGxContext context ,
                                             DateTime AV47Reportsworkhourlogdetailsds_1_tfworkhourlogdate ,
                                             DateTime AV48Reportsworkhourlogdetailsds_2_tfworkhourlogdate_to ,
                                             string AV50Reportsworkhourlogdetailsds_4_tfprojectname_sel ,
                                             string AV49Reportsworkhourlogdetailsds_3_tfprojectname ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P009U2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (DateTime)dynConstraints[8] , (DateTime)dynConstraints[9] , (DateTime)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (long)dynConstraints[14] , (long)dynConstraints[15] , (long)dynConstraints[16] , (long)dynConstraints[17] );
               case 1 :
                     return conditional_P009U3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (DateTime)dynConstraints[8] , (DateTime)dynConstraints[9] , (DateTime)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (long)dynConstraints[14] , (long)dynConstraints[15] , (long)dynConstraints[16] , (long)dynConstraints[17] );
               case 2 :
                     return conditional_P009U4(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (DateTime)dynConstraints[8] , (DateTime)dynConstraints[9] , (DateTime)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (long)dynConstraints[14] , (long)dynConstraints[15] , (long)dynConstraints[16] , (long)dynConstraints[17] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P009U4", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP009U4,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
