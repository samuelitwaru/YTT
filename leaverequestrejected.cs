   ...
   public class leaverequestrejected : GXWebComponent
   {
      ...
      protected void RF3B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV83Leaverequestrejectedds_16_tfemployeename = StringUtil.PadR( StringUtil.RTrim( AV83Leaverequestrejectedds_16_tfemployeename), 100, "%");
            /* Using cursor H003B2 */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202451916132550", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("leaverequestrejected.js", "?202451916132550", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
   ...
   public class leaverequestrejected__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV83Leaverequestrejectedds_16_tfemployeename",GXType.Char,100,0) ,
          new ParDef("AV84Leaverequestrejectedds_17_tfemployeename_sel",GXType.Char,100,0) ,
