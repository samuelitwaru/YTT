...
namespace GeneXus.Programs {
   public class downloadapp : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20246282116973", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("downloadapp.js", "?20246282116975", false, true);
            context.AddJavascriptSource("UserControls/DownloadAppJsRender.js", "", false, true);
         }
