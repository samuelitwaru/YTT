   ...
   public class aprojectsincompanytest : GXWebProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            AV12ProjectId.Add(166, 0);
            AV12ProjectId.Add(167, 0);
            AV12ProjectId.Add(151, 0);
            AV12ProjectId.Add(121, 0);
            AV12ProjectId.Add(80, 0);
            AV12ProjectId.Add(120, 0);
            /* Using cursor P00882 */
            pr_default.execute(0);
            while ( (pr_default.getStatus(0) != 101) )
            {
               A106EmployeeId = P00882_A106EmployeeId[0];
               A102ProjectId = P00882_A102ProjectId[0];
               A103ProjectName = P00882_A103ProjectName[0];
               n103ProjectName = P00882_n103ProjectName[0];
               A148EmployeeName = P00882_A148EmployeeName[0];
               A148EmployeeName = P00882_A148EmployeeName[0];
               A103ProjectName = P00882_A103ProjectName[0];
               n103ProjectName = P00882_n103ProjectName[0];
               H880( false, 47) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A148EmployeeName, "")), 50, Gx_line+11, 718, Gx_line+26, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
               ...
               {
                  A166ProjectManagerId = P00884_A166ProjectManagerId[0];
                  n166ProjectManagerId = P00884_n166ProjectManagerId[0];
                  A40000GXC1 = P00884_A40000GXC1[0];
                  n40000GXC1 = P00884_n40000GXC1[0];
                  A40001GXC2 = P00884_A40001GXC2[0];
                  n40001GXC2 = P00884_n40001GXC2[0];
                  A40000GXC1 = P00884_A40000GXC1[0];
                  n40000GXC1 = P00884_n40000GXC1[0];
                  A40001GXC2 = P00884_A40001GXC2[0];
                  n40001GXC2 = P00884_n40001GXC2[0];
                  AV10Count = (short)(A40000GXC1*60+A40001GXC2);
                  AV9Name = A103ProjectName;
                  H880( false, 58) ;
                  getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
                  getPrinter().GxDrawText(StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10Count), "ZZZ9")), 622, Gx_line+11, 700, Gx_line+26, 2, 0, 0, 0) ;
      ...
      public override void initialize( )
      {
         ...
         P00882_n103ProjectName = new bool[] {false} ;
         P00882_A148EmployeeName = new string[] {""} ;
         A103ProjectName = "";
         A148EmployeeName = "";
         P00884_A166ProjectManagerId = new long[1] ;
         P00884_n166ProjectManagerId = new bool[] {false} ;
         P00884_A102ProjectId = new long[1] ;
         P00884_A103ProjectName = new string[] {""} ;
         P00884_n103ProjectName = new bool[] {false} ;
         P00884_A106EmployeeId = new long[1] ;
         P00884_A40000GXC1 = new short[1] ;
         P00884_n40000GXC1 = new bool[] {false} ;
         P00884_A40001GXC2 = new short[1] ;
         P00884_n40001GXC2 = new bool[] {false} ;
         AV9Name = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aprojectsincompanytest__default(),
            new Object[][] {
                new Object[] {
               P00882_A106EmployeeId, P00882_A102ProjectId, P00882_A103ProjectName, P00882_A148EmployeeName
               }
               , new Object[] {
               P00884_A166ProjectManagerId, P00884_n166ProjectManagerId, P00884_A102ProjectId, P00884_A103ProjectName, P00884_n103ProjectName, P00884_A106EmployeeId, P00884_A40000GXC1, P00884_n40000GXC1, P00884_A40001GXC2, P00884_n40001GXC2
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00882_A103ProjectName ;
      private bool[] P00882_n103ProjectName ;
      private string[] P00882_A148EmployeeName ;
      private long[] P00884_A166ProjectManagerId ;
      private bool[] P00884_n166ProjectManagerId ;
      private long[] P00884_A102ProjectId ;
      private string[] P00884_A103ProjectName ;
      private bool[] P00884_n103ProjectName ;
      private long[] P00884_A106EmployeeId ;
      private short[] P00884_A40000GXC1 ;
      private bool[] P00884_n40000GXC1 ;
      private short[] P00884_A40001GXC2 ;
      private bool[] P00884_n40001GXC2 ;
   }

   public class aprojectsincompanytest__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P00884( IGxContext context ,
                                             long A102ProjectId ,
                                             GxSimpleCollection<long> AV12ProjectId ,
                                             long A106EmployeeId )
      {
         ...
         AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV12ProjectId, "T1.ProjectId IN (", ")")+")");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P00884(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (long)dynConstraints[2] );
         }
