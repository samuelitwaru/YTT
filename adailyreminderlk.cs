   ...
   public class adailyreminderlk : GXWebProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A115HolidayStartDate = P00AL2_A115HolidayStartDate[0];
            A113HolidayId = P00AL2_A113HolidayId[0];
            A157CompanyLocationId = P00AL2_A157CompanyLocationId[0];
            A159CompanyLocationCode = P00AL2_A159CompanyLocationCode[0];
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A157CompanyLocationId = P00AL3_A157CompanyLocationId[0];
            A106EmployeeId = P00AL3_A106EmployeeId[0];
            A159CompanyLocationCode = P00AL3_A159CompanyLocationCode[0];
            A112EmployeeIsActive = P00AL3_A112EmployeeIsActive[0];
            A107EmployeeFirstName = P00AL3_A107EmployeeFirstName[0];
            A109EmployeeEmail = P00AL3_A109EmployeeEmail[0];
            A157CompanyLocationId = P00AL3_A157CompanyLocationId[0];
            A159CompanyLocationCode = P00AL3_A159CompanyLocationCode[0];
            AV23GXLvl34 = 0;
            /* Using cursor P00AL4 */
            ...
            {
               A124LeaveTypeId = P00AL4_A124LeaveTypeId[0];
               A130LeaveRequestEndDate = P00AL4_A130LeaveRequestEndDate[0];
               A129LeaveRequestStartDate = P00AL4_A129LeaveRequestStartDate[0];
               A132LeaveRequestStatus = P00AL4_A132LeaveRequestStatus[0];
               A145LeaveTypeLoggingWorkHours = P00AL4_A145LeaveTypeLoggingWorkHours[0];
               A173LeaveRequestHalfDay = P00AL4_A173LeaveRequestHalfDay[0];
               n173LeaveRequestHalfDay = P00AL4_n173LeaveRequestHalfDay[0];
               A127LeaveRequestId = P00AL4_A127LeaveRequestId[0];
               A145LeaveTypeLoggingWorkHours = P00AL4_A145LeaveTypeLoggingWorkHours[0];
               AV23GXLvl34 = 1;
            ...
            AV24GXLvl60 = 0;
            /* Using cursor P00AL5 */
            pr_default.execute(3, new Object[] {AV14CheckDate, A106EmployeeId});
            while ( (pr_default.getStatus(3) != 101) )
            {
               A119WorkHourLogDate = P00AL5_A119WorkHourLogDate[0];
               A118WorkHourLogId = P00AL5_A118WorkHourLogId[0];
               AV24GXLvl60 = 1;
            ...
            if ( ! AV15HasLoggedHours )
            {
               if ( ( AV19HasNoLeave ) || ( AV18HasToLogOnLeave ) )
               {
                  ...
                  AV12Subject = "Daily Time Tracker Reminder" + StringUtil.Str( (decimal)(AV16CurrentHour), 4, 0) + " " + context.localUtil.DToC( AV14CheckDate, 2, "/");
      ...
      public override void initialize( )
      {
         ...
         P00AL2_A115HolidayStartDate = new DateTime[] {DateTime.MinValue} ;
         P00AL2_A113HolidayId = new long[1] ;
         A159CompanyLocationCode = "";
         A115HolidayStartDate = DateTime.MinValue;
         P00AL3_A100CompanyId = new long[1] ;
         P00AL3_A157CompanyLocationId = new long[1] ;
         P00AL3_A106EmployeeId = new long[1] ;
         P00AL3_A159CompanyLocationCode = new string[] {""} ;
         P00AL3_A112EmployeeIsActive = new bool[] {false} ;
         P00AL3_A107EmployeeFirstName = new string[] {""} ;
         P00AL3_A109EmployeeEmail = new string[] {""} ;
         A107EmployeeFirstName = "";
         A109EmployeeEmail = "";
         P00AL4_A124LeaveTypeId = new long[1] ;
         P00AL4_A106EmployeeId = new long[1] ;
         P00AL4_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         P00AL4_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         P00AL4_A132LeaveRequestStatus = new string[] {""} ;
         P00AL4_A145LeaveTypeLoggingWorkHours = new string[] {""} ;
         P00AL4_A173LeaveRequestHalfDay = new string[] {""} ;
         P00AL4_n173LeaveRequestHalfDay = new bool[] {false} ;
         P00AL4_A127LeaveRequestId = new long[1] ;
         A130LeaveRequestEndDate = DateTime.MinValue;
         A129LeaveRequestStartDate = DateTime.MinValue;
         A132LeaveRequestStatus = "";
         A145LeaveTypeLoggingWorkHours = "";
         A173LeaveRequestHalfDay = "";
         P00AL5_A106EmployeeId = new long[1] ;
         P00AL5_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P00AL5_A118WorkHourLogId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.adailyreminderlk__default(),
            new Object[][] {
                new Object[] {
               P00AL2_A100CompanyId, P00AL2_A157CompanyLocationId, P00AL2_A159CompanyLocationCode, P00AL2_A115HolidayStartDate, P00AL2_A113HolidayId
               }
               , new Object[] {
               P00AL3_A100CompanyId, P00AL3_A157CompanyLocationId, P00AL3_A106EmployeeId, P00AL3_A159CompanyLocationCode, P00AL3_A112EmployeeIsActive, P00AL3_A107EmployeeFirstName, P00AL3_A109EmployeeEmail
               }
               , new Object[] {
               P00AL4_A124LeaveTypeId, P00AL4_A106EmployeeId, P00AL4_A130LeaveRequestEndDate, P00AL4_A129LeaveRequestStartDate, P00AL4_A132LeaveRequestStatus, P00AL4_A145LeaveTypeLoggingWorkHours, P00AL4_A173LeaveRequestHalfDay, P00AL4_n173LeaveRequestHalfDay, P00AL4_A127LeaveRequestId
               }
               , new Object[] {
               P00AL5_A106EmployeeId, P00AL5_A119WorkHourLogDate, P00AL5_A118WorkHourLogId
               }
            }
         );
      ...
      private DateTime[] P00AL2_A115HolidayStartDate ;
      private long[] P00AL2_A113HolidayId ;
      private long[] P00AL3_A100CompanyId ;
      private long[] P00AL3_A157CompanyLocationId ;
      private long[] P00AL3_A106EmployeeId ;
      private string[] P00AL3_A159CompanyLocationCode ;
      private bool[] P00AL3_A112EmployeeIsActive ;
      private string[] P00AL3_A107EmployeeFirstName ;
      private string[] P00AL3_A109EmployeeEmail ;
      private long[] P00AL4_A124LeaveTypeId ;
      private long[] P00AL4_A106EmployeeId ;
      private DateTime[] P00AL4_A130LeaveRequestEndDate ;
      private DateTime[] P00AL4_A129LeaveRequestStartDate ;
      private string[] P00AL4_A132LeaveRequestStatus ;
      private string[] P00AL4_A145LeaveTypeLoggingWorkHours ;
      private string[] P00AL4_A173LeaveRequestHalfDay ;
      private bool[] P00AL4_n173LeaveRequestHalfDay ;
      private long[] P00AL4_A127LeaveRequestId ;
      private long[] P00AL5_A106EmployeeId ;
      private DateTime[] P00AL5_A119WorkHourLogDate ;
      private long[] P00AL5_A118WorkHourLogId ;
   ...
   public class adailyreminderlk__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00AL2", "SELECT T1.CompanyId, T2.CompanyLocationId, T3.CompanyLocationCode, T1.HolidayStartDate, T1.HolidayId FROM ((Holiday T1 INNER JOIN Company T2 ON T2.CompanyId = T1.CompanyId) INNER JOIN CompanyLocation T3 ON T3.CompanyLocationId = T2.CompanyLocationId) WHERE (T1.HolidayStartDate = :AV14CheckDate) AND (T3.CompanyLocationCode = ( 'lk')) ORDER BY T1.HolidayId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AL2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00AL3", "SELECT T1.CompanyId, T2.CompanyLocationId, T1.EmployeeId, T3.CompanyLocationCode, T1.EmployeeIsActive, T1.EmployeeFirstName, T1.EmployeeEmail FROM ((Employee T1 INNER JOIN Company T2 ON T2.CompanyId = T1.CompanyId) INNER JOIN CompanyLocation T3 ON T3.CompanyLocationId = T2.CompanyLocationId) WHERE (T1.EmployeeIsActive = TRUE) AND (T3.CompanyLocationCode = ( 'lk')) ORDER BY T1.EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AL3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00AL4", "SELECT T1.LeaveTypeId, T1.EmployeeId, T1.LeaveRequestEndDate, T1.LeaveRequestStartDate, T1.LeaveRequestStatus, T2.LeaveTypeLoggingWorkHours, T1.LeaveRequestHalfDay, T1.LeaveRequestId FROM (LeaveRequest T1 INNER JOIN LeaveType T2 ON T2.LeaveTypeId = T1.LeaveTypeId) WHERE (T1.EmployeeId = :EmployeeId) AND (T1.LeaveRequestStartDate <= :AV14CheckDate) AND (T1.LeaveRequestEndDate >= :AV14CheckDate) AND (T1.LeaveRequestStatus = ( 'Approved')) ORDER BY T1.EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AL4,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P00AL5", "SELECT EmployeeId, WorkHourLogDate, WorkHourLogId FROM WorkHourLog WHERE (WorkHourLogDate = :AV14CheckDate) AND (EmployeeId = :EmployeeId) ORDER BY WorkHourLogDate ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AL5,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
