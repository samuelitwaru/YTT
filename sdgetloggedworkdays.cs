   ...
   public class sdgetloggedworkdays : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A107EmployeeFirstName = P00892_A107EmployeeFirstName[0];
            A102ProjectId = P00892_A102ProjectId[0];
            A103ProjectName = P00892_A103ProjectName[0];
            A123WorkHourLogDescription = P00892_A123WorkHourLogDescription[0];
            A120WorkHourLogDuration = P00892_A120WorkHourLogDuration[0];
      ...
      public override void initialize( )
      {
         ...
         P00892_A102ProjectId = new long[1] ;
         P00892_A103ProjectName = new string[] {""} ;
         P00892_A123WorkHourLogDescription = new string[] {""} ;
         P00892_A120WorkHourLogDuration = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sdgetloggedworkdays__default(),
            new Object[][] {
                new Object[] {
               P00892_A106EmployeeId, P00892_A119WorkHourLogDate, P00892_A107EmployeeFirstName, P00892_A102ProjectId, P00892_A103ProjectName, P00892_A123WorkHourLogDescription, P00892_A120WorkHourLogDuration, P00892_A121WorkHourLogHour, P00892_A122WorkHourLogMinute, P00892_A118WorkHourLogId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00892_A107EmployeeFirstName ;
      private long[] P00892_A102ProjectId ;
      private string[] P00892_A103ProjectName ;
      private string[] P00892_A123WorkHourLogDescription ;
      private string[] P00892_A120WorkHourLogDuration ;
