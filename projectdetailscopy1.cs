...
namespace GeneXus.Programs {
   public class projectdetailscopy1 : GXDataArea
   {
      public projectdetailscopy1( )
      {
      ...
      public projectdetailscopy1( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("projectdetailscopy1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV22OneProjectId,4,0))}, new string[] {"OneProjectId"}) +"\">") ;
      ...
      {
         return formatLink("projectdetailscopy1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV22OneProjectId,4,0))}, new string[] {"OneProjectId"})  ;
      }

      public override string GetPgmname( )
      {
         return "ProjectDetailsCopy1" ;
      }

      public override string GetPgmdesc( )
      {
         return "Project Details Copy1" ;
      }
      ...
      protected void WB5Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnexportexcel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(23), 2, 0)+","+"null"+");", "Export", bttBtnexportexcel_Jsonclick, 5, "Export", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOEXPORTEXCEL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ProjectDetailsCopy1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START5Q2( )
      {
         ...
         Form.Meta.addItem("description", "Project Details Copy1", 0) ;
         context.wjLoc = "";
      ...
      protected void RF5Q2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A100CompanyId = H005Q2_A100CompanyId[0];
               A102ProjectId = H005Q2_A102ProjectId[0];
               A119WorkHourLogDate = H005Q2_A119WorkHourLogDate[0];
               A157CompanyLocationId = H005Q2_A157CompanyLocationId[0];
               A106EmployeeId = H005Q2_A106EmployeeId[0];
               A148EmployeeName = H005Q2_A148EmployeeName[0];
               A118WorkHourLogId = H005Q2_A118WorkHourLogId[0];
               A100CompanyId = H005Q2_A100CompanyId[0];
               A148EmployeeName = H005Q2_A148EmployeeName[0];
               A157CompanyLocationId = H005Q2_A157CompanyLocationId[0];
               E175Q2 ();
      ...
      protected int subFreestylegrid1_fnc_Recordcount( )
      {
         ...
         FREESTYLEGRID1_nRecordCount = H005Q3_AFREESTYLEGRID1_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20247241384339", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("projectdetailscopy1.js", "?20247241384339", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Project Details Copy1";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOEXPORTEXCEL'","{handler:'E135Q2',iparms:[{av:'AV21DateRange',fld:'vDATERANGE',pic:''},{av:'AV26DateRange_To',fld:'vDATERANGE_TO',pic:''},{av:'AV14ProjectId',fld:'vPROJECTID',pic:''},{av:'AV12CompanyLocationId',fld:'vCOMPANYLOCATIONID',pic:''},{av:'AV13EmployeeId',fld:'vEMPLOYEEID',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H005Q2_A100CompanyId = new long[1] ;
         H005Q2_A102ProjectId = new long[1] ;
         H005Q2_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         H005Q2_A157CompanyLocationId = new long[1] ;
         H005Q2_A106EmployeeId = new long[1] ;
         H005Q2_A148EmployeeName = new string[] {""} ;
         H005Q2_A118WorkHourLogId = new long[1] ;
         H005Q3_AFREESTYLEGRID1_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.projectdetailscopy1__default(),
            new Object[][] {
                new Object[] {
               H005Q2_A100CompanyId, H005Q2_A102ProjectId, H005Q2_A119WorkHourLogDate, H005Q2_A157CompanyLocationId, H005Q2_A106EmployeeId, H005Q2_A148EmployeeName, H005Q2_A118WorkHourLogId
               }
               , new Object[] {
               H005Q3_AFREESTYLEGRID1_nRecordCount
               }
            }
         );
      ...
      private long[] H005Q2_A100CompanyId ;
      private long[] H005Q2_A102ProjectId ;
      private DateTime[] H005Q2_A119WorkHourLogDate ;
      private long[] H005Q2_A157CompanyLocationId ;
      private long[] H005Q2_A106EmployeeId ;
      private string[] H005Q2_A148EmployeeName ;
      private long[] H005Q2_A118WorkHourLogId ;
      private long[] H005Q3_AFREESTYLEGRID1_nRecordCount ;
   ...
   public class projectdetailscopy1__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005Q2(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (long)dynConstraints[2] , (GxSimpleCollection<long>)dynConstraints[3] , (int)dynConstraints[4] , (int)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (long)dynConstraints[9] , (short)dynConstraints[10] );
               case 1 :
                     return conditional_H005Q3(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (long)dynConstraints[2] , (GxSimpleCollection<long>)dynConstraints[3] , (int)dynConstraints[4] , (int)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (long)dynConstraints[9] , (short)dynConstraints[10] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005Q2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Q2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H005Q3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Q3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
