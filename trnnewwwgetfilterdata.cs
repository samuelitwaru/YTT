...
namespace GeneXus.Programs {
   public class trnnewwwgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV30GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "TrnNewWWGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         {
            BRKBR2 = false;
            A181TrnNewName = P00BR2_A181TrnNewName[0];
            A182TrnNewDate = P00BR2_A182TrnNewDate[0];
            A180TrnNewId = P00BR2_A180TrnNewId[0];
            AV27count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00BR2_A181TrnNewName[0], A181TrnNewName) == 0 ) )
            {
               BRKBR2 = false;
               A180TrnNewId = P00BR2_A180TrnNewId[0];
      ...
      public override void initialize( )
      {
         ...
         P00BR2_A181TrnNewName = new string[] {""} ;
         P00BR2_A182TrnNewDate = new DateTime[] {DateTime.MinValue} ;
         P00BR2_A180TrnNewId = new long[1] ;
         AV22Option = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trnnewwwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00BR2_A181TrnNewName, P00BR2_A182TrnNewDate, P00BR2_A180TrnNewId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00BR2_A181TrnNewName ;
      private DateTime[] P00BR2_A182TrnNewDate ;
      private long[] P00BR2_A180TrnNewId ;
