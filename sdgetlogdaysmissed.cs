   ...
   public class sdgetlogdaysmissed : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( DateTimeUtil.ResetTime ( AV14StartMonthDate ) < DateTimeUtil.ResetTime ( Gx_date ) )
         {
            ...
            /* Using cursor P005R2 */
            pr_default.execute(0, new Object[] {AV8CurrentDate, AV18Udparg1});
   ...
   public class sdgetlogdaysmissed__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P005R2", "SELECT WorkHourLogDate, EmployeeId, WorkHourLogId FROM WorkHourLog WHERE (WorkHourLogDate = :AV8CurrentDate) AND (EmployeeId = :AV18Udparg1) ORDER BY WorkHourLogDate ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP005R2,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
