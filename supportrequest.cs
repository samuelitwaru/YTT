...
namespace GeneXus.Programs {
   public class supportrequest : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtSupportRequestId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A172SupportRequestId), 10, 0, ".", "")), StringUtil.LTrim( ((edtSupportRequestId_Enabled!=0) ? context.localUtil.Format( (decimal)(A172SupportRequestId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A172SupportRequestId), "ZZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupportRequestId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupportRequestId_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_SupportRequest.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtSupportRequestDescription_Internalname, A171SupportRequestDescription, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", 0, 1, edtSupportRequestDescription_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "GeneXusUnanimo\\Description", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_SupportRequest.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            Z172SupportRequestId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "Z172SupportRequestId"), ".", ","), 18, MidpointRounding.ToEven));
            Z170SupportRequestSubject = cgiGet( "Z170SupportRequestSubject");
            Z171SupportRequestDescription = cgiGet( "Z171SupportRequestDescription");
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtSupportRequestId_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtSupportRequestId_Internalname), ".", ",") > Convert.ToDecimal( 9999999999L )) ) )
            {
               ...
               AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               A172SupportRequestId = 0;
               AssignAttri("", false, "A172SupportRequestId", StringUtil.LTrimStr( (decimal)(A172SupportRequestId), 10, 0));
            }
            else
            {
               A172SupportRequestId = (long)(Math.Round(context.localUtil.CToN( cgiGet( edtSupportRequestId_Internalname), ".", ","), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "A172SupportRequestId", StringUtil.LTrimStr( (decimal)(A172SupportRequestId), 10, 0));
            }
            A170SupportRequestSubject = cgiGet( edtSupportRequestSubject_Internalname);
            AssignAttri("", false, "A170SupportRequestSubject", A170SupportRequestSubject);
            A171SupportRequestDescription = cgiGet( edtSupportRequestDescription_Internalname);
         ...
         else
         {
            ...
            if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") == 0 )
            {
               ...
               A172SupportRequestId = (long)(Math.Round(NumberUtil.Val( GetPar( "SupportRequestId"), "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "A172SupportRequestId", StringUtil.LTrimStr( (decimal)(A172SupportRequestId), 10, 0));
               getEqualNoModal( ) ;
               Gx_mode = "DSP";
               AssignAttri("", false, "Gx_mode", Gx_mode);
      ...
      protected void ZM0P29( short GX_JID )
      {
         if ( ( GX_JID == 1 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z170SupportRequestSubject = T000P3_A170SupportRequestSubject[0];
               Z171SupportRequestDescription = T000P3_A171SupportRequestDescription[0];
               Z106EmployeeId = T000P3_A106EmployeeId[0];
            }
            else
            {
         ...
         if ( GX_JID == -1 )
         {
            Z172SupportRequestId = A172SupportRequestId;
            Z170SupportRequestSubject = A170SupportRequestSubject;
            Z171SupportRequestDescription = A171SupportRequestDescription;
            Z106EmployeeId = A106EmployeeId;
      ...
      {
         /* Using cursor T000P5 */
         pr_default.execute(3, new Object[] {A172SupportRequestId});
         if ( (pr_default.getStatus(3) != 101) )
         {
            ...
            AssignAttri("", false, "A171SupportRequestDescription", A171SupportRequestDescription);
            A107EmployeeFirstName = T000P5_A107EmployeeFirstName[0];
            AssignAttri("", false, "A107EmployeeFirstName", A107EmployeeFirstName);
            A106EmployeeId = T000P5_A106EmployeeId[0];
            AssignAttri("", false, "A106EmployeeId", StringUtil.LTrimStr( (decimal)(A106EmployeeId), 10, 0));
            ZM0P29( -1) ;
         }
         pr_default.close(3);
      ...
      {
         /* Using cursor T000P7 */
         pr_default.execute(5, new Object[] {A172SupportRequestId});
      ...
      {
         /* Using cursor T000P3 */
         pr_default.execute(1, new Object[] {A172SupportRequestId});
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM0P29( 1) ;
            RcdFound29 = 1;
            A172SupportRequestId = T000P3_A172SupportRequestId[0];
            AssignAttri("", false, "A172SupportRequestId", StringUtil.LTrimStr( (decimal)(A172SupportRequestId), 10, 0));
            A170SupportRequestSubject = T000P3_A170SupportRequestSubject[0];
            AssignAttri("", false, "A170SupportRequestSubject", A170SupportRequestSubject);
            A171SupportRequestDescription = T000P3_A171SupportRequestDescription[0];
            AssignAttri("", false, "A171SupportRequestDescription", A171SupportRequestDescription);
            A106EmployeeId = T000P3_A106EmployeeId[0];
            AssignAttri("", false, "A106EmployeeId", StringUtil.LTrimStr( (decimal)(A106EmployeeId), 10, 0));
            Z172SupportRequestId = A172SupportRequestId;
            sMode29 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         RcdFound29 = 0;
         /* Using cursor T000P8 */
         pr_default.execute(6, new Object[] {A172SupportRequestId});
         if ( (pr_default.getStatus(6) != 101) )
         {
            while ( (pr_default.getStatus(6) != 101) && ( ( T000P8_A172SupportRequestId[0] < A172SupportRequestId ) ) )
            {
               pr_default.readNext(6);
            }
            if ( (pr_default.getStatus(6) != 101) && ( ( T000P8_A172SupportRequestId[0] > A172SupportRequestId ) ) )
            {
               A172SupportRequestId = T000P8_A172SupportRequestId[0];
               AssignAttri("", false, "A172SupportRequestId", StringUtil.LTrimStr( (decimal)(A172SupportRequestId), 10, 0));
               RcdFound29 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         RcdFound29 = 0;
         /* Using cursor T000P9 */
         pr_default.execute(7, new Object[] {A172SupportRequestId});
         if ( (pr_default.getStatus(7) != 101) )
         {
            while ( (pr_default.getStatus(7) != 101) && ( ( T000P9_A172SupportRequestId[0] > A172SupportRequestId ) ) )
            {
               pr_default.readNext(7);
            }
            if ( (pr_default.getStatus(7) != 101) && ( ( T000P9_A172SupportRequestId[0] < A172SupportRequestId ) ) )
            {
               A172SupportRequestId = T000P9_A172SupportRequestId[0];
               AssignAttri("", false, "A172SupportRequestId", StringUtil.LTrimStr( (decimal)(A172SupportRequestId), 10, 0));
               RcdFound29 = 1;
            }
         }
      ...
      protected void btn_enter( )
      {
         ...
         else
         {
            if ( RcdFound29 == 1 )
            {
               if ( A172SupportRequestId != Z172SupportRequestId )
               {
                  A172SupportRequestId = Z172SupportRequestId;
                  AssignAttri("", false, "A172SupportRequestId", StringUtil.LTrimStr( (decimal)(A172SupportRequestId), 10, 0));
      ...
      protected void CheckOptimisticConcurrency0P29( )
      {
         ...
         {
            /* Using cursor T000P2 */
            pr_default.execute(0, new Object[] {A172SupportRequestId});
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z170SupportRequestSubject, T000P2_A170SupportRequestSubject[0]) != 0 ) || ( StringUtil.StrCmp(Z171SupportRequestDescription, T000P2_A171SupportRequestDescription[0]) != 0 ) || ( Z106EmployeeId != T000P2_A106EmployeeId[0] ) )
            {
               if ( StringUtil.StrCmp(Z170SupportRequestSubject, T000P2_A170SupportRequestSubject[0]) != 0 )
               {
                  GXUtil.WriteLog("supportrequest:[seudo value changed for attri]"+"SupportRequestSubject");
                  GXUtil.WriteLogRaw("Old: ",Z170SupportRequestSubject);
                  GXUtil.WriteLogRaw("Current: ",T000P2_A170SupportRequestSubject[0]);
               }
               if ( StringUtil.StrCmp(Z171SupportRequestDescription, T000P2_A171SupportRequestDescription[0]) != 0 )
               {
                  GXUtil.WriteLog("supportrequest:[seudo value changed for attri]"+"SupportRequestDescription");
                  GXUtil.WriteLogRaw("Old: ",Z171SupportRequestDescription);
                  GXUtil.WriteLogRaw("Current: ",T000P2_A171SupportRequestDescription[0]);
               }
               if ( Z106EmployeeId != T000P2_A106EmployeeId[0] )
               {
                  GXUtil.WriteLog("supportrequest:[seudo value changed for attri]"+"EmployeeId");
                  GXUtil.WriteLogRaw("Old: ",Z106EmployeeId);
                  GXUtil.WriteLogRaw("Current: ",T000P2_A106EmployeeId[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A170SupportRequestSubject, A171SupportRequestDescription, A106EmployeeId});
                     pr_default.close(8);
                     /* Retrieving last key number assigned */
                     /* Using cursor T000P11 */
                     pr_default.execute(9);
                     A172SupportRequestId = T000P11_A172SupportRequestId[0];
                     AssignAttri("", false, "A172SupportRequestId", StringUtil.LTrimStr( (decimal)(A172SupportRequestId), 10, 0));
                     pr_default.close(9);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(10, new Object[] {A170SupportRequestSubject, A171SupportRequestDescription, A106EmployeeId, A172SupportRequestId});
                     pr_default.close(10);
                     pr_default.SmartCacheProvider.SetUpdated("SupportRequest");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(11, new Object[] {A172SupportRequestId});
                  pr_default.close(11);
                  pr_default.SmartCacheProvider.SetUpdated("SupportRequest");
                  if ( AnyError == 0 )
                  {
      ...
      public void ScanStart0P29( )
      {
         ...
         {
            RcdFound29 = 1;
            A172SupportRequestId = T000P15_A172SupportRequestId[0];
            AssignAttri("", false, "A172SupportRequestId", StringUtil.LTrimStr( (decimal)(A172SupportRequestId), 10, 0));
         }
         /* Load Subordinate Levels */
      }

      protected void ScanNext0P29( )
      {
         /* Scan next routine */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202521819494643", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("supportrequest.js", "?202521819494643", false, true);
      ...
      public override void initialize( )
      {
         ...
         T000P3_A170SupportRequestSubject = new string[] {""} ;
         T000P3_A171SupportRequestDescription = new string[] {""} ;
         T000P3_A106EmployeeId = new long[1] ;
         sMode29 = "";
         T000P8_A172SupportRequestId = new long[1] ;
         T000P9_A172SupportRequestId = new long[1] ;
         T000P2_A172SupportRequestId = new long[1] ;
         T000P2_A170SupportRequestSubject = new string[] {""} ;
         ...
         FormProcess = "";
         bodyStyle = "";
         ZZ170SupportRequestSubject = "";
         ZZ171SupportRequestDescription = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supportrequest__default(),
            new Object[][] {
                new Object[] {
               T000P2_A172SupportRequestId, T000P2_A170SupportRequestSubject, T000P2_A171SupportRequestDescription, T000P2_A106EmployeeId
               }
               , new Object[] {
               ...
               , new Object[] {
               T000P8_A172SupportRequestId
               }
               , new Object[] {
               T000P9_A172SupportRequestId
               }
               , new Object[] {
               }
               , new Object[] {
               T000P11_A172SupportRequestId
               }
               , new Object[] {
               }
               , new Object[] {
      ...
      private int idxLst ;
      private long Z172SupportRequestId ;
      ...
      private bool wbErr ;
      private string Z170SupportRequestSubject ;
      private string Z171SupportRequestDescription ;
      private string A170SupportRequestSubject ;
      ...
      private string[] T000P3_A170SupportRequestSubject ;
      private string[] T000P3_A171SupportRequestDescription ;
      private long[] T000P3_A106EmployeeId ;
      private long[] T000P8_A172SupportRequestId ;
      private long[] T000P9_A172SupportRequestId ;
      private long[] T000P2_A172SupportRequestId ;
      private string[] T000P2_A170SupportRequestSubject ;
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("T000P10", "SAVEPOINT gxupdate;INSERT INTO SupportRequest(SupportRequestSubject, SupportRequestDescription, EmployeeId) VALUES(:SupportRequestSubject, :SupportRequestDescription, :EmployeeId);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmT000P10)
