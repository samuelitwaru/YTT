...
namespace GeneXus.Programs {
   public class workhourlogview : GXDataArea
   {
      public workhourlogview( )
      {
      ...
      public workhourlogview( IGxContext context )
      {
      ...
      public void execute( long aP0_WorkHourLogId ,
                           string aP1_TabCode )
      {
         this.AV12WorkHourLogId = aP0_WorkHourLogId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12WorkHourLogId = (long)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV12WorkHourLogId", StringUtil.LTrimStr( (decimal)(AV12WorkHourLogId), 10, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vWORKHOURLOGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12WorkHourLogId), "ZZZZZZZZZ9"), context));
      ...
      {
         get {
            return "workhourlogview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workhourlogview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12WorkHourLogId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"WorkHourLogId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vWORKHOURLOGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12WorkHourLogId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vWORKHOURLOGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12WorkHourLogId), "ZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("workhourlogview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12WorkHourLogId,10,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"WorkHourLogId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "WorkHourLogView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Work Hour Log View" ;
      }
      ...
      protected void WB2W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Work Hour Log", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_WorkHourLogView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WorkHourLogView.htm");
            /* Div Control */
      ...
      protected void START2W2( )
      {
         ...
         Form.Meta.addItem("description", "Work Hour Log View", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP2W0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12WorkHourLogId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vWORKHOURLOGID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E112W2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("workhourlogww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H002W2 */
         pr_default.execute(0, new Object[] {AV12WorkHourLogId});
      ...
      protected void S112( )
      {
         ...
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV14SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "WorkHourLogGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "workhourloggeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "WorkHourLogGeneral";
               WebComp_Generalwc_Component = "WorkHourLogGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0025",(string)"",(long)AV12WorkHourLogId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12WorkHourLogId = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12WorkHourLogId", StringUtil.LTrimStr( (decimal)(AV12WorkHourLogId), 10, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vWORKHOURLOGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12WorkHourLogId), "ZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481414261010", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("workhourlogview.js", "?202481414261010", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Work Hour Log View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12WorkHourLogId',fld:'vWORKHOURLOGID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workhourlogview__default(),
            new Object[][] {
                new Object[] {
               H002W2_A118WorkHourLogId, H002W2_A119WorkHourLogDate
               }
            }
         );
      ...
      private int idxLst ;
      private long AV12WorkHourLogId ;
      private long wcpOAV12WorkHourLogId ;
      ...
      private long[] H002W2_A118WorkHourLogId ;
      private DateTime[] H002W2_A119WorkHourLogDate ;
   ...
   public class workhourlogview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV12WorkHourLogId",GXType.Int64,10,0)
          };
          def= new CursorDef[] {
              new CursorDef("H002W2", "SELECT WorkHourLogId, WorkHourLogDate FROM WorkHourLog WHERE WorkHourLogId = :AV12WorkHourLogId ORDER BY WorkHourLogId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002W2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
