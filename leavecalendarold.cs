...
namespace GeneXus.Programs {
   public class leavecalendarold : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024731441596", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("leavecalendarold.js", "?2024731441596", false, true);
         context.AddJavascriptSource("GXScheduler/dhtmlxscheduler.js", "", false, true);
         context.AddJavascriptSource("GXScheduler/GXSchedulerRender.js", "", false, true);
