...
namespace GeneXus.Programs {
   public class getleavedays : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            A124LeaveTypeId = P00B32_A124LeaveTypeId[0];
            A132LeaveRequestStatus = P00B32_A132LeaveRequestStatus[0];
            A106EmployeeId = P00B32_A106EmployeeId[0];
            A129LeaveRequestStartDate = P00B32_A129LeaveRequestStartDate[0];
            A130LeaveRequestEndDate = P00B32_A130LeaveRequestEndDate[0];
            A125LeaveTypeName = P00B32_A125LeaveTypeName[0];
            A127LeaveRequestId = P00B32_A127LeaveRequestId[0];
            A125LeaveTypeName = P00B32_A125LeaveTypeName[0];
      ...
      public override void initialize( )
      {
         ...
         P00B32_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         P00B32_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         P00B32_A125LeaveTypeName = new string[] {""} ;
         P00B32_A127LeaveRequestId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.getleavedays__default(),
            new Object[][] {
                new Object[] {
               P00B32_A124LeaveTypeId, P00B32_A132LeaveRequestStatus, P00B32_A106EmployeeId, P00B32_A129LeaveRequestStartDate, P00B32_A130LeaveRequestEndDate, P00B32_A125LeaveTypeName, P00B32_A127LeaveRequestId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P00B32_A106EmployeeId ;
      private DateTime[] P00B32_A129LeaveRequestStartDate ;
