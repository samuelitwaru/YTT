...
namespace GeneXus.Programs {
   public class companylocationcompanywc : GXWebComponent
   {
      public companylocationcompanywc( )
      {
      ...
      public companylocationcompanywc( IGxContext context )
      {
      ...
      {
         this.AV8CompanyLocationId = aP0_CompanyLocationId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8CompanyLocationId = (long)(Math.Round(NumberUtil.Val( GetPar( "CompanyLocationId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8CompanyLocationId", StringUtil.LTrimStr( (decimal)(AV8CompanyLocationId), 10, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV8CompanyLocationId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV8CompanyLocationId, AV20ManageFiltersExecutionStep, AV32Pgmname, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV32Pgmname = "CompanyLocationCompanyWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Company Location Company WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("companylocationcompanywc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8CompanyLocationId,10,0))}, new string[] {"CompanyLocationId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8CompanyLocationId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8CompanyLocationId), 10, 0, ".", "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCOMPANYLOCATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8CompanyLocationId), 10, 0, ".", "")));
      ...
      {
         return "CompanyLocationCompanyWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Company Location Company WC" ;
      }
      ...
      protected void WB4J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "companylocationcompanywc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CompanyLocationCompanyWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            wb_table1_22_4J2( true) ;
         }
         else
         {
            wb_table1_22_4J2( false) ;
         }
         return  ;
      }

      protected void wb_table1_22_4J2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 37 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCompanyLocationId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A157CompanyLocationId), 10, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A157CompanyLocationId), "ZZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCompanyLocationId_Jsonclick, 0, "Attribute", "", "", "", "", edtCompanyLocationId_Visible, 0, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_CompanyLocationCompanyWC.htm");
            /* User Defined Control */
      ...
      protected void START4J2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Company Location Company WC", 0) ;
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_COMPANYID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A100CompanyId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"COMPANYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A100CompanyId), 10, 0, ".", "")));
      }
      ...
      protected void RF4J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 new int[]{
                                                 TypeConstants.LONG, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.LONG
                                                 }
            });
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H004J2 */
            pr_default.execute(0, new Object[] {AV8CompanyLocationId, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A157CompanyLocationId = H004J2_A157CompanyLocationId[0];
               AssignAttri(sPrefix, false, "A157CompanyLocationId", StringUtil.LTrimStr( (decimal)(A157CompanyLocationId), 10, 0));
               A101CompanyName = H004J2_A101CompanyName[0];
               A100CompanyId = H004J2_A100CompanyId[0];
               /* Execute user event: Grid.Load */
               E184J2 ();
      ...
      protected void send_integrity_lvl_hashes4J2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_COMPANYID"+"_"+sGXsfl_37_idx, GetSecureSignedToken( sPrefix+sGXsfl_37_idx, context.localUtil.Format( (decimal)(A100CompanyId), "ZZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H004J3 */
         pr_default.execute(1, new Object[] {AV8CompanyLocationId, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtCompanyLocationId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCompanyLocationId_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP4J0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8CompanyLocationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8CompanyLocationId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E164J2( )
      {
         ...
         AssignProp(sPrefix, false, edtCompanyLocationId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtCompanyLocationId_Visible), 5, 0), true);
      ...
      protected void E114J2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("CompanyLocationCompanyWCFilters")),UrlEncode(StringUtil.RTrim(AV32Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("CompanyLocationCompanyWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "CompanyLocationCompanyWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "CompanyLocationCompanyWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Company";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "CompanyLocationId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8CompanyLocationId), 10, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_22_4J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_27_4J2( true) ;
         }
         else
         {
            wb_table2_27_4J2( false) ;
         }
         return  ;
      }

      protected void wb_table2_27_4J2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_22_4J2e( true) ;
         }
         else
         {
            wb_table1_22_4J2e( false) ;
         }
      }

      protected void wb_table2_27_4J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8CompanyLocationId = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8CompanyLocationId", StringUtil.LTrimStr( (decimal)(AV8CompanyLocationId), 10, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8CompanyLocationId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "companylocationcompanywc", GetJustCreated( ));
         ...
         {
            AV8CompanyLocationId = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8CompanyLocationId", StringUtil.LTrimStr( (decimal)(AV8CompanyLocationId), 10, 0));
         }
         wcpOAV8CompanyLocationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8CompanyLocationId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8CompanyLocationId != wcpOAV8CompanyLocationId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8CompanyLocationId = AV8CompanyLocationId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8CompanyLocationId = cgiGet( sPrefix+"AV8CompanyLocationId_CTRL");
         if ( StringUtil.Len( sCtrlAV8CompanyLocationId) > 0 )
         {
            AV8CompanyLocationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8CompanyLocationId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8CompanyLocationId", StringUtil.LTrimStr( (decimal)(AV8CompanyLocationId), 10, 0));
         }
         else
         {
            AV8CompanyLocationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8CompanyLocationId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8CompanyLocationId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8CompanyLocationId), 10, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8CompanyLocationId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8CompanyLocationId_CTRL", StringUtil.RTrim( sCtrlAV8CompanyLocationId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491716165593", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("companylocationcompanywc.js", "?202491716165593", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:CompanyId|3:CompanyName";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E184J2","iparms":[{"av":"AV28IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A100CompanyId","fld":"COMPANYID","pic":"ZZZZZZZZZ9","hsh":true},{"av":"AV30IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E154J2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8CompanyLocationId","fld":"vCOMPANYLOCATIONID","pic":"ZZZZZZZZZ9"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV32Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV30IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV31IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A100CompanyId","fld":"COMPANYID","pic":"ZZZZZZZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         A101CompanyName = "";
         lV16FilterFullText = "";
         H004J2_A157CompanyLocationId = new long[1] ;
         H004J2_A101CompanyName = new string[] {""} ;
         H004J2_A100CompanyId = new long[1] ;
         ...
         sCtrlAV8CompanyLocationId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.companylocationcompanywc__default(),
            new Object[][] {
                new Object[] {
               H004J2_A157CompanyLocationId, H004J2_A101CompanyName, H004J2_A100CompanyId
               }
               , new Object[] {
      ...
      private long AV8CompanyLocationId ;
      private long wcpOAV8CompanyLocationId ;
      ...
      private string sCtrlAV8CompanyLocationId ;
      ...
      private long[] H004J2_A157CompanyLocationId ;
      private string[] H004J2_A101CompanyName ;
      private long[] H004J2_A100CompanyId ;
   ...
   public class companylocationcompanywc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long AV8CompanyLocationId )
      {
         ...
         {
            sOrderString += " ORDER BY CompanyLocationId, CompanyName";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY CompanyLocationId DESC, CompanyName DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY CompanyLocationId, CompanyId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY CompanyLocationId DESC, CompanyId DESC";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004J2(context, (string)dynConstraints[0] , (long)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (long)dynConstraints[5] , (long)dynConstraints[6] );
               case 1 :
                     return conditional_H004J3(context, (string)dynConstraints[0] , (long)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (long)dynConstraints[5] , (long)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8CompanyLocationId",GXType.Int64,10,0) ,
