...
namespace GeneXus.Programs {
   public class getleaveevents : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( (0==AV20CompanyId) )
         {
            AV20CompanyId = (long)(Math.Round(NumberUtil.Val( AV24Httprequest.QueryString, "."), 18, MidpointRounding.ToEven));
            AV29CompanyLocationIdValue = AV25Session.Get("LeaveCalendarCompanyLocationId");
            AV30CompanyLocationId = (long)(Math.Round(NumberUtil.Val( AV29CompanyLocationIdValue, "."), 18, MidpointRounding.ToEven));
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV30CompanyLocationId ,
            ...
            /* Using cursor P007K2 */
            pr_default.execute(0, new Object[] {AV30CompanyLocationId});
      ...
      private long AV30CompanyLocationId ;
   ...
   public class getleaveevents__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long A157CompanyLocationId )
      {
         ...
         if ( ! (0==AV30CompanyLocationId) )
         {
            AddWhere(sWhereString, "(CompanyLocationId = :AV30CompanyLocationId)");
         }
         else
         {
            GXv_int3[0] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV30CompanyLocationId",GXType.Int64,10,0)
          };
          Object[] prmP007K4;
