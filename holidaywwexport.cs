...
namespace GeneXus.Programs {
   public class holidaywwexport : GXProcedure
   {
      ...
      protected void S161( )
      {
         ...
         /* Using cursor P00582 */
         pr_default.execute(0, new Object[] {AV62Udparg7, Gx_date, lV56Holidaywwds_1_filterfulltext, lV57Holidaywwds_2_tfholidayname, AV58Holidaywwds_3_tfholidayname_sel, AV59Holidaywwds_4_tfholidaystartdate, AV60Holidaywwds_5_tfholidaystartdate_to});
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            while ( AV64GXV2 <= AV24ColumnsSelector.gxTpr_Columns.Count )
            {
               ...
               if ( AV26ColumnsSelector_Column.gxTpr_Isvisible )
               {
                  ...
                  {
                     GXt_char1 = "";
                     new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  A114HolidayName, out  GXt_char1) ;
      ...
      protected void S151( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "HolidayWWColumnsSelector", out  GXt_char1) ;
      ...
      protected void S201( )
      {
         ...
         {
            AV22GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "HolidayWWGridState"), null, "", "");
         }
         else
         {
