...
namespace GeneXus.Programs {
   public class gamexampleidplogin : GXHttpHandler
   {
      ...
      protected void gxgrGridauthtypes_refresh_invoke( )
      {
         ...
         AV43AuxUserName = GetPar( "AuxUserName");
         ...
         gxgrGridauthtypes_refresh( AV13IDP_State, AV18Language, AV43AuxUserName, AV30UserRememberMe, AV22RememberMe, AV17KeepMeLoggedIn) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vAUXUSERNAME", AV43AuxUserName);
         GxWebStd.gx_hidden_field( context, "gxhash_vAUXUSERNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV43AuxUserName, "")), context));
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            AV20LogoAppClient_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV20LogoAppClient))&&String.IsNullOrEmpty(StringUtil.RTrim( AV50Logoappclient_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV20LogoAppClient)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV20LogoAppClient)) ? AV50Logoappclient_GXI : context.PathToRelativeUrl( AV20LogoAppClient));
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "GRIDAUTHTYPES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           AV48NameAuthType = cgiGet( edtavNameauthtype_Internalname);
                           AssignAttri("", false, edtavNameauthtype_Internalname, AV48NameAuthType);
                           GxWebStd.gx_hidden_field( context, "gxhash_vNAMEAUTHTYPE"+"_"+sGXsfl_58_idx, GetSecureSignedToken( sGXsfl_58_idx, StringUtil.RTrim( context.localUtil.Format( AV48NameAuthType, "")), context));
                           sEvtType = StringUtil.Right( sEvt, 1);
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_vNAMEAUTHTYPE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV48NameAuthType, "")), context));
         GxWebStd.gx_hidden_field( context, "vNAMEAUTHTYPE", StringUtil.RTrim( AV48NameAuthType));
      }
      ...
      protected void E150C2( )
      {
         ...
         else
         {
            if ( ! AV14isConnectionOK )
            {
               ...
               {
                  AV14isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnectionbyrepositoryguid(AV24RepositoryGUID, out  AV45GAMErrorCollection);
                  AssignAttri("", false, "AV14isConnectionOK", AV14isConnectionOK);
               }
               else
               {
                  ...
                  {
                     AV14isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnection(((GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo)AV8ConnectionInfoCollection.Item(1)).gxTpr_Name, out  AV45GAMErrorCollection);
                     AssignAttri("", false, "AV14isConnectionOK", AV14isConnectionOK);
                  }
               }
            }
         }
         AV31GAMApplication = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getremoteapplication(AV13IDP_State, out  AV45GAMErrorCollection);
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV31GAMApplication.gxTpr_Clientimageurl)) )
         {
            ...
            AssignProp("", false, imgavLogoappclient_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV20LogoAppClient)) ? AV50Logoappclient_GXI : context.convertURL( context.PathToRelativeUrl( AV20LogoAppClient))), true);
            AssignProp("", false, imgavLogoappclient_Internalname, "SrcSet", context.GetImageSrcSet( AV20LogoAppClient), true);
            AV50Logoappclient_GXI = GXDbFile.PathToUrl( AV31GAMApplication.gxTpr_Clientimageurl, context);
            AssignProp("", false, imgavLogoappclient_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV20LogoAppClient)) ? AV50Logoappclient_GXI : context.convertURL( context.PathToRelativeUrl( AV20LogoAppClient))), true);
            AssignProp("", false, imgavLogoappclient_Internalname, "SrcSet", context.GetImageSrcSet( AV20LogoAppClient), true);
         }
         else
      ...
      protected void E160C2( )
      {
         ...
         AV45GAMErrorCollection = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
         if ( AV45GAMErrorCollection.Count > 0 )
         {
            if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV45GAMErrorCollection.Item(1)).gxTpr_Code == 1 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV45GAMErrorCollection.Item(1)).gxTpr_Code == 104 ) )
            {
            }
            else if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV45GAMErrorCollection.Item(1)).gxTpr_Code == 24 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV45GAMErrorCollection.Item(1)).gxTpr_Code == 23 ) )
            {
            ...
            else if ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV45GAMErrorCollection.Item(1)).gxTpr_Code == 161 )
            {
         ...
         if ( ! AV16isRedirect )
         {
            AV26SessionValid = new GeneXus.Programs.genexussecurity.SdtGAMSession(context).isvalid(out  AV25Session, out  AV46GAMErrorDelete);
            ...
            else
            {
               ...
               AV7AuthenticationTypes = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getenabledauthenticationtypes(AV18Language, out  AV45GAMErrorCollection);
               AV51GXV1 = 1;
               while ( AV51GXV1 <= AV7AuthenticationTypes.Count )
               {
                  AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV51GXV1));
               ...
               AV15isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getrememberlogin(out  AV21LogOnTo, out  AV43AuxUserName, out  AV30UserRememberMe, out  AV45GAMErrorCollection);
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV43AuxUserName)) )
               {
                  AV28UserName = AV43AuxUserName;
                  AssignAttri("", false, "AV28UserName", AV28UserName);
               }
               ...
               if (returnInSub) return;
               AV52GXV2 = 1;
               while ( AV52GXV2 <= AV7AuthenticationTypes.Count )
               {
                  AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV52GXV2));
      ...
      private void E170C2( )
      {
         ...
         returnInSub = false;
         AV53GXV3 = 1;
         while ( AV53GXV3 <= AV7AuthenticationTypes.Count )
         {
            AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV53GXV3));
            if ( AV6AuthenticationType.gxTpr_Redirtoauthenticate )
            {
               AV48NameAuthType = GXUtil.UrlEncode( StringUtil.Trim( AV6AuthenticationType.gxTpr_Name));
               AssignAttri("", false, edtavNameauthtype_Internalname, AV48NameAuthType);
               GxWebStd.gx_hidden_field( context, "gxhash_vNAMEAUTHTYPE"+"_"+sGXsfl_58_idx, GetSecureSignedToken( sGXsfl_58_idx, StringUtil.RTrim( context.localUtil.Format( AV48NameAuthType, "")), context));
      ...
      protected void E120C2( )
      {
         ...
         AV33isModeOTP = false;
         AV54GXV4 = 1;
         while ( AV54GXV4 <= AV7AuthenticationTypes.Count )
         {
            AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV54GXV4));
            if ( StringUtil.StrCmp(AV6AuthenticationType.gxTpr_Name, AV21LogOnTo) == 0 )
            {
               /* Execute user subroutine: 'VALIDLOGONTOOTP' */
               S142 ();
      ...
      protected void E130C2( )
      {
         ...
         AV19LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV28UserName, AV29UserPassword, AV5AdditionalParameter, out  AV45GAMErrorCollection);
         if ( AV19LoginOK )
         {
         }
         else
         {
            if ( AV45GAMErrorCollection.Count > 0 )
            {
               if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV45GAMErrorCollection.Item(1)).gxTpr_Code == 24 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV45GAMErrorCollection.Item(1)).gxTpr_Code == 23 ) )
               {
                  CallWebObject(formatLink("gamexamplechangepassword.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV13IDP_State))}, new string[] {"IDP_State"}) );
                  context.wjLocDisableFrm = 1;
               }
               ...
               else if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV45GAMErrorCollection.Item(1)).gxTpr_Code == 400 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV45GAMErrorCollection.Item(1)).gxTpr_Code == 410 ) )
               {
                  AV46GAMErrorDelete = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
      ...
      protected void E140C2( )
      {
         ...
         AV5AdditionalParameter.gxTpr_Authenticationtypename = AV48NameAuthType;
         AV5AdditionalParameter.gxTpr_Idpstate = AV13IDP_State;
         AV19LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV28UserName, AV29UserPassword, AV5AdditionalParameter, out  AV45GAMErrorCollection);
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV5AdditionalParameter", AV5AdditionalParameter);
      ...
      protected void S112( )
      {
         ...
         {
            AV14isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnectionbyrepositoryid(AV12GAMRepository.gxTpr_Authenticationmasterrepositoryid, out  AV45GAMErrorCollection);
            AssignAttri("", false, "AV14isConnectionOK", AV14isConnectionOK);
         }
         if ( ! AV14isConnectionOK )
         {
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         AV55GXV5 = 1;
         while ( AV55GXV5 <= AV45GAMErrorCollection.Count )
         {
            AV44GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV45GAMErrorCollection.Item(AV55GXV5));
            GX_msglist.addItem(AV44GAMError.gxTpr_Message);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491115562846", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleidplogin.js", "?202491115562849", false, true);
      ...
      protected void StartGridControl58( )
      {
         ...
         else
         {
            ...
            GridauthtypesContainer.AddColumnProperties(GridauthtypesColumn);
            GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridauthtypesColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV48NameAuthType)));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDAUTHTYPES.LOAD",""","oparms":[{"av":"AV48NameAuthType","fld":"vNAMEAUTHTYPE","hsh":true},{"ctrl":"EXTERNALAUTHENTICATION","prop":"Caption"},{"ctrl":"EXTERNALAUTHENTICATION","prop":"Tooltiptext"},{"av":"divTblexternalsauth_Visible","ctrl":"TBLEXTERNALSAUTH","prop":"Visible"}]}""");
         ...
         setEventMetadata("'SELECTAUTHENTICATIONTYPE'","""{"handler":"E140C2","iparms":[{"av":"AV17KeepMeLoggedIn","fld":"vKEEPMELOGGEDIN"},{"av":"AV22RememberMe","fld":"vREMEMBERME"},{"av":"AV48NameAuthType","fld":"vNAMEAUTHTYPE","hsh":true},{"av":"AV13IDP_State","fld":"vIDP_STATE"},{"av":"AV28UserName","fld":"vUSERNAME"},{"av":"AV29UserPassword","fld":"vUSERPASSWORD"}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV46GAMErrorDelete = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         AV27URL = "";
         ...
         AV44GAMError = new GeneXus.Programs.genexussecurity.SdtGAMError(context);
      ...
      private string AV48NameAuthType ;
      ...
      private string AV43AuxUserName ;
      private string AV50Logoappclient_GXI ;
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV46GAMErrorDelete ;
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMError AV44GAMError ;
