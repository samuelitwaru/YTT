...
namespace GeneXus.Programs {
   public class companylocationgeneral : GXWebComponent
   {
      public companylocationgeneral( )
      {
      ...
      public companylocationgeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)A157CompanyLocationId});
                  componentstart();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV14Pgmname = "CompanyLocationGeneral";
               WS4I2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Company Location General") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("companylocationgeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A157CompanyLocationId,10,0))}, new string[] {"CompanyLocationId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA157CompanyLocationId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA157CompanyLocationId), 10, 0, ".", "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      {
         return "CompanyLocationGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return "Company Location General" ;
      }
      ...
      protected void WB4I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "companylocationgeneral.aspx");
            }
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e114i1_client"+"'", TempTags, "", 2, "HLP_CompanyLocationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e124i1_client"+"'", TempTags, "", 2, "HLP_CompanyLocationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF4I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A159CompanyLocationCode = H004I2_A159CompanyLocationCode[0];
               AssignAttri(sPrefix, false, "A159CompanyLocationCode", A159CompanyLocationCode);
               A158CompanyLocationName = H004I2_A158CompanyLocationName[0];
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtCompanyLocationCode_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCompanyLocationCode_Enabled), 5, 0), true);
      ...
      protected void STRUP4I0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA157CompanyLocationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA157CompanyLocationId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E144I2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "companylocation_Update", out  GXt_boolean1) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "companylocation_Delete", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         AV8TrnContext.gxTpr_Transactionname = "CompanyLocation";
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A157CompanyLocationId = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "A157CompanyLocationId", StringUtil.LTrimStr( (decimal)(A157CompanyLocationId), 10, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA157CompanyLocationId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "companylocationgeneral", GetJustCreated( ));
         ...
         {
            A157CompanyLocationId = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "A157CompanyLocationId", StringUtil.LTrimStr( (decimal)(A157CompanyLocationId), 10, 0));
         }
         wcpOA157CompanyLocationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA157CompanyLocationId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A157CompanyLocationId != wcpOA157CompanyLocationId ) ) )
         {
            setjustcreated();
         }
         wcpOA157CompanyLocationId = A157CompanyLocationId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA157CompanyLocationId = cgiGet( sPrefix+"A157CompanyLocationId_CTRL");
         if ( StringUtil.Len( sCtrlA157CompanyLocationId) > 0 )
         {
            A157CompanyLocationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA157CompanyLocationId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A157CompanyLocationId", StringUtil.LTrimStr( (decimal)(A157CompanyLocationId), 10, 0));
         }
         else
         {
            A157CompanyLocationId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A157CompanyLocationId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A157CompanyLocationId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A157CompanyLocationId), 10, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA157CompanyLocationId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A157CompanyLocationId_CTRL", StringUtil.RTrim( sCtrlA157CompanyLocationId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512201554", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("companylocationgeneral.js", "?2024102512201555", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtCompanyLocationCode_Internalname = sPrefix+"COMPANYLOCATIONCODE";
      ...
      public override void initialize( )
      {
         ...
         sCtrlA157CompanyLocationId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.companylocationgeneral__default(),
            new Object[][] {
                new Object[] {
               H004I2_A157CompanyLocationId, H004I2_A159CompanyLocationCode, H004I2_A158CompanyLocationName
               }
            }
         );
         AV14Pgmname = "CompanyLocationGeneral";
      ...
      private long wcpOA157CompanyLocationId ;
   ...
   public class companylocationgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004I2", "SELECT CompanyLocationId, CompanyLocationCode, CompanyLocationName FROM CompanyLocation WHERE CompanyLocationId = :CompanyLocationId ORDER BY CompanyLocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004I2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
