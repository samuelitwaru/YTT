   ...
   public class wc_leavedetails : GXWebComponent
   {
      ...
      protected void WB660( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "ButtonMaterial";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnapprovebutton_Internalname, "", "Approve", bttBtnapprovebutton_Jsonclick, 7, "Approve", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11661_client"+"'", TempTags, "", 2, "HLP_WC_LeaveDetails.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "ButtonMaterialDefault";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnrejectbutton_Internalname, "", "Reject", bttBtnrejectbutton_Jsonclick, 7, "Reject", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e12661_client"+"'", TempTags, "", 2, "HLP_WC_LeaveDetails.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndeletebutton_Internalname, "", "Delete", bttBtndeletebutton_Jsonclick, 7, "Delete", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e13661_client"+"'", TempTags, "", 2, "HLP_WC_LeaveDetails.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void GXDLVLEAVEREQUEST_LEAVETYPEID661( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         AddString( "[[") ;
         GXDLVLEAVEREQUEST_LEAVETYPEID_data661( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXVLEAVEREQUEST_LEAVETYPEID_html661( )
      {
         long gxdynajaxvalue;
         GXDLVLEAVEREQUEST_LEAVETYPEID_data661( ) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVLEAVEREQUEST_LEAVETYPEID_data661( )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H00662_A124LeaveTypeId[0]), 10, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H00662_A125LeaveTypeName[0]));
      ...
      protected void clear_multi_value_controls( )
      {
         if ( context.isAjaxRequest( ) )
         {
            ...
            {
               dynavLeaverequest_leavetypeid.addItem(StringUtil.Trim( StringUtil.Str( (decimal)(H00663_A124LeaveTypeId[0]), 10, 0)), H00663_A125LeaveTypeName[0], 0);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254119315732", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wc_leavedetails.js", "?20254119315733", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         {
            dynavLeaverequest_leavetypeid.addItem(StringUtil.Trim( StringUtil.Str( (decimal)(H00664_A124LeaveTypeId[0]), 10, 0)), H00664_A125LeaveTypeName[0], 0);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOAPPROVEBUTTON'","""{"handler":"E11661","iparms":[]}""");
         setEventMetadata("'DOREJECTBUTTON'","""{"handler":"E12661","iparms":[]}""");
         setEventMetadata("'DODELETEBUTTON'","""{"handler":"E13661","iparms":[]}""");
         setEventMetadata("'DOUPDATEBUTTON'","""{"handler":"E15662","iparms":[{"av":"AV11LeaveRequest","fld":"vLEAVEREQUEST"},{"av":"AV12LeaveRequestId","fld":"vLEAVEREQUESTID","pic":"ZZZZZZZZZ9"}]""");
         ...
         setEventMetadata("'DOCANCELUPDATEBUTTON'","""{"handler":"E16662","iparms":[{"av":"AV12LeaveRequestId","fld":"vLEAVEREQUESTID","pic":"ZZZZZZZZZ9"}]""");
         ...
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTSTARTDATE.CONTROLVALUECHANGED","""{"handler":"E17662","iparms":[{"av":"AV11LeaveRequest","fld":"vLEAVEREQUEST"}]""");
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTSTARTDATE.CONTROLVALUECHANGED",""","oparms":[{"av":"AV11LeaveRequest","fld":"vLEAVEREQUEST"}]}""");
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTENDDATE.CONTROLVALUECHANGED","""{"handler":"E18662","iparms":[{"av":"AV11LeaveRequest","fld":"vLEAVEREQUEST"}]""");
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTENDDATE.CONTROLVALUECHANGED",""","oparms":[{"av":"AV11LeaveRequest","fld":"vLEAVEREQUEST"}]}""");
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTHALFDAY.CONTROLVALUECHANGED","""{"handler":"E19662","iparms":[{"av":"AV11LeaveRequest","fld":"vLEAVEREQUEST"}]""");
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTHALFDAY.CONTROLVALUECHANGED",""","oparms":[{"av":"AV11LeaveRequest","fld":"vLEAVEREQUEST"}]}""");
         setEventMetadata("LEAVEREQUEST_LEAVETYPEID.CONTROLVALUECHANGED","""{"handler":"E20662","iparms":[{"av":"AV11LeaveRequest","fld":"vLEAVEREQUEST"}]""");
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         H00662_A124LeaveTypeId = new long[1] ;
         H00662_A125LeaveTypeName = new string[] {""} ;
         H00663_A124LeaveTypeId = new long[1] ;
         H00663_A125LeaveTypeName = new string[] {""} ;
         ...
         H00664_A124LeaveTypeId = new long[1] ;
         H00664_A125LeaveTypeName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wc_leavedetails__default(),
            new Object[][] {
                new Object[] {
               H00662_A124LeaveTypeId, H00662_A125LeaveTypeName
               }
               , new Object[] {
               H00663_A124LeaveTypeId, H00663_A125LeaveTypeName
               }
               , new Object[] {
               H00664_A124LeaveTypeId, H00664_A125LeaveTypeName
               }
            }
         );
         Gx_date = DateTimeUtil.Today( context);
      ...
      private long[] H00662_A124LeaveTypeId ;
      private string[] H00662_A125LeaveTypeName ;
      private long[] H00663_A124LeaveTypeId ;
      private string[] H00663_A125LeaveTypeName ;
      ...
      private long[] H00664_A124LeaveTypeId ;
      private string[] H00664_A125LeaveTypeName ;
 ...
 public class wc_leavedetails__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        Object[] prmH00664;
        prmH00664 = new Object[] {
        };
        def= new CursorDef[] {
            new CursorDef("H00662", "SELECT LeaveTypeId, LeaveTypeName FROM LeaveType ORDER BY LeaveTypeName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00662,0, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H00663", "SELECT LeaveTypeId, LeaveTypeName FROM LeaveType ORDER BY LeaveTypeName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00663,0, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H00664", "SELECT LeaveTypeId, LeaveTypeName FROM LeaveType ORDER BY LeaveTypeName ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00664,0, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
