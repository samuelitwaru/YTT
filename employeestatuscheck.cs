...
namespace GeneXus.Programs {
   public class employeestatuscheck : GXProcedure
   {
      ...
      {
         employeestatuscheck objemployeestatuscheck;
         objemployeestatuscheck = new employeestatuscheck();
         objemployeestatuscheck.A106EmployeeId = aP0_EmployeeId;
         objemployeestatuscheck.context.SetSubmitInitialConfig(context);
         objemployeestatuscheck.initialize();
         Submit( executePrivateCatch,objemployeestatuscheck);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((employeestatuscheck)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
