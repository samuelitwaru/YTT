...
namespace GeneXus.Programs {
   public class leaverequestlistexport : GXProcedure
   {
      ...
      protected void S131( )
      {
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV36TFLeaveTypeName_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV36TFLeaveTypeName_Sel)) ? "(Empty)" : AV36TFLeaveTypeName_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV35TFLeaveTypeName)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV35TFLeaveTypeName, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV38TFEmployeeName_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV38TFEmployeeName_Sel)) ? "(Empty)" : AV38TFEmployeeName_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV37TFEmployeeName)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV37TFEmployeeName, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV44TFLeaveRequestHalfDay_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV44TFLeaveRequestHalfDay_Sel)) ? "(Empty)" : AV44TFLeaveRequestHalfDay_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV43TFLeaveRequestHalfDay)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV43TFLeaveRequestHalfDay, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
         ...
         if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV51TFLeaveRequestDescription_Sel)) ) )
         {
            ...
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV51TFLeaveRequestDescription_Sel)) ? "(Empty)" : AV51TFLeaveRequestDescription_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV50TFLeaveRequestDescription)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV50TFLeaveRequestDescription, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
      ...
      protected void S151( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A124LeaveTypeId = P00BU2_A124LeaveTypeId[0];
            A133LeaveRequestDescription = P00BU2_A133LeaveRequestDescription[0];
            A131LeaveRequestDuration = P00BU2_A131LeaveRequestDuration[0];
            A173LeaveRequestHalfDay = P00BU2_A173LeaveRequestHalfDay[0];
            n173LeaveRequestHalfDay = P00BU2_n173LeaveRequestHalfDay[0];
            A130LeaveRequestEndDate = P00BU2_A130LeaveRequestEndDate[0];
            A129LeaveRequestStartDate = P00BU2_A129LeaveRequestStartDate[0];
            A148EmployeeName = P00BU2_A148EmployeeName[0];
            A125LeaveTypeName = P00BU2_A125LeaveTypeName[0];
            A128LeaveRequestDate = P00BU2_A128LeaveRequestDate[0];
            A127LeaveRequestId = P00BU2_A127LeaveRequestId[0];
            A148EmployeeName = P00BU2_A148EmployeeName[0];
            A125LeaveTypeName = P00BU2_A125LeaveTypeName[0];
      ...
      protected void S191( )
      {
         ...
         {
            AV22GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "LeaveRequestListGridState"), null, "", "");
         }
         else
         {
         ...
         {
            AV23GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV22GridState.gxTpr_Filtervalues.Item(AV76GXV1));
      ...
      public override void initialize( )
      {
         ...
         P00BU2_A124LeaveTypeId = new long[1] ;
         P00BU2_A133LeaveRequestDescription = new string[] {""} ;
         P00BU2_A131LeaveRequestDuration = new decimal[1] ;
         P00BU2_A173LeaveRequestHalfDay = new string[] {""} ;
         P00BU2_n173LeaveRequestHalfDay = new bool[] {false} ;
         P00BU2_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         P00BU2_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         P00BU2_A148EmployeeName = new string[] {""} ;
         P00BU2_A125LeaveTypeName = new string[] {""} ;
         P00BU2_A128LeaveRequestDate = new DateTime[] {DateTime.MinValue} ;
         P00BU2_A127LeaveRequestId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestlistexport__default(),
            new Object[][] {
                new Object[] {
               P00BU2_A106EmployeeId, P00BU2_A124LeaveTypeId, P00BU2_A133LeaveRequestDescription, P00BU2_A131LeaveRequestDuration, P00BU2_A173LeaveRequestHalfDay, P00BU2_n173LeaveRequestHalfDay, P00BU2_A130LeaveRequestEndDate, P00BU2_A129LeaveRequestStartDate, P00BU2_A148EmployeeName, P00BU2_A125LeaveTypeName,
               P00BU2_A128LeaveRequestDate, P00BU2_A127LeaveRequestId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P00BU2_A124LeaveTypeId ;
      private string[] P00BU2_A133LeaveRequestDescription ;
      private decimal[] P00BU2_A131LeaveRequestDuration ;
      private string[] P00BU2_A173LeaveRequestHalfDay ;
      private bool[] P00BU2_n173LeaveRequestHalfDay ;
      private DateTime[] P00BU2_A130LeaveRequestEndDate ;
      private DateTime[] P00BU2_A129LeaveRequestStartDate ;
      private string[] P00BU2_A148EmployeeName ;
      private string[] P00BU2_A125LeaveTypeName ;
      private DateTime[] P00BU2_A128LeaveRequestDate ;
      private long[] P00BU2_A127LeaveRequestId ;
   ...
   public class leaverequestlistexport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             DateTime AV57FromDate )
      {
         ...
         {
            AddWhere(sWhereString, "(( LOWER(T3.LeaveTypeName) like '%' || LOWER(:lV61Leaverequestlistds_1_filterfulltext)) or ( LOWER(T2.EmployeeName) like '%' || LOWER(:lV61Leaverequestlistds_1_filterfulltext)) or ( LOWER(T1.LeaveRequestHalfDay) like '%' || LOWER(:lV61Leaverequestlistds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'90.9'), 2) like '%' || :lV61Leaverequestlistds_1_filterfulltext) or ( LOWER(T1.LeaveRequestDescription) like '%' || LOWER(:lV61Leaverequestlistds_1_filterfulltext)))");
         }
         else
         {
            GXv_int4[2] = 1;
