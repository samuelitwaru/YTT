...
namespace GeneXus.Programs {
   public class companywwexport : GXProcedure
   {
      ...
      public void executeSubmit( out string aP0_Filename ,
                                 out string aP1_ErrorMessage )
      {
         companywwexport objcompanywwexport;
         objcompanywwexport = new companywwexport();
         objcompanywwexport.AV12Filename = "" ;
         objcompanywwexport.AV13ErrorMessage = "" ;
         objcompanywwexport.context.SetSubmitInitialConfig(context);
         objcompanywwexport.initialize();
         Submit( executePrivateCatch,objcompanywwexport);
         aP0_Filename=this.AV12Filename;
         aP1_ErrorMessage=this.AV13ErrorMessage;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((companywwexport)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S131( )
      {
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Location Name") ;
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV38TFCompanyName_Sel)) ? "(Empty)" : AV38TFCompanyName_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV37TFCompanyName)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV37TFCompanyName, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Location Country") ;
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
            new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  (String.IsNullOrEmpty(StringUtil.RTrim( AV45TFCompanyLocationName_Sel)) ? "(Empty)" : AV45TFCompanyLocationName_Sel), out  GXt_char1) ;
            AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
         }
         else
         {
            if ( ! ( String.IsNullOrEmpty(StringUtil.RTrim( AV44TFCompanyLocationName)) ) )
            {
               ...
               AV14CellRow = GXt_int2;
               GXt_char1 = "";
               new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV44TFCompanyLocationName, out  GXt_char1) ;
               AV11ExcelDocument.get_Cells(AV14CellRow, AV15FirstColumn+1, 1, 1).Text = GXt_char1;
            }
         }
      ...
      protected void S151( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "CompanyName",  "",  "Location Name",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV24ColumnsSelector,  "CompanyLocationName",  "",  "Location Country",  true,  "") ;
         GXt_char1 = AV28UserCustomValue;
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "CompanyWWColumnsSelector", out  GXt_char1) ;
      ...
      protected void S201( )
      {
         ...
         {
            AV22GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "CompanyWWGridState"), null, "", "");
         }
         else
         {
   ...
   public class companywwexport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV18OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(LOWER(T1.CompanyName) like LOWER(:lV49Companywwds_2_tfcompanyname))");
         }
         else
         {
            GXv_int3[2] = 1;
         ...
         {
            AddWhere(sWhereString, "(LOWER(T2.CompanyLocationName) like LOWER(:lV51Companywwds_4_tfcompanylocationname))");
         }
         else
         {
            GXv_int3[4] = 1;
