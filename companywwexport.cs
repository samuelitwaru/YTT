...
namespace GeneXus.Programs {
   public class companywwexport : GXProcedure
   {
      ...
      protected void S161( )
      {
         /* 'WRITEDATA' Routine */
         returnInSub = false;
         AV46Companywwds_1_filterfulltext = AV19FilterFullText;
         AV47Companywwds_2_tfcompanyname = AV37TFCompanyName;
         AV48Companywwds_3_tfcompanyname_sel = AV38TFCompanyName_Sel;
         ...
         /* Using cursor P006S2 */
         pr_default.execute(0, new Object[] {lV46Companywwds_1_filterfulltext, lV47Companywwds_2_tfcompanyname, AV48Companywwds_3_tfcompanyname_sel});
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.companywwexport__default(),
            new Object[][] {
                new Object[] {
               P006S2_A101CompanyName, P006S2_A100CompanyId
               }
            }
         );
         /* GeneXus formulas. */
   ...
   public class companywwexport__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV18OrderedDsc )
      {
         ...
         {
            AddWhere(sWhereString, "(( LOWER(CompanyName) like '%' || LOWER(:lV46Companywwds_1_filterfulltext)))");
         }
         else
         {
            GXv_int3[0] = 1;
         ...
         {
            AddWhere(sWhereString, "(LOWER(CompanyName) like LOWER(:lV47Companywwds_2_tfcompanyname))");
         }
         else
         {
            GXv_int3[1] = 1;
         ...
         {
            AddWhere(sWhereString, "(CompanyName = ( :AV48Companywwds_3_tfcompanyname_sel))");
         }
         else
         {
            GXv_int3[2] = 1;
         ...
         {
            scmdbuf += " ORDER BY CompanyName DESC";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P006S2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] );
         }
