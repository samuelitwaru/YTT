   ...
   public class gamexamplerecoverpasswordstep1 : GXHttpHandler
   {
      ...
      protected void WB090( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSignin_Internalname, "RECOVER", "", "", lblSignin_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleLogin", 0, "", 1, 1, 0, 0, "HLP_GAMExampleRecoverPasswordStep1.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      protected void E12092( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV9User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getuserbylogin(AV10UserAuthTypeName, AV11UserName, out  AV21GAMErrorCollection);
         if ( AV21GAMErrorCollection.Count == 0 )
         {
            ...
            AV9User.sendemailtorecoverpassword( AV5Application,  AV8LinkURL, out  AV21GAMErrorCollection);
            if ( AV21GAMErrorCollection.Count == 0 )
            {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV24GXV1 = 1;
         while ( AV24GXV1 <= AV21GAMErrorCollection.Count )
         {
            AV20GAMError = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV21GAMErrorCollection.Item(AV24GXV1));
            GX_msglist.addItem(AV20GAMError.gxTpr_Message);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024916733373", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplerecoverpasswordstep1.js", "?2024916733377", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'GOBACK'","""{"handler":"E13092","iparms":[{"av":"AV7IDP_State","fld":"vIDP_STATE"}]""");
      ...
      public override void initialize( )
      {
         ...
         AV21GAMErrorCollection = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         AV8LinkURL = "";
         GXt_char1 = "";
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV21GAMErrorCollection ;
