...
namespace GeneXus.Programs {
   public class project : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtProjectName_Internalname, StringUtil.RTrim( A103ProjectName), StringUtil.RTrim( context.localUtil.Format( A103ProjectName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProjectName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProjectName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Project.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtProjectDescription_Internalname, A104ProjectDescription, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", 0, 1, edtProjectDescription_Enabled, 0, 80, "chr", 3, "row", 0, StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "GeneXusUnanimo\\Description", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Project.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* ComboBox */
         GxWebStd.gx_combobox_ctrl1( context, cmbProjectStatus, cmbProjectStatus_Internalname, StringUtil.RTrim( A105ProjectStatus), 1, cmbProjectStatus_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbProjectStatus.Enabled, 1, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "", true, 0, "HLP_Project.htm");
         cmbProjectStatus.CurrentValue = StringUtil.RTrim( A105ProjectStatus);
         ...
         ucCombo_projectmanagerid.SetProperty("DropDownOptionsTitleSettingsIcons", AV26DDO_TitleSettingsIcons);
         ...
         GxWebStd.gx_single_line_edit( context, edtProjectManagerId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A166ProjectManagerId), 10, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A166ProjectManagerId), "ZZZZZZZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProjectManagerId_Jsonclick, 0, "Attribute", "", "", "", "", edtProjectManagerId_Visible, edtProjectManagerId_Enabled, 1, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Project.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Gx_mode = cgiGet( "Mode");
               N166ProjectManagerId = (long)(Math.Round(context.localUtil.CToN( cgiGet( "N166ProjectManagerId"), ".", ","), 18, MidpointRounding.ToEven));
               n166ProjectManagerId = ((0==A166ProjectManagerId) ? true : false);
               ...
               {
                  A166ProjectManagerId = (long)(Math.Round(context.localUtil.CToN( cgiGet( edtProjectManagerId_Internalname), ".", ","), 18, MidpointRounding.ToEven));
                  n166ProjectManagerId = false;
                  AssignAttri("", false, "A166ProjectManagerId", StringUtil.LTrimStr( (decimal)(A166ProjectManagerId), 10, 0));
               }
               n166ProjectManagerId = ((0==A166ProjectManagerId) ? true : false);
      ...
      protected void S112( )
      {
         ...
         new projectloaddvcombo(context ).execute(  "ProjectManagerId",  Gx_mode,  AV7ProjectId, out  AV16ComboSelectedValue, out  AV27ComboSelectedText, out  GXt_objcol_SdtDVB_SDTComboData_Item2) ;
      ...
      protected void ZM0E15( short GX_JID )
      {
         if ( ( GX_JID == 13 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z166ProjectManagerId = T000E3_A166ProjectManagerId[0];
            }
            else
            {
      ...
      protected void standaloneModal( )
      {
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! (0==AV20Insert_ProjectManagerId) )
         {
            A166ProjectManagerId = AV20Insert_ProjectManagerId;
            n166ProjectManagerId = false;
            AssignAttri("", false, "A166ProjectManagerId", StringUtil.LTrimStr( (decimal)(A166ProjectManagerId), 10, 0));
         }
         else
         {
            ...
            else
            {
               if ( ! (0==AV22ComboProjectManagerId) )
               {
                  A166ProjectManagerId = AV22ComboProjectManagerId;
                  n166ProjectManagerId = false;
                  AssignAttri("", false, "A166ProjectManagerId", StringUtil.LTrimStr( (decimal)(A166ProjectManagerId), 10, 0));
               }
            }
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ( Gx_BScreen == 0 ) )
         {
            ...
            A167ProjectManagerName = T000E4_A167ProjectManagerName[0];
      ...
      protected void Load0E15( )
      {
         ...
         if ( (pr_default.getStatus(4) != 101) )
         {
            ...
            AssignAttri("", false, "A105ProjectStatus", A105ProjectStatus);
            A167ProjectManagerName = T000E6_A167ProjectManagerName[0];
            A176ProjectManagerEmail = T000E6_A176ProjectManagerEmail[0];
            A177ProjectManagerIsActive = T000E6_A177ProjectManagerIsActive[0];
      ...
      {
         /* Using cursor T000E8 */
         pr_default.execute(6, new Object[] {n166ProjectManagerId, A166ProjectManagerId, A102ProjectId});
      ...
      protected void gxLoad_15( long A166ProjectManagerId )
      {
         ...
         A167ProjectManagerName = T000E9_A167ProjectManagerName[0];
         A176ProjectManagerEmail = T000E9_A176ProjectManagerEmail[0];
         A177ProjectManagerIsActive = T000E9_A177ProjectManagerIsActive[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( StringUtil.RTrim( A167ProjectManagerName))+"\""+","+"\""+GXUtil.EncodeJSConstant( A176ProjectManagerEmail)+"\""+","+"\""+GXUtil.EncodeJSConstant( StringUtil.BoolToStr( A177ProjectManagerIsActive))+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(7) == 101) )
         {
            AddString( ",") ;
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A105ProjectStatus", A105ProjectStatus);
            A166ProjectManagerId = T000E3_A166ProjectManagerId[0];
            n166ProjectManagerId = T000E3_n166ProjectManagerId[0];
            AssignAttri("", false, "A166ProjectManagerId", StringUtil.LTrimStr( (decimal)(A166ProjectManagerId), 10, 0));
      ...
      protected void CheckOptimisticConcurrency0E15( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z103ProjectName, T000E2_A103ProjectName[0]) != 0 ) || ( StringUtil.StrCmp(Z104ProjectDescription, T000E2_A104ProjectDescription[0]) != 0 ) || ( StringUtil.StrCmp(Z105ProjectStatus, T000E2_A105ProjectStatus[0]) != 0 ) || ( Z166ProjectManagerId != T000E2_A166ProjectManagerId[0] ) )
            {
               ...
               if ( Z166ProjectManagerId != T000E2_A166ProjectManagerId[0] )
               {
                  GXUtil.WriteLog("project:[seudo value changed for attri]"+"ProjectManagerId");
                  GXUtil.WriteLogRaw("Old: ",Z166ProjectManagerId);
                  GXUtil.WriteLogRaw("Current: ",T000E2_A166ProjectManagerId[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(11, new Object[] {A103ProjectName, A104ProjectDescription, A105ProjectStatus, n166ProjectManagerId, A166ProjectManagerId});
                     pr_default.close(11);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(13, new Object[] {A103ProjectName, A104ProjectDescription, A105ProjectStatus, n166ProjectManagerId, A166ProjectManagerId, A102ProjectId});
                     pr_default.close(13);
                     pr_default.SmartCacheProvider.SetUpdated("Project");
      ...
      protected void OnDeleteControls0E15( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            A176ProjectManagerEmail = T000E17_A176ProjectManagerEmail[0];
            A177ProjectManagerIsActive = T000E17_A177ProjectManagerIsActive[0];
            pr_default.close(15);
         }
         if ( AnyError == 0 )
         {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z166ProjectManagerId", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z166ProjectManagerId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "IsConfirmed", StringUtil.LTrim( StringUtil.NToC( (decimal)(IsConfirmed), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "IsModified", StringUtil.LTrim( StringUtil.NToC( (decimal)(IsModified), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Mode", StringUtil.RTrim( Gx_mode));
         GxWebStd.gx_hidden_field( context, "gxhash_Mode", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")), context));
         GxWebStd.gx_hidden_field( context, "N166ProjectManagerId", StringUtil.LTrim( StringUtil.NToC( (decimal)(A166ProjectManagerId), 10, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void InitializeNonKey0E15( )
      {
         ...
         AssignAttri("", false, "A167ProjectManagerName", A167ProjectManagerName);
         A176ProjectManagerEmail = "";
         AssignAttri("", false, "A176ProjectManagerEmail", A176ProjectManagerEmail);
         A177ProjectManagerIsActive = false;
         AssignAttri("", false, "A177ProjectManagerIsActive", A177ProjectManagerIsActive);
         A105ProjectStatus = "Active";
         AssignAttri("", false, "A105ProjectStatus", A105ProjectStatus);
         Z103ProjectName = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202471712101012", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("project.js", "?202471712101012", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      protected void XC_12_0E15( long A166ProjectManagerId ,
                                 long A102ProjectId )
      {
         new assignprojectmanagerrole(context ).execute(  A166ProjectManagerId,  A102ProjectId) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      public void Valid_Projectmanagerid( )
      {
         ...
         pr_default.execute(19, new Object[] {n166ProjectManagerId, A166ProjectManagerId, A102ProjectId});
      ...
      public override void initialize( )
      {
         ...
         AV21ProjectManagerId_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         AV27ComboSelectedText = "";
         Z167ProjectManagerName = "";
         Z176ProjectManagerEmail = "";
         T000E4_A167ProjectManagerName = new string[] {""} ;
         T000E4_A176ProjectManagerEmail = new string[] {""} ;
         T000E4_A177ProjectManagerIsActive = new bool[] {false} ;
         T000E6_A103ProjectName = new string[] {""} ;
         T000E6_A104ProjectDescription = new string[] {""} ;
         T000E6_A105ProjectStatus = new string[] {""} ;
         T000E6_A167ProjectManagerName = new string[] {""} ;
         T000E6_A176ProjectManagerEmail = new string[] {""} ;
         T000E6_A177ProjectManagerIsActive = new bool[] {false} ;
         T000E6_A166ProjectManagerId = new long[1] ;
         T000E6_n166ProjectManagerId = new bool[] {false} ;
         ...
         T000E9_A167ProjectManagerName = new string[] {""} ;
         T000E9_A176ProjectManagerEmail = new string[] {""} ;
         T000E9_A177ProjectManagerIsActive = new bool[] {false} ;
         ...
         T000E3_A166ProjectManagerId = new long[1] ;
         T000E3_n166ProjectManagerId = new bool[] {false} ;
         ...
         T000E2_A166ProjectManagerId = new long[1] ;
         T000E2_n166ProjectManagerId = new bool[] {false} ;
         T000E2_A102ProjectId = new long[1] ;
         T000E14_A102ProjectId = new long[1] ;
         T000E17_A167ProjectManagerName = new string[] {""} ;
         T000E17_A176ProjectManagerEmail = new string[] {""} ;
         T000E17_A177ProjectManagerIsActive = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.project__default(),
            new Object[][] {
                new Object[] {
               T000E2_A103ProjectName, T000E2_A104ProjectDescription, T000E2_A105ProjectStatus, T000E2_A166ProjectManagerId, T000E2_n166ProjectManagerId, T000E2_A102ProjectId
               }
               , new Object[] {
               T000E3_A103ProjectName, T000E3_A104ProjectDescription, T000E3_A105ProjectStatus, T000E3_A166ProjectManagerId, T000E3_n166ProjectManagerId, T000E3_A102ProjectId
               }
               , new Object[] {
               T000E4_A167ProjectManagerName, T000E4_A176ProjectManagerEmail, T000E4_A177ProjectManagerIsActive
               }
               , new Object[] {
               T000E5_A106EmployeeId
               }
               , new Object[] {
               T000E6_A103ProjectName, T000E6_A104ProjectDescription, T000E6_A105ProjectStatus, T000E6_A167ProjectManagerName, T000E6_A176ProjectManagerEmail, T000E6_A177ProjectManagerIsActive, T000E6_A166ProjectManagerId, T000E6_n166ProjectManagerId, T000E6_A102ProjectId
               }
               , new Object[] {
               ...
               , new Object[] {
               T000E9_A167ProjectManagerName, T000E9_A176ProjectManagerEmail, T000E9_A177ProjectManagerIsActive
               }
               , new Object[] {
               ...
               , new Object[] {
               T000E17_A167ProjectManagerName, T000E17_A176ProjectManagerEmail, T000E17_A177ProjectManagerIsActive
               }
               , new Object[] {
      ...
      private long N166ProjectManagerId ;
      ...
      private string AV27ComboSelectedText ;
      ...
      private bool[] T000E4_A177ProjectManagerIsActive ;
      private string[] T000E6_A103ProjectName ;
      private string[] T000E6_A104ProjectDescription ;
      private string[] T000E6_A105ProjectStatus ;
      private string[] T000E6_A167ProjectManagerName ;
      private string[] T000E6_A176ProjectManagerEmail ;
      private bool[] T000E6_A177ProjectManagerIsActive ;
      private long[] T000E6_A166ProjectManagerId ;
      private bool[] T000E6_n166ProjectManagerId ;
      ...
      private string[] T000E9_A167ProjectManagerName ;
      private string[] T000E9_A176ProjectManagerEmail ;
      private bool[] T000E9_A177ProjectManagerIsActive ;
      ...
      private long[] T000E3_A166ProjectManagerId ;
      private bool[] T000E3_n166ProjectManagerId ;
      ...
      private long[] T000E2_A166ProjectManagerId ;
      private bool[] T000E2_n166ProjectManagerId ;
      private long[] T000E2_A102ProjectId ;
      private long[] T000E14_A102ProjectId ;
      private string[] T000E17_A167ProjectManagerName ;
      private string[] T000E17_A176ProjectManagerEmail ;
      private bool[] T000E17_A177ProjectManagerIsActive ;
