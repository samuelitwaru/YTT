...
namespace GeneXus.Programs {
   public class aprocedure1 : GXWebProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            {
               A106EmployeeId = P00AF2_A106EmployeeId[0];
               A109EmployeeEmail = P00AF2_A109EmployeeEmail[0];
               ...
               AV8GAMUser = new GeneXus.Programs.genexussecurity.SdtGAMUser(context).getbylogin("local", StringUtil.Trim( A109EmployeeEmail), out  AV10GAMErrorCollection);
               AV9Employee.gxTpr_Gamuserguid = AV8GAMUser.gxTpr_Guid;
               AV9Employee.Save();
               context.CommitDataStores("procedure1",pr_default);
               HAF0( false, 58) ;
               getPrinter().GxAttris("Microsoft Sans Serif", 8, false, false, false, false, 0, 0, 0, 0, 0, 255, 255, 255) ;
               getPrinter().GxDrawText(StringUtil.RTrim( context.localUtil.Format( A109EmployeeEmail, "")), 150, Gx_line+22, 672, Gx_line+37, 0+256, 0, 0, 0) ;
               Gx_OldLine = Gx_line;
      ...
      public override void initialize( )
      {
         ...
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.aprocedure1__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.aprocedure1__default(),
            new Object[][] {
                new Object[] {
               P00AF2_A106EmployeeId, P00AF2_A109EmployeeEmail
               }
            }
         );
         /* GeneXus formulas. */
 ...
 public class aprocedure1__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
            new CursorDef("P00AF2", "SELECT EmployeeId, EmployeeEmail FROM Employee ORDER BY EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AF2,100, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
