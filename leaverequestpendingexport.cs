...
namespace GeneXus.Programs {
   public class leaverequestpendingexport : GXProcedure
   {
      ...
      protected void S161( )
      {
         ...
         lV65Leaverequestpendingds_12_tfemployeename = StringUtil.PadR( StringUtil.RTrim( AV65Leaverequestpendingds_12_tfemployeename), 100, "%");
         /* Using cursor P006U2 */
      ...
      public override void initialize( )
      {
         ...
         P006U2_A131LeaveRequestDuration = new short[1] ;
      ...
      private short AV61Leaverequestpendingds_8_tfleaverequestduration ;
      private short AV62Leaverequestpendingds_9_tfleaverequestduration_to ;
      ...
      private short[] P006U2_A131LeaveRequestDuration ;
   ...
   public class leaverequestpendingexport__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P006U2( IGxContext context ,
                                             ...
                                             short AV61Leaverequestpendingds_8_tfleaverequestduration ,
                                             short AV62Leaverequestpendingds_9_tfleaverequestduration_to ,
                                             ...
                                             string A132LeaveRequestStatus )
      {
         ...
         {
            AddWhere(sWhereString, "(( LOWER(T2.LeaveTypeName) like '%' || LOWER(:lV54Leaverequestpendingds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'9999'), 2) like '%' || :lV54Leaverequestpendingds_1_filterfulltext) or ( LOWER(T1.LeaveRequestDescription) like '%' || LOWER(:lV54Leaverequestpendingds_1_filterfulltext)) or ( LOWER(T3.EmployeeName) like '%' || LOWER(:lV54Leaverequestpendingds_1_filterfulltext)))");
         }
         else
         {
            GXv_int4[0] = 1;
         ...
         if ( ! (0==AV61Leaverequestpendingds_8_tfleaverequestduration) )
         {
         ...
         if ( ! (0==AV62Leaverequestpendingds_9_tfleaverequestduration_to) )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P006U2(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (DateTime)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (DateTime)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (short)dynConstraints[16] , (string)dynConstraints[17] , (string)dynConstraints[18] , (DateTime)dynConstraints[19] , (DateTime)dynConstraints[20] , (long)dynConstraints[21] , (long)dynConstraints[22] , (short)dynConstraints[23] , (bool)dynConstraints[24] , (string)dynConstraints[25] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV61Leaverequestpendingds_8_tfleaverequestduration",GXType.Int16,4,0) ,
          new ParDef("AV62Leaverequestpendingds_9_tfleaverequestduration_to",GXType.Int16,4,0) ,
          ...
          new ParDef("lV65Leaverequestpendingds_12_tfemployeename",GXType.Char,100,0) ,
          new ParDef("AV66Leaverequestpendingds_13_tfemployeename_sel",GXType.Char,100,0) ,
