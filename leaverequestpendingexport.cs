...
namespace GeneXus.Programs {
   public class leaverequestpendingexport : GXProcedure
   {
      ...
      protected void S141( )
      {
         ...
         AV57GXV1 = 1;
         while ( AV57GXV1 <= AV24ColumnsSelector.gxTpr_Columns.Count )
         {
            AV26ColumnsSelector_Column = ((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV24ColumnsSelector.gxTpr_Columns.Item(AV57GXV1));
      ...
      protected void S161( )
      {
         /* 'WRITEDATA' Routine */
         returnInSub = false;
         AV59Leaverequestpendingds_1_filterfulltext = AV19FilterFullText;
         AV60Leaverequestpendingds_2_tfemployeename = AV35TFEmployeeName;
         AV61Leaverequestpendingds_3_tfemployeename_sel = AV36TFEmployeeName_Sel;
         AV62Leaverequestpendingds_4_tfleavetypename = AV37TFLeaveTypeName;
         AV63Leaverequestpendingds_5_tfleavetypename_sel = AV38TFLeaveTypeName_Sel;
         AV64Leaverequestpendingds_6_tfleaverequeststartdate = AV41TFLeaveRequestStartDate;
         AV65Leaverequestpendingds_7_tfleaverequeststartdate_to = AV42TFLeaveRequestStartDate_To;
         AV66Leaverequestpendingds_8_tfleaverequestenddate = AV43TFLeaveRequestEndDate;
         AV67Leaverequestpendingds_9_tfleaverequestenddate_to = AV44TFLeaveRequestEndDate_To;
         AV68Leaverequestpendingds_10_tfleaverequesthalfday = AV52TFLeaveRequestHalfDay;
         AV69Leaverequestpendingds_11_tfleaverequesthalfdayoperator = AV54TFLeaveRequestHalfDayOperator;
         AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel = AV53TFLeaveRequestHalfDay_Sel;
         AV71Leaverequestpendingds_13_tfleaverequestduration = AV45TFLeaveRequestDuration;
         AV72Leaverequestpendingds_14_tfleaverequestduration_to = AV46TFLeaveRequestDuration_To;
         AV73Leaverequestpendingds_15_tfemployeebalance = AV55TFEmployeeBalance;
         AV74Leaverequestpendingds_16_tfemployeebalance_to = AV56TFEmployeeBalance_To;
         AV75Udparg17 = new getloggedinusercompanyid(context).executeUdp( );
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              A106EmployeeId ,
                                              AV50EmployeeIds ,
                                              AV59Leaverequestpendingds_1_filterfulltext ,
                                              AV61Leaverequestpendingds_3_tfemployeename_sel ,
                                              AV60Leaverequestpendingds_2_tfemployeename ,
                                              AV63Leaverequestpendingds_5_tfleavetypename_sel ,
                                              AV62Leaverequestpendingds_4_tfleavetypename ,
                                              AV64Leaverequestpendingds_6_tfleaverequeststartdate ,
                                              AV65Leaverequestpendingds_7_tfleaverequeststartdate_to ,
                                              AV66Leaverequestpendingds_8_tfleaverequestenddate ,
                                              AV67Leaverequestpendingds_9_tfleaverequestenddate_to ,
                                              AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel ,
                                              AV68Leaverequestpendingds_10_tfleaverequesthalfday ,
                                              AV69Leaverequestpendingds_11_tfleaverequesthalfdayoperator ,
                                              AV71Leaverequestpendingds_13_tfleaverequestduration ,
                                              AV72Leaverequestpendingds_14_tfleaverequestduration_to ,
                                              AV73Leaverequestpendingds_15_tfemployeebalance ,
                                              AV74Leaverequestpendingds_16_tfemployeebalance_to ,
                                              A148EmployeeName ,
                                              A125LeaveTypeName ,
         ...
         lV59Leaverequestpendingds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV59Leaverequestpendingds_1_filterfulltext), "%", "");
         lV59Leaverequestpendingds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV59Leaverequestpendingds_1_filterfulltext), "%", "");
         lV59Leaverequestpendingds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV59Leaverequestpendingds_1_filterfulltext), "%", "");
         lV59Leaverequestpendingds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV59Leaverequestpendingds_1_filterfulltext), "%", "");
         lV59Leaverequestpendingds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV59Leaverequestpendingds_1_filterfulltext), "%", "");
         lV60Leaverequestpendingds_2_tfemployeename = StringUtil.PadR( StringUtil.RTrim( AV60Leaverequestpendingds_2_tfemployeename), 100, "%");
         lV62Leaverequestpendingds_4_tfleavetypename = StringUtil.PadR( StringUtil.RTrim( AV62Leaverequestpendingds_4_tfleavetypename), 100, "%");
         lV68Leaverequestpendingds_10_tfleaverequesthalfday = StringUtil.PadR( StringUtil.RTrim( AV68Leaverequestpendingds_10_tfleaverequesthalfday), 20, "%");
         /* Using cursor P006U2 */
         pr_default.execute(0, new Object[] {lV59Leaverequestpendingds_1_filterfulltext, lV59Leaverequestpendingds_1_filterfulltext, lV59Leaverequestpendingds_1_filterfulltext, lV59Leaverequestpendingds_1_filterfulltext, lV59Leaverequestpendingds_1_filterfulltext, lV60Leaverequestpendingds_2_tfemployeename, AV61Leaverequestpendingds_3_tfemployeename_sel, lV62Leaverequestpendingds_4_tfleavetypename, AV63Leaverequestpendingds_5_tfleavetypename_sel, AV64Leaverequestpendingds_6_tfleaverequeststartdate, AV65Leaverequestpendingds_7_tfleaverequeststartdate_to, AV66Leaverequestpendingds_8_tfleaverequestenddate, AV67Leaverequestpendingds_9_tfleaverequestenddate_to, lV68Leaverequestpendingds_10_tfleaverequesthalfday, AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel, AV71Leaverequestpendingds_13_tfleaverequestduration, AV72Leaverequestpendingds_14_tfleaverequestduration_to, AV73Leaverequestpendingds_15_tfemployeebalance, AV74Leaverequestpendingds_16_tfemployeebalance_to, AV75Udparg17});
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            AV32VisibleColumnCount = 0;
            AV76GXV2 = 1;
            while ( AV76GXV2 <= AV24ColumnsSelector.gxTpr_Columns.Count )
            {
               AV26ColumnsSelector_Column = ((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV24ColumnsSelector.gxTpr_Columns.Item(AV76GXV2));
               if ( AV26ColumnsSelector_Column.gxTpr_Isvisible )
               {
      ...
      protected void S201( )
      {
         ...
         AV77GXV3 = 1;
         while ( AV77GXV3 <= AV22GridState.gxTpr_Filtervalues.Count )
         {
            AV23GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV22GridState.gxTpr_Filtervalues.Item(AV77GXV3));
      ...
      public override void initialize( )
      {
         ...
         AV62Leaverequestpendingds_4_tfleavetypename = "";
         AV63Leaverequestpendingds_5_tfleavetypename_sel = "";
         AV64Leaverequestpendingds_6_tfleaverequeststartdate = DateTime.MinValue;
         AV65Leaverequestpendingds_7_tfleaverequeststartdate_to = DateTime.MinValue;
         AV66Leaverequestpendingds_8_tfleaverequestenddate = DateTime.MinValue;
         AV67Leaverequestpendingds_9_tfleaverequestenddate_to = DateTime.MinValue;
         AV68Leaverequestpendingds_10_tfleaverequesthalfday = "";
         AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel = "";
         scmdbuf = "";
         lV59Leaverequestpendingds_1_filterfulltext = "";
         lV60Leaverequestpendingds_2_tfemployeename = "";
         lV62Leaverequestpendingds_4_tfleavetypename = "";
         lV68Leaverequestpendingds_10_tfleaverequesthalfday = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestpendingexport__default(),
            new Object[][] {
                new Object[] {
               P006U2_A124LeaveTypeId, P006U2_A106EmployeeId, P006U2_A100CompanyId, P006U2_A132LeaveRequestStatus, P006U2_A147EmployeeBalance, P006U2_A131LeaveRequestDuration, P006U2_A173LeaveRequestHalfDay, P006U2_n173LeaveRequestHalfDay, P006U2_A130LeaveRequestEndDate, P006U2_A129LeaveRequestStartDate,
      ...
      private short AV69Leaverequestpendingds_11_tfleaverequesthalfdayoperator ;
      ...
      private decimal AV71Leaverequestpendingds_13_tfleaverequestduration ;
      private decimal AV72Leaverequestpendingds_14_tfleaverequestduration_to ;
      private decimal AV73Leaverequestpendingds_15_tfemployeebalance ;
      private decimal AV74Leaverequestpendingds_16_tfemployeebalance_to ;
      ...
      private string AV60Leaverequestpendingds_2_tfemployeename ;
      private string AV61Leaverequestpendingds_3_tfemployeename_sel ;
      private string AV62Leaverequestpendingds_4_tfleavetypename ;
      private string AV63Leaverequestpendingds_5_tfleavetypename_sel ;
      private string AV68Leaverequestpendingds_10_tfleaverequesthalfday ;
      private string AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel ;
      private string scmdbuf ;
      private string lV60Leaverequestpendingds_2_tfemployeename ;
      private string lV62Leaverequestpendingds_4_tfleavetypename ;
      private string lV68Leaverequestpendingds_10_tfleaverequesthalfday ;
      ...
      private DateTime AV64Leaverequestpendingds_6_tfleaverequeststartdate ;
      private DateTime AV65Leaverequestpendingds_7_tfleaverequeststartdate_to ;
      private DateTime AV66Leaverequestpendingds_8_tfleaverequestenddate ;
      private DateTime AV67Leaverequestpendingds_9_tfleaverequestenddate_to ;
      ...
      private string AV59Leaverequestpendingds_1_filterfulltext ;
      private string lV59Leaverequestpendingds_1_filterfulltext ;
   ...
   public class leaverequestpendingexport__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P006U2( IGxContext context ,
                                             ...
                                             string AV59Leaverequestpendingds_1_filterfulltext ,
                                             string AV61Leaverequestpendingds_3_tfemployeename_sel ,
                                             string AV60Leaverequestpendingds_2_tfemployeename ,
                                             string AV63Leaverequestpendingds_5_tfleavetypename_sel ,
                                             string AV62Leaverequestpendingds_4_tfleavetypename ,
                                             DateTime AV64Leaverequestpendingds_6_tfleaverequeststartdate ,
                                             DateTime AV65Leaverequestpendingds_7_tfleaverequeststartdate_to ,
                                             DateTime AV66Leaverequestpendingds_8_tfleaverequestenddate ,
                                             DateTime AV67Leaverequestpendingds_9_tfleaverequestenddate_to ,
                                             string AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel ,
                                             string AV68Leaverequestpendingds_10_tfleaverequesthalfday ,
                                             short AV69Leaverequestpendingds_11_tfleaverequesthalfdayoperator ,
                                             decimal AV71Leaverequestpendingds_13_tfleaverequestduration ,
                                             decimal AV72Leaverequestpendingds_14_tfleaverequestduration_to ,
                                             decimal AV73Leaverequestpendingds_15_tfemployeebalance ,
                                             decimal AV74Leaverequestpendingds_16_tfemployeebalance_to ,
                                             ...
                                             string A132LeaveRequestStatus )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV59Leaverequestpendingds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T3.EmployeeName) like '%' || LOWER(:lV59Leaverequestpendingds_1_filterfulltext)) or ( LOWER(T2.LeaveTypeName) like '%' || LOWER(:lV59Leaverequestpendingds_1_filterfulltext)) or ( LOWER(T1.LeaveRequestHalfDay) like '%' || LOWER(:lV59Leaverequestpendingds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'90.9'), 2) like '%' || :lV59Leaverequestpendingds_1_filterfulltext) or ( SUBSTR(TO_CHAR(T3.EmployeeBalance,'90.9'), 2) like '%' || :lV59Leaverequestpendingds_1_filterfulltext))");
         }
         else
         {
            GXv_int4[0] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV61Leaverequestpendingds_3_tfemployeename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV60Leaverequestpendingds_2_tfemployeename)) ) )
         {
            AddWhere(sWhereString, "(LOWER(T3.EmployeeName) like LOWER(:lV60Leaverequestpendingds_2_tfemployeename))");
         }
         else
         {
            GXv_int4[5] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV61Leaverequestpendingds_3_tfemployeename_sel)) && ! ( StringUtil.StrCmp(AV61Leaverequestpendingds_3_tfemployeename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T3.EmployeeName = ( :AV61Leaverequestpendingds_3_tfemployeename_sel))");
         }
         else
         {
            GXv_int4[6] = 1;
         }
         if ( StringUtil.StrCmp(AV61Leaverequestpendingds_3_tfemployeename_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T3.EmployeeName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV63Leaverequestpendingds_5_tfleavetypename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV62Leaverequestpendingds_4_tfleavetypename)) ) )
         {
            AddWhere(sWhereString, "(LOWER(T2.LeaveTypeName) like LOWER(:lV62Leaverequestpendingds_4_tfleavetypename))");
         }
         else
         {
            GXv_int4[7] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV63Leaverequestpendingds_5_tfleavetypename_sel)) && ! ( StringUtil.StrCmp(AV63Leaverequestpendingds_5_tfleavetypename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.LeaveTypeName = ( :AV63Leaverequestpendingds_5_tfleavetypename_sel))");
         }
         else
         {
            GXv_int4[8] = 1;
         }
         if ( StringUtil.StrCmp(AV63Leaverequestpendingds_5_tfleavetypename_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T2.LeaveTypeName))=0))");
         }
         if ( ! (DateTime.MinValue==AV64Leaverequestpendingds_6_tfleaverequeststartdate) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestStartDate >= :AV64Leaverequestpendingds_6_tfleaverequeststartdate)");
         }
         else
         {
            GXv_int4[9] = 1;
         }
         if ( ! (DateTime.MinValue==AV65Leaverequestpendingds_7_tfleaverequeststartdate_to) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestStartDate <= :AV65Leaverequestpendingds_7_tfleaverequeststartdate_to)");
         }
         else
         {
            GXv_int4[10] = 1;
         }
         if ( ! (DateTime.MinValue==AV66Leaverequestpendingds_8_tfleaverequestenddate) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestEndDate >= :AV66Leaverequestpendingds_8_tfleaverequestenddate)");
         }
         else
         {
            GXv_int4[11] = 1;
         }
         if ( ! (DateTime.MinValue==AV67Leaverequestpendingds_9_tfleaverequestenddate_to) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestEndDate <= :AV67Leaverequestpendingds_9_tfleaverequestenddate_to)");
         }
         else
         {
            GXv_int4[12] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV68Leaverequestpendingds_10_tfleaverequesthalfday)) ) )
         {
            AddWhere(sWhereString, "(LOWER(T1.LeaveRequestHalfDay) like LOWER(:lV68Leaverequestpendingds_10_tfleaverequesthalfday))");
         }
         else
         {
            GXv_int4[13] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel)) && ! ( StringUtil.StrCmp(AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestHalfDay = ( :AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel))");
         }
         else
         {
            GXv_int4[14] = 1;
         }
         if ( StringUtil.StrCmp(AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestHalfDay IS NULL or (char_length(trim(trailing ' ' from T1.LeaveRequestHalfDay))=0))");
         }
         if ( AV69Leaverequestpendingds_11_tfleaverequesthalfdayoperator == 1 )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestHalfDay = ( 'Morning'))");
         }
         if ( AV69Leaverequestpendingds_11_tfleaverequesthalfdayoperator == 2 )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestHalfDay = ( 'Afternoon'))");
         }
         if ( ! (Convert.ToDecimal(0)==AV71Leaverequestpendingds_13_tfleaverequestduration) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestDuration >= :AV71Leaverequestpendingds_13_tfleaverequestduration)");
         }
         else
         {
            GXv_int4[15] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV72Leaverequestpendingds_14_tfleaverequestduration_to) )
         {
            AddWhere(sWhereString, "(T1.LeaveRequestDuration <= :AV72Leaverequestpendingds_14_tfleaverequestduration_to)");
         }
         else
         {
            GXv_int4[16] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV73Leaverequestpendingds_15_tfemployeebalance) )
         {
            AddWhere(sWhereString, "(T3.EmployeeBalance >= :AV73Leaverequestpendingds_15_tfemployeebalance)");
         }
         else
         {
            GXv_int4[17] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV74Leaverequestpendingds_16_tfemployeebalance_to) )
         {
            AddWhere(sWhereString, "(T3.EmployeeBalance <= :AV74Leaverequestpendingds_16_tfemployeebalance_to)");
         }
         else
         {
            GXv_int4[18] = 1;
         ...
         {
            AddWhere(sWhereString, "(T2.CompanyId = :AV75Udparg17)");
         }
         else
         {
            GXv_int4[19] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV59Leaverequestpendingds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV59Leaverequestpendingds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV59Leaverequestpendingds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV59Leaverequestpendingds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV59Leaverequestpendingds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV60Leaverequestpendingds_2_tfemployeename",GXType.Char,100,0) ,
          new ParDef("AV61Leaverequestpendingds_3_tfemployeename_sel",GXType.Char,100,0) ,
          new ParDef("lV62Leaverequestpendingds_4_tfleavetypename",GXType.Char,100,0) ,
          new ParDef("AV63Leaverequestpendingds_5_tfleavetypename_sel",GXType.Char,100,0) ,
          new ParDef("AV64Leaverequestpendingds_6_tfleaverequeststartdate",GXType.Date,8,0) ,
          new ParDef("AV65Leaverequestpendingds_7_tfleaverequeststartdate_to",GXType.Date,8,0) ,
          new ParDef("AV66Leaverequestpendingds_8_tfleaverequestenddate",GXType.Date,8,0) ,
          new ParDef("AV67Leaverequestpendingds_9_tfleaverequestenddate_to",GXType.Date,8,0) ,
          new ParDef("lV68Leaverequestpendingds_10_tfleaverequesthalfday",GXType.Char,20,0) ,
          new ParDef("AV70Leaverequestpendingds_12_tfleaverequesthalfday_sel",GXType.Char,20,0) ,
          new ParDef("AV71Leaverequestpendingds_13_tfleaverequestduration",GXType.Number,4,1) ,
          new ParDef("AV72Leaverequestpendingds_14_tfleaverequestduration_to",GXType.Number,4,1) ,
          new ParDef("AV73Leaverequestpendingds_15_tfemployeebalance",GXType.Number,4,1) ,
          new ParDef("AV74Leaverequestpendingds_16_tfemployeebalance_to",GXType.Number,4,1) ,
          new ParDef("AV75Udparg17",GXType.Int64,10,0)
          };
          def= new CursorDef[] {
