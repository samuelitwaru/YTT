...
namespace GeneXus.Programs {
   public class trnnewww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV50RedirectToFirstDetail = StringUtil.StrToBool( GetPar( "RedirectToFirstDetail"));
         AV51QueryIntent = GetPar( "QueryIntent");
         AV42GridAppliedFilters = GetPar( "GridAppliedFilters");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV16FilterFullText, AV26ManageFiltersExecutionStep, AV21ColumnsSelector, AV52Pgmname, AV27TFTrnNewId, AV28TFTrnNewId_To, AV29TFTrnNewName, AV30TFTrnNewName_Sel, AV31TFTrnNewDate, AV32TFTrnNewDate_To, AV50RedirectToFirstDetail, AV51QueryIntent, AV42GridAppliedFilters, AV44IsAuthorized_Update, AV46IsAuthorized_Delete, AV49IsAuthorized_Insert) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vREDIRECTTOFIRSTDETAIL", AV50RedirectToFirstDetail);
         GxWebStd.gx_hidden_field( context, "gxhash_vREDIRECTTOFIRSTDETAIL", GetSecureSignedToken( "", AV50RedirectToFirstDetail, context));
         GxWebStd.gx_hidden_field( context, "vQUERYINTENT", AV51QueryIntent);
         GxWebStd.gx_hidden_field( context, "gxhash_vQUERYINTENT", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV51QueryIntent, "")), context));
      ...
      protected void WB5U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_TrnNewWW.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnagexport_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Export", bttBtnagexport_Jsonclick, 0, "Export", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_TrnNewWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_TrnNewWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 39 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_trnnewdateauxdatetext_Internalname, AV35DDO_TrnNewDateAuxDateText, StringUtil.RTrim( context.localUtil.Format( AV35DDO_TrnNewDateAuxDateText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,57);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_trnnewdateauxdatetext_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_TrnNewWW.htm");
            /* User Defined Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtTrnNewImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A183TrnNewImage)) ? A40000TrnNewImage_GXI : context.convertURL( context.PathToRelativeUrl( A183TrnNewImage))), !bGXsfl_39_Refreshing);
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV50RedirectToFirstDetail ,
                                       string AV51QueryIntent ,
                                       string AV42GridAppliedFilters ,
      ...
      protected void RF5U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV53Trnnewwwds_1_filterfulltext ,
                                                 AV54Trnnewwwds_2_tftrnnewid ,
                                                 AV55Trnnewwwds_3_tftrnnewid_to ,
                                                 AV57Trnnewwwds_5_tftrnnewname_sel ,
                                                 AV56Trnnewwwds_4_tftrnnewname ,
                                                 AV58Trnnewwwds_6_tftrnnewdate ,
                                                 AV59Trnnewwwds_7_tftrnnewdate_to ,
                                                 A180TrnNewId ,
                                                 A181TrnNewName ,
                                                 A182TrnNewDate ,
                                                 AV13OrderedBy ,
            ...
            lV53Trnnewwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV53Trnnewwwds_1_filterfulltext), "%", "");
            lV53Trnnewwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV53Trnnewwwds_1_filterfulltext), "%", "");
            lV56Trnnewwwds_4_tftrnnewname = StringUtil.PadR( StringUtil.RTrim( AV56Trnnewwwds_4_tftrnnewname), 100, "%");
            /* Using cursor H005U2 */
            pr_default.execute(0, new Object[] {lV53Trnnewwwds_1_filterfulltext, lV53Trnnewwwds_1_filterfulltext, AV54Trnnewwwds_2_tftrnnewid, AV55Trnnewwwds_3_tftrnnewid_to, lV56Trnnewwwds_4_tftrnnewname, AV57Trnnewwwds_5_tftrnnewname_sel, AV58Trnnewwwds_6_tftrnnewdate, AV59Trnnewwwds_7_tftrnnewdate_to, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
      ...
      protected void send_integrity_lvl_hashes5U2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV52Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV52Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_TRNNEWID"+"_"+sGXsfl_39_idx, GetSecureSignedToken( sGXsfl_39_idx, context.localUtil.Format( (decimal)(A180TrnNewId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_boolean_hidden_field( context, "vREDIRECTTOFIRSTDETAIL", AV50RedirectToFirstDetail);
         GxWebStd.gx_hidden_field( context, "gxhash_vREDIRECTTOFIRSTDETAIL", GetSecureSignedToken( "", AV50RedirectToFirstDetail, context));
         GxWebStd.gx_hidden_field( context, "vQUERYINTENT", AV51QueryIntent);
         GxWebStd.gx_hidden_field( context, "gxhash_vQUERYINTENT", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV51QueryIntent, "")), context));
      ...
      {
         AV53Trnnewwwds_1_filterfulltext = AV16FilterFullText;
         AV54Trnnewwwds_2_tftrnnewid = AV27TFTrnNewId;
         AV55Trnnewwwds_3_tftrnnewid_to = AV28TFTrnNewId_To;
         AV56Trnnewwwds_4_tftrnnewname = AV29TFTrnNewName;
         AV57Trnnewwwds_5_tftrnnewname_sel = AV30TFTrnNewName_Sel;
         AV58Trnnewwwds_6_tftrnnewdate = AV31TFTrnNewDate;
         AV59Trnnewwwds_7_tftrnnewdate_to = AV32TFTrnNewDate_To;
         ...
         lV56Trnnewwwds_4_tftrnnewname = StringUtil.PadR( StringUtil.RTrim( AV56Trnnewwwds_4_tftrnnewname), 100, "%");
         /* Using cursor H005U3 */
         pr_default.execute(1, new Object[] {lV53Trnnewwwds_1_filterfulltext, lV53Trnnewwwds_1_filterfulltext, AV54Trnnewwwds_2_tftrnnewid, AV55Trnnewwwds_3_tftrnnewid_to, lV56Trnnewwwds_4_tftrnnewname, AV57Trnnewwwds_5_tftrnnewname_sel, AV58Trnnewwwds_6_tftrnnewdate, AV59Trnnewwwds_7_tftrnnewdate_to});
      ...
      protected void E195U2( )
      {
         ...
         AssignProp("", false, edtTrnNewId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtTrnNewId_Visible), 5, 0), !bGXsfl_39_Refreshing);
         ...
         AssignProp("", false, edtTrnNewName_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtTrnNewName_Visible), 5, 0), !bGXsfl_39_Refreshing);
         ...
         AssignProp("", false, edtTrnNewDate_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtTrnNewDate_Visible), 5, 0), !bGXsfl_39_Refreshing);
         ...
         AssignProp("", false, edtTrnNewImage_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtTrnNewImage_Visible), 5, 0), !bGXsfl_39_Refreshing);
         ...
         AV51QueryIntent = StringUtil.Trim( AV23Session.Get(AV52Pgmname+"QueryIntent"));
         AssignAttri("", false, "AV51QueryIntent", AV51QueryIntent);
         GxWebStd.gx_hidden_field( context, "gxhash_vQUERYINTENT", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV51QueryIntent, "")), context));
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV51QueryIntent)) )
         {
            AV23Session.Remove(AV52Pgmname+"QueryIntent");
            if ( StringUtil.StrCmp(AV51QueryIntent, "5") == 0 )
            {
               if ( new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context).executeUdp(  "trnnew_Insert") )
               {
            ...
            {
               AV50RedirectToFirstDetail = true;
               AssignAttri("", false, "AV50RedirectToFirstDetail", AV50RedirectToFirstDetail);
               GxWebStd.gx_hidden_field( context, "gxhash_vREDIRECTTOFIRSTDETAIL", GetSecureSignedToken( "", AV50RedirectToFirstDetail, context));
            }
         }
         AV53Trnnewwwds_1_filterfulltext = AV16FilterFullText;
      ...
      private void E205U2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         if ( AV50RedirectToFirstDetail )
         {
            if ( StringUtil.StrCmp(AV51QueryIntent, "2") == 0 )
            {
               AV23Session.Set("TrnNewViewQueryAppliedFilters", AV42GridAppliedFilters);
               if ( new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context).executeUdp(  "trnnewview_Execute") )
               {
                  CallWebObject(formatLink("trnnewview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A180TrnNewId,10,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"TrnNewId","TabCode"}) );
                  context.wjLocDisableFrm = 1;
               }
            }
            else if ( StringUtil.StrCmp(AV51QueryIntent, "3") == 0 )
            {
               if ( new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context).executeUdp(  "trnnew_Update") )
               {
                  CallWebObject(formatLink("trnnew.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A180TrnNewId,10,0))}, new string[] {"Mode","TrnNewId"}) );
                  context.wjLocDisableFrm = 1;
               }
            }
            else if ( StringUtil.StrCmp(AV51QueryIntent, "4") == 0 )
            {
               if ( new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context).executeUdp(  "trnnew_Delete") )
               {
                  CallWebObject(formatLink("trnnew.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A180TrnNewId,10,0))}, new string[] {"Mode","TrnNewId"}) );
                  context.wjLocDisableFrm = 1;
               }
            }
            AV50RedirectToFirstDetail = false;
            AssignAttri("", false, "AV50RedirectToFirstDetail", AV50RedirectToFirstDetail);
            GxWebStd.gx_hidden_field( context, "gxhash_vREDIRECTTOFIRSTDETAIL", GetSecureSignedToken( "", AV50RedirectToFirstDetail, context));
         }
      ...
      protected void E115U2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("TrnNewWWFilters")),UrlEncode(StringUtil.RTrim(AV52Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV26ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV26ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV26ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefresh();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411281048946", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trnnewww.js", "?202411281048950", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_392( )
      {
         ...
         edtTrnNewId_Internalname = "TRNNEWID_"+sGXsfl_39_idx;
         edtTrnNewName_Internalname = "TRNNEWNAME_"+sGXsfl_39_idx;
         edtTrnNewDate_Internalname = "TRNNEWDATE_"+sGXsfl_39_idx;
         edtTrnNewImage_Internalname = "TRNNEWIMAGE_"+sGXsfl_39_idx;
      }
      ...
      protected void SubsflControlProps_fel_392( )
      {
         ...
         edtTrnNewId_Internalname = "TRNNEWID_"+sGXsfl_39_fel_idx;
         edtTrnNewName_Internalname = "TRNNEWNAME_"+sGXsfl_39_fel_idx;
         edtTrnNewDate_Internalname = "TRNNEWDATE_"+sGXsfl_39_fel_idx;
         edtTrnNewImage_Internalname = "TRNNEWIMAGE_"+sGXsfl_39_fel_idx;
      }
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:TrnNewId|3:TrnNewName|4:TrnNewDate|5:TrnNewImage";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV42GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFTrnNewId","fld":"vTFTRNNEWID","pic":"ZZZZZZZZZ9"},{"av":"AV28TFTrnNewId_To","fld":"vTFTRNNEWID_TO","pic":"ZZZZZZZZZ9"},{"av":"AV29TFTrnNewName","fld":"vTFTRNNEWNAME"},{"av":"AV30TFTrnNewName_Sel","fld":"vTFTRNNEWNAME_SEL"},{"av":"AV31TFTrnNewDate","fld":"vTFTRNNEWDATE"},{"av":"AV32TFTrnNewDate_To","fld":"vTFTRNNEWDATE_TO"},{"av":"AV50RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true},{"av":"AV51QueryIntent","fld":"vQUERYINTENT","hsh":true},{"av":"AV44IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV46IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV49IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A180TrnNewId","fld":"TRNNEWID","pic":"ZZZZZZZZZ9","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtTrnNewId_Visible","ctrl":"TRNNEWID","prop":"Visible"},{"av":"edtTrnNewName_Visible","ctrl":"TRNNEWNAME","prop":"Visible"},{"av":"edtTrnNewDate_Visible","ctrl":"TRNNEWDATE","prop":"Visible"},{"av":"edtTrnNewImage_Visible","ctrl":"TRNNEWIMAGE","prop":"Visible"},{"av":"AV40GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV41GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV42GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV51QueryIntent","fld":"vQUERYINTENT","hsh":true},{"av":"AV50RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true},{"av":"AV44IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV46IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV49IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV24ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E125U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFTrnNewId","fld":"vTFTRNNEWID","pic":"ZZZZZZZZZ9"},{"av":"AV28TFTrnNewId_To","fld":"vTFTRNNEWID_TO","pic":"ZZZZZZZZZ9"},{"av":"AV29TFTrnNewName","fld":"vTFTRNNEWNAME"},{"av":"AV30TFTrnNewName_Sel","fld":"vTFTRNNEWNAME_SEL"},{"av":"AV31TFTrnNewDate","fld":"vTFTRNNEWDATE"},{"av":"AV32TFTrnNewDate_To","fld":"vTFTRNNEWDATE_TO"},{"av":"AV50RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true},{"av":"AV51QueryIntent","fld":"vQUERYINTENT","hsh":true},{"av":"AV42GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV44IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV46IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV49IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E205U2","iparms":[{"av":"AV50RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true},{"av":"AV51QueryIntent","fld":"vQUERYINTENT","hsh":true},{"av":"AV42GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"A180TrnNewId","fld":"TRNNEWID","pic":"ZZZZZZZZZ9","hsh":true},{"av":"AV44IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV46IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV50RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true},{"av":"AV43Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV45Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E165U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFTrnNewId","fld":"vTFTRNNEWID","pic":"ZZZZZZZZZ9"},{"av":"AV28TFTrnNewId_To","fld":"vTFTRNNEWID_TO","pic":"ZZZZZZZZZ9"},{"av":"AV29TFTrnNewName","fld":"vTFTRNNEWNAME"},{"av":"AV30TFTrnNewName_Sel","fld":"vTFTRNNEWNAME_SEL"},{"av":"AV31TFTrnNewDate","fld":"vTFTRNNEWDATE"},{"av":"AV32TFTrnNewDate_To","fld":"vTFTRNNEWDATE_TO"},{"av":"AV50RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true},{"av":"AV51QueryIntent","fld":"vQUERYINTENT","hsh":true},{"av":"AV42GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV44IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV46IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV49IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"},{"av":"A180TrnNewId","fld":"TRNNEWID","pic":"ZZZZZZZZZ9","hsh":true}]""");
         ...
         setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED","""{"handler":"E145U2","iparms":[{"av":"Ddo_agexport_Activeeventkey","ctrl":"DDO_AGEXPORT","prop":"ActiveEventKey"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV30TFTrnNewName_Sel","fld":"vTFTRNNEWNAME_SEL"},{"av":"AV27TFTrnNewId","fld":"vTFTRNNEWID","pic":"ZZZZZZZZZ9"},{"av":"AV29TFTrnNewName","fld":"vTFTRNNEWNAME"},{"av":"AV31TFTrnNewDate","fld":"vTFTRNNEWDATE"},{"av":"AV28TFTrnNewId_To","fld":"vTFTRNNEWID_TO","pic":"ZZZZZZZZZ9"},{"av":"AV32TFTrnNewDate_To","fld":"vTFTRNNEWDATE_TO"}]""");
         setEventMetadata("DDO_AGEXPORT.ONOPTIONCLICKED",""","oparms":[{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV26ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV21ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV52Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFTrnNewId","fld":"vTFTRNNEWID","pic":"ZZZZZZZZZ9"},{"av":"AV28TFTrnNewId_To","fld":"vTFTRNNEWID_TO","pic":"ZZZZZZZZZ9"},{"av":"AV29TFTrnNewName","fld":"vTFTRNNEWNAME"},{"av":"AV30TFTrnNewName_Sel","fld":"vTFTRNNEWNAME_SEL"},{"av":"AV31TFTrnNewDate","fld":"vTFTRNNEWDATE"},{"av":"AV32TFTrnNewDate_To","fld":"vTFTRNNEWDATE_TO"},{"av":"AV50RedirectToFirstDetail","fld":"vREDIRECTTOFIRSTDETAIL","hsh":true},{"av":"AV51QueryIntent","fld":"vQUERYINTENT","hsh":true},{"av":"AV42GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV44IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV46IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV49IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Filteredtextto_set","ctrl":"DDO_GRID","prop":"FilteredTextTo_set"}]}""");
         setEventMetadata("NULL","""{"handler":"Valid_Trnnewimage","iparms":[]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         lV53Trnnewwwds_1_filterfulltext = "";
         lV56Trnnewwwds_4_tftrnnewname = "";
         AV53Trnnewwwds_1_filterfulltext = "";
         AV57Trnnewwwds_5_tftrnnewname_sel = "";
         AV56Trnnewwwds_4_tftrnnewname = "";
         AV58Trnnewwwds_6_tftrnnewdate = DateTime.MinValue;
         AV59Trnnewwwds_7_tftrnnewdate_to = DateTime.MinValue;
      ...
      private long AV54Trnnewwwds_2_tftrnnewid ;
      private long AV55Trnnewwwds_3_tftrnnewid_to ;
      ...
      private string lV56Trnnewwwds_4_tftrnnewname ;
      private string AV57Trnnewwwds_5_tftrnnewname_sel ;
      private string AV56Trnnewwwds_4_tftrnnewname ;
      ...
      private DateTime AV58Trnnewwwds_6_tftrnnewdate ;
      private DateTime AV59Trnnewwwds_7_tftrnnewdate_to ;
      private bool entryPointCalled ;
      private bool toggleJsOutput ;
      private bool AV14OrderedDsc ;
      private bool AV50RedirectToFirstDetail ;
      ...
      private string AV51QueryIntent ;
      private string AV42GridAppliedFilters ;
      private string AV35DDO_TrnNewDateAuxDateText ;
      private string A40000TrnNewImage_GXI ;
      private string lV53Trnnewwwds_1_filterfulltext ;
      private string AV53Trnnewwwds_1_filterfulltext ;
   ...
   public class trnnewww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H005U2( IGxContext context ,
                                             string AV53Trnnewwwds_1_filterfulltext ,
                                             long AV54Trnnewwwds_2_tftrnnewid ,
                                             long AV55Trnnewwwds_3_tftrnnewid_to ,
                                             string AV57Trnnewwwds_5_tftrnnewname_sel ,
                                             string AV56Trnnewwwds_4_tftrnnewname ,
                                             DateTime AV58Trnnewwwds_6_tftrnnewdate ,
                                             DateTime AV59Trnnewwwds_7_tftrnnewdate_to ,
                                             long A180TrnNewId ,
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV53Trnnewwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(TrnNewId,'9999999999'), 2) like '%' || :lV53Trnnewwwds_1_filterfulltext) or ( LOWER(TrnNewName) like '%' || LOWER(:lV53Trnnewwwds_1_filterfulltext)))");
         }
         else
         {
            GXv_int5[0] = 1;
         ...
         if ( ! (0==AV54Trnnewwwds_2_tftrnnewid) )
         {
            AddWhere(sWhereString, "(TrnNewId >= :AV54Trnnewwwds_2_tftrnnewid)");
         }
         else
         {
            GXv_int5[2] = 1;
         }
         if ( ! (0==AV55Trnnewwwds_3_tftrnnewid_to) )
         {
            AddWhere(sWhereString, "(TrnNewId <= :AV55Trnnewwwds_3_tftrnnewid_to)");
         }
         else
         {
            GXv_int5[3] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV57Trnnewwwds_5_tftrnnewname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Trnnewwwds_4_tftrnnewname)) ) )
         {
            AddWhere(sWhereString, "(TrnNewName like :lV56Trnnewwwds_4_tftrnnewname)");
         }
         else
         {
            GXv_int5[4] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV57Trnnewwwds_5_tftrnnewname_sel)) && ! ( StringUtil.StrCmp(AV57Trnnewwwds_5_tftrnnewname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(TrnNewName = ( :AV57Trnnewwwds_5_tftrnnewname_sel))");
         }
         else
         {
            GXv_int5[5] = 1;
         }
         if ( StringUtil.StrCmp(AV57Trnnewwwds_5_tftrnnewname_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from TrnNewName))=0))");
         }
         if ( ! (DateTime.MinValue==AV58Trnnewwwds_6_tftrnnewdate) )
         {
            AddWhere(sWhereString, "(TrnNewDate >= :AV58Trnnewwwds_6_tftrnnewdate)");
         }
         else
         {
            GXv_int5[6] = 1;
         }
         if ( ! (DateTime.MinValue==AV59Trnnewwwds_7_tftrnnewdate_to) )
         {
            AddWhere(sWhereString, "(TrnNewDate <= :AV59Trnnewwwds_7_tftrnnewdate_to)");
         }
         else
         {
            GXv_int5[7] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV53Trnnewwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV53Trnnewwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("AV54Trnnewwwds_2_tftrnnewid",GXType.Int64,10,0) ,
          new ParDef("AV55Trnnewwwds_3_tftrnnewid_to",GXType.Int64,10,0) ,
          new ParDef("lV56Trnnewwwds_4_tftrnnewname",GXType.Char,100,0) ,
          new ParDef("AV57Trnnewwwds_5_tftrnnewname_sel",GXType.Char,100,0) ,
          new ParDef("AV58Trnnewwwds_6_tftrnnewdate",GXType.Date,8,0) ,
          new ParDef("AV59Trnnewwwds_7_tftrnnewdate_to",GXType.Date,8,0) ,
