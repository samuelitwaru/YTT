...
namespace GeneXus.Programs {
   public class prc_getleaverequestdays : GXProcedure
   {
      ...
      public prc_getleaverequestdays( )
      {
      ...
      public prc_getleaverequestdays( IGxContext context )
      {
   ...
   public class prc_getleaverequestdays__default : DataStoreHelperBase, IDataStoreHelper
   {
