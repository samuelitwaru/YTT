...
namespace GeneXus.Programs {
   public class adailyremindertomanagerug : GXWebProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            while ( (pr_default.getStatus(2) != 101) )
            {
               ...
               A173LeaveRequestHalfDay = P005U4_A173LeaveRequestHalfDay[0];
               n173LeaveRequestHalfDay = P005U4_n173LeaveRequestHalfDay[0];
      ...
      public override void initialize( )
      {
         ...
         P005U4_A173LeaveRequestHalfDay = new string[] {""} ;
         P005U4_n173LeaveRequestHalfDay = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.adailyremindertomanagerug__default(),
            new Object[][] {
               ...
               , new Object[] {
               P005U4_A124LeaveTypeId, P005U4_A106EmployeeId, P005U4_A130LeaveRequestEndDate, P005U4_A129LeaveRequestStartDate, P005U4_A132LeaveRequestStatus, P005U4_A145LeaveTypeLoggingWorkHours, P005U4_A173LeaveRequestHalfDay, P005U4_n173LeaveRequestHalfDay, P005U4_A127LeaveRequestId
               }
               , new Object[] {
      ...
      private string[] P005U4_A173LeaveRequestHalfDay ;
      private bool[] P005U4_n173LeaveRequestHalfDay ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P005U5", "SELECT EmployeeId, WorkHourLogDate, WorkHourLogId FROM WorkHourLog WHERE (WorkHourLogDate = :AV23CheckDate) AND (EmployeeId = :EmployeeId) ORDER BY WorkHourLogDate ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP005U5,1, GxCacheFrequency.OFF ,false,true )
