...
namespace GeneXus.Programs {
   public class checkemployeependingvacationleave : GXProcedure
   {
                           ...
                           out bool aP2_HasPendingLeave )
      {
         ...
         initialize();
         executePrivate();
         aP2_HasPendingLeave=this.AV8HasPendingLeave;
      }

      public bool executeUdp( long aP0_EmployeeId ,
                              long aP1_LeaveRequestId )
      {
         execute(aP0_EmployeeId, aP1_LeaveRequestId, out aP2_HasPendingLeave);
                                 ...
                                 out bool aP2_HasPendingLeave )
      {
         ...
         objcheckemployeependingvacationleave.AV10LeaveRequestId = aP1_LeaveRequestId;
      ...
      void executePrivate( )
      {
         ...
         /* Using cursor P009A2 */
         pr_default.execute(0, new Object[] {AV9EmployeeId, AV10LeaveRequestId});
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.checkemployeependingvacationleave__default(),
            new Object[][] {
                new Object[] {
               P009A2_A124LeaveTypeId, P009A2_A127LeaveRequestId, P009A2_A106EmployeeId, P009A2_A144LeaveTypeVacationLeave, P009A2_A132LeaveRequestStatus
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool aP2_HasPendingLeave ;
   }
   ...
   public class checkemployeependingvacationleave__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P009A2", "SELECT T1.LeaveTypeId, T1.LeaveRequestId, T1.EmployeeId, T2.LeaveTypeVacationLeave, T1.LeaveRequestStatus FROM (LeaveRequest T1 INNER JOIN LeaveType T2 ON T2.LeaveTypeId = T1.LeaveTypeId) WHERE (T1.EmployeeId = :AV9EmployeeId) AND (T1.LeaveRequestId <> :AV10LeaveRequestId) AND (T1.LeaveRequestStatus = ( 'Pending')) AND (T2.LeaveTypeVacationLeave = ( 'Yes')) ORDER BY T1.EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP009A2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
