...
namespace GeneXus.Programs {
   public class leavedetailspopup : GXDataArea
   {
      ...
      protected void E113O2( )
      {
         /* Start Routine */
         returnInSub = false;
         GX_msglist.addItem(AV5websession.Get("currentevent"));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202462821151070", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("leavedetailspopup.js", "?202462821151070", false, true);
         }
