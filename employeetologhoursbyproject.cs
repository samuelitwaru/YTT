...
namespace GeneXus.Programs {
   public class employeetologhoursbyproject : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( AV10IsProjectManager )
         {
            ...
            {
               A112EmployeeIsActive = P00C82_A112EmployeeIsActive[0];
               A184EmployeeIsActiveInProject = P00C82_A184EmployeeIsActiveInProject[0];
               A102ProjectId = P00C82_A102ProjectId[0];
               A106EmployeeId = P00C82_A106EmployeeId[0];
               A112EmployeeIsActive = P00C82_A112EmployeeIsActive[0];
            ...
            {
               A112EmployeeIsActive = P00C83_A112EmployeeIsActive[0];
               A106EmployeeId = P00C83_A106EmployeeId[0];
               A148EmployeeName = P00C83_A148EmployeeName[0];
         ...
         if ( AV14IsManager )
         {
            ...
            {
               A106EmployeeId = P00C84_A106EmployeeId[0];
               A112EmployeeIsActive = P00C84_A112EmployeeIsActive[0];
               A100CompanyId = P00C84_A100CompanyId[0];
               A148EmployeeName = P00C84_A148EmployeeName[0];
               AV8Employee = new SdtSDTEmployeeToLogHours_SDTEmployeeToLogHoursItem(context);
               AV8Employee.gxTpr_Sdtemployeeid = A106EmployeeId;
               AV8Employee.gxTpr_Sdtemployeename = A148EmployeeName;
               AV9Employees.Add(AV8Employee, 0);
         ...
         {
            A106EmployeeId = P00C85_A106EmployeeId[0];
            A148EmployeeName = P00C85_A148EmployeeName[0];
            AV8Employee = new SdtSDTEmployeeToLogHours_SDTEmployeeToLogHoursItem(context);
            AV8Employee.gxTpr_Sdtemployeeid = A106EmployeeId;
            AV8Employee.gxTpr_Sdtemployeename = A148EmployeeName;
            AV9Employees.Add(AV8Employee, 0);
      ...
      public override void initialize( )
      {
         ...
         P00C82_A112EmployeeIsActive = new bool[] {false} ;
         P00C82_A184EmployeeIsActiveInProject = new bool[] {false} ;
         P00C82_A102ProjectId = new long[1] ;
         P00C82_A106EmployeeId = new long[1] ;
         AV12EmployeeIds = new GxSimpleCollection<long>();
         P00C83_A112EmployeeIsActive = new bool[] {false} ;
         P00C83_A106EmployeeId = new long[1] ;
         P00C83_A148EmployeeName = new string[] {""} ;
         A148EmployeeName = "";
         AV8Employee = new SdtSDTEmployeeToLogHours_SDTEmployeeToLogHoursItem(context);
         P00C84_A106EmployeeId = new long[1] ;
         P00C84_A112EmployeeIsActive = new bool[] {false} ;
         P00C84_A100CompanyId = new long[1] ;
         P00C84_A148EmployeeName = new string[] {""} ;
         P00C85_A106EmployeeId = new long[1] ;
         P00C85_A148EmployeeName = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.employeetologhoursbyproject__default(),
            new Object[][] {
                new Object[] {
               P00C82_A112EmployeeIsActive, P00C82_A184EmployeeIsActiveInProject, P00C82_A102ProjectId, P00C82_A106EmployeeId
               }
               , new Object[] {
               P00C83_A112EmployeeIsActive, P00C83_A106EmployeeId, P00C83_A148EmployeeName
               }
               , new Object[] {
               P00C84_A106EmployeeId, P00C84_A112EmployeeIsActive, P00C84_A100CompanyId, P00C84_A148EmployeeName
               }
               , new Object[] {
               P00C85_A106EmployeeId, P00C85_A148EmployeeName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private bool[] P00C82_A112EmployeeIsActive ;
      private bool[] P00C82_A184EmployeeIsActiveInProject ;
      private long[] P00C82_A102ProjectId ;
      private long[] P00C82_A106EmployeeId ;
      private GxSimpleCollection<long> AV12EmployeeIds ;
      private bool[] P00C83_A112EmployeeIsActive ;
      private long[] P00C83_A106EmployeeId ;
      private string[] P00C83_A148EmployeeName ;
      private SdtSDTEmployeeToLogHours_SDTEmployeeToLogHoursItem AV8Employee ;
      private long[] P00C84_A106EmployeeId ;
      private bool[] P00C84_A112EmployeeIsActive ;
      private long[] P00C84_A100CompanyId ;
      private string[] P00C84_A148EmployeeName ;
      private long[] P00C85_A106EmployeeId ;
      private string[] P00C85_A148EmployeeName ;
   ...
   public class employeetologhoursbyproject__default : DataStoreHelperBase, IDataStoreHelper
   {
      ...
      protected Object[] conditional_P00C84( IGxContext context ,
                                             long A106EmployeeId ,
                                             GxSimpleCollection<long> AV12EmployeeIds ,
                                             bool A112EmployeeIsActive ,
                                             long AV16CompanyId ,
      ...
      protected Object[] conditional_P00C85( IGxContext context ,
                                             long A106EmployeeId ,
                                             GxSimpleCollection<long> AV12EmployeeIds ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00C82(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (bool)dynConstraints[2] , (bool)dynConstraints[3] );
               case 1 :
                     return conditional_P00C83(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (bool)dynConstraints[2] );
               case 2 :
                     return conditional_P00C84(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (bool)dynConstraints[2] , (long)dynConstraints[3] , (long)dynConstraints[4] );
               case 3 :
                     return conditional_P00C85(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (long)dynConstraints[2] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00C84", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C84,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P00C85", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00C85,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
