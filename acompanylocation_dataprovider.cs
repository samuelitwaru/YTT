   ...
   public class acompanylocation_dataprovider : GXProcedure
   {
      public static int Main( string[] args )
      {
         try
         {
            ...
            return new acompanylocation_dataprovider().executeCmdLine(args); ;
         }
         catch ( Exception e )
         {
      ...
      {
         acompanylocation_dataprovider objacompanylocation_dataprovider;
         objacompanylocation_dataprovider = new acompanylocation_dataprovider();
         objacompanylocation_dataprovider.Gxm1rootcol = new GXBCCollection<SdtCompanyLocation>( context, "CompanyLocation", "YTT_version4") ;
         objacompanylocation_dataprovider.context.SetSubmitInitialConfig(context);
         objacompanylocation_dataprovider.initialize();
         Submit( executePrivateCatch,objacompanylocation_dataprovider);
         aP0_Gxm1rootcol=this.Gxm1rootcol;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((acompanylocation_dataprovider)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
            GXUtil.SaveToEventLog( "Design", e);
