   ...
   public class wp_leavebalancereport1 : GXDataArea
   {
      ...
      protected void S112( )
      {
         ...
         while ( (pr_default.getStatus(3) != 101) )
         {
            ...
            {
               A186VacationSetDate = H005Z6_A186VacationSetDate[0];
               A187VacationSetDays = H005Z6_A187VacationSetDays[0];
               AV34SDT_EmployeeBalanceAction = new SdtSDT_EmployeeBalanceAction(context);
            ...
            {
               A124LeaveTypeId = H005Z7_A124LeaveTypeId[0];
               A129LeaveRequestStartDate = H005Z7_A129LeaveRequestStartDate[0];
               A145LeaveTypeLoggingWorkHours = H005Z7_A145LeaveTypeLoggingWorkHours[0];
               A144LeaveTypeVacationLeave = H005Z7_A144LeaveTypeVacationLeave[0];
               A132LeaveRequestStatus = H005Z7_A132LeaveRequestStatus[0];
               A130LeaveRequestEndDate = H005Z7_A130LeaveRequestEndDate[0];
               A131LeaveRequestDuration = H005Z7_A131LeaveRequestDuration[0];
               A133LeaveRequestDescription = H005Z7_A133LeaveRequestDescription[0];
               A145LeaveTypeLoggingWorkHours = H005Z7_A145LeaveTypeLoggingWorkHours[0];
               A144LeaveTypeVacationLeave = H005Z7_A144LeaveTypeVacationLeave[0];
               AV34SDT_EmployeeBalanceAction = new SdtSDT_EmployeeBalanceAction(context);
            ...
            {
               A115HolidayStartDate = H005Z8_A115HolidayStartDate[0];
               A139HolidayIsActive = H005Z8_A139HolidayIsActive[0];
               A100CompanyId = H005Z8_A100CompanyId[0];
               A116HolidayEndDate = H005Z8_A116HolidayEndDate[0];
               n116HolidayEndDate = H005Z8_n116HolidayEndDate[0];
               A114HolidayName = H005Z8_A114HolidayName[0];
               AV34SDT_EmployeeBalanceAction = new SdtSDT_EmployeeBalanceAction(context);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112810474888", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_leavebalancereport1.js", "?2024112810474888", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H005Z6_A186VacationSetDate = new DateTime[] {DateTime.MinValue} ;
         H005Z6_A187VacationSetDays = new decimal[1] ;
         H005Z7_A127LeaveRequestId = new long[1] ;
         H005Z7_A124LeaveTypeId = new long[1] ;
         H005Z7_A106EmployeeId = new long[1] ;
         H005Z7_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         H005Z7_A145LeaveTypeLoggingWorkHours = new string[] {""} ;
         H005Z7_A144LeaveTypeVacationLeave = new string[] {""} ;
         H005Z7_A132LeaveRequestStatus = new string[] {""} ;
         H005Z7_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         H005Z7_A131LeaveRequestDuration = new decimal[1] ;
         H005Z7_A133LeaveRequestDescription = new string[] {""} ;
         H005Z8_A113HolidayId = new long[1] ;
         H005Z8_A115HolidayStartDate = new DateTime[] {DateTime.MinValue} ;
         H005Z8_A139HolidayIsActive = new bool[] {false} ;
         H005Z8_A100CompanyId = new long[1] ;
         H005Z8_A116HolidayEndDate = new DateTime[] {DateTime.MinValue} ;
         H005Z8_n116HolidayEndDate = new bool[] {false} ;
         H005Z8_A114HolidayName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_leavebalancereport1__default(),
            new Object[][] {
               ...
               , new Object[] {
               H005Z5_A106EmployeeId, H005Z5_A146EmployeeVactionDays, H005Z5_A178EmployeeVacationDaysSetDate, H005Z5_A100CompanyId, H005Z5_A147EmployeeBalance
               }
               , new Object[] {
               H005Z6_A106EmployeeId, H005Z6_A186VacationSetDate, H005Z6_A187VacationSetDays
               }
               , new Object[] {
               H005Z7_A127LeaveRequestId, H005Z7_A124LeaveTypeId, H005Z7_A106EmployeeId, H005Z7_A129LeaveRequestStartDate, H005Z7_A145LeaveTypeLoggingWorkHours, H005Z7_A144LeaveTypeVacationLeave, H005Z7_A132LeaveRequestStatus, H005Z7_A130LeaveRequestEndDate, H005Z7_A131LeaveRequestDuration, H005Z7_A133LeaveRequestDescription
               }
               , new Object[] {
               H005Z8_A113HolidayId, H005Z8_A115HolidayStartDate, H005Z8_A139HolidayIsActive, H005Z8_A100CompanyId, H005Z8_A116HolidayEndDate, H005Z8_n116HolidayEndDate, H005Z8_A114HolidayName
               }
            }
         );
         Gx_date = DateTimeUtil.Today( context);
      ...
      private DateTime[] H005Z6_A186VacationSetDate ;
      private decimal[] H005Z6_A187VacationSetDays ;
      private long[] H005Z7_A127LeaveRequestId ;
      private long[] H005Z7_A124LeaveTypeId ;
      private long[] H005Z7_A106EmployeeId ;
      private DateTime[] H005Z7_A129LeaveRequestStartDate ;
      private string[] H005Z7_A145LeaveTypeLoggingWorkHours ;
      private string[] H005Z7_A144LeaveTypeVacationLeave ;
      private string[] H005Z7_A132LeaveRequestStatus ;
      private DateTime[] H005Z7_A130LeaveRequestEndDate ;
      private decimal[] H005Z7_A131LeaveRequestDuration ;
      private string[] H005Z7_A133LeaveRequestDescription ;
      private long[] H005Z8_A113HolidayId ;
      private DateTime[] H005Z8_A115HolidayStartDate ;
      private bool[] H005Z8_A139HolidayIsActive ;
      private long[] H005Z8_A100CompanyId ;
      private DateTime[] H005Z8_A116HolidayEndDate ;
      private bool[] H005Z8_n116HolidayEndDate ;
      private string[] H005Z8_A114HolidayName ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H005Z5", "SELECT EmployeeId, EmployeeVactionDays, EmployeeVacationDaysSetDate, CompanyId, EmployeeBalance FROM Employee WHERE EmployeeId = :AV36EmployeeId ORDER BY EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Z5,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H005Z6", "SELECT EmployeeId, VacationSetDate, VacationSetDays FROM EmployeeVacationSet WHERE (EmployeeId = :EmployeeId) AND (date_part('year', VacationSetDate) = :AV35Year) ORDER BY EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Z6,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005Z7", "SELECT T1.LeaveRequestId, T1.LeaveTypeId, T1.EmployeeId, T1.LeaveRequestStartDate, T2.LeaveTypeLoggingWorkHours, T2.LeaveTypeVacationLeave, T1.LeaveRequestStatus, T1.LeaveRequestEndDate, T1.LeaveRequestDuration, T1.LeaveRequestDescription FROM (LeaveRequest T1 INNER JOIN LeaveType T2 ON T2.LeaveTypeId = T1.LeaveTypeId) WHERE (T1.EmployeeId = :EmployeeId) AND (date_part('year', T1.LeaveRequestStartDate) = :AV35Year) AND (T1.LeaveRequestStatus = ( 'Approved')) AND (T2.LeaveTypeVacationLeave = ( 'Yes')) AND (T2.LeaveTypeLoggingWorkHours = ( 'No')) ORDER BY T1.EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Z7,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H005Z8", "SELECT HolidayId, HolidayStartDate, HolidayIsActive, CompanyId, HolidayEndDate, HolidayName FROM Holiday WHERE (CompanyId = :AV37CompanyId) AND (date_part('year', HolidayStartDate) = :AV35Year) AND (HolidayIsActive = TRUE) ORDER BY CompanyId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Z8,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
