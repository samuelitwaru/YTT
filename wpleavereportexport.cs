...
namespace GeneXus.Programs {
   public class wpleavereportexport : GXProcedure
   {
      ...
      public void executeSubmit( SdtSDTLeaveReport aP0_SDTLeaveReport ,
                                 ...
                                 out string aP2_ErrorMessage )
      {
         wpleavereportexport objwpleavereportexport;
         objwpleavereportexport = new wpleavereportexport();
         objwpleavereportexport.AV29SDTLeaveReport = aP0_SDTLeaveReport;
         objwpleavereportexport.AV12Filename = "" ;
         objwpleavereportexport.AV13ErrorMessage = "" ;
         objwpleavereportexport.context.SetSubmitInitialConfig(context);
         objwpleavereportexport.initialize();
         Submit( executePrivateCatch,objwpleavereportexport);
         aP1_Filename=this.AV12Filename;
         aP2_ErrorMessage=this.AV13ErrorMessage;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wpleavereportexport)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S131( )
      {
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "View") ;
            AV14CellRow = GXt_int2;
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Employee") ;
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Project") ;
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
         ...
         {
            GXt_int2 = (short)(AV14CellRow);
            new GeneXus.Programs.wwpbaseobjects.wwp_exportwritefilter(context ).execute( ref  AV11ExcelDocument,  true, ref  GXt_int2,  (short)(AV15FirstColumn),  "Location") ;
            AV14CellRow = GXt_int2;
            GXt_char1 = "";
      ...
      protected void S141( )
      {
         ...
         {
            AV32ColumnsSelector_Column = ((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV30ColumnsSelector.gxTpr_Columns.Item(AV47GXV1));
      ...
      protected void S161( )
      {
         ...
         while ( AV48GXV2 <= AV29SDTLeaveReport.gxTpr_Periodcollection.Count )
         {
            ...
            {
               AV32ColumnsSelector_Column = ((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV30ColumnsSelector.gxTpr_Columns.Item(AV49GXV3));
               if ( AV32ColumnsSelector_Column.gxTpr_Isvisible )
               {
                  if ( StringUtil.StrCmp(AV32ColumnsSelector_Column.gxTpr_Columnname, "SDTLeaveReport_PeriodCollection__Label") == 0 )
                  {
                     GXt_char1 = "";
                     new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV17SDTLeaveReportItem.gxTpr_Label, out  GXt_char1) ;
                  ...
                  {
                     GXt_char1 = "";
                     new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV17SDTLeaveReportItem.gxTpr_Formattedtotalwork, out  GXt_char1) ;
                     AV11ExcelDocument.get_Cells(AV14CellRow, (int)(AV15FirstColumn+AV38VisibleColumnCount), 1, 1).Text = GXt_char1;
                  }
                  ...
                  {
                     GXt_char1 = "";
                     new GeneXus.Programs.wwpbaseobjects.wwp_export_securetext(context ).execute(  AV17SDTLeaveReportItem.gxTpr_Formattedtotalleave, out  GXt_char1) ;
                     AV11ExcelDocument.get_Cells(AV14CellRow, (int)(AV15FirstColumn+AV38VisibleColumnCount), 1, 1).Text = GXt_char1;
                  }
                  AV38VisibleColumnCount = (long)(AV38VisibleColumnCount+1);
               }
      ...
      protected void S151( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV30ColumnsSelector,  "SDTLeaveReport_PeriodCollection__Label",  "",  "Period",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV30ColumnsSelector,  "SDTLeaveReport_PeriodCollection__FromDate",  "",  "DateFrom",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV30ColumnsSelector,  "SDTLeaveReport_PeriodCollection__ToDate",  "",  "Date To",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV30ColumnsSelector,  "SDTLeaveReport_PeriodCollection__FormattedTotalWork",  "",  "Work Hours",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV30ColumnsSelector,  "SDTLeaveReport_PeriodCollection__FormattedTotalLeave",  "",  "Leave Hours",  true,  "") ;
         GXt_char1 = AV34UserCustomValue;
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "WPLeaveReportColumnsSelector", out  GXt_char1) ;
      ...
      protected void S201( )
      {
         ...
         {
            AV27GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "WPLeaveReportGridState"), null, "", "");
         }
         else
         {
      ...
      public override void initialize( )
      {
         ...
         AV30ColumnsSelector = new GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector(context);
         AV32ColumnsSelector_Column = new GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column(context);
      ...
      private GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column AV32ColumnsSelector_Column ;
   }
