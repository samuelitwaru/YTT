...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      private void ExecuteOnlyRisReorganization( )
      {
         ...
         ReorgExecute.RegisterBlockForSubmit( 7 ,  "RIEmployeeProjectEmployee" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 8 ,  "RIEmployeeProjectProject" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 9 ,  "RIEmployeeCompany" , new Object[]{ });
      }
      ...
      private void SetPrecedenceris( )
      {
         ...
         GXReorganization.SetMsg( 7 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IEMPLOYEEPROJECT2"}) );
         ReorgExecute.RegisterPrecedence( "RIEmployeeProjectEmployee" ,  "ReorganizeEmployee" );
         GXReorganization.SetMsg( 8 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IEMPLOYEEPROJECT1"}) );
         GXReorganization.SetMsg( 9 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IEMPLOYEE1"}) );
