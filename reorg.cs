...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateEmployeeProject( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE EmployeeProject (EmployeeId bigint NOT NULL , ProjectId bigint NOT NULL , PRIMARY KEY(EmployeeId, ProjectId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateLeaveRequest( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE LeaveRequest (LeaveRequestId bigint NOT NULL DEFAULT nextval('LeaveRequestId'), LeaveTypeId bigint NOT NULL , LeaveRequestDate date NOT NULL , LeaveRequestStartDate date NOT NULL , LeaveRequestEndDate date NOT NULL , LeaveRequestDuration smallint NOT NULL , LeaveRequestStatus CHAR(20) NOT NULL , LeaveRequestDescription VARCHAR(200) NOT NULL , LeaveRequestRejectionReason VARCHAR(200) NOT NULL , EmployeeId bigint NOT NULL , PRIMARY KEY(LeaveRequestId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateLeaveType( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE LeaveType (LeaveTypeId bigint NOT NULL DEFAULT nextval('LeaveTypeId'), LeaveTypeName CHAR(100) NOT NULL , CompanyId bigint NOT NULL , LeaveTypeVacationLeave CHAR(20) NOT NULL , LeaveTypeLoggingWorkHours CHAR(20) NOT NULL , PRIMARY KEY(LeaveTypeId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateWorkHourLog( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE WorkHourLog (WorkHourLogId bigint NOT NULL DEFAULT nextval('WorkHourLogId'), WorkHourLogDate date NOT NULL , WorkHourLogDuration VARCHAR(40) NOT NULL , WorkHourLogHour smallint NOT NULL , WorkHourLogMinute smallint NOT NULL , WorkHourLogDescription TEXT NOT NULL , ProjectId bigint NOT NULL , EmployeeId bigint NOT NULL , PRIMARY KEY(WorkHourLogId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateSupportRequest" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "CreateEmployeeProject" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "CreateSiteSetting" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 4 ,  "CreateCompanyLocation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 5 ,  "CreateDevice" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 6 ,  "CreateLeaveRequest" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 7 ,  "CreateLeaveType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 8 ,  "CreateWorkHourLog" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 9 ,  "CreateHoliday" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 10 ,  "CreateEmployee" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 11 ,  "CreateProject" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 12 ,  "CreateCompany" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 13 ,  "CreateUserCustomizations" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 14 ,  "CreateWWP_MailAttachments" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 15 ,  "CreateWWP_Mail" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 16 ,  "CreateWWP_MailTemplate" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 17 ,  "CreateWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 18 ,  "CreateWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 19 ,  "CreateWWP_WebClient" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 20 ,  "CreateWWP_WebNotification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 21 ,  "CreateWWP_SMS" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 22 ,  "CreateWWP_Subscription" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 23 ,  "CreateWWP_Entity" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 24 ,  "CreateWWP_Parameter" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 25 ,  "CreateWWP_UserExtended" , new Object[]{ });
      }

      private void ExecuteOnlyRisReorganization( )
      {
         ReorgExecute.RegisterBlockForSubmit( 26 ,  "RIWWP_SubscriptionWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 27 ,  "RIWWP_SubscriptionWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 28 ,  "RIWWP_SMSWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 29 ,  "RIWWP_WebNotificationWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 30 ,  "RIWWP_WebClientWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 31 ,  "RIWWP_NotificationDefinitionWWP_Entity" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 32 ,  "RIWWP_NotificationWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 33 ,  "RIWWP_NotificationWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 34 ,  "RIWWP_MailWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 35 ,  "RIWWP_MailAttachmentsWWP_Mail" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 36 ,  "RICompanyCompanyLocation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 37 ,  "RIProjectEmployee" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 38 ,  "RIProjectEmployeeProject" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 39 ,  "RIEmployeeCompany" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 40 ,  "RIHolidayCompany" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 41 ,  "RIWorkHourLogEmployeeProject" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 42 ,  "RILeaveTypeCompany" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 43 ,  "RILeaveRequestLeaveType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 44 ,  "RILeaveRequestEmployee" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 45 ,  "RISiteSettingCompany" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 46 ,  "RIEmployeeProjectEmployee" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 47 ,  "RIEmployeeProjectProject" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 48 ,  "RISupportRequestEmployee" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"SupportRequest", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateSupportRequest" ,  "CreateEmployee" );
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"EmployeeProject", ""}) );
         ...
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"SiteSetting", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateSiteSetting" ,  "CreateCompany" );
         GXReorganization.SetMsg( 4 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"CompanyLocation", ""}) );
         GXReorganization.SetMsg( 5 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Device", ""}) );
         GXReorganization.SetMsg( 6 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"LeaveRequest", ""}) );
         ...
         GXReorganization.SetMsg( 7 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"LeaveType", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateLeaveType" ,  "CreateCompany" );
         GXReorganization.SetMsg( 8 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WorkHourLog", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWorkHourLog" ,  "CreateEmployeeProject" );
         GXReorganization.SetMsg( 9 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Holiday", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateHoliday" ,  "CreateCompany" );
         GXReorganization.SetMsg( 10 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Employee", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateEmployee" ,  "CreateCompany" );
         GXReorganization.SetMsg( 11 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Project", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateProject" ,  "CreateEmployee" );
         GXReorganization.SetMsg( 12 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Company", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateCompany" ,  "CreateCompanyLocation" );
         GXReorganization.SetMsg( 13 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"UserCustomizations", ""}) );
         GXReorganization.SetMsg( 14 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_MailAttachments", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_MailAttachments" ,  "CreateWWP_Mail" );
         GXReorganization.SetMsg( 15 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Mail", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_Mail" ,  "CreateWWP_Notification" );
         GXReorganization.SetMsg( 16 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_MailTemplate", ""}) );
         GXReorganization.SetMsg( 17 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Notification", ""}) );
         ...
         GXReorganization.SetMsg( 18 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_NotificationDefinition", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_NotificationDefinition" ,  "CreateWWP_Entity" );
         GXReorganization.SetMsg( 19 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_WebClient", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_WebClient" ,  "CreateWWP_UserExtended" );
         GXReorganization.SetMsg( 20 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_WebNotification", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_WebNotification" ,  "CreateWWP_Notification" );
         GXReorganization.SetMsg( 21 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_SMS", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_SMS" ,  "CreateWWP_Notification" );
         GXReorganization.SetMsg( 22 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Subscription", ""}) );
         ...
         GXReorganization.SetMsg( 23 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Entity", ""}) );
         GXReorganization.SetMsg( 24 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Parameter", ""}) );
         GXReorganization.SetMsg( 25 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_UserExtended", ""}) );
      }

      private void SetPrecedenceris( )
      {
         GXReorganization.SetMsg( 26 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SUBSCRIPTION2"}) );
         ...
         GXReorganization.SetMsg( 27 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SUBSCRIPTION1"}) );
         ...
         GXReorganization.SetMsg( 28 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SMS1"}) );
         ...
         GXReorganization.SetMsg( 29 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_WEBNOTIFICATION1"}) );
         ...
         GXReorganization.SetMsg( 30 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_WEBCLIENT1"}) );
         ...
         GXReorganization.SetMsg( 31 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATIONDEFINITION1"}) );
         ...
         GXReorganization.SetMsg( 32 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATION2"}) );
         ...
         GXReorganization.SetMsg( 33 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATION1"}) );
         ...
         GXReorganization.SetMsg( 34 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_MAIL1"}) );
         ...
         GXReorganization.SetMsg( 35 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_MAILATTACHMENTS1"}) );
         ...
         GXReorganization.SetMsg( 36 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ICOMPANY1"}) );
         ...
         GXReorganization.SetMsg( 37 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"GX_000F004M"}) );
         ...
         GXReorganization.SetMsg( 38 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IPROJECT1"}) );
         ...
         GXReorganization.SetMsg( 39 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IEMPLOYEE1"}) );
         ...
         GXReorganization.SetMsg( 40 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IHOLIDAY1"}) );
         ...
         GXReorganization.SetMsg( 41 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWORKHOURLOG1"}) );
         ...
         GXReorganization.SetMsg( 42 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ILEAVETYPE1"}) );
         ...
         GXReorganization.SetMsg( 43 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ILEAVEREQUEST2"}) );
         ...
         GXReorganization.SetMsg( 44 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ILEAVEREQUEST1"}) );
         ...
         GXReorganization.SetMsg( 45 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ISITESETTING1"}) );
         ...
         GXReorganization.SetMsg( 46 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IEMPLOYEEPROJECT2"}) );
         ...
         GXReorganization.SetMsg( 47 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IEMPLOYEEPROJECT1"}) );
         ...
         GXReorganization.SetMsg( 48 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ISUPPORTREQUEST1"}) );
