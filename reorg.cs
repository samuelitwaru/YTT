...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateSupportRequest( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE SupportRequest (SupportRequestId bigint NOT NULL DEFAULT nextval('SupportRequestId'), SupportRequestSubject VARCHAR(200) NOT NULL , SupportRequestDescription VARCHAR(200) NOT NULL , EmployeeId bigint NOT NULL , PRIMARY KEY(SupportRequestId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "RISupportRequestEmployee" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ISUPPORTREQUEST1"}) );
