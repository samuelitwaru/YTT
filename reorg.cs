...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeEmployee( )
      {
         ...
         cmdBuffer=" ALTER TABLE Employee ADD EmployeeVacationDaysSetDate date NOT NULL DEFAULT DATE '00010101' "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE Employee ALTER COLUMN EmployeeVacationDaysSetDate DROP DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            EmployeeCount = P00012_AEmployeeCount[0];
            pr_default.close(0);
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("Employee",sSchemaVar,"EmployeeVacationDaysSetDate") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"EmployeeVacationDaysSetDate", "Employee"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         scmdbuf = "";
         P00012_AEmployeeCount = new int[1] ;
         sSchemaVar = "";
         sTableName = "";
         sMySchemaName = "";
         sMyColumnName = "";
      ...
      protected int[] P00012_AEmployeeCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM Employee ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100, GxCacheFrequency.OFF ,true,false )
