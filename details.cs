...
namespace GeneXus.Programs {
   public class details : GXDataArea
   {
      ...
      {
         GxWebStd.gx_boolean_hidden_field( context, "vCANAPPROVE", AV49CanApprove);
         GxWebStd.gx_hidden_field( context, "gxhash_vCANAPPROVE", GetSecureSignedToken( "", AV49CanApprove, context));
         ...
         GxWebStd.gx_hidden_field( context, "vLOGGEDINEMPLOYEEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV44LoggedInEmployeeId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vLOGGEDINEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV44LoggedInEmployeeId), "ZZZZZZZZZ9"), context));
      ...
      protected void WB4M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavLeaverequest_employeename_Internalname, StringUtil.RTrim( AV8LeaveRequest.gxTpr_Employeename), StringUtil.RTrim( context.localUtil.Format( AV8LeaveRequest.gxTpr_Employeename, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLeaverequest_employeename_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavLeaverequest_employeename_Enabled, 1, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Details.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavDeductfromvacationdaysvariable_Internalname, StringUtil.RTrim( AV20DeductFromVacationDaysVariable), StringUtil.RTrim( context.localUtil.Format( AV20DeductFromVacationDaysVariable, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDeductfromvacationdaysvariable_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavDeductfromvacationdaysvariable_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Details.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavLeaverequest_employeebalance_Internalname, StringUtil.LTrim( StringUtil.NToC( AV8LeaveRequest.gxTpr_Employeebalance, 4, 1, ".", "")), StringUtil.LTrim( ((edtavLeaverequest_employeebalance_Enabled!=0) ? context.localUtil.Format( AV8LeaveRequest.gxTpr_Employeebalance, "Z9.9") : context.localUtil.Format( AV8LeaveRequest.gxTpr_Employeebalance, "Z9.9"))), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','1');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','1');"+";gx.evt.onblur(this,48);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLeaverequest_employeebalance_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavLeaverequest_employeebalance_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Details.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavLeaverequest_leaverequeststartdate_Internalname, context.localUtil.Format(AV8LeaveRequest.gxTpr_Leaverequeststartdate, "99/99/99"), context.localUtil.Format( AV8LeaveRequest.gxTpr_Leaverequeststartdate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,12,'eng',false,0);"+";gx.evt.onblur(this,53);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavLeaverequest_leaverequeststartdate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavLeaverequest_leaverequeststartdate_Enabled, 1, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Details.htm");
      ...
      protected void E184M2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vLOGGEDINEMPLOYEEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV44LoggedInEmployeeId), "ZZZZZZZZZ9"), context));
         AV49CanApprove = false;
         AssignAttri("", false, "AV49CanApprove", AV49CanApprove);
         GxWebStd.gx_hidden_field( context, "gxhash_vCANAPPROVE", GetSecureSignedToken( "", AV49CanApprove, context));
         AV45IsEditable = false;
         AssignAttri("", false, "AV45IsEditable", AV45IsEditable);
         ...
         if ( new userhasrole(context).executeUdp(  "Employee") && ( ( AV8LeaveRequest.gxTpr_Employeeid == AV44LoggedInEmployeeId ) ) && ( ( DateTimeUtil.ResetTime ( AV8LeaveRequest.gxTpr_Leaverequeststartdate ) > DateTimeUtil.ResetTime ( Gx_date ) ) ) )
         {
            AV45IsEditable = true;
            AssignAttri("", false, "AV45IsEditable", AV45IsEditable);
         }
         else
         {
            if ( new userhasrole(context).executeUdp(  "Manager") || new userhasrole(context).executeUdp(  "Project Manager") )
            {
               AV45IsEditable = true;
               AssignAttri("", false, "AV45IsEditable", AV45IsEditable);
               AV49CanApprove = (bool)(!((StringUtil.StrCmp(AV8LeaveRequest.gxTpr_Leaverequeststatus, "Approved")==0)));
               AssignAttri("", false, "AV49CanApprove", AV49CanApprove);
               GxWebStd.gx_hidden_field( context, "gxhash_vCANAPPROVE", GetSecureSignedToken( "", AV49CanApprove, context));
            }
         }
      ...
      protected void S132( )
      {
         ...
         if ( ! ( ( AV8LeaveRequest.gxTpr_Employeeid == AV44LoggedInEmployeeId ) && ( DateTimeUtil.ResetTime ( AV8LeaveRequest.gxTpr_Leaverequeststartdate ) > DateTimeUtil.ResetTime ( Gx_date ) ) ) )
         {
      ...
      protected void S122( )
      {
         ...
         divTableeditaction_Visible = ((AV45IsEditable) ? 1 : 0);
         AssignProp("", false, divTableeditaction_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divTableeditaction_Visible), 5, 0), true);
         divTableapproveaction_Visible = (((AV45IsEditable)) ? 1 : 0);
         AssignProp("", false, divTableapproveaction_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(divTableapproveaction_Visible), 5, 0), true);
      }
      ...
      protected void S192( )
      {
         ...
         returnInSub = false;
         GXt_decimal4 = 0;
         new prc_getleaverequestdays(context ).execute(  AV8LeaveRequest.gxTpr_Leaverequeststartdate,  AV8LeaveRequest.gxTpr_Leaverequestenddate,  AV8LeaveRequest.gxTpr_Leaverequesthalfday,  AV8LeaveRequest.gxTpr_Employeeid, out  GXt_decimal4) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20254119415974", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("details.js", "?20254119415975", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/ConfirmPanel/BootstrapConfirmPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DVELOP_CONFIRMPANEL_DELETEBUTTON.CLOSE","""{"handler":"E174M2","iparms":[{"av":"Dvelop_confirmpanel_deletebutton_Result","ctrl":"DVELOP_CONFIRMPANEL_DELETEBUTTON","prop":"Result"},{"av":"AV8LeaveRequest","fld":"vLEAVEREQUEST"}]""");
         setEventMetadata("DVELOP_CONFIRMPANEL_DELETEBUTTON.CLOSE",""","oparms":[{"av":"AV8LeaveRequest","fld":"vLEAVEREQUEST"}]}""");
         setEventMetadata("'DOUPDATEBUTTON'","""{"handler":"E204M2","iparms":[{"av":"AV8LeaveRequest","fld":"vLEAVEREQUEST"},{"av":"AV15LeaveRequestId","fld":"vLEAVEREQUESTID","pic":"ZZZZZZZZZ9","hsh":true}]""");
         ...
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTSTARTDATE.CONTROLVALUECHANGED","""{"handler":"E224M2","iparms":[{"av":"AV8LeaveRequest","fld":"vLEAVEREQUEST"}]""");
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTSTARTDATE.CONTROLVALUECHANGED",""","oparms":[{"av":"AV8LeaveRequest","fld":"vLEAVEREQUEST"}]}""");
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTENDDATE.CONTROLVALUECHANGED","""{"handler":"E234M2","iparms":[{"av":"AV8LeaveRequest","fld":"vLEAVEREQUEST"}]""");
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTENDDATE.CONTROLVALUECHANGED",""","oparms":[{"av":"AV8LeaveRequest","fld":"vLEAVEREQUEST"}]}""");
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTHALFDAY.CONTROLVALUECHANGED","""{"handler":"E244M2","iparms":[{"av":"AV8LeaveRequest","fld":"vLEAVEREQUEST"}]""");
         setEventMetadata("LEAVEREQUEST_LEAVEREQUESTHALFDAY.CONTROLVALUECHANGED",""","oparms":[{"av":"AV8LeaveRequest","fld":"vLEAVEREQUEST"}]}""");
         setEventMetadata("LEAVEREQUEST_LEAVETYPEID.CONTROLVALUECHANGED","""{"handler":"E254M2","iparms":[{"av":"AV8LeaveRequest","fld":"vLEAVEREQUEST"}]""");
