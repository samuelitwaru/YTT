...
namespace GeneXus.Programs {
   public class setnewpassword : GXDataArea
   {
      ...
      public setnewpassword( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "GamGuid");
            ...
            {
               AV44GamGuid = gxfirstwebparm;
               AssignAttri("", false, "AV44GamGuid", AV44GamGuid);
               GxWebStd.gx_hidden_field( context, "gxhash_vGAMGUID", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV44GamGuid, "")), context));
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("setnewpassword.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV44GamGuid))}, new string[] {"GamGuid"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vGAMGUID", StringUtil.RTrim( AV44GamGuid));
         GxWebStd.gx_hidden_field( context, "gxhash_vGAMGUID", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV44GamGuid, "")), context));
      ...
      {
         return formatLink("setnewpassword.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV44GamGuid))}, new string[] {"GamGuid"})  ;
      }
      ...
      protected void WB510( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_bitmap( context, imgHeaderoriginal_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_SetNewPassword.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSignin_Internalname, "Set Password", "", "", lblSignin_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleLogin", 0, "", 1, 1, 0, 0, "HLP_SetNewPassword.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavNewpassword_Internalname, StringUtil.RTrim( AV45NewPassword), StringUtil.RTrim( context.localUtil.Format( AV45NewPassword, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "New Password", edtavNewpassword_Jsonclick, 0, "AttributeLogin", "", "", "", "", 1, edtavNewpassword_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, -1, 0, 0, 0, 0, -1, true, "", "start", true, "", "HLP_SetNewPassword.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavConfirmpassword_Internalname, AV46ConfirmPassword, StringUtil.RTrim( context.localUtil.Format( AV46ConfirmPassword, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Confirm Password", edtavConfirmpassword_Jsonclick, 0, "AttributeLogin", "", "", "", "", 1, edtavConfirmpassword_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, -1, 0, 0, 0, 0, -1, true, "", "start", true, "", "HLP_SetNewPassword.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "Confirm", bttBtnenter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_SetNewPassword.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
      ...
      protected void STRUP510( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV45NewPassword = cgiGet( edtavNewpassword_Internalname);
            AssignAttri("", false, "AV45NewPassword", AV45NewPassword);
            AV46ConfirmPassword = cgiGet( edtavConfirmpassword_Internalname);
            AssignAttri("", false, "AV46ConfirmPassword", AV46ConfirmPassword);
      ...
      protected void E11512( )
      {
         /* Start Routine */
         returnInSub = false;
         GX_msglist.addItem("You have successfully activated your account");
      }
      ...
      protected void E12512( )
      {
         /* Enter Routine */
         returnInSub = false;
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV45NewPassword)) )
         {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV46ConfirmPassword)) )
         {
         ...
         if ( StringUtil.StrCmp(AV45NewPassword, AV46ConfirmPassword) == 0 )
         {
            AV48GamUser.load( AV44GamGuid);
            AV47ChangePwdOK = AV48GamUser.setpassword(AV45NewPassword, out  AV11Errors);
            if ( AV47ChangePwdOK )
            {
               context.CommitDataStores("setnewpassword",pr_default);
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV48GamUser", AV48GamUser);
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         AV51GXV1 = 1;
         while ( AV51GXV1 <= AV11Errors.Count )
         {
            AV10Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV11Errors.Item(AV51GXV1));
      ...
      protected void S112( )
      {
         ...
         AV23LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV48GamUser.gxTpr_Email, AV45NewPassword, AV5AdditionalParameter, out  AV11Errors);
         if ( AV23LoginOK )
         {
            if ( AV48GamUser.checkrole("Administrator") )
            {
            ...
            if ( AV48GamUser.checkrole("Employee") )
            {
               CallWebObject(formatLink("logworkhours.aspx") );
               context.wjLocDisableFrm = 1;
            }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV44GamGuid = (string)getParm(obj,0);
         AssignAttri("", false, "AV44GamGuid", AV44GamGuid);
         GxWebStd.gx_hidden_field( context, "gxhash_vGAMGUID", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV44GamGuid, "")), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512273690", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("setnewpassword.js", "?2024102512273694", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.setnewpassword__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.setnewpassword__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
      ...
      private int idxLst ;
      private string AV44GamGuid ;
      private string wcpOAV44GamGuid ;
      ...
      private string AV45NewPassword ;
 ...
 public class setnewpassword__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
