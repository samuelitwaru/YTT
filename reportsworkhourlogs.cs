...
namespace GeneXus.Programs {
   public class reportsworkhourlogs : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV25Pgmname, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV25Pgmname = "ReportsWorkHourLogs";
               WS4R2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV25Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV25Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTODATE", context.localUtil.DToC( AV20ToDate, 0, "/"));
         GxWebStd.gx_hidden_field( context, sPrefix+"vFROMDATE", context.localUtil.DToC( AV19FromDate, 0, "/"));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void E144R2( )
      {
         ...
         GXt_char1 = AV24GridAppliedFilters;
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV25Pgmname, out  GXt_char1) ;
         AV24GridAppliedFilters = GXt_char1;
      ...
      private void E154R2( )
      {
         ...
         returnInSub = false;
         AV26GXV1 = 1;
         while ( AV26GXV1 <= AV13SDTEmployeeWorkHourLogss.Count )
         {
            AV13SDTEmployeeWorkHourLogss.CurrentItem = ((SdtSDTEmployeeWorkHourLogs)AV13SDTEmployeeWorkHourLogss.Item(AV26GXV1));
            /* Load Method */
            if ( wbStart != -1 )
            {
               wbStart = 10;
      ...
      protected void S112( )
      {
         ...
         {
            AV11GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV25Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV14Session.Get(AV25Pgmname+"GridState"), null, "", "");
         }
      ...
      protected void S122( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV25Pgmname+"GridState",  AV11GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void E124R2( )
      {
         ...
         new employeeworkhourlogs(context ).execute(  AV15CompanyLocationId,  AV17ProjectId,  AV16EmployeeId,  AV19FromDate,  AV20ToDate, out  GXt_objcol_SdtSDTEmployeeWorkHourLogs2) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202471517102748", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("reportsworkhourlogs.js", "?202471517102748", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV22GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV23GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV24GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E114R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E154R2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("GLOBALEVENTS.REPORTSFILTERCHANAGED","{handler:'E124R2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'sPrefix'},{av:'AV20ToDate',fld:'vTODATE',pic:''},{av:'AV19FromDate',fld:'vFROMDATE',pic:''},{av:'AV17ProjectId',fld:'vPROJECTID',pic:''},{av:'AV16EmployeeId',fld:'vEMPLOYEEID',pic:''},{av:'AV15CompanyLocationId',fld:'vCOMPANYLOCATIONID',pic:''}]");
         setEventMetadata("GLOBALEVENTS.REPORTSFILTERCHANAGED",",oparms:[{av:'AV22GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV23GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV24GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''}]}");
         return  ;
      }
