...
namespace GeneXus.Programs {
   public class reportsdetail1 : GXWebComponent
   {
      ...
      protected void RF4V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A100CompanyId = H004V2_A100CompanyId[0];
               A102ProjectId = H004V2_A102ProjectId[0];
               A119WorkHourLogDate = H004V2_A119WorkHourLogDate[0];
               A157CompanyLocationId = H004V2_A157CompanyLocationId[0];
               A148EmployeeName = H004V2_A148EmployeeName[0];
               A106EmployeeId = H004V2_A106EmployeeId[0];
               A118WorkHourLogId = H004V2_A118WorkHourLogId[0];
               A100CompanyId = H004V2_A100CompanyId[0];
               A148EmployeeName = H004V2_A148EmployeeName[0];
               A157CompanyLocationId = H004V2_A157CompanyLocationId[0];
               E154V2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202452012135657", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("reportsdetail1.js", "?202452012135657", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID1.LOAD","{handler:'E154V2',iparms:[{av:'A106EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZZZZZ9'},{av:'A148EmployeeName',fld:'EMPLOYEENAME',pic:''}]");
         setEventMetadata("GRID1.LOAD",",oparms:[{ctrl:'WCREPORTSWORKHOURLOGDETAILS'}]}");
         setEventMetadata("GRID1PAGINATIONBAR.CHANGEPAGE","{handler:'E114V2',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'edtEmployeeId_Visible',ctrl:'EMPLOYEEID',prop:'Visible'},{av:'edtEmployeeName_Visible',ctrl:'EMPLOYEENAME',prop:'Visible'},{av:'edtCompanyLocationId_Visible',ctrl:'COMPANYLOCATIONID',prop:'Visible'},{av:'sPrefix'},{av:'Grid1paginationbar_Selectedpage',ctrl:'GRID1PAGINATIONBAR',prop:'SelectedPage'},{av:'AV8Grid1CurrentPage',fld:'vGRID1CURRENTPAGE',pic:'ZZZZZZZZZ9'}]");
         setEventMetadata("GRID1PAGINATIONBAR.CHANGEPAGE",",oparms:[{av:'AV8Grid1CurrentPage',fld:'vGRID1CURRENTPAGE',pic:'ZZZZZZZZZ9'}]}");
         setEventMetadata("GLOBALEVENTS.REPORTSFILTERCHANAGED","{handler:'E124V2',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'edtEmployeeId_Visible',ctrl:'EMPLOYEEID',prop:'Visible'},{av:'edtEmployeeName_Visible',ctrl:'EMPLOYEENAME',prop:'Visible'},{av:'edtCompanyLocationId_Visible',ctrl:'COMPANYLOCATIONID',prop:'Visible'},{av:'sPrefix'},{av:'AV16ToDate',fld:'vTODATE',pic:''},{av:'AV15FromDate',fld:'vFROMDATE',pic:''},{av:'AV14ProjectId',fld:'vPROJECTID',pic:''},{av:'AV13EmployeeId',fld:'vEMPLOYEEID',pic:''},{av:'AV12CompanyLocationId',fld:'vCOMPANYLOCATIONID',pic:''}]");
         setEventMetadata("GLOBALEVENTS.REPORTSFILTERCHANAGED",",oparms:[{av:'AV12CompanyLocationId',fld:'vCOMPANYLOCATIONID',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         H004V2_A100CompanyId = new long[1] ;
         H004V2_A102ProjectId = new long[1] ;
         H004V2_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         H004V2_A157CompanyLocationId = new long[1] ;
         H004V2_A148EmployeeName = new string[] {""} ;
         H004V2_A106EmployeeId = new long[1] ;
         H004V2_A118WorkHourLogId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reportsdetail1__default(),
            new Object[][] {
                new Object[] {
               H004V2_A100CompanyId, H004V2_A102ProjectId, H004V2_A119WorkHourLogDate, H004V2_A157CompanyLocationId, H004V2_A148EmployeeName, H004V2_A106EmployeeId, H004V2_A118WorkHourLogId
               }
               , new Object[] {
      ...
      private long[] H004V2_A100CompanyId ;
      private long[] H004V2_A102ProjectId ;
      private DateTime[] H004V2_A119WorkHourLogDate ;
      private long[] H004V2_A157CompanyLocationId ;
      private string[] H004V2_A148EmployeeName ;
      private long[] H004V2_A106EmployeeId ;
      private long[] H004V2_A118WorkHourLogId ;
   ...
   public class reportsdetail1__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004V2(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (long)dynConstraints[2] , (GxSimpleCollection<long>)dynConstraints[3] , (long)dynConstraints[4] , (GxSimpleCollection<long>)dynConstraints[5] , (int)dynConstraints[6] , (int)dynConstraints[7] , (DateTime)dynConstraints[8] , (DateTime)dynConstraints[9] , (DateTime)dynConstraints[10] );
               case 1 :
                     return conditional_H004V3(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (long)dynConstraints[2] , (GxSimpleCollection<long>)dynConstraints[3] , (long)dynConstraints[4] , (GxSimpleCollection<long>)dynConstraints[5] , (int)dynConstraints[6] , (int)dynConstraints[7] , (DateTime)dynConstraints[8] , (DateTime)dynConstraints[9] , (DateTime)dynConstraints[10] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004V2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004V2,51, GxCacheFrequency.OFF ,true,false )
