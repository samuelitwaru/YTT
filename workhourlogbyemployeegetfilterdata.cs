...
namespace GeneXus.Programs {
   public class workhourlogbyemployeegetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV44GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "WorkHourLogByEmployeeGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A100CompanyId = P009L2_A100CompanyId[0];
            A120WorkHourLogDuration = P009L2_A120WorkHourLogDuration[0];
            A103ProjectName = P009L2_A103ProjectName[0];
            A102ProjectId = P009L2_A102ProjectId[0];
            A107EmployeeFirstName = P009L2_A107EmployeeFirstName[0];
            A123WorkHourLogDescription = P009L2_A123WorkHourLogDescription[0];
            A122WorkHourLogMinute = P009L2_A122WorkHourLogMinute[0];
            A121WorkHourLogHour = P009L2_A121WorkHourLogHour[0];
            A119WorkHourLogDate = P009L2_A119WorkHourLogDate[0];
            A118WorkHourLogId = P009L2_A118WorkHourLogId[0];
            A100CompanyId = P009L2_A100CompanyId[0];
            A107EmployeeFirstName = P009L2_A107EmployeeFirstName[0];
            A103ProjectName = P009L2_A103ProjectName[0];
            AV41count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( P009L2_A106EmployeeId[0] == A106EmployeeId ) && ( StringUtil.StrCmp(P009L2_A120WorkHourLogDuration[0], A120WorkHourLogDuration) == 0 ) )
            {
               BRK9L2 = false;
               A118WorkHourLogId = P009L2_A118WorkHourLogId[0];
      ...
      protected void S131( )
      {
         ...
         {
            BRK9L4 = false;
            A106EmployeeId = P009L3_A106EmployeeId[0];
            A100CompanyId = P009L3_A100CompanyId[0];
            A123WorkHourLogDescription = P009L3_A123WorkHourLogDescription[0];
            A103ProjectName = P009L3_A103ProjectName[0];
            A102ProjectId = P009L3_A102ProjectId[0];
            A107EmployeeFirstName = P009L3_A107EmployeeFirstName[0];
            A122WorkHourLogMinute = P009L3_A122WorkHourLogMinute[0];
            A121WorkHourLogHour = P009L3_A121WorkHourLogHour[0];
            A120WorkHourLogDuration = P009L3_A120WorkHourLogDuration[0];
            A119WorkHourLogDate = P009L3_A119WorkHourLogDate[0];
            A118WorkHourLogId = P009L3_A118WorkHourLogId[0];
            A100CompanyId = P009L3_A100CompanyId[0];
            A107EmployeeFirstName = P009L3_A107EmployeeFirstName[0];
            A103ProjectName = P009L3_A103ProjectName[0];
            AV41count = 0;
            while ( (pr_default.getStatus(1) != 101) && ( P009L3_A106EmployeeId[0] == A106EmployeeId ) && ( StringUtil.StrCmp(P009L3_A123WorkHourLogDescription[0], A123WorkHourLogDescription) == 0 ) )
            {
               BRK9L4 = false;
               A118WorkHourLogId = P009L3_A118WorkHourLogId[0];
               AV41count = (long)(AV41count+1);
      ...
      protected void S141( )
      {
         ...
         {
            BRK9L6 = false;
            A106EmployeeId = P009L4_A106EmployeeId[0];
            A100CompanyId = P009L4_A100CompanyId[0];
            A103ProjectName = P009L4_A103ProjectName[0];
            A102ProjectId = P009L4_A102ProjectId[0];
            A107EmployeeFirstName = P009L4_A107EmployeeFirstName[0];
            A123WorkHourLogDescription = P009L4_A123WorkHourLogDescription[0];
            A122WorkHourLogMinute = P009L4_A122WorkHourLogMinute[0];
            A121WorkHourLogHour = P009L4_A121WorkHourLogHour[0];
            A120WorkHourLogDuration = P009L4_A120WorkHourLogDuration[0];
            A119WorkHourLogDate = P009L4_A119WorkHourLogDate[0];
            A118WorkHourLogId = P009L4_A118WorkHourLogId[0];
            A100CompanyId = P009L4_A100CompanyId[0];
            A107EmployeeFirstName = P009L4_A107EmployeeFirstName[0];
            A103ProjectName = P009L4_A103ProjectName[0];
            AV41count = 0;
            while ( (pr_default.getStatus(2) != 101) && ( P009L4_A106EmployeeId[0] == A106EmployeeId ) )
            {
               BRK9L6 = false;
               A118WorkHourLogId = P009L4_A118WorkHourLogId[0];
               AV41count = (long)(AV41count+1);
      ...
      protected void S151( )
      {
         ...
         {
            BRK9L8 = false;
            A106EmployeeId = P009L5_A106EmployeeId[0];
            A100CompanyId = P009L5_A100CompanyId[0];
            A103ProjectName = P009L5_A103ProjectName[0];
            A102ProjectId = P009L5_A102ProjectId[0];
            A107EmployeeFirstName = P009L5_A107EmployeeFirstName[0];
            A123WorkHourLogDescription = P009L5_A123WorkHourLogDescription[0];
            A122WorkHourLogMinute = P009L5_A122WorkHourLogMinute[0];
            A121WorkHourLogHour = P009L5_A121WorkHourLogHour[0];
            A120WorkHourLogDuration = P009L5_A120WorkHourLogDuration[0];
            A119WorkHourLogDate = P009L5_A119WorkHourLogDate[0];
            A118WorkHourLogId = P009L5_A118WorkHourLogId[0];
            A100CompanyId = P009L5_A100CompanyId[0];
            A107EmployeeFirstName = P009L5_A107EmployeeFirstName[0];
            A103ProjectName = P009L5_A103ProjectName[0];
            AV41count = 0;
            while ( (pr_default.getStatus(3) != 101) && ( P009L5_A106EmployeeId[0] == A106EmployeeId ) && ( StringUtil.StrCmp(P009L5_A103ProjectName[0], A103ProjectName) == 0 ) )
            {
               BRK9L8 = false;
               A102ProjectId = P009L5_A102ProjectId[0];
               A118WorkHourLogId = P009L5_A118WorkHourLogId[0];
      ...
      public override void initialize( )
      {
         ...
         P009L2_A100CompanyId = new long[1] ;
         P009L2_A120WorkHourLogDuration = new string[] {""} ;
         P009L2_A103ProjectName = new string[] {""} ;
         P009L2_A102ProjectId = new long[1] ;
         P009L2_A107EmployeeFirstName = new string[] {""} ;
         P009L2_A123WorkHourLogDescription = new string[] {""} ;
         P009L2_A122WorkHourLogMinute = new short[1] ;
         P009L2_A121WorkHourLogHour = new short[1] ;
         P009L2_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P009L2_A118WorkHourLogId = new long[1] ;
         AV36Option = "";
         P009L3_A106EmployeeId = new long[1] ;
         P009L3_A100CompanyId = new long[1] ;
         P009L3_A123WorkHourLogDescription = new string[] {""} ;
         P009L3_A103ProjectName = new string[] {""} ;
         P009L3_A102ProjectId = new long[1] ;
         P009L3_A107EmployeeFirstName = new string[] {""} ;
         P009L3_A122WorkHourLogMinute = new short[1] ;
         P009L3_A121WorkHourLogHour = new short[1] ;
         P009L3_A120WorkHourLogDuration = new string[] {""} ;
         P009L3_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P009L3_A118WorkHourLogId = new long[1] ;
         P009L4_A106EmployeeId = new long[1] ;
         P009L4_A100CompanyId = new long[1] ;
         P009L4_A103ProjectName = new string[] {""} ;
         P009L4_A102ProjectId = new long[1] ;
         P009L4_A107EmployeeFirstName = new string[] {""} ;
         P009L4_A123WorkHourLogDescription = new string[] {""} ;
         P009L4_A122WorkHourLogMinute = new short[1] ;
         P009L4_A121WorkHourLogHour = new short[1] ;
         P009L4_A120WorkHourLogDuration = new string[] {""} ;
         P009L4_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P009L4_A118WorkHourLogId = new long[1] ;
         P009L5_A106EmployeeId = new long[1] ;
         P009L5_A100CompanyId = new long[1] ;
         P009L5_A103ProjectName = new string[] {""} ;
         P009L5_A102ProjectId = new long[1] ;
         P009L5_A107EmployeeFirstName = new string[] {""} ;
         P009L5_A123WorkHourLogDescription = new string[] {""} ;
         P009L5_A122WorkHourLogMinute = new short[1] ;
         P009L5_A121WorkHourLogHour = new short[1] ;
         P009L5_A120WorkHourLogDuration = new string[] {""} ;
         P009L5_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P009L5_A118WorkHourLogId = new long[1] ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workhourlogbyemployeegetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P009L2_A106EmployeeId, P009L2_A100CompanyId, P009L2_A120WorkHourLogDuration, P009L2_A103ProjectName, P009L2_A102ProjectId, P009L2_A107EmployeeFirstName, P009L2_A123WorkHourLogDescription, P009L2_A122WorkHourLogMinute, P009L2_A121WorkHourLogHour, P009L2_A119WorkHourLogDate,
               P009L2_A118WorkHourLogId
               }
               , new Object[] {
               P009L3_A106EmployeeId, P009L3_A100CompanyId, P009L3_A123WorkHourLogDescription, P009L3_A103ProjectName, P009L3_A102ProjectId, P009L3_A107EmployeeFirstName, P009L3_A122WorkHourLogMinute, P009L3_A121WorkHourLogHour, P009L3_A120WorkHourLogDuration, P009L3_A119WorkHourLogDate,
               P009L3_A118WorkHourLogId
               }
               , new Object[] {
               P009L4_A106EmployeeId, P009L4_A100CompanyId, P009L4_A103ProjectName, P009L4_A102ProjectId, P009L4_A107EmployeeFirstName, P009L4_A123WorkHourLogDescription, P009L4_A122WorkHourLogMinute, P009L4_A121WorkHourLogHour, P009L4_A120WorkHourLogDuration, P009L4_A119WorkHourLogDate,
               P009L4_A118WorkHourLogId
               }
               , new Object[] {
               P009L5_A106EmployeeId, P009L5_A100CompanyId, P009L5_A103ProjectName, P009L5_A102ProjectId, P009L5_A107EmployeeFirstName, P009L5_A123WorkHourLogDescription, P009L5_A122WorkHourLogMinute, P009L5_A121WorkHourLogHour, P009L5_A120WorkHourLogDuration, P009L5_A119WorkHourLogDate,
               P009L5_A118WorkHourLogId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P009L2_A120WorkHourLogDuration ;
      private string[] P009L2_A103ProjectName ;
      private long[] P009L2_A102ProjectId ;
      private string[] P009L2_A107EmployeeFirstName ;
      private string[] P009L2_A123WorkHourLogDescription ;
      private short[] P009L2_A122WorkHourLogMinute ;
      private short[] P009L2_A121WorkHourLogHour ;
      private DateTime[] P009L2_A119WorkHourLogDate ;
      private long[] P009L2_A118WorkHourLogId ;
      private long[] P009L3_A106EmployeeId ;
      private long[] P009L3_A100CompanyId ;
      private string[] P009L3_A123WorkHourLogDescription ;
      private string[] P009L3_A103ProjectName ;
      private long[] P009L3_A102ProjectId ;
      private string[] P009L3_A107EmployeeFirstName ;
      private short[] P009L3_A122WorkHourLogMinute ;
      private short[] P009L3_A121WorkHourLogHour ;
      private string[] P009L3_A120WorkHourLogDuration ;
      private DateTime[] P009L3_A119WorkHourLogDate ;
      private long[] P009L3_A118WorkHourLogId ;
      private long[] P009L4_A106EmployeeId ;
      private long[] P009L4_A100CompanyId ;
      private string[] P009L4_A103ProjectName ;
      private long[] P009L4_A102ProjectId ;
      private string[] P009L4_A107EmployeeFirstName ;
      private string[] P009L4_A123WorkHourLogDescription ;
      private short[] P009L4_A122WorkHourLogMinute ;
      private short[] P009L4_A121WorkHourLogHour ;
      private string[] P009L4_A120WorkHourLogDuration ;
      private DateTime[] P009L4_A119WorkHourLogDate ;
      private long[] P009L4_A118WorkHourLogId ;
      private long[] P009L5_A106EmployeeId ;
      private long[] P009L5_A100CompanyId ;
      private string[] P009L5_A103ProjectName ;
      private long[] P009L5_A102ProjectId ;
      private string[] P009L5_A107EmployeeFirstName ;
      private string[] P009L5_A123WorkHourLogDescription ;
      private short[] P009L5_A122WorkHourLogMinute ;
      private short[] P009L5_A121WorkHourLogHour ;
      private string[] P009L5_A120WorkHourLogDuration ;
      private DateTime[] P009L5_A119WorkHourLogDate ;
      private long[] P009L5_A118WorkHourLogId ;
   ...
   {
      protected Object[] conditional_P009L2( IGxContext context ,
      ...
      protected Object[] conditional_P009L3( IGxContext context ,
                                             string AV60Workhourlogbyemployeeds_2_filterfulltext ,
                                             long AV61Workhourlogbyemployeeds_3_tfworkhourlogid ,
                                             long AV62Workhourlogbyemployeeds_4_tfworkhourlogid_to ,
                                             DateTime AV63Workhourlogbyemployeeds_5_tfworkhourlogdate ,
      ...
      protected Object[] conditional_P009L5( IGxContext context ,
                                             string AV60Workhourlogbyemployeeds_2_filterfulltext ,
                                             long AV61Workhourlogbyemployeeds_3_tfworkhourlogid ,
                                             long AV62Workhourlogbyemployeeds_4_tfworkhourlogid_to ,
                                             DateTime AV63Workhourlogbyemployeeds_5_tfworkhourlogdate ,
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P009L2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP009L2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P009L3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP009L3,100, GxCacheFrequency.OFF ,true,false )
             ...
             ,new CursorDef("P009L5", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP009L5,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
