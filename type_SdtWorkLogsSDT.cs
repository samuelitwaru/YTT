...
{
	[XmlRoot(ElementName="WorkLogsSDT")]
	[XmlType(TypeName="WorkLogsSDT" , Namespace="YTT_version4" )]
	[Serializable]
	public class SdtWorkLogsSDT : GxUserType
	{
		public SdtWorkLogsSDT( )
		{
			/* Constructor for serialization */
			gxTv_SdtWorkLogsSDT_Workhourlogduration = "";

			gxTv_SdtWorkLogsSDT_Workhourlogdescription = "";

			gxTv_SdtWorkLogsSDT_Employeefirstname = "";

			gxTv_SdtWorkLogsSDT_Projectname = "";

			gxTv_SdtWorkLogsSDT_Logdetails = "";

		}

		public SdtWorkLogsSDT(IGxContext context)
		{
		...
		public override void ToJSON(bool includeState)
		{
			...
			AddObjectProperty("LogDetails", gxTpr_Logdetails, false);
		...
		{
			get {
				return gxTv_SdtWorkLogsSDT_Workhourlogid; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Workhourlogid = value;
		...
		{
			get {
				if ( gxTv_SdtWorkLogsSDT_Workhourlogdate == DateTime.MinValue)
					return null;
				return new GxDateString(gxTv_SdtWorkLogsSDT_Workhourlogdate).value ;
			}
			set {
				gxTv_SdtWorkLogsSDT_Workhourlogdate = DateTimeUtil.CToD2(value);
			}
		}
		...
		{
			get {
				return gxTv_SdtWorkLogsSDT_Workhourlogdate; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Workhourlogdate = value;
		...
		{
			get {
				return gxTv_SdtWorkLogsSDT_Workhourlogduration; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Workhourlogduration = value;
		...
		{
			get {
				return gxTv_SdtWorkLogsSDT_Workhourloghour; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Workhourloghour = value;
		...
		{
			get {
				return gxTv_SdtWorkLogsSDT_Workhourlogminute; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Workhourlogminute = value;
		...
		{
			get {
				return gxTv_SdtWorkLogsSDT_Workhourlogdescription; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Workhourlogdescription = value;
		...
		{
			get {
				return gxTv_SdtWorkLogsSDT_Employeeid; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Employeeid = value;
				SetDirty("Employeeid");
			}
		}
		...
		{
			get {
				return gxTv_SdtWorkLogsSDT_Employeefirstname; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Employeefirstname = value;
		...
		{
			get {
				return gxTv_SdtWorkLogsSDT_Projectid; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Projectid = value;
				SetDirty("Projectid");
			}
		}
		...
		{
			get {
				return gxTv_SdtWorkLogsSDT_Projectname; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Projectname = value;
		...
		[SoapElement(ElementName="LogDetails")]
		[XmlElement(ElementName="LogDetails")]
		public string gxTpr_Logdetails
		{
			get {
				return gxTv_SdtWorkLogsSDT_Logdetails; 
			}
			set {
				gxTv_SdtWorkLogsSDT_Logdetails = value;
				SetDirty("Logdetails");
			}
		}
		...
		protected long gxTv_SdtWorkLogsSDT_Workhourlogid;
		 

		protected DateTime gxTv_SdtWorkLogsSDT_Workhourlogdate;
		 

		protected string gxTv_SdtWorkLogsSDT_Workhourlogduration;
		 

		protected short gxTv_SdtWorkLogsSDT_Workhourloghour;
		 

		protected short gxTv_SdtWorkLogsSDT_Workhourlogminute;
		 

		protected string gxTv_SdtWorkLogsSDT_Workhourlogdescription;
		 

		protected long gxTv_SdtWorkLogsSDT_Employeeid;
		 

		protected string gxTv_SdtWorkLogsSDT_Employeefirstname;
		 

		protected long gxTv_SdtWorkLogsSDT_Projectid;
		 

		protected string gxTv_SdtWorkLogsSDT_Projectname;
		 

		protected string gxTv_SdtWorkLogsSDT_Logdetails;
	...
	{
		public SdtWorkLogsSDT_RESTInterface( ) : base()
		{	
		}

		public SdtWorkLogsSDT_RESTInterface( SdtWorkLogsSDT psdt ) : base(psdt)
		{	
		}
		...
		[DataMember(Name="LogDetails", Order=10)]
		public  string gxTpr_Logdetails
		{
			get { 
				return sdt.gxTpr_Logdetails;

			}
			set { 
				 sdt.gxTpr_Logdetails = value;
			}
		}
		...
		public SdtWorkLogsSDT sdt
		{
			get { 
				return (SdtWorkLogsSDT)Sdt;
			}
			set { 
				Sdt = value;
			}
