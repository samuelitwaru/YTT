...
namespace GeneXus.Programs {
   public class holidaywwgetfilterdata : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         holidaywwgetfilterdata objholidaywwgetfilterdata;
         objholidaywwgetfilterdata = new holidaywwgetfilterdata();
         objholidaywwgetfilterdata.AV41DDOName = aP0_DDOName;
         objholidaywwgetfilterdata.AV42SearchTxtParms = aP1_SearchTxtParms;
         objholidaywwgetfilterdata.AV43SearchTxtTo = aP2_SearchTxtTo;
         objholidaywwgetfilterdata.AV44OptionsJson = "" ;
         objholidaywwgetfilterdata.AV45OptionsDescJson = "" ;
         objholidaywwgetfilterdata.AV46OptionIndexesJson = "" ;
         objholidaywwgetfilterdata.context.SetSubmitInitialConfig(context);
         objholidaywwgetfilterdata.initialize();
         Submit( executePrivateCatch,objholidaywwgetfilterdata);
         aP3_OptionsJson=this.AV44OptionsJson;
         aP4_OptionsDescJson=this.AV45OptionsDescJson;
         aP5_OptionIndexesJson=this.AV46OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((holidaywwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S111( )
      {
         ...
         {
            AV38GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "HolidayWWGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         AV60Udparg7 = new getloggedinusercompanyid(context).executeUdp( );
         AV60Udparg7 = new getloggedinusercompanyid(context).executeUdp( );
         AV60Udparg7 = new getloggedinusercompanyid(context).executeUdp( );
         AV60Udparg7 = new getloggedinusercompanyid(context).executeUdp( );
         AV60Udparg7 = new getloggedinusercompanyid(context).executeUdp( );
         ...
         /* Using cursor P00412 */
         pr_default.execute(0, new Object[] {Gx_date, Gx_date, AV60Udparg7, lV54Holidaywwds_1_filterfulltext, lV55Holidaywwds_2_tfholidayname, AV56Holidaywwds_3_tfholidayname_sel, AV57Holidaywwds_4_tfholidaystartdate, AV58Holidaywwds_5_tfholidaystartdate_to});
   ...
   public class holidaywwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long AV60Udparg7 )
      {
         ...
         AddWhere(sWhereString, "(CompanyId = :AV60Udparg7)");
         ...
         {
            AddWhere(sWhereString, "(LOWER(HolidayName) like LOWER(:lV55Holidaywwds_2_tfholidayname))");
         }
         else
         {
            GXv_int1[4] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("Gx_date",GXType.Date,8,0) ,
          new ParDef("AV60Udparg7",GXType.Int64,10,0) ,
