...
namespace GeneXus.Programs {
   public class holidaywwgetfilterdata : GXProcedure
   {
      ...
      protected void S121( )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              Gx_date } ,
                                              new int[]{
                                              TypeConstants.DATE, TypeConstants.DATE, TypeConstants.SHORT, TypeConstants.DATE, TypeConstants.BOOLEAN, TypeConstants.DATE
                                              }
         });
         ...
         /* Using cursor P00412 */
         pr_default.execute(0, new Object[] {Gx_date, Gx_date, lV54Holidaywwds_1_filterfulltext, lV55Holidaywwds_2_tfholidayname, AV56Holidaywwds_3_tfholidayname_sel, AV57Holidaywwds_4_tfholidaystartdate, AV58Holidaywwds_5_tfholidaystartdate_to});
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.holidaywwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00412_A114HolidayName, P00412_A139HolidayIsActive, P00412_A115HolidayStartDate, P00412_A113HolidayId
               }
            }
         );
   ...
   public class holidaywwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             DateTime Gx_date )
      {
         ...
         scmdbuf = "SELECT HolidayName, HolidayIsActive, HolidayStartDate, HolidayId FROM Holiday";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00412(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (DateTime)dynConstraints[3] , (DateTime)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (DateTime)dynConstraints[7] , (bool)dynConstraints[8] , (DateTime)dynConstraints[9] );
         }
