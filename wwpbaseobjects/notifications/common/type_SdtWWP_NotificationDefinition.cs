...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   ...
   [XmlType(TypeName =  "WWP_NotificationDefinition" , Namespace = "YTT_version4" )]
   [Serializable]
   public class SdtWWP_NotificationDefinition : GxSilentTrnSdt
   {
      ...
      public void Load( long AV23WWPNotificationDefinitionId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV23WWPNotificationDefinitionId});
         return  ;
      }
