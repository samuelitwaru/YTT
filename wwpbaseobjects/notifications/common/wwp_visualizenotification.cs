   ...
   public class wwp_visualizenotification : GXDataArea
   {
      ...
      protected void E11242( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            if ( StringUtil.StrCmp(A7WWPUserExtendedId, new GeneXus.Programs.wwpbaseobjects.wwp_getloggeduserid(context).executeUdp( )) != 0 )
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112810451628", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/notifications/common/wwp_visualizenotification.js", "?2024112810451628", false, true);
