...
namespace GeneXus.Programs.wwpbaseobjects.notifications.web {
   ...
   [XmlType(TypeName =  "WWP_WebNotification" , Namespace = "YTT_version4" )]
   [Serializable]
   public class SdtWWP_WebNotification : GxSilentTrnSdt
   {
      ...
      public void Load( long AV47WWPWebNotificationId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV47WWPWebNotificationId});
         return  ;
      }
