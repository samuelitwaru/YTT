...
namespace GeneXus.Programs.wwpbaseobjects {
   public class listwwpprograms : GXProcedure
   {
      ...
      {
         this.AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtProgramNames_ProgramName>( context, "ProgramName", "YTT_version4") ;
         initialize();
         ExecuteImpl();
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV9ProgramNames = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtProgramNames_ProgramName>( context, "ProgramName", "YTT_version4");
         ...
         AV13name = "WorkHourLogList";
         AV14description = "";
         AV15link = formatLink("workhourloglist.aspx") ;
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {
