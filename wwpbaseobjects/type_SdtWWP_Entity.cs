...
namespace GeneXus.Programs.wwpbaseobjects {
   ...
   [XmlType(TypeName =  "WWP_Entity" , Namespace = "YTT_version4" )]
   [Serializable]
   public class SdtWWP_Entity : GxSilentTrnSdt
   {
      ...
      public void Load( long AV20WWPEntityId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV20WWPEntityId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\WWP_Entity", Namespace = "YTT_version4")]
