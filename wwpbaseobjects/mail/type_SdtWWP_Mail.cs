...
namespace GeneXus.Programs.wwpbaseobjects.mail {
   ...
   [XmlType(TypeName =  "WWP_Mail" , Namespace = "YTT_version4" )]
   [Serializable]
   public class SdtWWP_Mail : GxSilentTrnSdt
   {
      ...
      public void Load( long AV80WWPMailId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV80WWPMailId});
         return  ;
      }
      ...
      public GXBCLevelCollection<GeneXus.Programs.wwpbaseobjects.mail.SdtWWP_Mail_Attachments> gxTpr_Attachments_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtWWP_Mail_Attachments == null )
            {
               gxTv_SdtWWP_Mail_Attachments = new GXBCLevelCollection<GeneXus.Programs.wwpbaseobjects.mail.SdtWWP_Mail_Attachments>( context, "WWP_Mail.Attachments", "YTT_version4");
            }
