...
namespace GeneXus.Programs.wwpbaseobjects.mail {
   ...
   [XmlType(TypeName =  "WWP_MailTemplate" , Namespace = "YTT_version4" )]
   [Serializable]
   public class SdtWWP_MailTemplate : GxSilentTrnSdt
   {
      ...
      public void Load( string AV88WWPMailTemplateName )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(string)AV88WWPMailTemplateName});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\Mail\WWP_MailTemplate", Namespace = "YTT_version4")]
