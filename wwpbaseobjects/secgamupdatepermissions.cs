...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secgamupdatepermissions : GXProcedure
   {
      ...
      public void executeSubmit( )
      {
         ...
         Submit( executePrivateCatch,objsecgamupdatepermissions);
      }
      ...
      void executePrivate( )
      {
         ...
         AV14GAMApplicationId = "131450e8-6fac-42e4-85a0-40894f16ba44";
      ...
      public override void initialize( )
      {
         ...
         AV27SecGAMFunctionalitiesToLoadCollection = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtSecGAMFunctionalitiesToLoad>( context, "SecGAMFunctionalitiesToLoad", "YTT_version4");
         GXt_objcol_SdtSecGAMFunctionalitiesToLoad1 = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtSecGAMFunctionalitiesToLoad>( context, "SecGAMFunctionalitiesToLoad", "YTT_version4");
