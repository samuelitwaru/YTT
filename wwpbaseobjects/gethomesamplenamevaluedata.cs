...
namespace GeneXus.Programs.wwpbaseobjects {
   public class gethomesamplenamevaluedata : GXWebProcedure
   {
      ...
      public override void webExecute( )
      {
         ...
         initialize();
         Gxm3rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleNameValueData_HomeSampleNameValueDataItem>( context, "HomeSampleNameValueDataItem", "YTT_version4") ;
