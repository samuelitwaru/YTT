...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_entity : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPEntityId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A20WWPEntityId), 10, 0, ".", "")), StringUtil.LTrim( ((edtWWPEntityId_Enabled!=0) ? context.localUtil.Format( (decimal)(A20WWPEntityId), "ZZZZZZZZZ9") : context.localUtil.Format( (decimal)(A20WWPEntityId), "ZZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPEntityId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPEntityId_Enabled, 0, "text", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_Id", "end", false, "", "HLP_WWPBaseObjects/WWP_Entity.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPEntityName_Internalname, A21WWPEntityName, StringUtil.RTrim( context.localUtil.Format( A21WWPEntityName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPEntityName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPEntityName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WWPBaseObjects\\WWP_Description", "start", true, "", "HLP_WWPBaseObjects/WWP_Entity.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            Z21WWPEntityName = cgiGet( "Z21WWPEntityName");
      ...
      protected void ZM033( short GX_JID )
      {
         if ( ( GX_JID == 1 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z21WWPEntityName = T00033_A21WWPEntityName[0];
            }
            else
            {
      ...
      protected void Load033( )
      {
         ...
         {
            RcdFound3 = 1;
            A21WWPEntityName = T00034_A21WWPEntityName[0];
            AssignAttri("", false, "A21WWPEntityName", A21WWPEntityName);
            ZM033( -1) ;
         }
         pr_default.close(2);
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM033( 1) ;
            RcdFound3 = 1;
            A20WWPEntityId = T00033_A20WWPEntityId[0];
            AssignAttri("", false, "A20WWPEntityId", StringUtil.LTrimStr( (decimal)(A20WWPEntityId), 10, 0));
            A21WWPEntityName = T00033_A21WWPEntityName[0];
            AssignAttri("", false, "A21WWPEntityName", A21WWPEntityName);
            Z20WWPEntityId = A20WWPEntityId;
            sMode3 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(4) != 101) && ( ( T00036_A20WWPEntityId[0] < A20WWPEntityId ) ) )
            {
               pr_default.readNext(4);
            }
            if ( (pr_default.getStatus(4) != 101) && ( ( T00036_A20WWPEntityId[0] > A20WWPEntityId ) ) )
            {
               A20WWPEntityId = T00036_A20WWPEntityId[0];
               AssignAttri("", false, "A20WWPEntityId", StringUtil.LTrimStr( (decimal)(A20WWPEntityId), 10, 0));
               RcdFound3 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         RcdFound3 = 0;
         /* Using cursor T00037 */
         pr_default.execute(5, new Object[] {A20WWPEntityId});
         if ( (pr_default.getStatus(5) != 101) )
         {
            while ( (pr_default.getStatus(5) != 101) && ( ( T00037_A20WWPEntityId[0] > A20WWPEntityId ) ) )
            {
               pr_default.readNext(5);
            }
            if ( (pr_default.getStatus(5) != 101) && ( ( T00037_A20WWPEntityId[0] < A20WWPEntityId ) ) )
            {
               A20WWPEntityId = T00037_A20WWPEntityId[0];
               AssignAttri("", false, "A20WWPEntityId", StringUtil.LTrimStr( (decimal)(A20WWPEntityId), 10, 0));
               RcdFound3 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency033( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z21WWPEntityName, T00032_A21WWPEntityName[0]) != 0 ) )
            {
               if ( StringUtil.StrCmp(Z21WWPEntityName, T00032_A21WWPEntityName[0]) != 0 )
               {
                  GXUtil.WriteLog("wwpbaseobjects.wwp_entity:[seudo value changed for attri]"+"WWPEntityName");
                  GXUtil.WriteLogRaw("Old: ",Z21WWPEntityName);
                  GXUtil.WriteLogRaw("Current: ",T00032_A21WWPEntityName[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00038 */
                     pr_default.execute(6, new Object[] {A21WWPEntityName});
                     pr_default.close(6);
                     /* Retrieving last key number assigned */
                     /* Using cursor T00039 */
                     pr_default.execute(7);
                     A20WWPEntityId = T00039_A20WWPEntityId[0];
                     AssignAttri("", false, "A20WWPEntityId", StringUtil.LTrimStr( (decimal)(A20WWPEntityId), 10, 0));
                     pr_default.close(7);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A21WWPEntityName, A20WWPEntityId});
                     pr_default.close(8);
                     pr_default.SmartCacheProvider.SetUpdated("WWP_Entity");
      ...
      protected void OnDeleteControls033( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(10, new Object[] {A20WWPEntityId});
      ...
      public void ScanStart033( )
      {
         ...
         {
            RcdFound3 = 1;
            A20WWPEntityId = T000313_A20WWPEntityId[0];
            AssignAttri("", false, "A20WWPEntityId", StringUtil.LTrimStr( (decimal)(A20WWPEntityId), 10, 0));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112810392527", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/wwp_entity.js", "?2024112810392527", false, true);
      ...
      public override void initialize( )
      {
         ...
         endTrnMsgTxt = "";
         endTrnMsgCod = "";
         T00034_A20WWPEntityId = new long[1] ;
         T00034_A21WWPEntityName = new string[] {""} ;
         T00035_A20WWPEntityId = new long[1] ;
         T00033_A20WWPEntityId = new long[1] ;
         T00033_A21WWPEntityName = new string[] {""} ;
         sMode3 = "";
         T00036_A20WWPEntityId = new long[1] ;
         T00037_A20WWPEntityId = new long[1] ;
         T00032_A20WWPEntityId = new long[1] ;
         T00032_A21WWPEntityName = new string[] {""} ;
         T00039_A20WWPEntityId = new long[1] ;
         T000312_A23WWPNotificationDefinitionId = new long[1] ;
         T000313_A20WWPEntityId = new long[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ZZ21WWPEntityName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.wwp_entity__default(),
            new Object[][] {
                new Object[] {
               T00032_A20WWPEntityId, T00032_A21WWPEntityName
               }
               , new Object[] {
               T00033_A20WWPEntityId, T00033_A21WWPEntityName
               }
               , new Object[] {
               T00034_A20WWPEntityId, T00034_A21WWPEntityName
               }
               , new Object[] {
               T00035_A20WWPEntityId
               }
               , new Object[] {
               T00036_A20WWPEntityId
               }
               , new Object[] {
               T00037_A20WWPEntityId
               }
               , new Object[] {
               }
               , new Object[] {
               T00039_A20WWPEntityId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T000312_A23WWPNotificationDefinitionId
               }
               , new Object[] {
               T000313_A20WWPEntityId
               }
            }
         );
      }
      ...
      private long[] T00034_A20WWPEntityId ;
      private string[] T00034_A21WWPEntityName ;
      private long[] T00035_A20WWPEntityId ;
      private long[] T00033_A20WWPEntityId ;
      private string[] T00033_A21WWPEntityName ;
      private long[] T00036_A20WWPEntityId ;
      private long[] T00037_A20WWPEntityId ;
      private long[] T00032_A20WWPEntityId ;
      private string[] T00032_A21WWPEntityName ;
      private long[] T00039_A20WWPEntityId ;
 ...
 public class wwp_entity__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
            new CursorDef("T00032", "SELECT WWPEntityId, WWPEntityName FROM WWP_Entity WHERE WWPEntityId = :WWPEntityId  FOR UPDATE OF WWP_Entity NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT00032,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T00033", "SELECT WWPEntityId, WWPEntityName FROM WWP_Entity WHERE WWPEntityId = :WWPEntityId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00033,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T00034", "SELECT TM1.WWPEntityId, TM1.WWPEntityName FROM WWP_Entity TM1 WHERE TM1.WWPEntityId = :WWPEntityId ORDER BY TM1.WWPEntityId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00034,100, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T00035", "SELECT WWPEntityId FROM WWP_Entity WHERE WWPEntityId = :WWPEntityId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00035,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T00036", "SELECT WWPEntityId FROM WWP_Entity WHERE ( WWPEntityId > :WWPEntityId) ORDER BY WWPEntityId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00036,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T00037", "SELECT WWPEntityId FROM WWP_Entity WHERE ( WWPEntityId < :WWPEntityId) ORDER BY WWPEntityId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT00037,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T00038", "SAVEPOINT gxupdate;INSERT INTO WWP_Entity(WWPEntityName) VALUES(:WWPEntityName);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmT00038)
           ,new CursorDef("T00039", "SELECT currval('WWPEntityId') ",true, GxErrorMask.GX_NOMASK, false, this,prmT00039,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000310", "SAVEPOINT gxupdate;UPDATE WWP_Entity SET WWPEntityName=:WWPEntityName  WHERE WWPEntityId = :WWPEntityId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000310)
           ,new CursorDef("T000311", "SAVEPOINT gxupdate;DELETE FROM WWP_Entity  WHERE WWPEntityId = :WWPEntityId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000311)
           ,new CursorDef("T000312", "SELECT WWPNotificationDefinitionId FROM WWP_NotificationDefinition WHERE WWPEntityId = :WWPEntityId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000312,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T000313", "SELECT WWPEntityId FROM WWP_Entity ORDER BY WWPEntityId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000313,100, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
