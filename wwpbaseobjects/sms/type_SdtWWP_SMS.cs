...
namespace GeneXus.Programs.wwpbaseobjects.sms {
   ...
   [XmlType(TypeName =  "WWP_SMS" , Namespace = "YTT_version4" )]
   [Serializable]
   public class SdtWWP_SMS : GxSilentTrnSdt
   {
      ...
      public void Load( long AV33WWPSMSId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV33WWPSMSId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\SMS\WWP_SMS", Namespace = "YTT_version4")]
