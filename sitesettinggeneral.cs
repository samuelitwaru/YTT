...
namespace GeneXus.Programs {
   public class sitesettinggeneral : GXWebComponent
   {
      public sitesettinggeneral( )
      {
      ...
      public sitesettinggeneral( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "SiteSettingId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "A160SiteSettingId", StringUtil.LTrimStr( (decimal)(A160SiteSettingId), 10, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)A160SiteSettingId});
                  componentstart();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV14Pgmname = "SiteSettingGeneral";
               WS5N2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Site Setting General") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("sitesettinggeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A160SiteSettingId,10,0))}, new string[] {"SiteSettingId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA160SiteSettingId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA160SiteSettingId), 10, 0, ".", "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      {
         return "SiteSettingGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return "Site Setting General" ;
      }
      ...
      protected void WB5N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "sitesettinggeneral.aspx");
            }
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e115n1_client"+"'", TempTags, "", 2, "HLP_SiteSettingGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e125n1_client"+"'", TempTags, "", 2, "HLP_SiteSettingGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         AssignAttri(sPrefix, false, "A161IsLogHourOpen", A161IsLogHourOpen);
      }
      ...
      protected void RF5N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A100CompanyId = H005N2_A100CompanyId[0];
               A161IsLogHourOpen = H005N2_A161IsLogHourOpen[0];
               AssignAttri(sPrefix, false, "A161IsLogHourOpen", A161IsLogHourOpen);
               A101CompanyName = H005N2_A101CompanyName[0];
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtSiteSettingId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSiteSettingId_Enabled), 5, 0), true);
         ...
         AssignProp(sPrefix, false, chkIsLogHourOpen_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(chkIsLogHourOpen.Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP5N0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA160SiteSettingId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA160SiteSettingId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E145N2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "sitesetting_Update", out  GXt_boolean1) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "sitesetting_Delete", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         AV8TrnContext.gxTpr_Transactionname = "SiteSetting";
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A160SiteSettingId = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "A160SiteSettingId", StringUtil.LTrimStr( (decimal)(A160SiteSettingId), 10, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA160SiteSettingId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "sitesettinggeneral", GetJustCreated( ));
         ...
         {
            A160SiteSettingId = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "A160SiteSettingId", StringUtil.LTrimStr( (decimal)(A160SiteSettingId), 10, 0));
         }
         wcpOA160SiteSettingId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA160SiteSettingId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A160SiteSettingId != wcpOA160SiteSettingId ) ) )
         {
            setjustcreated();
         }
         wcpOA160SiteSettingId = A160SiteSettingId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA160SiteSettingId = cgiGet( sPrefix+"A160SiteSettingId_CTRL");
         if ( StringUtil.Len( sCtrlA160SiteSettingId) > 0 )
         {
            A160SiteSettingId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA160SiteSettingId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A160SiteSettingId", StringUtil.LTrimStr( (decimal)(A160SiteSettingId), 10, 0));
         }
         else
         {
            A160SiteSettingId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A160SiteSettingId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A160SiteSettingId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A160SiteSettingId), 10, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA160SiteSettingId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A160SiteSettingId_CTRL", StringUtil.RTrim( sCtrlA160SiteSettingId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512201923", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("sitesettinggeneral.js", "?2024102512201923", false, true);
      ...
      {
         edtSiteSettingId_Internalname = sPrefix+"SITESETTINGID";
         edtCompanyName_Internalname = sPrefix+"COMPANYNAME";
         chkIsLogHourOpen_Internalname = sPrefix+"ISLOGHOUROPEN";
      ...
      public override void initialize( )
      {
         ...
         H005N2_A101CompanyName = new string[] {""} ;
         ...
         sCtrlA160SiteSettingId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sitesettinggeneral__default(),
            new Object[][] {
                new Object[] {
               H005N2_A100CompanyId, H005N2_A160SiteSettingId, H005N2_A161IsLogHourOpen, H005N2_A101CompanyName
               }
            }
         );
         AV14Pgmname = "SiteSettingGeneral";
      ...
      private long wcpOA160SiteSettingId ;
      ...
      private long[] H005N2_A100CompanyId ;
   ...
   public class sitesettinggeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005N2", "SELECT T1.CompanyId, T1.SiteSettingId, T1.IsLogHourOpen, T2.CompanyName FROM (SiteSetting T1 INNER JOIN Company T2 ON T2.CompanyId = T1.CompanyId) WHERE T1.SiteSettingId = :SiteSettingId ORDER BY T1.SiteSettingId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005N2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
