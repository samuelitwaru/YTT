   ...
   public class wc_setemployeevacationdays : GXWebComponent
   {
      ...
      protected void WB610( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancelbtn_Internalname, "", "Cancel", bttBtncancelbtn_Jsonclick, 7, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11611_client"+"'", TempTags, "", 2, "HLP_WC_SetEmployeeVacationDays.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E13612( )
      {
         ...
         else
         {
            ...
            {
               AV16GXV2 = 1;
               AV15GXV1 = AV11BC_Employee.GetMessages();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112810393589", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wc_setemployeevacationdays.js", "?2024112810393589", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOCANCELBTN'","""{"handler":"E11611","iparms":[]}""");
         setEventMetadata("ENTER","""{"handler":"E13612","iparms":[{"av":"AV9EmployeeVactionDays","fld":"vEMPLOYEEVACTIONDAYS","pic":"Z9.9"},{"av":"AV8EmployeeVacationDaysSetDate","fld":"vEMPLOYEEVACATIONDAYSSETDATE"},{"av":"AV12BC_VacationSet","fld":"vBC_VACATIONSET"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"AV11BC_Employee","fld":"vBC_EMPLOYEE"}]""");
