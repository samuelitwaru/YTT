...
namespace GeneXus.Programs {
   public class dpemployeesbyproject : GXProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A107EmployeeFirstName = P00152_A107EmployeeFirstName[0];
            A108EmployeeLastName = P00152_A108EmployeeLastName[0];
            A148EmployeeName = P00152_A148EmployeeName[0];
            A109EmployeeEmail = P00152_A109EmployeeEmail[0];
            A100CompanyId = P00152_A100CompanyId[0];
            A101CompanyName = P00152_A101CompanyName[0];
            A110EmployeeIsManager = P00152_A110EmployeeIsManager[0];
            A111GAMUserGUID = P00152_A111GAMUserGUID[0];
            A112EmployeeIsActive = P00152_A112EmployeeIsActive[0];
            A146EmployeeVactionDays = P00152_A146EmployeeVactionDays[0];
            A147EmployeeBalance = P00152_A147EmployeeBalance[0];
            A101CompanyName = P00152_A101CompanyName[0];
            ...
            {
               A166ProjectManagerId = P00153_A166ProjectManagerId[0];
               n166ProjectManagerId = P00153_n166ProjectManagerId[0];
               A102ProjectId = P00153_A102ProjectId[0];
               A103ProjectName = P00153_A103ProjectName[0];
      ...
      public override void initialize( )
      {
         ...
         P00152_A109EmployeeEmail = new string[] {""} ;
         P00152_A100CompanyId = new long[1] ;
         P00152_A101CompanyName = new string[] {""} ;
         ...
         A111GAMUserGUID = "";
         Gxm1sdtemployee = new SdtSDTEmployee(context);
         P00153_A166ProjectManagerId = new long[1] ;
         P00153_n166ProjectManagerId = new bool[] {false} ;
         P00153_A102ProjectId = new long[1] ;
         P00153_A103ProjectName = new string[] {""} ;
         A103ProjectName = "";
         Gxm3sdtemployee_project = new SdtSDTEmployee_ProjectItem(context);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.dpemployeesbyproject__default(),
            new Object[][] {
                new Object[] {
               P00152_A106EmployeeId, P00152_A107EmployeeFirstName, P00152_A108EmployeeLastName, P00152_A148EmployeeName, P00152_A109EmployeeEmail, P00152_A100CompanyId, P00152_A101CompanyName, P00152_A110EmployeeIsManager, P00152_A111GAMUserGUID, P00152_A112EmployeeIsActive,
               P00152_A146EmployeeVactionDays, P00152_A147EmployeeBalance
               }
               , new Object[] {
               P00153_A166ProjectManagerId, P00153_n166ProjectManagerId, P00153_A102ProjectId, P00153_A103ProjectName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00152_A108EmployeeLastName ;
      private string[] P00152_A148EmployeeName ;
      private string[] P00152_A109EmployeeEmail ;
      private long[] P00152_A100CompanyId ;
      private string[] P00152_A101CompanyName ;
   ...
   public class dpemployeesbyproject__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00152(context, (long)dynConstraints[0] , (GxSimpleCollection<long>)dynConstraints[1] , (int)dynConstraints[2] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00152", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00152,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00153", "SELECT ProjectManagerId, ProjectId, ProjectName FROM Project WHERE ProjectManagerId = :EmployeeId ORDER BY ProjectManagerId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00153,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
