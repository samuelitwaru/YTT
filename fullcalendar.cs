...
namespace GeneXus.Programs {
   public class fullcalendar : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("UserControls/UCFullCalendarRender.js", "", false, true);
      ...
      protected void WB560( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ucUcfullcalendar1.Render(context, "ucfullcalendar", Ucfullcalendar1_Internalname, "UCFULLCALENDAR1Container");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20245281215778", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("fullcalendar.js", "?20245281215778", false, true);
            context.AddJavascriptSource("UserControls/UCFullCalendarRender.js", "", false, true);
         }
      ...
      {
         Ucfullcalendar1_Internalname = "UCFULLCALENDAR1";
      ...
      public override void initialize( )
      {
         ...
         Form = new GXWebForm();
         sPrefix = "";
         ucUcfullcalendar1 = new GXUserControl();
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         sEvtType = "";
      ...
      private string Ucfullcalendar1_Internalname ;
      private string sEvt ;
      ...
      private GXUserControl ucUcfullcalendar1 ;
