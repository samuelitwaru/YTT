...
namespace GeneXus.Programs {
   public class companylocationwwgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV30GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "CompanyLocationWWGridState"), null, "", "");
         }
         else
         {
      ...
      protected void S121( )
      {
         ...
         {
            BRK912 = false;
            A158CompanyLocationName = P00912_A158CompanyLocationName[0];
            A159CompanyLocationCode = P00912_A159CompanyLocationCode[0];
            A157CompanyLocationId = P00912_A157CompanyLocationId[0];
            AV27count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00912_A158CompanyLocationName[0], A158CompanyLocationName) == 0 ) )
            {
               BRK912 = false;
               A157CompanyLocationId = P00912_A157CompanyLocationId[0];
      ...
      protected void S131( )
      {
         ...
         {
            BRK914 = false;
            A159CompanyLocationCode = P00913_A159CompanyLocationCode[0];
            A158CompanyLocationName = P00913_A158CompanyLocationName[0];
            A157CompanyLocationId = P00913_A157CompanyLocationId[0];
            AV27count = 0;
            while ( (pr_default.getStatus(1) != 101) && ( StringUtil.StrCmp(P00913_A159CompanyLocationCode[0], A159CompanyLocationCode) == 0 ) )
            {
               BRK914 = false;
               A157CompanyLocationId = P00913_A157CompanyLocationId[0];
               AV27count = (long)(AV27count+1);
      ...
      public override void initialize( )
      {
         ...
         A158CompanyLocationName = "";
         A159CompanyLocationCode = "";
         P00912_A158CompanyLocationName = new string[] {""} ;
         P00912_A159CompanyLocationCode = new string[] {""} ;
         P00912_A157CompanyLocationId = new long[1] ;
         AV22Option = "";
         P00913_A159CompanyLocationCode = new string[] {""} ;
         P00913_A158CompanyLocationName = new string[] {""} ;
         P00913_A157CompanyLocationId = new long[1] ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.companylocationwwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00912_A158CompanyLocationName, P00912_A159CompanyLocationCode, P00912_A157CompanyLocationId
               }
               , new Object[] {
               P00913_A159CompanyLocationCode, P00913_A158CompanyLocationName, P00913_A157CompanyLocationId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P00912_A157CompanyLocationId ;
      private string[] P00913_A159CompanyLocationCode ;
      private string[] P00913_A158CompanyLocationName ;
      private long[] P00913_A157CompanyLocationId ;
