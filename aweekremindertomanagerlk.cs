...
namespace GeneXus.Programs {
   public class aweekremindertomanagerlk : GXWebProcedure
   {
      ...
      {
         aweekremindertomanagerlk objaweekremindertomanagerlk;
         objaweekremindertomanagerlk = new aweekremindertomanagerlk();
         objaweekremindertomanagerlk.context.SetSubmitInitialConfig(context);
         objaweekremindertomanagerlk.initialize();
         Submit( executePrivateCatch,objaweekremindertomanagerlk);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((aweekremindertomanagerlk)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
