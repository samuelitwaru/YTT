...
namespace GeneXus.Programs {
   public class adailyreminderua : GXWebProcedure
   {
      ...
      {
         context.CommitDataStores("dailyreminderua",pr_default);
         CloseOpenCursors();
         base.cleanup();
         if ( IsMain )
         {
