   ...
   public class adailyreminderua : GXWebProcedure
   {
      ...
      void executePrivate( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            A106EmployeeId = P00AK2_A106EmployeeId[0];
            A159CompanyLocationCode = P00AK2_A159CompanyLocationCode[0];
            A112EmployeeIsActive = P00AK2_A112EmployeeIsActive[0];
            A107EmployeeFirstName = P00AK2_A107EmployeeFirstName[0];
            A109EmployeeEmail = P00AK2_A109EmployeeEmail[0];
            A157CompanyLocationId = P00AK2_A157CompanyLocationId[0];
            A159CompanyLocationCode = P00AK2_A159CompanyLocationCode[0];
            ...
            {
               A119WorkHourLogDate = P00AK3_A119WorkHourLogDate[0];
               A118WorkHourLogId = P00AK3_A118WorkHourLogId[0];
            ...
            if ( ! AV14HasLoggedHours )
            {
               ...
               AV12Subject = "Daily Time Tracker Reminder" + StringUtil.Str( (decimal)(AV17CurrentHour), 4, 0);
      ...
      public override void initialize( )
      {
         ...
         P00AK2_A106EmployeeId = new long[1] ;
         P00AK2_A159CompanyLocationCode = new string[] {""} ;
         P00AK2_A112EmployeeIsActive = new bool[] {false} ;
         P00AK2_A107EmployeeFirstName = new string[] {""} ;
         P00AK2_A109EmployeeEmail = new string[] {""} ;
         A159CompanyLocationCode = "";
         A107EmployeeFirstName = "";
         A109EmployeeEmail = "";
         P00AK3_A106EmployeeId = new long[1] ;
         P00AK3_A119WorkHourLogDate = new DateTime[] {DateTime.MinValue} ;
         P00AK3_A118WorkHourLogId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.adailyreminderua__default(),
            new Object[][] {
                new Object[] {
               P00AK2_A100CompanyId, P00AK2_A157CompanyLocationId, P00AK2_A106EmployeeId, P00AK2_A159CompanyLocationCode, P00AK2_A112EmployeeIsActive, P00AK2_A107EmployeeFirstName, P00AK2_A109EmployeeEmail
               }
               , new Object[] {
               P00AK3_A106EmployeeId, P00AK3_A119WorkHourLogDate, P00AK3_A118WorkHourLogId
               }
            }
         );
      ...
      private long[] P00AK2_A106EmployeeId ;
      private string[] P00AK2_A159CompanyLocationCode ;
      private bool[] P00AK2_A112EmployeeIsActive ;
      private string[] P00AK2_A107EmployeeFirstName ;
      private string[] P00AK2_A109EmployeeEmail ;
      private long[] P00AK3_A106EmployeeId ;
      private DateTime[] P00AK3_A119WorkHourLogDate ;
      private long[] P00AK3_A118WorkHourLogId ;
   ...
   public class adailyreminderua__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00AK2", "SELECT T1.CompanyId, T2.CompanyLocationId, T1.EmployeeId, T3.CompanyLocationCode, T1.EmployeeIsActive, T1.EmployeeFirstName, T1.EmployeeEmail FROM ((Employee T1 INNER JOIN Company T2 ON T2.CompanyId = T1.CompanyId) INNER JOIN CompanyLocation T3 ON T3.CompanyLocationId = T2.CompanyLocationId) WHERE (T1.EmployeeIsActive = TRUE) AND (T3.CompanyLocationCode = ( 'ukrainian')) ORDER BY T1.EmployeeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AK2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00AK3", "SELECT EmployeeId, WorkHourLogDate, WorkHourLogId FROM WorkHourLog WHERE (WorkHourLogDate = :AV15CheckDate) AND (EmployeeId = :EmployeeId) ORDER BY WorkHourLogDate ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00AK3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
