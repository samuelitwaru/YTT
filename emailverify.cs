...
namespace GeneXus.Programs {
   public class emailverify : GXDataArea
   {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'SETPASSWORD'") == 0 )
                           {
                              context.wbHandled = 1;
                              dynload_actions( ) ;
                              /* Execute user event: 'SetPassword' */
                              E13502 ();
                           }
      ...
      protected void before_start_formulas( )
      {
         ...
         {
            A40000EmployeeId = H00503_A40000EmployeeId[0];
            n40000EmployeeId = H00503_n40000EmployeeId[0];
         }
         else
         {
            A40000EmployeeId = 0;
      ...
      protected void E13502( )
      {
         ...
         {
            A40000EmployeeId = H00505_A40000EmployeeId[0];
            n40000EmployeeId = H00505_n40000EmployeeId[0];
         }
         else
         {
            A40000EmployeeId = 0;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202451718125011", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("emailverify.js", "?202451718125014", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.emailverify__default(),
            new Object[][] {
                new Object[] {
               H00503_A40000EmployeeId, H00503_n40000EmployeeId
               }
               , new Object[] {
               H00505_A40000EmployeeId, H00505_n40000EmployeeId
               }
            }
         );
         /* GeneXus formulas. */
 ...
 public class emailverify__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
            new CursorDef("H00503", "SELECT COALESCE( T1.EmployeeId, 0) AS EmployeeId FROM (SELECT MIN(EmployeeId) AS EmployeeId FROM Employee WHERE GAMUserGUID = ( :AV45GamGuid) ) T1 ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00503,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H00505", "SELECT COALESCE( T1.EmployeeId, 0) AS EmployeeId FROM (SELECT MIN(EmployeeId) AS EmployeeId FROM Employee WHERE GAMUserGUID = ( :AV45GamGuid) ) T1 ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00505,1, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
