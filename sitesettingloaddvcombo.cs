...
namespace GeneXus.Programs {
   public class sitesettingloaddvcombo : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            {
               A101CompanyName = P00BD2_A101CompanyName[0];
               A100CompanyId = P00BD2_A100CompanyId[0];
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  ...
                  {
                     A160SiteSettingId = P00BD3_A160SiteSettingId[0];
                     A100CompanyId = P00BD3_A100CompanyId[0];
                     A101CompanyName = P00BD3_A101CompanyName[0];
                     A101CompanyName = P00BD3_A101CompanyName[0];
               ...
               else
               {
                  ...
                  {
                     A100CompanyId = P00BD4_A100CompanyId[0];
                     A101CompanyName = P00BD4_A101CompanyName[0];
                     AV23SelectedText = A101CompanyName;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      public override void initialize( )
      {
         ...
         P00BD2_A100CompanyId = new long[1] ;
         AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV15Combo_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         P00BD3_A160SiteSettingId = new long[1] ;
         P00BD3_A100CompanyId = new long[1] ;
         P00BD3_A101CompanyName = new string[] {""} ;
         P00BD4_A100CompanyId = new long[1] ;
         P00BD4_A101CompanyName = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.sitesettingloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P00BD2_A101CompanyName, P00BD2_A100CompanyId
               }
               , new Object[] {
               P00BD3_A160SiteSettingId, P00BD3_A100CompanyId, P00BD3_A101CompanyName
               }
               , new Object[] {
               P00BD4_A100CompanyId, P00BD4_A101CompanyName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P00BD4_A100CompanyId ;
      private string[] P00BD4_A101CompanyName ;
   ...
   {
      protected Object[] conditional_P00BD2( IGxContext context ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00BD2(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00BD2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BD2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P00BD3", "SELECT T1.SiteSettingId, T1.CompanyId, T2.CompanyName FROM (SiteSetting T1 INNER JOIN Company T2 ON T2.CompanyId = T1.CompanyId) WHERE T1.SiteSettingId = :AV20SiteSettingId ORDER BY T1.SiteSettingId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BD3,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00BD4", "SELECT CompanyId, CompanyName FROM Company WHERE CompanyId = :AV28CompanyId ORDER BY CompanyId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BD4,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
