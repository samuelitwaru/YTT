...
namespace GeneXus.Programs {
   public class gamrecoverpasswordstep1 : GXDataArea
   {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV26GXV1 = 1;
         while ( AV26GXV1 <= AV6Errors.Count )
         {
            AV24Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV6Errors.Item(AV26GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102512203779", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep1.js", "?2024102512203783", false, true);
