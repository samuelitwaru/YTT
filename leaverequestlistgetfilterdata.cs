...
namespace GeneXus.Programs {
   public class leaverequestlistgetfilterdata : GXProcedure
   {
      ...
      protected void S111( )
      {
         ...
         {
            AV42GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "LeaveRequestListGridState"), null, "", "");
         }
         else
         {
         ...
         {
            AV43GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV42GridState.gxTpr_Filtervalues.Item(AV57GXV1));
      ...
      protected void S121( )
      {
         ...
         {
            BRKBV2 = false;
            A124LeaveTypeId = P00BV2_A124LeaveTypeId[0];
            A106EmployeeId = P00BV2_A106EmployeeId[0];
            A133LeaveRequestDescription = P00BV2_A133LeaveRequestDescription[0];
            A131LeaveRequestDuration = P00BV2_A131LeaveRequestDuration[0];
            A173LeaveRequestHalfDay = P00BV2_A173LeaveRequestHalfDay[0];
            n173LeaveRequestHalfDay = P00BV2_n173LeaveRequestHalfDay[0];
            A130LeaveRequestEndDate = P00BV2_A130LeaveRequestEndDate[0];
            A129LeaveRequestStartDate = P00BV2_A129LeaveRequestStartDate[0];
            A148EmployeeName = P00BV2_A148EmployeeName[0];
            A125LeaveTypeName = P00BV2_A125LeaveTypeName[0];
            A127LeaveRequestId = P00BV2_A127LeaveRequestId[0];
            A125LeaveTypeName = P00BV2_A125LeaveTypeName[0];
            A148EmployeeName = P00BV2_A148EmployeeName[0];
            AV39count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( P00BV2_A124LeaveTypeId[0] == A124LeaveTypeId ) )
            {
               BRKBV2 = false;
               A127LeaveRequestId = P00BV2_A127LeaveRequestId[0];
      ...
      protected void S131( )
      {
         ...
         {
            BRKBV4 = false;
            A148EmployeeName = P00BV3_A148EmployeeName[0];
            A106EmployeeId = P00BV3_A106EmployeeId[0];
            A124LeaveTypeId = P00BV3_A124LeaveTypeId[0];
            A133LeaveRequestDescription = P00BV3_A133LeaveRequestDescription[0];
            A131LeaveRequestDuration = P00BV3_A131LeaveRequestDuration[0];
            A173LeaveRequestHalfDay = P00BV3_A173LeaveRequestHalfDay[0];
            n173LeaveRequestHalfDay = P00BV3_n173LeaveRequestHalfDay[0];
            A130LeaveRequestEndDate = P00BV3_A130LeaveRequestEndDate[0];
            A129LeaveRequestStartDate = P00BV3_A129LeaveRequestStartDate[0];
            A125LeaveTypeName = P00BV3_A125LeaveTypeName[0];
            A127LeaveRequestId = P00BV3_A127LeaveRequestId[0];
            A148EmployeeName = P00BV3_A148EmployeeName[0];
            A125LeaveTypeName = P00BV3_A125LeaveTypeName[0];
            AV39count = 0;
            while ( (pr_default.getStatus(1) != 101) && ( StringUtil.StrCmp(P00BV3_A148EmployeeName[0], A148EmployeeName) == 0 ) )
            {
               BRKBV4 = false;
               A106EmployeeId = P00BV3_A106EmployeeId[0];
               A127LeaveRequestId = P00BV3_A127LeaveRequestId[0];
      ...
      protected void S141( )
      {
         ...
         {
            BRKBV6 = false;
            A173LeaveRequestHalfDay = P00BV4_A173LeaveRequestHalfDay[0];
            n173LeaveRequestHalfDay = P00BV4_n173LeaveRequestHalfDay[0];
            A106EmployeeId = P00BV4_A106EmployeeId[0];
            A124LeaveTypeId = P00BV4_A124LeaveTypeId[0];
            A133LeaveRequestDescription = P00BV4_A133LeaveRequestDescription[0];
            A131LeaveRequestDuration = P00BV4_A131LeaveRequestDuration[0];
            A130LeaveRequestEndDate = P00BV4_A130LeaveRequestEndDate[0];
            A129LeaveRequestStartDate = P00BV4_A129LeaveRequestStartDate[0];
            A148EmployeeName = P00BV4_A148EmployeeName[0];
            A125LeaveTypeName = P00BV4_A125LeaveTypeName[0];
            A127LeaveRequestId = P00BV4_A127LeaveRequestId[0];
            A148EmployeeName = P00BV4_A148EmployeeName[0];
            A125LeaveTypeName = P00BV4_A125LeaveTypeName[0];
            AV39count = 0;
            while ( (pr_default.getStatus(2) != 101) && ( StringUtil.StrCmp(P00BV4_A173LeaveRequestHalfDay[0], A173LeaveRequestHalfDay) == 0 ) )
            {
               BRKBV6 = false;
               A127LeaveRequestId = P00BV4_A127LeaveRequestId[0];
               AV39count = (long)(AV39count+1);
            ...
            if ( (0==AV30SkipItems) )
            {
               AV34Option = (String.IsNullOrEmpty(StringUtil.RTrim( A173LeaveRequestHalfDay)) ? "<#Empty#>" : A173LeaveRequestHalfDay);
               AV35Options.Add(AV34Option, 0);
               AV38OptionIndexes.Add(StringUtil.Trim( context.localUtil.Format( (decimal)(AV39count), "Z,ZZZ,ZZZ,ZZ9")), 0);
               if ( AV35Options.Count == 10 )
               {
      ...
      protected void S151( )
      {
         ...
         {
            BRKBV8 = false;
            A133LeaveRequestDescription = P00BV5_A133LeaveRequestDescription[0];
            A106EmployeeId = P00BV5_A106EmployeeId[0];
            A124LeaveTypeId = P00BV5_A124LeaveTypeId[0];
            A131LeaveRequestDuration = P00BV5_A131LeaveRequestDuration[0];
            A173LeaveRequestHalfDay = P00BV5_A173LeaveRequestHalfDay[0];
            n173LeaveRequestHalfDay = P00BV5_n173LeaveRequestHalfDay[0];
            A130LeaveRequestEndDate = P00BV5_A130LeaveRequestEndDate[0];
            A129LeaveRequestStartDate = P00BV5_A129LeaveRequestStartDate[0];
            A148EmployeeName = P00BV5_A148EmployeeName[0];
            A125LeaveTypeName = P00BV5_A125LeaveTypeName[0];
            A127LeaveRequestId = P00BV5_A127LeaveRequestId[0];
            A148EmployeeName = P00BV5_A148EmployeeName[0];
            A125LeaveTypeName = P00BV5_A125LeaveTypeName[0];
            AV39count = 0;
            while ( (pr_default.getStatus(3) != 101) && ( StringUtil.StrCmp(P00BV5_A133LeaveRequestDescription[0], A133LeaveRequestDescription) == 0 ) )
            {
               BRKBV8 = false;
               A127LeaveRequestId = P00BV5_A127LeaveRequestId[0];
               AV39count = (long)(AV39count+1);
      ...
      public override void initialize( )
      {
         ...
         P00BV2_A124LeaveTypeId = new long[1] ;
         P00BV2_A106EmployeeId = new long[1] ;
         P00BV2_A133LeaveRequestDescription = new string[] {""} ;
         P00BV2_A131LeaveRequestDuration = new decimal[1] ;
         P00BV2_A173LeaveRequestHalfDay = new string[] {""} ;
         P00BV2_n173LeaveRequestHalfDay = new bool[] {false} ;
         P00BV2_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         P00BV2_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         P00BV2_A148EmployeeName = new string[] {""} ;
         P00BV2_A125LeaveTypeName = new string[] {""} ;
         P00BV2_A127LeaveRequestId = new long[1] ;
         AV34Option = "";
         P00BV3_A148EmployeeName = new string[] {""} ;
         P00BV3_A106EmployeeId = new long[1] ;
         P00BV3_A124LeaveTypeId = new long[1] ;
         P00BV3_A133LeaveRequestDescription = new string[] {""} ;
         P00BV3_A131LeaveRequestDuration = new decimal[1] ;
         P00BV3_A173LeaveRequestHalfDay = new string[] {""} ;
         P00BV3_n173LeaveRequestHalfDay = new bool[] {false} ;
         P00BV3_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         P00BV3_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         P00BV3_A125LeaveTypeName = new string[] {""} ;
         P00BV3_A127LeaveRequestId = new long[1] ;
         P00BV4_A173LeaveRequestHalfDay = new string[] {""} ;
         P00BV4_n173LeaveRequestHalfDay = new bool[] {false} ;
         P00BV4_A106EmployeeId = new long[1] ;
         P00BV4_A124LeaveTypeId = new long[1] ;
         P00BV4_A133LeaveRequestDescription = new string[] {""} ;
         P00BV4_A131LeaveRequestDuration = new decimal[1] ;
         P00BV4_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         P00BV4_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         P00BV4_A148EmployeeName = new string[] {""} ;
         P00BV4_A125LeaveTypeName = new string[] {""} ;
         P00BV4_A127LeaveRequestId = new long[1] ;
         P00BV5_A133LeaveRequestDescription = new string[] {""} ;
         P00BV5_A106EmployeeId = new long[1] ;
         P00BV5_A124LeaveTypeId = new long[1] ;
         P00BV5_A131LeaveRequestDuration = new decimal[1] ;
         P00BV5_A173LeaveRequestHalfDay = new string[] {""} ;
         P00BV5_n173LeaveRequestHalfDay = new bool[] {false} ;
         P00BV5_A130LeaveRequestEndDate = new DateTime[] {DateTime.MinValue} ;
         P00BV5_A129LeaveRequestStartDate = new DateTime[] {DateTime.MinValue} ;
         P00BV5_A148EmployeeName = new string[] {""} ;
         P00BV5_A125LeaveTypeName = new string[] {""} ;
         P00BV5_A127LeaveRequestId = new long[1] ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.leaverequestlistgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00BV2_A124LeaveTypeId, P00BV2_A106EmployeeId, P00BV2_A133LeaveRequestDescription, P00BV2_A131LeaveRequestDuration, P00BV2_A173LeaveRequestHalfDay, P00BV2_n173LeaveRequestHalfDay, P00BV2_A130LeaveRequestEndDate, P00BV2_A129LeaveRequestStartDate, P00BV2_A148EmployeeName, P00BV2_A125LeaveTypeName,
               P00BV2_A127LeaveRequestId
               }
               , new Object[] {
               P00BV3_A148EmployeeName, P00BV3_A106EmployeeId, P00BV3_A124LeaveTypeId, P00BV3_A133LeaveRequestDescription, P00BV3_A131LeaveRequestDuration, P00BV3_A173LeaveRequestHalfDay, P00BV3_n173LeaveRequestHalfDay, P00BV3_A130LeaveRequestEndDate, P00BV3_A129LeaveRequestStartDate, P00BV3_A125LeaveTypeName,
               P00BV3_A127LeaveRequestId
               }
               , new Object[] {
               P00BV4_A173LeaveRequestHalfDay, P00BV4_n173LeaveRequestHalfDay, P00BV4_A106EmployeeId, P00BV4_A124LeaveTypeId, P00BV4_A133LeaveRequestDescription, P00BV4_A131LeaveRequestDuration, P00BV4_A130LeaveRequestEndDate, P00BV4_A129LeaveRequestStartDate, P00BV4_A148EmployeeName, P00BV4_A125LeaveTypeName,
               P00BV4_A127LeaveRequestId
               }
               , new Object[] {
               P00BV5_A133LeaveRequestDescription, P00BV5_A106EmployeeId, P00BV5_A124LeaveTypeId, P00BV5_A131LeaveRequestDuration, P00BV5_A173LeaveRequestHalfDay, P00BV5_n173LeaveRequestHalfDay, P00BV5_A130LeaveRequestEndDate, P00BV5_A129LeaveRequestStartDate, P00BV5_A148EmployeeName, P00BV5_A125LeaveTypeName,
               P00BV5_A127LeaveRequestId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private long[] P00BV2_A124LeaveTypeId ;
      private long[] P00BV2_A106EmployeeId ;
      private string[] P00BV2_A133LeaveRequestDescription ;
      private decimal[] P00BV2_A131LeaveRequestDuration ;
      private string[] P00BV2_A173LeaveRequestHalfDay ;
      private bool[] P00BV2_n173LeaveRequestHalfDay ;
      private DateTime[] P00BV2_A130LeaveRequestEndDate ;
      private DateTime[] P00BV2_A129LeaveRequestStartDate ;
      private string[] P00BV2_A148EmployeeName ;
      private string[] P00BV2_A125LeaveTypeName ;
      private long[] P00BV2_A127LeaveRequestId ;
      private string[] P00BV3_A148EmployeeName ;
      private long[] P00BV3_A106EmployeeId ;
      private long[] P00BV3_A124LeaveTypeId ;
      private string[] P00BV3_A133LeaveRequestDescription ;
      private decimal[] P00BV3_A131LeaveRequestDuration ;
      private string[] P00BV3_A173LeaveRequestHalfDay ;
      private bool[] P00BV3_n173LeaveRequestHalfDay ;
      private DateTime[] P00BV3_A130LeaveRequestEndDate ;
      private DateTime[] P00BV3_A129LeaveRequestStartDate ;
      private string[] P00BV3_A125LeaveTypeName ;
      private long[] P00BV3_A127LeaveRequestId ;
      private string[] P00BV4_A173LeaveRequestHalfDay ;
      private bool[] P00BV4_n173LeaveRequestHalfDay ;
      private long[] P00BV4_A106EmployeeId ;
      private long[] P00BV4_A124LeaveTypeId ;
      private string[] P00BV4_A133LeaveRequestDescription ;
      private decimal[] P00BV4_A131LeaveRequestDuration ;
      private DateTime[] P00BV4_A130LeaveRequestEndDate ;
      private DateTime[] P00BV4_A129LeaveRequestStartDate ;
      private string[] P00BV4_A148EmployeeName ;
      private string[] P00BV4_A125LeaveTypeName ;
      private long[] P00BV4_A127LeaveRequestId ;
      private string[] P00BV5_A133LeaveRequestDescription ;
      private long[] P00BV5_A106EmployeeId ;
      private long[] P00BV5_A124LeaveTypeId ;
      private decimal[] P00BV5_A131LeaveRequestDuration ;
      private string[] P00BV5_A173LeaveRequestHalfDay ;
      private bool[] P00BV5_n173LeaveRequestHalfDay ;
      private DateTime[] P00BV5_A130LeaveRequestEndDate ;
      private DateTime[] P00BV5_A129LeaveRequestStartDate ;
      private string[] P00BV5_A148EmployeeName ;
      private string[] P00BV5_A125LeaveTypeName ;
      private long[] P00BV5_A127LeaveRequestId ;
   ...
   public class leaverequestlistgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             DateTime AV54FromDate )
      {
         ...
         scmdbuf = "SELECT T1.LeaveTypeId, T1.EmployeeId, T1.LeaveRequestDescription, T1.LeaveRequestDuration, T1.LeaveRequestHalfDay, T1.LeaveRequestEndDate, T1.LeaveRequestStartDate, T3.EmployeeName, T2.LeaveTypeName, T1.LeaveRequestId FROM ((LeaveRequest T1 INNER JOIN LeaveType T2 ON T2.LeaveTypeId = T1.LeaveTypeId) INNER JOIN Employee T3 ON T3.EmployeeId = T1.EmployeeId)";
         ...
         {
            AddWhere(sWhereString, "(( LOWER(T2.LeaveTypeName) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)) or ( LOWER(T3.EmployeeName) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)) or ( LOWER(T1.LeaveRequestHalfDay) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'90.9'), 2) like '%' || :lV59Leaverequestlistds_1_filterfulltext) or ( LOWER(T1.LeaveRequestDescription) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)))");
         }
         else
         {
            GXv_int1[2] = 1;
      ...
      protected Object[] conditional_P00BV3( IGxContext context ,
                                             string AV59Leaverequestlistds_1_filterfulltext ,
                                             string AV61Leaverequestlistds_3_tfleavetypename_sel ,
                                             string AV60Leaverequestlistds_2_tfleavetypename ,
                                             string AV63Leaverequestlistds_5_tfemployeename_sel ,
                                             ...
                                             DateTime AV54FromDate )
      {
         ...
         scmdbuf = "SELECT T2.EmployeeName, T1.EmployeeId, T1.LeaveTypeId, T1.LeaveRequestDescription, T1.LeaveRequestDuration, T1.LeaveRequestHalfDay, T1.LeaveRequestEndDate, T1.LeaveRequestStartDate, T3.LeaveTypeName, T1.LeaveRequestId FROM ((LeaveRequest T1 INNER JOIN Employee T2 ON T2.EmployeeId = T1.EmployeeId) INNER JOIN LeaveType T3 ON T3.LeaveTypeId = T1.LeaveTypeId)";
         AddWhere(sWhereString, "(T1.LeaveRequestStartDate < :AV55ToDate and T1.LeaveRequestEndDate > :AV54FromDate)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV59Leaverequestlistds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T3.LeaveTypeName) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)) or ( LOWER(T2.EmployeeName) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)) or ( LOWER(T1.LeaveRequestHalfDay) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'90.9'), 2) like '%' || :lV59Leaverequestlistds_1_filterfulltext) or ( LOWER(T1.LeaveRequestDescription) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)))");
         }
         else
         {
            GXv_int3[2] = 1;
      ...
      protected Object[] conditional_P00BV4( IGxContext context ,
                                             string AV59Leaverequestlistds_1_filterfulltext ,
                                             string AV61Leaverequestlistds_3_tfleavetypename_sel ,
                                             string AV60Leaverequestlistds_2_tfleavetypename ,
                                             string AV63Leaverequestlistds_5_tfemployeename_sel ,
      ...
      protected Object[] conditional_P00BV5( IGxContext context ,
                                             string AV59Leaverequestlistds_1_filterfulltext ,
                                             string AV61Leaverequestlistds_3_tfleavetypename_sel ,
                                             string AV60Leaverequestlistds_2_tfleavetypename ,
                                             string AV63Leaverequestlistds_5_tfemployeename_sel ,
                                             ...
                                             DateTime AV54FromDate )
      {
         ...
         scmdbuf = "SELECT T1.LeaveRequestDescription, T1.EmployeeId, T1.LeaveTypeId, T1.LeaveRequestDuration, T1.LeaveRequestHalfDay, T1.LeaveRequestEndDate, T1.LeaveRequestStartDate, T2.EmployeeName, T3.LeaveTypeName, T1.LeaveRequestId FROM ((LeaveRequest T1 INNER JOIN Employee T2 ON T2.EmployeeId = T1.EmployeeId) INNER JOIN LeaveType T3 ON T3.LeaveTypeId = T1.LeaveTypeId)";
         AddWhere(sWhereString, "(T1.LeaveRequestStartDate < :AV55ToDate and T1.LeaveRequestEndDate > :AV54FromDate)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV59Leaverequestlistds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( LOWER(T3.LeaveTypeName) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)) or ( LOWER(T2.EmployeeName) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)) or ( LOWER(T1.LeaveRequestHalfDay) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)) or ( SUBSTR(TO_CHAR(T1.LeaveRequestDuration,'90.9'), 2) like '%' || :lV59Leaverequestlistds_1_filterfulltext) or ( LOWER(T1.LeaveRequestDescription) like '%' || LOWER(:lV59Leaverequestlistds_1_filterfulltext)))");
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00BV3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BV3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00BV4", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BV4,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P00BV5", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00BV5,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
