...
namespace GeneXus.Programs {
   public class projectprojectemployeewc : GXWebComponent
   {
      public projectprojectemployeewc( )
      {
      ...
      public projectprojectemployeewc( IGxContext context )
      {
      ...
      {
         this.AV8ProjectId = aP0_ProjectId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8ProjectId = (long)(Math.Round(NumberUtil.Val( GetPar( "ProjectId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8ProjectId", StringUtil.LTrimStr( (decimal)(AV8ProjectId), 10, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV8ProjectId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ProjectId, AV20ManageFiltersExecutionStep, AV32Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_Insert, A106EmployeeId, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV32Pgmname = "ProjectProjectEmployeeWC";
               edtavUpdate_Enabled = 0;
               AssignProp(sPrefix, false, edtavUpdate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUpdate_Enabled), 5, 0), !bGXsfl_37_Refreshing);
               edtavDelete_Enabled = 0;
               AssignProp(sPrefix, false, edtavDelete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDelete_Enabled), 5, 0), !bGXsfl_37_Refreshing);
               WS5C2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Project Project Employee WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("projectprojectemployeewc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8ProjectId,10,0))}, new string[] {"ProjectId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"EMPLOYEEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A106EmployeeId), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_EMPLOYEEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A106EmployeeId), "ZZZZZZZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8ProjectId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8ProjectId), 10, 0, ".", "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPROJECTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ProjectId), 10, 0, ".", "")));
      ...
      {
         return "ProjectProjectEmployeeWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Project Project Employee WC" ;
      }
      ...
      protected void WB5C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "projectprojectemployeewc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ProjectProjectEmployeeWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "", "start", "top", "", "", "div");
            wb_table1_22_5C2( true) ;
         }
         else
         {
            wb_table1_22_5C2( false) ;
         }
         return  ;
      }

      protected void wb_table1_22_5C2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START5C2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Project Project Employee WC", 0) ;
            context.wjLoc = "";
      ...
      protected void RF5C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H005C2 */
            pr_default.execute(0, new Object[] {AV8ProjectId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A106EmployeeId = H005C2_A106EmployeeId[0];
               A102ProjectId = H005C2_A102ProjectId[0];
               AssignAttri(sPrefix, false, "A102ProjectId", StringUtil.LTrimStr( (decimal)(A102ProjectId), 10, 0));
               A147EmployeeBalance = H005C2_A147EmployeeBalance[0];
               A146EmployeeVactionDays = H005C2_A146EmployeeVactionDays[0];
               A112EmployeeIsActive = H005C2_A112EmployeeIsActive[0];
               A111GAMUserGUID = H005C2_A111GAMUserGUID[0];
               A110EmployeeIsManager = H005C2_A110EmployeeIsManager[0];
               A101CompanyName = H005C2_A101CompanyName[0];
               A100CompanyId = H005C2_A100CompanyId[0];
               A109EmployeeEmail = H005C2_A109EmployeeEmail[0];
               A108EmployeeLastName = H005C2_A108EmployeeLastName[0];
               A107EmployeeFirstName = H005C2_A107EmployeeFirstName[0];
               A147EmployeeBalance = H005C2_A147EmployeeBalance[0];
               A146EmployeeVactionDays = H005C2_A146EmployeeVactionDays[0];
               A112EmployeeIsActive = H005C2_A112EmployeeIsActive[0];
               A111GAMUserGUID = H005C2_A111GAMUserGUID[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H005C3 */
         pr_default.execute(1, new Object[] {AV8ProjectId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtEmployeeFirstName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmployeeFirstName_Enabled), 5, 0), !bGXsfl_37_Refreshing);
         edtEmployeeLastName_Enabled = 0;
         AssignProp(sPrefix, false, edtEmployeeLastName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmployeeLastName_Enabled), 5, 0), !bGXsfl_37_Refreshing);
         edtEmployeeEmail_Enabled = 0;
         AssignProp(sPrefix, false, edtEmployeeEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmployeeEmail_Enabled), 5, 0), !bGXsfl_37_Refreshing);
         edtCompanyId_Enabled = 0;
         AssignProp(sPrefix, false, edtCompanyId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCompanyId_Enabled), 5, 0), !bGXsfl_37_Refreshing);
         edtCompanyName_Enabled = 0;
         AssignProp(sPrefix, false, edtCompanyName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCompanyName_Enabled), 5, 0), !bGXsfl_37_Refreshing);
         chkEmployeeIsManager.Enabled = 0;
         AssignProp(sPrefix, false, chkEmployeeIsManager_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(chkEmployeeIsManager.Enabled), 5, 0), !bGXsfl_37_Refreshing);
         edtGAMUserGUID_Enabled = 0;
         AssignProp(sPrefix, false, edtGAMUserGUID_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtGAMUserGUID_Enabled), 5, 0), !bGXsfl_37_Refreshing);
         chkEmployeeIsActive.Enabled = 0;
         AssignProp(sPrefix, false, chkEmployeeIsActive_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(chkEmployeeIsActive.Enabled), 5, 0), !bGXsfl_37_Refreshing);
         edtEmployeeVactionDays_Enabled = 0;
         AssignProp(sPrefix, false, edtEmployeeVactionDays_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmployeeVactionDays_Enabled), 5, 0), !bGXsfl_37_Refreshing);
         edtEmployeeBalance_Enabled = 0;
         AssignProp(sPrefix, false, edtEmployeeBalance_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtEmployeeBalance_Enabled), 5, 0), !bGXsfl_37_Refreshing);
      ...
      protected void STRUP5C0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8ProjectId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ProjectId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E115C2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("ProjectProjectEmployeeWCFilters")),UrlEncode(StringUtil.RTrim(AV32Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("ProjectProjectEmployeeWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "ProjectProjectEmployeeWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         if ( ! ( AV28IsAuthorized_Update ) )
         {
            ...
            AssignProp(sPrefix, false, edtavUpdate_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavUpdate_Visible), 5, 0), !bGXsfl_37_Refreshing);
         }
         ...
         if ( ! ( AV30IsAuthorized_Delete ) )
         {
            ...
            AssignProp(sPrefix, false, edtavDelete_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavDelete_Visible), 5, 0), !bGXsfl_37_Refreshing);
         }
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "ProjectProjectEmployeeWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Employee";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "ProjectId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8ProjectId), 10, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_22_5C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_27_5C2( true) ;
         }
         else
         {
            wb_table2_27_5C2( false) ;
         }
         return  ;
      }

      protected void wb_table2_27_5C2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_22_5C2e( true) ;
         }
         else
         {
            wb_table1_22_5C2e( false) ;
         }
      }

      protected void wb_table2_27_5C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavFilterfulltext_Internalname, AV16FilterFullText, StringUtil.RTrim( context.localUtil.Format( AV16FilterFullText, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "Search", edtavFilterfulltext_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFilterfulltext_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "WWPFullTextFilter", "start", true, "", "HLP_ProjectProjectEmployeeWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_27_5C2e( true) ;
         }
         else
         {
            wb_table2_27_5C2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8ProjectId = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8ProjectId", StringUtil.LTrimStr( (decimal)(AV8ProjectId), 10, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8ProjectId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "projectprojectemployeewc", GetJustCreated( ));
         ...
         {
            AV8ProjectId = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8ProjectId", StringUtil.LTrimStr( (decimal)(AV8ProjectId), 10, 0));
         }
         wcpOAV8ProjectId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ProjectId"), ".", ","), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8ProjectId != wcpOAV8ProjectId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8ProjectId = AV8ProjectId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8ProjectId = cgiGet( sPrefix+"AV8ProjectId_CTRL");
         if ( StringUtil.Len( sCtrlAV8ProjectId) > 0 )
         {
            AV8ProjectId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8ProjectId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8ProjectId", StringUtil.LTrimStr( (decimal)(AV8ProjectId), 10, 0));
         }
         else
         {
            AV8ProjectId = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8ProjectId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8ProjectId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ProjectId), 10, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8ProjectId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8ProjectId_CTRL", StringUtil.RTrim( sCtrlAV8ProjectId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202462821101823", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("projectprojectemployeewc.js", "?202462821101823", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_372( )
      {
         ...
         edtEmployeeLastName_Internalname = sPrefix+"EMPLOYEELASTNAME_"+sGXsfl_37_idx;
         edtEmployeeEmail_Internalname = sPrefix+"EMPLOYEEEMAIL_"+sGXsfl_37_idx;
         edtCompanyId_Internalname = sPrefix+"COMPANYID_"+sGXsfl_37_idx;
         edtCompanyName_Internalname = sPrefix+"COMPANYNAME_"+sGXsfl_37_idx;
         chkEmployeeIsManager_Internalname = sPrefix+"EMPLOYEEISMANAGER_"+sGXsfl_37_idx;
         edtGAMUserGUID_Internalname = sPrefix+"GAMUSERGUID_"+sGXsfl_37_idx;
         chkEmployeeIsActive_Internalname = sPrefix+"EMPLOYEEISACTIVE_"+sGXsfl_37_idx;
         edtEmployeeVactionDays_Internalname = sPrefix+"EMPLOYEEVACTIONDAYS_"+sGXsfl_37_idx;
      ...
      protected void SubsflControlProps_fel_372( )
      {
         ...
         edtEmployeeLastName_Internalname = sPrefix+"EMPLOYEELASTNAME_"+sGXsfl_37_fel_idx;
         edtEmployeeEmail_Internalname = sPrefix+"EMPLOYEEEMAIL_"+sGXsfl_37_fel_idx;
         edtCompanyId_Internalname = sPrefix+"COMPANYID_"+sGXsfl_37_fel_idx;
         edtCompanyName_Internalname = sPrefix+"COMPANYNAME_"+sGXsfl_37_fel_idx;
         chkEmployeeIsManager_Internalname = sPrefix+"EMPLOYEEISMANAGER_"+sGXsfl_37_fel_idx;
         edtGAMUserGUID_Internalname = sPrefix+"GAMUSERGUID_"+sGXsfl_37_fel_idx;
         chkEmployeeIsActive_Internalname = sPrefix+"EMPLOYEEISACTIVE_"+sGXsfl_37_fel_idx;
         edtEmployeeVactionDays_Internalname = sPrefix+"EMPLOYEEVACTIONDAYS_"+sGXsfl_37_fel_idx;
      ...
      protected void sendrow_372( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtEmployeeLastName_Internalname,StringUtil.RTrim( A108EmployeeLastName),(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtEmployeeLastName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)37,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCompanyName_Internalname,StringUtil.RTrim( A101CompanyName),(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCompanyName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)37,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            StyleString = "";
            GXCCtl = "EMPLOYEEISMANAGER_" + sGXsfl_37_idx;
            chkEmployeeIsManager.Name = GXCCtl;
            chkEmployeeIsManager.WebTags = "";
            chkEmployeeIsManager.Caption = "";
            AssignProp(sPrefix, false, chkEmployeeIsManager_Internalname, "TitleCaption", chkEmployeeIsManager.Caption, !bGXsfl_37_Refreshing);
            chkEmployeeIsManager.CheckedValue = "false";
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkEmployeeIsManager_Internalname,StringUtil.BoolToStr( A110EmployeeIsManager),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn hidden-xs",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            ClassString = "AttributeCheckBox";
            StyleString = "";
            GXCCtl = "EMPLOYEEISACTIVE_" + sGXsfl_37_idx;
            chkEmployeeIsActive.Name = GXCCtl;
            chkEmployeeIsActive.WebTags = "";
            chkEmployeeIsActive.Caption = "";
            AssignProp(sPrefix, false, chkEmployeeIsActive_Internalname, "TitleCaption", chkEmployeeIsActive.Caption, !bGXsfl_37_Refreshing);
            chkEmployeeIsActive.CheckedValue = "false";
            GridRow.AddColumnProperties("checkbox", 1, isAjaxCallMode( ), new Object[] {(string)chkEmployeeIsActive_Internalname,StringUtil.BoolToStr( A112EmployeeIsActive),(string)"",(string)"",(short)-1,(short)0,(string)"true",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn hidden-xs",(string)"",(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"end"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl37( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Vaction Days") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8ProjectId',fld:'vPROJECTID',pic:'ZZZZZZZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A106EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E125C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProjectId',fld:'vPROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A106EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E135C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProjectId',fld:'vPROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A106EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E145C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProjectId',fld:'vPROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A106EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E185C2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A106EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E115C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProjectId',fld:'vPROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A106EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E155C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProjectId',fld:'vPROJECTID',pic:'ZZZZZZZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A106EmployeeId',fld:'EMPLOYEEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H005C2_A106EmployeeId = new long[1] ;
         H005C2_A102ProjectId = new long[1] ;
         H005C2_A147EmployeeBalance = new short[1] ;
         H005C2_A146EmployeeVactionDays = new short[1] ;
         H005C2_A112EmployeeIsActive = new bool[] {false} ;
         H005C2_A111GAMUserGUID = new string[] {""} ;
         H005C2_A110EmployeeIsManager = new bool[] {false} ;
         H005C2_A101CompanyName = new string[] {""} ;
         H005C2_A100CompanyId = new long[1] ;
         H005C2_A109EmployeeEmail = new string[] {""} ;
         H005C2_A108EmployeeLastName = new string[] {""} ;
         H005C2_A107EmployeeFirstName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.projectprojectemployeewc__default(),
            new Object[][] {
                new Object[] {
               H005C2_A106EmployeeId, H005C2_A102ProjectId, H005C2_A147EmployeeBalance, H005C2_A146EmployeeVactionDays, H005C2_A112EmployeeIsActive, H005C2_A111GAMUserGUID, H005C2_A110EmployeeIsManager, H005C2_A101CompanyName, H005C2_A100CompanyId, H005C2_A109EmployeeEmail,
               H005C2_A108EmployeeLastName, H005C2_A107EmployeeFirstName
               }
               , new Object[] {
      ...
      private string sCtrlAV8ProjectId ;
      ...
      private long[] H005C2_A106EmployeeId ;
      private long[] H005C2_A102ProjectId ;
      private short[] H005C2_A147EmployeeBalance ;
      private short[] H005C2_A146EmployeeVactionDays ;
      private bool[] H005C2_A112EmployeeIsActive ;
      private string[] H005C2_A111GAMUserGUID ;
      private bool[] H005C2_A110EmployeeIsManager ;
      private string[] H005C2_A101CompanyName ;
      private long[] H005C2_A100CompanyId ;
      private string[] H005C2_A109EmployeeEmail ;
      private string[] H005C2_A108EmployeeLastName ;
      private string[] H005C2_A107EmployeeFirstName ;
   ...
   public class projectprojectemployeewc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long AV8ProjectId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.EmployeeId, T1.ProjectId, T2.EmployeeBalance, T2.EmployeeVactionDays, T2.EmployeeIsActive, T2.GAMUserGUID, T2.EmployeeIsManager, T3.CompanyName, T2.CompanyId, T2.EmployeeEmail, T2.EmployeeLastName, T2.EmployeeFirstName";
         sFromString = " FROM ((EmployeeProject T1 INNER JOIN Employee T2 ON T2.EmployeeId = T1.EmployeeId) INNER JOIN Company T3 ON T3.CompanyId = T2.CompanyId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.ProjectId = :AV8ProjectId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( LOWER(T2.EmployeeFirstName) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(T2.EmployeeLastName) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(T2.EmployeeEmail) like '%' || LOWER(:lV16FilterFullText)) or ( SUBSTR(TO_CHAR(T2.CompanyId,'9999999999'), 2) like '%' || :lV16FilterFullText) or ( LOWER(T3.CompanyName) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(T2.GAMUserGUID) like '%' || LOWER(:lV16FilterFullText)) or ( SUBSTR(TO_CHAR(T2.EmployeeVactionDays,'9999'), 2) like '%' || :lV16FilterFullText) or ( SUBSTR(TO_CHAR(T2.EmployeeBalance,'9999'), 2) like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.ProjectId, T2.EmployeeFirstName, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProjectId DESC, T2.EmployeeFirstName DESC, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProjectId, T2.EmployeeLastName, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProjectId DESC, T2.EmployeeLastName DESC, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProjectId, T2.EmployeeEmail, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProjectId DESC, T2.EmployeeEmail DESC, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProjectId, T2.CompanyId, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProjectId DESC, T2.CompanyId DESC, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProjectId, T3.CompanyName, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProjectId DESC, T3.CompanyName DESC, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProjectId, T2.EmployeeIsManager, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProjectId DESC, T2.EmployeeIsManager DESC, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProjectId, T2.GAMUserGUID, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProjectId DESC, T2.GAMUserGUID DESC, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProjectId, T2.EmployeeIsActive, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProjectId DESC, T2.EmployeeIsActive DESC, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProjectId, T2.EmployeeVactionDays, T1.EmployeeId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
                                             ...
                                             long AV8ProjectId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((EmployeeProject T1 INNER JOIN Employee T2 ON T2.EmployeeId = T1.EmployeeId) INNER JOIN Company T3 ON T3.CompanyId = T2.CompanyId)";
         AddWhere(sWhereString, "(T1.ProjectId = :AV8ProjectId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( LOWER(T2.EmployeeFirstName) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(T2.EmployeeLastName) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(T2.EmployeeEmail) like '%' || LOWER(:lV16FilterFullText)) or ( SUBSTR(TO_CHAR(T2.CompanyId,'9999999999'), 2) like '%' || :lV16FilterFullText) or ( LOWER(T3.CompanyName) like '%' || LOWER(:lV16FilterFullText)) or ( LOWER(T2.GAMUserGUID) like '%' || LOWER(:lV16FilterFullText)) or ( SUBSTR(TO_CHAR(T2.EmployeeVactionDays,'9999'), 2) like '%' || :lV16FilterFullText) or ( SUBSTR(TO_CHAR(T2.EmployeeBalance,'9999'), 2) like '%' || :lV16FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005C2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (long)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (bool)dynConstraints[10] , (long)dynConstraints[11] , (long)dynConstraints[12] );
               case 1 :
